...
class JGTower_v1:
    ...
    def SCIndex(self) -> func_adl_servicex_xaodr22.vector_int_.vector_int_:
        "A method"
        ...

    def TileIndex(self) -> func_adl_servicex_xaodr22.vector_int_.vector_int_:
        "A method"
        ...
