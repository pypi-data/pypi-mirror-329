...
_method_map = {
    'clearDecorations': {
        ...
        'type_string': 'xAOD::AFPTrackAuxContainer_v2',
...
def _add_method_metadata(s: ObjectStream[T], a: ast.Call) -> Tuple[ObjectStream[T], ast.Call]:
    ...
    if a.func.attr in _method_map:
        ...
        s_update = s_update.MetaData({
            ...
            'name': 'xAODForward/versions/AFPTrackAuxContainer_v2.h',
            'body_includes': ["xAODForward/versions/AFPTrackAuxContainer_v2.h"],
        })
