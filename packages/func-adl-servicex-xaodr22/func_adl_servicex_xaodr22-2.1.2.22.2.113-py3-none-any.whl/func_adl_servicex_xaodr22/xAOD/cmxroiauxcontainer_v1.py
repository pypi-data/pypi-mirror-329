...
_method_map = {
    'clearDecorations': {
        ...
        'type_string': 'xAOD::CMXRoIAuxContainer_v1',
...
def _add_method_metadata(s: ObjectStream[T], a: ast.Call) -> Tuple[ObjectStream[T], ast.Call]:
    ...
    if a.func.attr in _method_map:
        ...
        s_update = s_update.MetaData({
            ...
            'name': 'xAODTrigL1Calo/versions/CMXRoIAuxContainer_v1.h',
            'body_includes': ["xAODTrigL1Calo/versions/CMXRoIAuxContainer_v1.h"],
        })
