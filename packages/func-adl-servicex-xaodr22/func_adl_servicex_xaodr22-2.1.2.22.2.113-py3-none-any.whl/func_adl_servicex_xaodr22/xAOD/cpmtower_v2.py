...
_method_map = {
    'emErrorVec': {
        ...
        'type_string': 'xAOD::CPMTower_v2',
        'method_name': 'emErrorVec',
    ...
    'hadError': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::CPMTower_v2',
        'method_name': 'hadError',
        'return_type': 'unsigned int',
    },
    'emSliceError': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::CPMTower_v2',
        'method_name': 'emSliceError',
        'return_type': 'unsigned int',
    },
    'hadSliceError': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::CPMTower_v2',
        'method_name': 'hadSliceError',
        'return_type': 'unsigned int',
    },
    'index': {
        'metadata_type': 'add_method_type_info',
...
def _add_method_metadata(s: ObjectStream[T], a: ast.Call) -> Tuple[ObjectStream[T], ast.Call]:
    ...
    if a.func.attr in _method_map:
        ...
        s_update = s_update.MetaData({
            ...
            'name': 'xAODTrigL1Calo/versions/CPMTower_v2.h',
            'body_includes': ["xAODTrigL1Calo/versions/CPMTower_v2.h"],
        })
...
class CPMTower_v2:
    ...
    def emErrorVec(self) -> func_adl_servicex_xaodr22.vector_int_.vector_int_:
        "A method"
        ...

    def hadErrorVec(self) -> func_adl_servicex_xaodr22.vector_int_.vector_int_:
        "A method"
        ...
    ...
    def emError(self) -> int:
        "A method"
        ...

    def hadError(self) -> int:
        "A method"
        ...

    def emSliceError(self, slice: int) -> int:
        "A method"
        ...

    def hadSliceError(self, slice: int) -> int:
        "A method"
        ...
