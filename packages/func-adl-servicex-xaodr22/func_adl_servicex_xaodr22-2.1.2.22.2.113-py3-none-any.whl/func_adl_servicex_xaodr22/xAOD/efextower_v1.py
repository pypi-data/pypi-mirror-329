...
_method_map = {
    ...
    'disconnectedCount': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::eFexTower_v1',
        'method_name': 'disconnectedCount',
        'return_type': 'bool',
    },
    'em_status': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::eFexTower_v1',
        'method_name': 'em_status',
        'return_type': 'unsigned int',
    },
    'had_status': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::eFexTower_v1',
        'method_name': 'had_status',
        'return_type': 'unsigned int',
    },
    'eFEXtowerID': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::eFexTower_v1',
        'method_name': 'eFEXtowerID',
        'return_type': 'unsigned int',
    },
    'index': {
        'metadata_type': 'add_method_type_info',
...
def _add_method_metadata(s: ObjectStream[T], a: ast.Call) -> Tuple[ObjectStream[T], ast.Call]:
    ...
    if a.func.attr in _method_map:
        ...
        s_update = s_update.MetaData({
            ...
            'name': 'xAODTrigL1Calo/versions/eFexTower_v1.h',
            'body_includes': ["xAODTrigL1Calo/versions/eFexTower_v1.h"],
        })
...
class eFexTower_v1:
    ...
    def et_count(self) -> func_adl_servicex_xaodr22.vector_int_.vector_int_:
        "A method"
        ...

    def disconnectedCount(self, idx: int) -> bool:
        "A method"
        ...

    def em_status(self) -> int:
        "A method"
        ...

    def had_status(self) -> int:
        "A method"
        ...

    def eFEXtowerID(self) -> int:
        "A method"
        ...
