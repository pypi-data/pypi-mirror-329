...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kinesisanalytics)](https://pypistats.org/packages/mypy-boto3-kinesisanalytics)
...
`mypy-boto3-kinesisanalytics` dependency in production. However, there is an
