...
_MH_NAME_TO_ALGO: dict[str, collections.abc.Callable] = {
    'id': IdentityHash
}
for mhname, hlname in _MH_NAME_TO_ALGO_NAME.items():
    algo: collections.abc.Callable = typing.cast(collections.abc.Callable, getattr(hashlib, hlname, None))
...
def get_algorithm_by_code(code: str | int) -> collections.abc.Callable:
