...
from momotor.rpc.proto.asset_pb2 import DownloadAssetRequest, \
    UploadAssetRequest
from momotor.rpc.proto.auth_pb2 import AuthenticateRequest
from momotor.rpc.proto.job_pb2 import TEST_RECIPE, VERIFY_PRODUCT, \
    CreateJobRequest, EndJobRequest, JobStatusRequest, StartJobRequest
from momotor.rpc.proto.resource_pb2 import ADD_RESOURCE_ACTION, \
    REMOVE_RESOURCE_ACTION, SET_RESOURCE_ACTION, UpdateResourceRequest
...
__all__ = [
    ...
    'validate_update_resource_request',
]
...
def validate_update_resource_request(message: UpdateResourceRequest):
    """ Validate :py:class:`~momotor.rpc.proto.resource_pb2.GlobalResourceRequirementsRequest`
    
    :param message: The message to validate
    :raises FormatException: When the message is invalid
    """
    validate_required(message, ['action'])

    if message.action not in {SET_RESOURCE_ACTION, ADD_RESOURCE_ACTION, REMOVE_RESOURCE_ACTION}:
        raise FormatException("UpdateResourceRequest: action invalid")
