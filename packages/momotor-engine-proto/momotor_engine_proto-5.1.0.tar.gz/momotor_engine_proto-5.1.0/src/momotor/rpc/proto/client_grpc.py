...
import momotor.rpc.proto.resource_pb2
import momotor.rpc.proto.stats_pb2
...
class ClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def updateResources(self, stream: 'grpclib.server.Stream[momotor.rpc.proto.resource_pb2.UpdateResourceRequest, momotor.rpc.proto.resource_pb2.UpdateResourceResponse]') -> None:
        pass

    @abc.abstractmethod
    async def statistics(self, stream: 'grpclib.server.Stream[google.protobuf.empty_pb2.Empty, momotor.rpc.proto.stats_pb2.StatisticsResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/momotor.rpc.proto.Client/updateResources': grpclib.const.Handler(
                self.updateResources,
                grpclib.const.Cardinality.UNARY_UNARY,
                momotor.rpc.proto.resource_pb2.UpdateResourceRequest,
                momotor.rpc.proto.resource_pb2.UpdateResourceResponse,
            ),
            '/momotor.rpc.proto.Client/statistics': grpclib.const.Handler(
                self.statistics,
                grpclib.const.Cardinality.UNARY_UNARY,
                google.protobuf.empty_pb2.Empty,
                momotor.rpc.proto.stats_pb2.StatisticsResponse,
            ),
        }
...
class ClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.updateResources = grpclib.client.UnaryUnaryMethod(
            channel,
            '/momotor.rpc.proto.Client/updateResources',
            momotor.rpc.proto.resource_pb2.UpdateResourceRequest,
            momotor.rpc.proto.resource_pb2.UpdateResourceResponse,
        )
        self.statistics = grpclib.client.UnaryUnaryMethod(
            channel,
            '/momotor.rpc.proto.Client/statistics',
            google.protobuf.empty_pb2.Empty,
            momotor.rpc.proto.stats_pb2.StatisticsResponse,
        )
