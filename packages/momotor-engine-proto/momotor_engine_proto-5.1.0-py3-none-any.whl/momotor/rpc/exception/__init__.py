...
from momotor.rpc.proto.exception_pb2 import ASSET, ASSET_NOT_FOUND, AUTH, \
    FORMAT, INVALID_EXCEPTION, JOB
from momotor.rpc.proto.exception_pb2 import Exception as ExceptionMessage
...
def raise_message_exception(message: Message | None, *, log_level=logging.DEBUG):
    ...
    if has_exception:
        exc_message: ExceptionMessage = message.exception  # type: ignore
