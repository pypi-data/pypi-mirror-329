...
from momotor.rpc.proto.asset_pb2 import NO_CATEGORY, RESULT, AssetData, \
    AssetQuery, Category, DownloadAssetRequest
...
def validate_query_field(message: AssetData | DownloadAssetRequest):
