...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-amplifyuibuilder)](https://pypistats.org/packages/mypy-boto3-amplifyuibuilder)
...
`mypy-boto3-amplifyuibuilder` dependency in production. However, there is an
