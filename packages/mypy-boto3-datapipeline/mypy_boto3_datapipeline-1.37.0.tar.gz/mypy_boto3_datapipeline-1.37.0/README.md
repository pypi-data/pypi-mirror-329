...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-datapipeline)](https://pypistats.org/packages/mypy-boto3-datapipeline)
...
`mypy-boto3-datapipeline` dependency in production. However, there is an issue
