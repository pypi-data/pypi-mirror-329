...
def resize_samescale(image, width=None, height=None, inter=cv2.INTER_AREA):
    """
    ...
    Args:
        ...
        inter (int, optional): Interpolation method for resizing. Default is cv2.INTER_AREA.
...
if __name__=="__main__":
    ...
    # process_img, _, _ = resizepad(image, (256, 256))
