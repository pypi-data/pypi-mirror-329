...
async def repair_async(
    ...
    :rtype:  Mesh
    """
    func = environment_dispatch("itkwasm_mesh_filters", "repair_async")
    output = await func(input_mesh, merge_tolerance=merge_tolerance, minimum_component_area=minimum_component_area, maximum_hole_area=maximum_hole_area, maximum_hole_edges=maximum_hole_edges, maximum_degree3_distance=maximum_degree3_distance, remove_intersecting_triangles=remove_intersecting_triangles)
    return output
