...
async def smooth_remesh_async(
    ...
    :rtype:  Mesh
    """
    func = environment_dispatch("itkwasm_mesh_filters", "smooth_remesh_async")
    output = await func(input_mesh, number_points=number_points, triangle_shape_adaptation=triangle_shape_adaptation, triangle_size_adaptation=triangle_size_adaptation, normal_iterations=normal_iterations, lloyd_iterations=lloyd_iterations, newton_iterations=newton_iterations, newton_m=newton_m, lfs_samples=lfs_samples)
    return output
