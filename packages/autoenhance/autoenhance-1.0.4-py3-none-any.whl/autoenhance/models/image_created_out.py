...
class ImageCreatedOut(BaseModel):
    """
    ImageCreatedOut
    """ # noqa: E501
    ...
    s3_put_object_url: Optional[Any] = Field(default=None, description="The signed AWS S3 URL for the image to be uploaded to.", alias="s3PutObjectUrl")
    ...
    __properties: ClassVar[List[str]] = ["ai_version", "cloud_type", "date_added", "downloaded", "enhance", "enhance_type", "image_id", "image_name", "image_type", "is_threesixty", "lens_correction", "metadata", "order_id", "privacy", "rating", "s3PutObjectUrl", "scene", "sky_replacement", "status", "status_reason", "upscale", "user_id", "vertical_correction", "window_pull"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if s3_put_object_url (nullable) is None
        # and model_fields_set contains the field
        if self.s3_put_object_url is None and "s3_put_object_url" in self.model_fields_set:
            _dict['s3PutObjectUrl'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "s3PutObjectUrl": obj.get("s3PutObjectUrl"),
            "scene": obj.get("scene"),
