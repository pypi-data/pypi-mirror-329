...
class ImageInUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ai_version", "cloud_type", "content_type", "enhance", "enhance_type", "hdr", "image_name", "lens_correction", "order_id", "privacy", "rating", "sky_replacement", "threesixty", "upscale", "vertical_correction", "window_pull"]
