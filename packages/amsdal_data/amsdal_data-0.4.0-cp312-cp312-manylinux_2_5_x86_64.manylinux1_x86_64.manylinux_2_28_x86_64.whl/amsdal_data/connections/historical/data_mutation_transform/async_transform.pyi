...
from amsdal_data.connections.historical.data_query_transform import DEFAULT_PKS as DEFAULT_PKS, META_CLASS_NAME as META_CLASS_NAME, META_FOREIGN_KEYS as META_FOREIGN_KEYS, META_PRIMARY_KEY_FIELDS as META_PRIMARY_KEY_FIELDS, PK_FIELD_ALIAS_FOR_METADATA as PK_FIELD_ALIAS_FOR_METADATA, build_simple_query_statement_with_metadata as build_simple_query_statement_with_metadata
...
class AsyncDataMutationTransform(BaseDataMutationTransform):
    ...
    def __init__(self, connection: AsyncSqliteHistoricalConnection | AsyncPostgresHistoricalConnection, mutation: DataMutation) -> None: ...
    @property
    ...
    @classmethod
    async def _build_insert_mutations(cls, schema: glue.SchemaReference, data: list[glue.Data]) -> Sequence[glue.InsertData]: ...
