...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iotsecuretunneling)](https://pypistats.org/packages/mypy-boto3-iotsecuretunneling)
...
`mypy-boto3-iotsecuretunneling` dependency in production. However, there is an
