...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-frauddetector)](https://pypistats.org/packages/mypy-boto3-frauddetector)
...
`mypy-boto3-frauddetector` dependency in production. However, there is an issue
