...
if TYPE_CHECKING:
    from ..models.get_flow_version_response_200_extra_perms import GetFlowVersionResponse200ExtraPerms
    from ..models.get_flow_version_response_200_schema import GetFlowVersionResponse200Schema
    from ..models.get_flow_version_response_200_value import GetFlowVersionResponse200Value


T = TypeVar("T", bound="GetFlowVersionResponse200")


@_attrs_define
class GetFlowVersionResponse200:
    """
    Attributes:
        summary (str):
        value (GetFlowVersionResponse200Value):
        path (str):
        edited_by (str):
        ...
        schema (Union[Unset, GetFlowVersionResponse200Schema]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value = GetFlowVersionResponse200Value.from_dict(d.pop("value"))
        ...
        extra_perms = GetFlowVersionResponse200ExtraPerms.from_dict(d.pop("extra_perms"))
        ...
        return get_flow_version_response_200
