...
if TYPE_CHECKING:
    from ..models.abstract_job_result import AbstractJobResult
...
class JobDto:
    ...
    Attributes:
        ...
        result (Union['AbstractJobResult', 'JobProcessOfflineImportResult', 'JobSamplingOfflineDataImportResult',
            'JobSamplingOfflineImportAutoResult', Unset]):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.result, Unset):
            result = UNSET
        elif isinstance(self.result, AbstractJobResult):
        ...
        def _parse_result(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                result_type_0 = AbstractJobResult.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                result_type_1 = AbstractJobResult.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                result_type_2 = AbstractJobResult.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                result_type_3 = AbstractJobResult.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            result_type_7 = AbstractJobResult.from_dict(data)
