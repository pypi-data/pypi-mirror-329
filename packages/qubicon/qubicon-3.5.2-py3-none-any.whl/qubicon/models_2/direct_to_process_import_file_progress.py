...
from ..models.direct_to_process_import_file_progress_type import DirectToProcessImportFileProgressType
...
T = TypeVar("T", bound="DirectToProcessImportFileProgress")


@_attrs_define
class DirectToProcessImportFileProgress:
    """
    Attributes:
        grand_failure (Union[Unset, bool]):
        grand_skipped (Union[Unset, bool]):
        errors (Union[Unset, List['XlsxParsingErrorModel']]):
        type (Union[Unset, DirectToProcessImportFileProgressType]):
    ...
    type: Union[Unset, DirectToProcessImportFileProgressType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = DirectToProcessImportFileProgressType(_type)
        ...
        direct_to_process_import_file_progress = cls(
        ...
        direct_to_process_import_file_progress.additional_properties = d
        return direct_to_process_import_file_progress
