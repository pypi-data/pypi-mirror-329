...
T = TypeVar("T", bound="PHMeterImportFileMappingDto")


@_attrs_define
class PHMeterImportFileMappingDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ph_meter_import_file_mapping_dto = cls(
            type=type,
            columns=columns,
        ...
        ph_meter_import_file_mapping_dto.additional_properties = d
        return ph_meter_import_file_mapping_dto
