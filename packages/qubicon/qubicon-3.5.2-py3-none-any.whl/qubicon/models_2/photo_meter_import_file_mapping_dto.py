...
class PhotoMeterImportFileMappingDto:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        tag_name_column = self.tag_name_column
        ...
        if tag_name_column is not UNSET:
            field_dict["tagNameColumn"] = tag_name_column
        if sample_id_column is not UNSET:
            field_dict["sampleIdColumn"] = sample_id_column
        if data_column is not UNSET:
            field_dict["dataColumn"] = data_column
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        tag_name_column = d.pop("tagNameColumn", UNSET)

        sample_id_column = d.pop("sampleIdColumn", UNSET)

        data_column = d.pop("dataColumn", UNSET)

        error_column = d.pop("errorColumn", UNSET)

        photo_meter_import_file_mapping_dto = cls(
            type=type,
            columns=columns,
            tag_name_column=tag_name_column,
            sample_id_column=sample_id_column,
            data_column=data_column,
            error_column=error_column,
        )

        photo_meter_import_file_mapping_dto.additional_properties = d
        return photo_meter_import_file_mapping_dto
