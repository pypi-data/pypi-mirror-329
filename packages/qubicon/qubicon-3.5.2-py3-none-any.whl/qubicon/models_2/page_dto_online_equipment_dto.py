...
T = TypeVar("T", bound="PageDtoOnlineEquipmentDto")


@_attrs_define
class PageDtoOnlineEquipmentDto:
    """
    Attributes:
        content (Union[Unset, List['OnlineEquipmentDto']]):
        page (Union[Unset, PageMetaDataDto]):
    """

    content: Union[Unset, List["OnlineEquipmentDto"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for content_item_data in _content or []:
            content_item = OnlineEquipmentDto.from_dict(content_item_data)
        ...
        page_dto_online_equipment_dto = cls(
            content=content,
            page=page,
        )

        page_dto_online_equipment_dto.additional_properties = d
        return page_dto_online_equipment_dto
