...
if TYPE_CHECKING:
    from ..models.xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags_defined_packages_item import (
        XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsDefinedPackagesItem,
    )
    from ..models.xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags_parent import (
        XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParent,
    )
    from ..models.xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags_unnamed_module import (
        XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsUnnamedModule,
    )


T = TypeVar("T", bound="XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlags")


@_attrs_define
class XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlags:
    """
    Attributes:
        unnamed_module (Union[Unset, XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsUnnamedModule]):
        parent (Union[Unset, XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParent]):
        default_assertion_status (Union[Unset, bool]):
        name (Union[Unset, str]):
        defined_packages (Union[Unset,
            List['XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsDefinedPackagesItem']]):
        default_assertion_status_impl (Union[Unset, bool]):
        registered_as_parallel_capable (Union[Unset, bool]):
    """

    unnamed_module: Union[Unset, "XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsUnnamedModule"] = UNSET
    parent: Union[Unset, "XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParent"] = UNSET
    default_assertion_status: Union[Unset, bool] = UNSET
    name: Union[Unset, str] = UNSET
    defined_packages: Union[
        Unset, List["XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsDefinedPackagesItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_unnamed_module, Unset):
            ...
            unnamed_module = XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsUnnamedModule.from_dict(
                _unnamed_module
            )
        ...
        if isinstance(_parent, Unset):
            ...
            parent = XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParent.from_dict(_parent)
        ...
        for defined_packages_item_data in _defined_packages or []:
            defined_packages_item = (
                XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsDefinedPackagesItem.from_dict(
        ...
        xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags = cls(
        ...
        xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags.additional_properties = d
        return xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags
