...
T = TypeVar("T", bound="AbstractComputableModelDto")


@_attrs_define
class AbstractComputableModelDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        abstract_computable_model_dto = cls(
        ...
        abstract_computable_model_dto.additional_properties = d
        return abstract_computable_model_dto
