...
class OnlineEquipmentNodeVariableDto:
    ...
    Attributes:
        ...
        auto_start_reading (Union[Unset, bool]):
    ...
    auto_start_reading: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        auto_start_reading = self.auto_start_reading
        ...
        if auto_start_reading is not UNSET:
            field_dict["autoStartReading"] = auto_start_reading
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        auto_start_reading = d.pop("autoStartReading", UNSET)
        ...
        online_equipment_node_variable_dto = cls(
            ...
            auto_start_reading=auto_start_reading,
