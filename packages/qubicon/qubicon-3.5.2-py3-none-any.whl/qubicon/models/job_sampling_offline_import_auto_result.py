...
T = TypeVar("T", bound="JobSamplingOfflineImportAutoResult")


@_attrs_define
class JobSamplingOfflineImportAutoResult:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_sampling_offline_import_auto_result = cls(
            job_type=job_type,
            result=result,
        )

        job_sampling_offline_import_auto_result.additional_properties = d
        return job_sampling_offline_import_auto_result
