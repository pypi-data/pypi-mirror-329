...
T = TypeVar("T", bound="CeDexImportFileMappingDto")


@_attrs_define
class CeDexImportFileMappingDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ce_dex_import_file_mapping_dto = cls(
            type=type,
            columns=columns,
        ...
        ce_dex_import_file_mapping_dto.additional_properties = d
        return ce_dex_import_file_mapping_dto
