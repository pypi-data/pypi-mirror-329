...
T = TypeVar("T", bound="PageDtoOfflineEquipmentDto")


@_attrs_define
class PageDtoOfflineEquipmentDto:
    """
    Attributes:
        content (Union[Unset, List['OfflineEquipmentDto']]):
        page (Union[Unset, PageMetaDataDto]):
    """

    content: Union[Unset, List["OfflineEquipmentDto"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for content_item_data in _content or []:
            content_item = OfflineEquipmentDto.from_dict(content_item_data)
        ...
        page_dto_offline_equipment_dto = cls(
            content=content,
            page=page,
        )

        page_dto_offline_equipment_dto.additional_properties = d
        return page_dto_offline_equipment_dto
