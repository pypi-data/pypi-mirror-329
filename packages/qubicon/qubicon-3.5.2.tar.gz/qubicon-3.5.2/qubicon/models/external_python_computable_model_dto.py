...
T = TypeVar("T", bound="ExternalPythonComputableModelDto")


@_attrs_define
class ExternalPythonComputableModelDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        external_file = StoredFileDto.from_dict(d.pop("externalFile"))
        ...
        external_python_computable_model_dto = cls(
        ...
        external_python_computable_model_dto.additional_properties = d
        return external_python_computable_model_dto
