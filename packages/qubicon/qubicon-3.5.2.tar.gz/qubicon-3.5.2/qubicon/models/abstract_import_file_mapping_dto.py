...
T = TypeVar("T", bound="AbstractImportFileMappingDto")


@_attrs_define
class AbstractImportFileMappingDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        abstract_import_file_mapping_dto = cls(
            type=type,
            columns=columns,
        )

        abstract_import_file_mapping_dto.additional_properties = d
        return abstract_import_file_mapping_dto
