...
if TYPE_CHECKING:
    from ..models.xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags_parent_defined_packages_item_annotations_item import (
        XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParentDefinedPackagesItemAnnotationsItem,
    )
    from ..models.xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags_parent_defined_packages_item_declared_annotations_item import (
        XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParentDefinedPackagesItemDeclaredAnnotationsItem,
    )


T = TypeVar("T", bound="XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParentDefinedPackagesItem")


@_attrs_define
class XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParentDefinedPackagesItem:
    """
    Attributes:
        ...
        annotations (Union[Unset,
            List['XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParentDefinedPackagesItemAnnotationsItem']]):
        declared_annotations (Union[Unset, List['XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParentDefin
            edPackagesItemDeclaredAnnotationsItem']]):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for annotations_item_data in _annotations or []:
            annotations_item = XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParentDefinedPackagesItemAnnotationsItem.from_dict(
        ...
        for declared_annotations_item_data in _declared_annotations or []:
            declared_annotations_item = XlsxParsingErrorModelThrowableStackTraceItemIncludeInfoFlagsParentDefinedPackagesItemDeclaredAnnotationsItem.from_dict(
                declared_annotations_item_data
            )

            declared_annotations.append(declared_annotations_item)

        xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags_parent_defined_packages_item = cls(
            name=name,
        ...
        xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags_parent_defined_packages_item.additional_properties = d
        return xlsx_parsing_error_model_throwable_stack_trace_item_include_info_flags_parent_defined_packages_item
