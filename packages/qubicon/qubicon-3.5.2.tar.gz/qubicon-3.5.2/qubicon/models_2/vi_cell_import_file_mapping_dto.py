...
T = TypeVar("T", bound="ViCellImportFileMappingDto")


@_attrs_define
class ViCellImportFileMappingDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        vi_cell_import_file_mapping_dto = cls(
            type=type,
            columns=columns,
        ...
        vi_cell_import_file_mapping_dto.additional_properties = d
        return vi_cell_import_file_mapping_dto
