...
class BrainbaseLabs(SyncAPIClient):
    ...
    with_raw_response: BrainbaseLabsWithRawResponse
    with_streaming_response: BrainbaseLabsWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous brainbase-labs client instance.
        ...
        self.with_raw_response = BrainbaseLabsWithRawResponse(self)
        self.with_streaming_response = BrainbaseLabsWithStreamedResponse(self)
...
class AsyncBrainbaseLabs(AsyncAPIClient):
    ...
    with_raw_response: AsyncBrainbaseLabsWithRawResponse
    with_streaming_response: AsyncBrainbaseLabsWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async brainbase-labs client instance.
        ...
        self.with_raw_response = AsyncBrainbaseLabsWithRawResponse(self)
        self.with_streaming_response = AsyncBrainbaseLabsWithStreamedResponse(self)
