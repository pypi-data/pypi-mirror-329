...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-appconfigdata)](https://pypistats.org/packages/mypy-boto3-appconfigdata)
...
`mypy-boto3-appconfigdata` dependency in production. However, there is an issue
