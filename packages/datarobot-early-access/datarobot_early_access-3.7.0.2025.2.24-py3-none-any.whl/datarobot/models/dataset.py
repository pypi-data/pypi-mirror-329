...
from datarobot.models.credential import Credential, CredentialDataSchema
...
class Dataset(APIObject, BrowserMixin):
    ...
    def create_from_project(
        ...
        ----------
        project_id: string
            The project to create the dataset from.
        categories: list[string], optional
            An array of strings describing the intended use of the dataset. The
            current supported options are "TRAINING" and "PREDICTION".
        max_wait: Optional[int]
        ...
        -------
        response: Dataset
            The dataset created from the project dataset.
        """
        base_data = {"project_id": project_id, "categories": categories}
        data = _remove_empty_params(base_data)
