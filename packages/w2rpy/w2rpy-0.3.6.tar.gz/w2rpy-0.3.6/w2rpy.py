...
def make_pdf_maps(QGIS_install_path,qgs_file,results_df,aoi,project_title,extra_text,output_folder,basemap=False,extra_layers=None,style_dict=None,legend_dict=None,zorder=-2):
