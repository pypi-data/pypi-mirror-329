...
from fastapi import File as File, Form as Form, Request as Request
...
class TortoiseCRUDRouter(CRUDGenerator[SCHEMA]):
    db_model: Incomplete
    def __init__(self, schema: type[SCHEMA], db_model: type[Model], create_schema: type[SCHEMA] | None = None, update_schema: type[SCHEMA] | None = None, filter_schema: type[SCHEMA] | None = None, user_data_option: UserDataOption = ..., tenant_data_option: TenantDataOption = ..., prefix: str | None = None, target: str | None = None, tags: list[str] | None = None, paginate: int | None = None, get_all_route: bool | DEPENDENCIES = False, get_one_route: bool | DEPENDENCIES = False, create_route: bool | DEPENDENCIES = False, update_route: bool | DEPENDENCIES = False, delete_one_route: bool | DEPENDENCIES = False, delete_all_route: bool | DEPENDENCIES = False, kcreate_route: bool | DEPENDENCIES = True, kbatch_create_route: bool | DEPENDENCIES = True, kdelete_route: bool | DEPENDENCIES = True, kbatch_delete_route: bool | DEPENDENCIES = True, kdelete_all_route: bool | DEPENDENCIES = True, kupdate_route: bool | DEPENDENCIES = True, kget_by_id_route: bool | DEPENDENCIES = True, kget_one_by_filter_route: bool | DEPENDENCIES = True, klist_route: bool | DEPENDENCIES = True, kquery_route: bool | DEPENDENCIES = True, kquery_ex_route: bool | DEPENDENCIES = True, kupsert_route: bool | DEPENDENCIES = True, kupload_file_route: bool | DEPENDENCIES = False, kupdate_file_route: bool | DEPENDENCIES = False, **kwargs: Any) -> None: ...
