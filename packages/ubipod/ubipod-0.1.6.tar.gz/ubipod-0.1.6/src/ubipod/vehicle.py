...
class Auto:
    ...
    motor_curves: list[int] = field(default_factory=list)
...
class Graphics:
    ...
    def read(self, read: PbdfReader) -> None:
        ...
        self.texture_project = read.any(TextureProject, read.format.tex_size_small)
...
class Sounds:
    ...
    def read(self, read: PbdfReader) -> None:
        ...
        self.slide_x = read.i16()
        self.slide_x_fine = read.i16()
        self.slide_y = read.i16()
        self.slide_y_fine = read.i16()
        self.shock = read.i16()
        self.accel = read.i16()
        self.accel_fine = read.i16()
        self.decel = read.i16()
        self.decel_fine = read.i16()
        self.hit_ground = read.i16()
        self.hit_roof = read.i16()
        self.hit_roof_stop = read.i16()
        read.bytes(2)
    ...
    def write(self, write: PbdfWriter) -> None:
        ...
        write.i16(self.slide_x)
        write.i16(self.slide_x_fine)
        write.i16(self.slide_y)
        write.i16(self.slide_y_fine)
        write.i16(self.shock)
        write.i16(self.accel)
        write.i16(self.accel_fine)
        write.i16(self.decel)
        write.i16(self.decel_fine)
        write.i16(self.hit_ground)
        write.i16(self.hit_roof)
        write.i16(self.hit_roof_stop)
...
class Vehicle:
    ...
    lod1: Decor = field(default_factory=Decor)
    lod2: Decor = field(default_factory=Decor)
    ...
    def read(self, read: PbdfReader) -> None:
        ...
        if read.format.version < 8:
            ...
            self.lod1 = read.any(Decor)
            self.lod2 = read.any(Decor)
        else:
            self.graphics = read.any(Graphics)
            self.lod1 = read.any(Decor)
            self.lod2 = read.any(Decor)
