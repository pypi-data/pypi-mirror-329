...
class MPIEnvironment:
    ...
    try:
        ...
        # running test_casampi[test_server_not_responsive]
    ...
    def setup_logger(origin, show):
        ...
        casalog.processorOrigin(origin)
        casalog.showconsole()
    ...
    if is_mpi_enabled:
        ...
        setup_logger(processor_origin, is_mpi_enabled and log_to_console)
