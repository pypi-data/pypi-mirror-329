...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-codecommit)](https://pypistats.org/packages/mypy-boto3-codecommit)
...
`mypy-boto3-codecommit` dependency in production. However, there is an issue in
