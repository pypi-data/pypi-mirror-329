...
# pylint: skip-file
#
# pytest-isolate-mpi documentation build configuration file.
#
...
htmlhelp_basename = "pytest_isolate_mpidoc"
...
latex_documents = [
    (
        master_doc,
        "pytest_isolate_mpi.tex",
        "pytest-isolate-mpi Documentation",
...
man_pages = [(master_doc, "pytest_isolate_mpi", "pytest-isolate-mpi Documentation", [author], 1)]
