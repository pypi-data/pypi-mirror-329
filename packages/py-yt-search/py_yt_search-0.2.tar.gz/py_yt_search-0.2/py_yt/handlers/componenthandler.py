...
from py_yt.core.constants import videoElementKey, channelElementKey, playlistElementKey, shelfElementKey
...
class ComponentHandler:
    def _getVideoComponent(self, element: dict, shelfTitle: str = None) -> dict:
        ...
        component = {
            ...
            'richThumbnail': self._getValue(video,
            ...
            'channel': {
                ...
                'id': self._getValue(video,
                                     ['ownerText', 'runs', 0, 'navigationEndpoint', 'browseEndpoint', 'browseId']),
                'thumbnails': self._getValue(video,
    ...
    def _getPlaylistComponent(self, element: dict) -> dict:
        ...
        component = {
            ...
            'thumbnails': self._getValue(playlist, ['thumbnailRenderer', 'playlistVideoThumbnailRenderer', 'thumbnail',
                                                    'thumbnails']),
        }
            ...
            if responsetype == "video":
                json = {
                    ...
                    "views": {
                        ...
                        "approximate": self._getValue(element,
                    ...
                    "channel": {
                        ...
                        "thumbnails": self._getValue(element, ["channelThumbnailSupportedRenderers",
