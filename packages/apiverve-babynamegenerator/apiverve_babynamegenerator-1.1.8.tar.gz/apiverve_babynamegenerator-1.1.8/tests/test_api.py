...
class TestBabynamegeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = BabynamegeneratorAPIClient(self.api_key)

    @patch('apiverve_babynamegenerator.apiClient.requests.get')
