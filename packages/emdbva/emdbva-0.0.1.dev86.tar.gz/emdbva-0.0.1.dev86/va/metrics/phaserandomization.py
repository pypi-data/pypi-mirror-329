...
def relion_mask(mapone, maptwo, out_dir, relion_mask_executable, mapname=None, resolution=None):
    ...
    filter_to = 12. if float(resolution) < 8. else float(resolution) * 1.5
...
def relion_fsc_calculation(mapone, maptwo, root, mapname=None, resolution=None):
    ...
    try:
        ...
        if fsc_dir and mask_dir and relion_mask_executable:
            relion_mask_name = relion_mask(mapone, maptwo, mask_dir, relion_mask_executable, mapname, resolution)
            ...
            relion_fsc_result = relion_fsc(mapone, maptwo, fsc_dir, relion_executable, mapname)
