...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iotfleethub)](https://pypistats.org/packages/mypy-boto3-iotfleethub)
...
`mypy-boto3-iotfleethub` dependency in production. However, there is an issue
