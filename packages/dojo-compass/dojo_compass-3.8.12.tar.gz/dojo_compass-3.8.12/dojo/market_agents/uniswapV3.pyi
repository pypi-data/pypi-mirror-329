...
class HistoricReplayAgent(BaseAgent[UniswapV3Observation]):
    def __init__(self, chain: Chain, pools: list[str], block_range: tuple[int, int], mode: Literal['standard', 'swaps_only'] = 'standard', name: str = 'MarketAgent', dataloader: BaseUniswapV3Loader | None = None) -> None: ...
