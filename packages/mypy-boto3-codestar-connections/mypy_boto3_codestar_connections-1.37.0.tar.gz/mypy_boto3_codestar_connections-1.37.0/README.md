...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-codestar-connections)](https://pypistats.org/packages/mypy-boto3-codestar-connections)
...
`mypy-boto3-codestar-connections` dependency in production. However, there is
