...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-fms)](https://pypistats.org/packages/mypy-boto3-fms)
...
`mypy-boto3-fms` dependency in production. However, there is an issue in
