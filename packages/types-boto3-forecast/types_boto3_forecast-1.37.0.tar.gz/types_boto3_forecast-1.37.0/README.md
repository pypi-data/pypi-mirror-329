<a id="types-boto3-forecast"></a>

# types-boto3-forecast

[![PyPI - types-boto3-forecast](https://img.shields.io/pypi/v/types-boto3-forecast.svg?color=blue)](https://pypi.org/project/types-boto3-forecast/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-forecast.svg?color=blue)](https://pypi.org/project/types-boto3-forecast/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-forecast)](https://pypistats.org/packages/types-boto3-forecast)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 ForecastService 1.37.0](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-forecast docs](https://youtype.github.io/types_boto3_docs/types_boto3_forecast/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-forecast](#types-boto3-forecast)
...
- Install `types-boto3[forecast]` in your environment:
...
- Install `types-boto3[forecast]` with services you use in your environment:
...
`types-boto3-forecast` dependency in production. However, there is an issue in
...
from types_boto3_forecast import ForecastServiceClient
...
`types_boto3_forecast.paginator` module contains type annotations for all
paginators.
...
`types_boto3_forecast.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `ForecastService` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_forecast/literals/).
...
`types_boto3_forecast.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `ForecastService` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_forecast/type_defs/).
...
`types-boto3-forecast` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_forecast/)
