...
from chromadb_deterministic.proto import logservice_pb2 as chromadb_dot_proto_dot_logservice__pb2
...
class LogServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PushLogs = channel.unary_unary(
                '/chroma_deterministic.LogService/PushLogs',
        ...
        self.PullLogs = channel.unary_unary(
                '/chroma_deterministic.LogService/PullLogs',
        ...
        self.GetAllCollectionInfoToCompact = channel.unary_unary(
                '/chroma_deterministic.LogService/GetAllCollectionInfoToCompact',
        ...
        self.UpdateCollectionLogOffset = channel.unary_unary(
                '/chroma_deterministic.LogService/UpdateCollectionLogOffset',
...
def add_LogServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'chroma_deterministic.LogService', rpc_method_handlers)
