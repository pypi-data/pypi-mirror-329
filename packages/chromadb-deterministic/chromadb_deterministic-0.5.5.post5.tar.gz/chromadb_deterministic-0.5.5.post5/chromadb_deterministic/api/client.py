...
import httpx
from chromadb_deterministic.api import AdminAPI, ClientAPI, ServerAPI
...
class Client(SharedSystemClient, ClientAPI):
    """A client for chroma_deterministic. This is the main entrypoint for interacting with chroma_deterministic.
    A client internally stores its tenant and database and proxies calls to a
    Server API instance of chroma_deterministic. It treats the Server API and corresponding System
