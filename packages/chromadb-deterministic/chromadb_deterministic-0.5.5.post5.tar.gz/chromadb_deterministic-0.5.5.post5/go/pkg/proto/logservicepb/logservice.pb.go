...
type GetAllCollectionInfoToCompactRequest struct {
	...
	MinCompactionSize uint64 `protobuf:"varint,1,opt,name=min_compaction_size,json=minCompactionSize,proto3" json:"min_compaction_size,omitempty"`
}
...
func (x *GetAllCollectionInfoToCompactRequest) GetMinCompactionSize() uint64 {
	if x != nil {
		return x.MinCompactionSize
	}
	return 0
}
...
var file_chromadb_proto_logservice_proto_rawDesc = []byte{
	...
	0x67, 0x54, 0x73, 0x22, 0x56, 0x0a, 0x24, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x43, 0x6f, 0x6c,
	0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x54, 0x6f, 0x43, 0x6f, 0x6d,
	0x70, 0x61, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x13, 0x6d,
	0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69,
	0x7a, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x11, 0x6d, 0x69, 0x6e, 0x43, 0x6f, 0x6d,
	0x70, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x6f, 0x0a, 0x25, 0x47,
...
var file_chromadb_proto_logservice_proto_goTypes = []any{
	(*PushLogsRequest)(nil),                       // 0: chroma_deterministic.PushLogsRequest
	(*PushLogsResponse)(nil),                      // 1: chroma_deterministic.PushLogsResponse
	(*PullLogsRequest)(nil),                       // 2: chroma_deterministic.PullLogsRequest
	(*LogRecord)(nil),                             // 3: chroma_deterministic.LogRecord
	(*PullLogsResponse)(nil),                      // 4: chroma_deterministic.PullLogsResponse
	(*CollectionInfo)(nil),                        // 5: chroma_deterministic.CollectionInfo
	(*GetAllCollectionInfoToCompactRequest)(nil),  // 6: chroma_deterministic.GetAllCollectionInfoToCompactRequest
	(*GetAllCollectionInfoToCompactResponse)(nil), // 7: chroma_deterministic.GetAllCollectionInfoToCompactResponse
	(*UpdateCollectionLogOffsetRequest)(nil),      // 8: chroma_deterministic.UpdateCollectionLogOffsetRequest
	(*UpdateCollectionLogOffsetResponse)(nil),     // 9: chroma_deterministic.UpdateCollectionLogOffsetResponse
	(*coordinatorpb.OperationRecord)(nil),         // 10: chroma_deterministic.OperationRecord
}
var file_chromadb_proto_logservice_proto_depIdxs = []int32{
	10, // 0: chroma_deterministic.PushLogsRequest.records:type_name -> chroma_deterministic.OperationRecord
	10, // 1: chroma_deterministic.LogRecord.record:type_name -> chroma_deterministic.OperationRecord
	3,  // 2: chroma_deterministic.PullLogsResponse.records:type_name -> chroma_deterministic.LogRecord
	5,  // 3: chroma_deterministic.GetAllCollectionInfoToCompactResponse.all_collection_info:type_name -> chroma_deterministic.CollectionInfo
	0,  // 4: chroma_deterministic.LogService.PushLogs:input_type -> chroma_deterministic.PushLogsRequest
	2,  // 5: chroma_deterministic.LogService.PullLogs:input_type -> chroma_deterministic.PullLogsRequest
	6,  // 6: chroma_deterministic.LogService.GetAllCollectionInfoToCompact:input_type -> chroma_deterministic.GetAllCollectionInfoToCompactRequest
	8,  // 7: chroma_deterministic.LogService.UpdateCollectionLogOffset:input_type -> chroma_deterministic.UpdateCollectionLogOffsetRequest
	1,  // 8: chroma_deterministic.LogService.PushLogs:output_type -> chroma_deterministic.PushLogsResponse
	4,  // 9: chroma_deterministic.LogService.PullLogs:output_type -> chroma_deterministic.PullLogsResponse
	7,  // 10: chroma_deterministic.LogService.GetAllCollectionInfoToCompact:output_type -> chroma_deterministic.GetAllCollectionInfoToCompactResponse
	9,  // 11: chroma_deterministic.LogService.UpdateCollectionLogOffset:output_type -> chroma_deterministic.UpdateCollectionLogOffsetResponse
...
func file_chromadb_proto_logservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chromadb_proto_logservice_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_chromadb_proto_logservice_proto_msgTypes[9].Exporter = func(v any, i int) any {
