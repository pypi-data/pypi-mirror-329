...
2. The user-submitted question is passed to OpenAI's API, along with the extra context retrieved by chroma_deterministic. The OpenAI API generates generates a response.
