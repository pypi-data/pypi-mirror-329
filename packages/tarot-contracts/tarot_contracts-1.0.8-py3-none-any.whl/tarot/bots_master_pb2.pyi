...
class Bot(_message.Message):
    __slots__ = ["id", "token", "group", "provider", "name", "tarot_config"]
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[int] = ..., token: _Optional[str] = ..., group: _Optional[_Union[BotGroup, str]] = ..., provider: _Optional[_Union[BotProvider, str]] = ..., name: _Optional[str] = ..., tarot_config: _Optional[_Union[TarotBotConfig, _Mapping]] = ...) -> None: ...
