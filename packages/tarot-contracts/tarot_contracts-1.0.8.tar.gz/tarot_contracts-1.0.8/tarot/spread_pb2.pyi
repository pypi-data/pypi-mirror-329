...
class SaveSpreadRequest(_message.Message):
    __slots__ = ["tg_id", "bot_id", "spread", "question", "category", "language", "histories"]
    TG_ID_FIELD_NUMBER: _ClassVar[int]
    BOT_ID_FIELD_NUMBER: _ClassVar[int]
    SPREAD_FIELD_NUMBER: _ClassVar[int]
    QUESTION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, tg_id: _Optional[int] = ..., bot_id: _Optional[int] = ..., spread: _Optional[str] = ..., question: _Optional[str] = ..., category: _Optional[str] = ..., language: _Optional[str] = ..., histories: _Optional[_Iterable[_Union[SpreadHistoryItem, _Mapping]]] = ...) -> None: ...
