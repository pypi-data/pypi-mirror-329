<a id="types-boto3-elasticache"></a>

# types-boto3-elasticache

[![PyPI - types-boto3-elasticache](https://img.shields.io/pypi/v/types-boto3-elasticache.svg?color=blue)](https://pypi.org/project/types-boto3-elasticache/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-elasticache.svg?color=blue)](https://pypi.org/project/types-boto3-elasticache/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-elasticache)](https://pypistats.org/packages/types-boto3-elasticache)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 ElastiCache 1.37.0](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-elasticache docs](https://youtype.github.io/types_boto3_docs/types_boto3_elasticache/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-elasticache](#types-boto3-elasticache)
...
- Install `types-boto3[elasticache]` in your environment:
...
- Install `types-boto3[elasticache]` with services you use in your environment:
...
`types-boto3-elasticache` dependency in production. However, there is an issue
...
from types_boto3_elasticache import ElastiCacheClient
...
`types_boto3_elasticache.paginator` module contains type annotations for all
paginators.
...
`types_boto3_elasticache.waiter` module contains type annotations for all
waiters.
...
`types_boto3_elasticache.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `ElastiCache` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_elasticache/literals/).
...
`types_boto3_elasticache.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `ElastiCache` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_elasticache/type_defs/).
...
`types-boto3-elasticache` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_elasticache/)
