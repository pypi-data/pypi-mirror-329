...
| aichat_default_prompt_file | str | 否 | "" | 默认提示词文件路径，与提示词二选一，优先使用文件 |
...
| aichat_save_user_config | bool | 否 | true | 是否保存用户配置，关闭nonebot时将会保存用户所选模型，对话内容等，启动时读取 |
...
[
{
    "url": "图片地址，支持链接或本地路径，本地路径请注意将斜杠转义！",
