...
from .group_group_type import GroupGroupTypesLocal as GroupType
from .insert_link import InsertLink
...
class GroupsLocal(GenericCRUDML, metaclass=MetaLogger,
    ...
    def insert(  # noqa
        ...
        """
        group_group_type_instance = GroupType()
        group_group_types_ids = group_group_type_instance.link_group_to_group_types(group_id=group_id, group_type_ids=group_types_ids)
        """
    ...
    def upsert(self, *,  # noqa
        ...
        if group_dict.get("is_job_title"):
            insert_link_instance = InsertLink()
            insert_link_job_result_dict = insert_link_instance.insert_link_job_title(
