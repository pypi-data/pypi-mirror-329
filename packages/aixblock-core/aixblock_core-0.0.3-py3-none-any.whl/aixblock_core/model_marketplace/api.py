...
class AddModelApi(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        @transaction.atomic
        def process_compute(compute_id, index, gpus_id_list=None, model_name = None, model_pk = None, info_run=None):
        ...
        for gpu_info in gpus_data:
            ...
            for index, gpu_id in enumerate(gpus):
                process_compute(compute_id, index, gpu_id, model_name, max_pk+1, info_run)
...
class BuildModelSourceAPI(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        def process_compute(compute_id, gpu_id, max_pk):
...
class HistoryRentModelListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if settings.DJANGO_DB == "sqlite":
            ...
            rented_records = list({obj["model_new_id"]: obj for obj in rented_records.values("model_new_id")}.values())
