        ...
        if containers:
            ...
            if container_status != "running":
                try:
                    ...
                    local_privkey = "./aixblock_core/templates/ssl_cert/reverse.aixblock.io.privkey.pem"
                    local_fullchain = "./aixblock_core/templates/ssl_cert/reverse.aixblock.io.fullchain.pem"
