...
MIDDLEWARE = [
    ...
    # 'core.middleware.ActivityLoggerMiddleware'
]
...
CRYPTO_API = get_env('CRYPTO_API', '')
CRYPTO_SECRET_KEY = get_env('CRYPTO_SECRET_KEY', '')
SEND_LOG_ACTIVITY = get_env('SEND_LOG_ACTIVITY', True)