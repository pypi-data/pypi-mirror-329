<a id="types-boto3-observabilityadmin"></a>
...
[boto3 CloudWatchObservabilityAdminService 1.37.0](https://pypi.org/project/boto3/)
...
```python
from types_boto3_observabilityadmin.literals import (
