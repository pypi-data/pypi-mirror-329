...
class IndexArgs:
    def __init__(__self__, *,
                 ...
                 col_exprs: pulumi.Input[Sequence[pulumi.Input['IndexColExprArgs']]],
        ...
        :param pulumi.Input[str] cluster_name: The cluster to maintain this index.
        ...
        :param pulumi.Input[str] comment: Comment on an object in the database.
    ...
    def col_exprs(self) -> pulumi.Input[Sequence[pulumi.Input['IndexColExprArgs']]]:
        """
    ...
    @col_exprs.setter
    def col_exprs(self, value: pulumi.Input[Sequence[pulumi.Input['IndexColExprArgs']]]):
...
class _IndexState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The identifier for the index.
        :param pulumi.Input['IndexObjNameArgs'] obj_name: The name of the source, view, or materialized view on which you want to create an index.
        :param pulumi.Input[str] qualified_sql_name: The fully qualified name of the index.
        :param pulumi.Input[str] region: The region to use for the resource connection. If not set, the default region is used.
...
class Index(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if col_exprs is None and not opts.urn:
                raise TypeError("Missing required property 'col_exprs'")
