...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-b2bi)](https://pypistats.org/packages/mypy-boto3-b2bi)
...
`mypy-boto3-b2bi` dependency in production. However, there is an issue in
