...
from vajra.config import ModelConfig, SystemConfig
...
from vajra.engine.ray_utils import RayWorker, initialize_cluster, ray
...
class BaseLLMEngine:
    ...
    def _get_worker_impl(self):
        ...
        from vajra.worker.base_worker import (
