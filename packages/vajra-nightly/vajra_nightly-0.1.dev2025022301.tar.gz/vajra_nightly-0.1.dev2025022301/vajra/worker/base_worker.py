...
class BaseWorker(ABC):
    ...
    def __init__(
        ...
        # Init specific worker timers and threads
        self._init_worker_timers()

    @abstractmethod
    def _init_worker_timers(self) -> None:
        """This will be used to setup various CPU/GPU timers for the worker
        We can enclose various methods in the execute_model method to time them using these timers
        All the timers will be added to the relevant MetricsStore.
        """
    ...
    def execute_model(
        ...
        4. Report batch/step level metrics to the MetricsStore
