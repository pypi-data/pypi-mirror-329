...
from vajra._kernels import moe_align_block_size as moe_align_block_size_kernel
from vajra._kernels import silu_and_mul, topk_softmax
...
def invoke_fused_moe_kernel(
    ...
    fused_moe_kernel[grid](  # type: ignore
        A,
        B,
        C,
        A_scale,
...
def fused_experts(
    ...
    # https://github.com/project-vajra/vajra/issues/5938
    # (rithvikkolla): Can feed such constants through a env/config file like in vllm
    CHUNK_SIZE = 64 * 1024
