...
from vajra._native.model_executor import (
...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def __init__(
        ...
        linear_op_metric: Optional[OperationMetrics] = None,
        communication_op_metric: Optional[OperationMetrics] = None,
    ...
    def forward(self, input_):
        if self.use_native_execution_backend:
            return self.native_handle.forward(input_)
...
class ReplicatedLinear(torch.nn.Module):
    ...
    def __init__(
        ...
        params_dtype: Optional[torch.dtype] = None,
        metric_op: Optional[OperationMetrics] = None,
        layer_id: Optional[int] = None,
    ):
