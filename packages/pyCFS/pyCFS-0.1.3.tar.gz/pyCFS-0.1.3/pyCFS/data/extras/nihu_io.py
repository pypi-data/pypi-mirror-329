...
from pyCFS.data.extras import nihu_to_cfs_element_types
...
def convert_mesh_to_cfs(nihu_mesh: Dict, reg_name="surface"):
    ...
    coordinates = nodes[:, 1:]
    types = nihu_to_cfs_element_types.nihu_to_cfs_elem_type(elements[:, 1])
...
def convert_mat_to_cfs(
    ...
    cfs_result = io.CFSResultData(analysis_type=cfs_types.cfs_analysis_type.HARMONIC, multi_step_id=1)
