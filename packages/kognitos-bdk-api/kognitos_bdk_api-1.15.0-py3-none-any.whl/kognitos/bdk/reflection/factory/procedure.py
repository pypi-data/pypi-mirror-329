...
class BookProcedureFactory:
    ...
    @classmethod
    def create_discoverd_procedure(
        cls,
        procedure_name: str,
        what: str,
        english: str,
        ...
        Args:
            procedure_name: The name of the procedure. It cannot contain '|'.
            what: The name of the parameter that will hold the value of what
        ...
        if "|" in procedure_name:
            raise ValueError("procedure_name cannot contain '|'")
