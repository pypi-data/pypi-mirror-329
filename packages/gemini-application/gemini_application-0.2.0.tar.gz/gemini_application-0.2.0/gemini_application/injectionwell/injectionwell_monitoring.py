...
class InjectionWellMonitoring(ApplicationAbstract):
    ...
    def init_parameters(self, parameters):
        ...
        well_param = dict()
        well_traj = well_unit.parameters['property'][-1]['injectionwell_trajectory_table']
        length = []
        diameter = []
        angle = []
        roughness = []
        ...
        well_param['friction_correlation'] = well_unit.parameters['property'][-1][
            'injectionwell_friction_correlation']
        well_param['friction_correlation_2p'] = 'BeggsBrill'
        well_param['correction_factors'] = [1, 0]
        well_param['injectionwell_soil_temperature'] = well_unit.parameters['property'][-1][
    ...
    def calculate_skin_lines(self):
        ...
        try:
            ...
            u_well['temperature_ambient'] = float(
                self.unit.parameters['property'][-1][
                    'injectionwell_soil_temperature']) + 273.15  # C to K
