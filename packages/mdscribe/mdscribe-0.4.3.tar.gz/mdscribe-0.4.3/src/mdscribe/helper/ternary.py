...
from .coord import kabsch_algorithm
from .svg import view_svg
...
class Ternary:
    ...
    def create_ligand(self, st, resname:str, prefix:str) -> Ligand:
    ...
    def create_pocket(self, st, resname:str, dist:float, include:str, exclude:str) -> Pocket:
        try:
