...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-autoscaling-plans)](https://pypistats.org/packages/mypy-boto3-autoscaling-plans)
...
`mypy-boto3-autoscaling-plans` dependency in production. However, there is an
