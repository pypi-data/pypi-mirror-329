...
class WorkflowApi:
    ...
    @validate_call
    async def workflow_get_by_name(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        name: Annotated[StrictStr, Field(description="The workflow name")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._workflow_get_by_name_serialize(
            tenant=tenant,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def workflow_get_by_name_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        name: Annotated[StrictStr, Field(description="The workflow name")],
        _request_timeout: Union[
    ...
    @validate_call
    async def workflow_get_by_name_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        name: Annotated[StrictStr, Field(description="The workflow name")],
        _request_timeout: Union[
    ...
    def _workflow_get_by_name_serialize(
        self,
        tenant,
        name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/tenants/{tenant}/workflows/byName/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
