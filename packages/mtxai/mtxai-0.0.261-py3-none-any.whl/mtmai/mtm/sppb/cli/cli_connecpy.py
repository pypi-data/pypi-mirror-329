...
import mtm.sppb.cli.cli_pb2 as _pb2
...
class MtCliServiceServer(ConnecpyServer):
    def __init__(self, *, service: MtCliService, server_path_prefix=""):
        super().__init__()
        self._prefix = f"{server_path_prefix}/mtfilter.MtCliService"
        self._endpoints = {
    ...
    def CliCommandTemplates(
        ...
        **kwargs,
        ...
        return self._make_request(
            url=f"{server_path_prefix}/mtfilter.MtCliService/CliCommandTemplates",
            ctx=ctx,
            request=request,
