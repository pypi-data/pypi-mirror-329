...
# -*- coding: utf-8 -*-
#
# ipybbycell documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipybbycell', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipybbycelldoc'
...
latex_documents = [
    (master_doc, 'ipybbycell.tex', 'ipybbycell Documentation',
     'boyuai', 'manual'),
]
