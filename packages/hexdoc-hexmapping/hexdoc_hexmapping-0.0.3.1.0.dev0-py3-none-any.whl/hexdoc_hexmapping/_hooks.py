...
import hexdoc_hexmapping

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexMappingPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexMappingModPlugin(branch=branch)


class HexMappingModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexmapping"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexmapping, "_templates"
