...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kinesisanalyticsv2)](https://pypistats.org/packages/mypy-boto3-kinesisanalyticsv2)
...
`mypy-boto3-kinesisanalyticsv2` dependency in production. However, there is an
