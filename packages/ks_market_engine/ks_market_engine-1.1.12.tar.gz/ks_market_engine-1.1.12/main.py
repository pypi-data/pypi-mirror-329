...
import numpy as np
import talib
from ks_trade_api.constant import Adjustment, RET_OK, SUBSCRIBE_TYPE2INTERVAL
...
class KsMarketEngineServer(ZmqPublisher, ZmqSubscriber):
    ...
    def subscribe(
        ...
        api = self.market_api
        # 订阅市场数据
        api.subscribe(vt_symbols, subscribe_types)
...
if __name__ == '__main__':
    ...
    setting = config['ks_market_engine']['setting']
    KsMarketEngineServer(setting)
