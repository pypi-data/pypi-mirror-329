...
class OpenAIChatBackend(BaseModelBackend):
    ...
    def set_base_url(self, base_url: str) -> Self:
        """Set the base URL for the model backend.

        Args:
            base_url (str): Base URL for the model backend
        """
    ...
    def set_api_key(self, api_key: str) -> Self:
        """Set the API key for the model backend.

        Args:
            api_key (str): API key for the model backend
        """
