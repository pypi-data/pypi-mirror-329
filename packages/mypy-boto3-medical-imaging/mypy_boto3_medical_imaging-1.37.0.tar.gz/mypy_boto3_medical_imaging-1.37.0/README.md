...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-medical-imaging)](https://pypistats.org/packages/mypy-boto3-medical-imaging)
...
`mypy-boto3-medical-imaging` dependency in production. However, there is an
