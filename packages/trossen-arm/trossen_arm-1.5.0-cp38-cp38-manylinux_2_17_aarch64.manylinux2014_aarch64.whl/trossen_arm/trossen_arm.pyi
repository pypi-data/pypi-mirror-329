...
class EndEffectorProperties:
    ...
    def t_max_factor(self) -> float:
        """
                ...
                @note It must be within [0.0, 1.0], 0.0 for no force, 1.0 for max force in the
                  specifications
        """
    @t_max_factor.setter
...
class TrossenArmDriver:
    ...
    def get_gripper_force_limit_scaling_factor(self) -> float:
        """
                ...
                @return Scaling factor for the max gripper force, 0.0 for no force, 1.0 for max force in
                  the specifications
        """
