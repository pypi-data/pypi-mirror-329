...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-finspace)](https://pypistats.org/packages/mypy-boto3-finspace)
...
`mypy-boto3-finspace` dependency in production. However, there is an issue in
