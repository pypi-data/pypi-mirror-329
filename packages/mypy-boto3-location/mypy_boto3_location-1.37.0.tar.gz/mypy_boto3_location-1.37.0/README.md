...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-location)](https://pypistats.org/packages/mypy-boto3-location)
...
`mypy-boto3-location` dependency in production. However, there is an issue in
