...
class LLReasoner(MHAModule):
    def __init__(self,
        ...
        for learner in self._directory.internal.learning:
            ...
            in_id_channels_callbacks.append(self.recipient_reg_entry(learner.module_id, ConnType.send, self._receive_learning_status, 'status'))
            in_id_channels_callbacks.append(self.recipient_reg_entry(learner.module_id, ConnType.send, self._receive_learner_model, 'model'))
