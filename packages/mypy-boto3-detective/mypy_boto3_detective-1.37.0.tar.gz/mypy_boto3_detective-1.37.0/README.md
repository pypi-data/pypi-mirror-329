...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-detective)](https://pypistats.org/packages/mypy-boto3-detective)
...
`mypy-boto3-detective` dependency in production. However, there is an issue in
