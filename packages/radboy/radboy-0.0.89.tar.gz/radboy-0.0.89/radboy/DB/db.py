...
"""
    ...
    def seeShortRaw(self):
        msg=f'''Short Data - {self.Name}[Name][EID={self.EntryId}] ({self.rebar()}[UPC]:{self.Code}[SHELF/TAG/CIC])|{self.CaseCount}[CaseCount]|{self.Price}[Price]'''
        return msg
...
{Fore.light_yellow}{self.Name} [{Fore.misty_rose_3}EID={Fore.pale_green_1b}{self.EntryId}{Fore.light_yellow}] ({Fore.light_magenta}{rebar}{Fore.light_magenta}[{Fore.spring_green_3a}UPC{Style.reset}{Fore.light_magenta}]:{Fore.light_red}{self.Code}[{Fore.orange_red_1}SHELF/TAG/CIC]{Fore.light_red}){Style.reset}'''
        return msg
    ...
    def __repr__(self):
        ...
        {Fore.violet}{Style.underline}Code{Style.reset}:{Fore.grey_70}{types['Code']}{Style.reset}='{self.Code}',
...
"""
    ...
    def __repr__(self):
        ...
        {Fore.hot_pink_2}{Style.bold}{Style.underline}EntryId{Style.reset}:{Fore.grey_70}{types['EntryId']}{Style.reset}={self.EntryId}
        {Fore.violet}{Style.underline}Code{Style.reset}:{Fore.grey_70}{types['Code']}{Style.reset}='{self.Code}',
        {Fore.orange_3}{Style.bold}Barcode{Style.reset}:{Fore.grey_70}{types['Barcode']}{Style.reset}='{self.Barcode}',
        {Fore.orange_3}{Style.underline}UPCE from UPCA[if any]{Style.reset}:{Fore.grey_70}{types['upce2upca']}{Style.reset}='{self.upce2upca}',
        {Fore.green}{Style.bold}Price{Style.reset}{Fore.grey_70}:{types['Price']}{Style.reset}=${self.Price},
        {Fore.green}{Style.bold}CRV{Style.reset}{Fore.grey_70}:{types['CRV']}{Style.reset}=${self.CRV},
        {Fore.green}{Style.bold}Tax{Style.reset}{Fore.grey_70}:{types['Tax']}{Style.reset}=${self.Tax},
