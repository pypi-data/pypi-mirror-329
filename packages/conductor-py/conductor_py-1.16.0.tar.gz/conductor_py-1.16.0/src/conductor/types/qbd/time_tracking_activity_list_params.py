...
class TimeTrackingActivityListParams(TypedDict, total=False):
    ...
    **NOTE**: If any of the values you specify in this parameter are not found, the
    ...
    """
    Filter for time tracking activities created on or after this date, in ISO 8601
    format (YYYY-MM-DD).
    """

    transaction_date_to: Annotated[Union[str, date], PropertyInfo(alias="transactionDateTo", format="iso8601")]
    """
    Filter for time tracking activities created on or before this date, in ISO 8601
    format (YYYY-MM-DD).
    """

    updated_after: Annotated[str, PropertyInfo(alias="updatedAfter")]
    """
    Filter for time tracking activities updated on or after this date and time, in
    ...
    """
    Filter for time tracking activities updated on or before this date and time, in
    ISO 8601 format (YYYY-MM-DDTHH:mm:ss). If you only provide a date (YYYY-MM-DD),
