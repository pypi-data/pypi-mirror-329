...
class TestDebReleaseFileResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DebReleaseFileResponse:
        """Test DebReleaseFileResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebReleaseFileResponse`
        """
        model = DebReleaseFileResponse()
        if include_optional:
