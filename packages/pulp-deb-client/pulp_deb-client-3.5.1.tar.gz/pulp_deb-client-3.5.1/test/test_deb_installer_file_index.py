...
class TestDebInstallerFileIndex(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DebInstallerFileIndex:
        """Test DebInstallerFileIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebInstallerFileIndex`
        """
        model = DebInstallerFileIndex()
        if include_optional:
