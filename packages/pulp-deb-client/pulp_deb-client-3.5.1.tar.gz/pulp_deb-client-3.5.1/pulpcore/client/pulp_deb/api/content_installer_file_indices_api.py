...
class ContentInstallerFileIndicesApi:
    ...
    def create(
        self,
        deb_installer_file_index: DebInstallerFileIndex,
        ...
        :param deb_installer_file_index: (required)
        :type deb_installer_file_index: DebInstallerFileIndex
        ...
        _param = self._create_serialize(
            deb_installer_file_index=deb_installer_file_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "DebInstallerFileIndexResponse",
        }
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DebInstallerFileIndexResponse]:
        """Create an installer file index
    ...
    def _create_serialize(
        ...
        if deb_installer_file_index is not None:
            _body_params = deb_installer_file_index
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/content/deb/installer_file_indices/',
    ...
    def list(
        ...
        ordering: Annotated[Optional[List[StrictStr]], Field(description="Ordering  * `pulp_id` - Pulp id * `-pulp_id` - Pulp id (descending) * `pulp_created` - Pulp created * `-pulp_created` - Pulp created (descending) * `pulp_last_updated` - Pulp last updated * `-pulp_last_updated` - Pulp last updated (descending) * `pulp_type` - Pulp type * `-pulp_type` - Pulp type (descending) * `upstream_id` - Upstream id * `-upstream_id` - Upstream id (descending) * `timestamp_of_interest` - Timestamp of interest * `-timestamp_of_interest` - Timestamp of interest (descending) * `component` - Component * `-component` - Component (descending) * `architecture` - Architecture * `-architecture` - Architecture (descending) * `relative_path` - Relative path * `-relative_path` - Relative path (descending) * `sha256` - Sha256 * `-sha256` - Sha256 (descending) * `pk` - Pk * `-pk` - Pk (descending)")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginateddebInstallerFileIndexResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginateddebInstallerFileIndexResponseList]:
        """List InstallerFileIndices
    ...
    def read(
        self,
        deb_installer_file_index_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param deb_installer_file_index_href: (required)
        :type deb_installer_file_index_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            deb_installer_file_index_href=deb_installer_file_index_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DebInstallerFileIndexResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if deb_installer_file_index_href is not None:
            _path_params['deb_installer_file_index_href'] = deb_installer_file_index_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{deb_installer_file_index_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
