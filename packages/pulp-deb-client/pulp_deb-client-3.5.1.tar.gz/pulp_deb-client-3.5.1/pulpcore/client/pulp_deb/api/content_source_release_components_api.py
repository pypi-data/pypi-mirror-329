...
class ContentSourceReleaseComponentsApi:
    ...
    def create(
        self,
        deb_source_package_release_component: DebSourcePackageReleaseComponent,
        ...
        :param deb_source_package_release_component: (required)
        :type deb_source_package_release_component: DebSourcePackageReleaseComponent
        ...
        _param = self._create_serialize(
            deb_source_package_release_component=deb_source_package_release_component,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "DebSourcePackageReleaseComponentResponse",
        }
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DebSourcePackageReleaseComponentResponse]:
        """Create a source package release component
    ...
    def _create_serialize(
        self,
        deb_source_package_release_component,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if deb_source_package_release_component is not None:
            _body_params = deb_source_package_release_component
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/content/deb/source_release_components/',
    ...
    def list(
        ...
        ordering: Annotated[Optional[List[StrictStr]], Field(description="Ordering  * `pulp_id` - Pulp id * `-pulp_id` - Pulp id (descending) * `pulp_created` - Pulp created * `-pulp_created` - Pulp created (descending) * `pulp_last_updated` - Pulp last updated * `-pulp_last_updated` - Pulp last updated (descending) * `pulp_type` - Pulp type * `-pulp_type` - Pulp type (descending) * `upstream_id` - Upstream id * `-upstream_id` - Upstream id (descending) * `timestamp_of_interest` - Timestamp of interest * `-timestamp_of_interest` - Timestamp of interest (descending) * `pk` - Pk * `-pk` - Pk (descending)")] = None,
        ...
        release_component: Annotated[Optional[StrictStr], Field(description="Filter results where release_component matches value")] = None,
        ...
        source_package: Annotated[Optional[StrictStr], Field(description="Filter results where source_package matches value")] = None,
        ...
        :type q: str
        :param release_component: Filter results where release_component matches value
        ...
        :param source_package: Filter results where source_package matches value
        :type source_package: str
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginateddebSourcePackageReleaseComponentResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginateddebSourcePackageReleaseComponentResponseList]:
        """List source package release components
    ...
    def _list_serialize(
        ...
        if source_package is not None:
            ...
            _query_params.append(('source_package', source_package))
    ...
    def read(
        self,
        deb_source_package_release_component_href: StrictStr,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param deb_source_package_release_component_href: (required)
        :type deb_source_package_release_component_href: str
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        :param exclude_fields: A list of fields to exclude from the response.
        :type exclude_fields: List[str]
        ...
        _param = self._read_serialize(
            deb_source_package_release_component_href=deb_source_package_release_component_href,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DebSourcePackageReleaseComponentResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if deb_source_package_release_component_href is not None:
            _path_params['deb_source_package_release_component_href'] = deb_source_package_release_component_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{deb_source_package_release_component_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
