...
class DebPackageReleaseComponent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["repository", "package", "release_component"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebPackageReleaseComponent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebPackageReleaseComponent from a dict"""
        if obj is None:
            return None
