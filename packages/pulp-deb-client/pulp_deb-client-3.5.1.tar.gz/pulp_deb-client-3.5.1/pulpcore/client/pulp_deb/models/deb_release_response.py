...
class DebReleaseResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "codename", "suite", "distribution", "version", "origin", "label", "description", "architectures", "components"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebReleaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebReleaseResponse from a dict"""
        if obj is None:
            return None
