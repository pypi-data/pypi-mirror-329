...
class DebPackageReleaseComponentResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "package", "release_component"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebPackageReleaseComponentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebPackageReleaseComponentResponse from a dict"""
        if obj is None:
            return None
