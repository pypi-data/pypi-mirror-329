...
class DebRelease(BaseModel):
    ...
    codename: Annotated[str, Field(min_length=1, strict=True)]
    suite: Annotated[str, Field(min_length=1, strict=True)]
    distribution: Annotated[str, Field(min_length=1, strict=True)]
    ...
    architectures: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = None
    components: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = None
    __properties: ClassVar[List[str]] = ["repository", "codename", "suite", "distribution", "version", "origin", "label", "description", "architectures", "components"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebRelease from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebRelease from a dict"""
        if obj is None:
            return None
