...
class DebGenericContentResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "artifact", "relative_path", "md5", "sha1", "sha224", "sha256", "sha384", "sha512"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebGenericContentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebGenericContentResponse from a dict"""
        if obj is None:
            return None
