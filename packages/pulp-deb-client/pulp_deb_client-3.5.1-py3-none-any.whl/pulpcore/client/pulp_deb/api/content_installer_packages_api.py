...
class ContentInstallerPackagesApi:
    ...
    def _create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/content/deb/installer_packages/',
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginateddebInstallerPackageResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginateddebInstallerPackageResponseList]:
        """List installer packages
    ...
    def read(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DebInstallerPackageResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DebInstallerPackageResponse]:
        """Inspect an installer package
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if deb_installer_package_href is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{deb_installer_package_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
