...
class PublicationsVerbatimApi:
    ...
    def add_role(
        self,
        deb_verbatim_publication_href: StrictStr,
        ...
        :param deb_verbatim_publication_href: (required)
        :type deb_verbatim_publication_href: str
        ...
        _param = self._add_role_serialize(
            deb_verbatim_publication_href=deb_verbatim_publication_href,
    ...
    def _add_role_serialize(
        ...
        if deb_verbatim_publication_href is not None:
            _path_params['deb_verbatim_publication_href'] = deb_verbatim_publication_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{deb_verbatim_publication_href}add_role/',
    ...
    def create(
        self,
        deb_verbatim_publication: DebVerbatimPublication,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param deb_verbatim_publication: (required)
        :type deb_verbatim_publication: DebVerbatimPublication
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_serialize(
            deb_verbatim_publication=deb_verbatim_publication,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if deb_verbatim_publication is not None:
            _body_params = deb_verbatim_publication
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/publications/deb/verbatim/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{deb_verbatim_publication_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginateddebVerbatimPublicationResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginateddebVerbatimPublicationResponseList]:
        """List verbatim publications
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{deb_verbatim_publication_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{deb_verbatim_publication_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def read(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DebVerbatimPublicationResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DebVerbatimPublicationResponse]:
        """Inspect a verbatim publication
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{deb_verbatim_publication_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
