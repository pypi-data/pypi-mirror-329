...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kendra)](https://pypistats.org/packages/mypy-boto3-kendra)
...
`mypy-boto3-kendra` dependency in production. However, there is an issue in
