...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-license-manager)](https://pypistats.org/packages/mypy-boto3-license-manager)
...
`mypy-boto3-license-manager` dependency in production. However, there is an
