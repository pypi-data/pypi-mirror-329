...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kinesisvideo)](https://pypistats.org/packages/mypy-boto3-kinesisvideo)
...
`mypy-boto3-kinesisvideo` dependency in production. However, there is an issue
