...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-dynamodbstreams)](https://pypistats.org/packages/mypy-boto3-dynamodbstreams)
...
`mypy-boto3-dynamodbstreams` dependency in production. However, there is an
