...
from fi.integrations.otel.frameworks.anthropic._stream import _MessagesStream, _Stream
...
class _WithTracer(ABC):
    ...
    def __init__(self, tracer: trace_api.Tracer, *args: Any, **kwargs: Any) -> None:
        print(f"Initializing _WithTracer with tracer: {tracer}")
...
class _CompletionsWrapper(_BaseWrapper):
    ...
    def __call__(
        ...
        llm_input_messages = extracted_data["filtered_messages"]
        ...
        with self._start_as_current_span(
            ...
            attributes=dict(
                chain(
                    ...
                    _get_inputs(llm_input_messages),
                ...
                for block in content:
                    if isinstance(block, ToolUseBlock):
                        ...
                        if block_type == "tool_use":
                            ...
                            yield f"{LLM_INPUT_MESSAGES}.{i}.{MESSAGE_CONTENT}", block.get(
                                "text"
                            )
