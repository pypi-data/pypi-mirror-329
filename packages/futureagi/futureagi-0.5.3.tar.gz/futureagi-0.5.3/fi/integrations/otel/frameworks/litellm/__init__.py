...
from fi.integrations.otel.frameworks.litellm.package import _instruments
from fi.integrations.otel.frameworks.litellm.version import __version__
...
def _instrument_func_type_embedding(
    ...
    _set_span_attribute(
        span, EmbeddingAttributes.EMBEDDING_TEXT, str(kwargs.get("input"))
    )
