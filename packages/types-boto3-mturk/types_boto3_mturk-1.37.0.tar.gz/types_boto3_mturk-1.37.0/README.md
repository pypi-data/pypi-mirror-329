<a id="types-boto3-mturk"></a>

# types-boto3-mturk

[![PyPI - types-boto3-mturk](https://img.shields.io/pypi/v/types-boto3-mturk.svg?color=blue)](https://pypi.org/project/types-boto3-mturk/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-mturk.svg?color=blue)](https://pypi.org/project/types-boto3-mturk/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-mturk)](https://pypistats.org/packages/types-boto3-mturk)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 MTurk 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-mturk docs](https://youtype.github.io/types_boto3_docs/types_boto3_mturk/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-mturk](#types-boto3-mturk)
...
- Install `types-boto3[mturk]` in your environment:
...
- Install `types-boto3[mturk]` with services you use in your environment:
...
`types-boto3-mturk` dependency in production. However, there is an issue in
...
from types_boto3_mturk import MTurkClient
...
`types_boto3_mturk.paginator` module contains type annotations for all
paginators.
...
`types_boto3_mturk.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `MTurk` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_mturk/literals/).
...
`types_boto3_mturk.type_defs` module contains structures and shapes assembled
to typed dictionaries and unions for additional type checking.

Full list of `MTurk` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_mturk/type_defs/).
...
`types-boto3-mturk` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_mturk/)
