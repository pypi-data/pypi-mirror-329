...
# Also, consider setting pytorch-xtlib docker image (in factory_config.yaml) to new version just before releasing new XT
BUILD = "version: 0.0.337, build: Feb-21-2025"
...
WINDOWS_AFTER_LOGS = "__after__\\xt_logs"
LINUX_AFTER_LOGS = "__after__/xt_logs"
...
FN_DOCKER_ENV = "__docker_env__.txt"
...
FN_JOB_RELEASE_TASK = "__job_release_task__.py"

# if using docker, most cmds are stored in the secondary inner file
# FN_INNER_SH = "__inner__.sh"
# FN_INNER_BAT = "__inner__.bat"

FN_INNER_SCRIPT = "__inner_script__.sh"
FN_NODE_SCRIPT = "__node_script__.sh"

LOGS_DIR = "__logs__"
FN_IMAGE_NAME =  "__docker_image_name__.txt"
