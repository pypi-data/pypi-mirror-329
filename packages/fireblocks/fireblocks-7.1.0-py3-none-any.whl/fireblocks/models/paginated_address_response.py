...
class PaginatedAddressResponse(BaseModel):
    ...
    """ # noqa: E501
    addresses: Optional[List[VaultWalletAddress]] = None
    paging: Optional[PaginatedAddressResponsePaging] = None
    __properties: ClassVar[List[str]] = ["addresses", "paging"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addresses": [VaultWalletAddress.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
            "paging": PaginatedAddressResponsePaging.from_dict(obj["paging"]) if obj.get("paging") is not None else None
        })
        return _obj
