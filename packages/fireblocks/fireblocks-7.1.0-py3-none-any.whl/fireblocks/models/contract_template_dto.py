...
class ContractTemplateDto(BaseModel):
    """
    ContractTemplateDto
    """ # noqa: E501
    ...
    implementation_contract_id: Optional[StrictStr] = Field(default=None, alias="implementationContractId")
    initialization_phase: StrictStr = Field(alias="initializationPhase")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "longDescription", "abi", "attributes", "docs", "owner", "vendor", "isPublic", "canDeploy", "type", "implementationContractId", "initializationPhase"]
    ...
    @field_validator('initialization_phase')
    def initialization_phase_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ON_DEPLOYMENT', 'POST_DEPLOYMENT']):
            raise ValueError("must be one of enum values ('ON_DEPLOYMENT', 'POST_DEPLOYMENT')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "implementationContractId": obj.get("implementationContractId"),
            "initializationPhase": obj.get("initializationPhase")
        })
        return _obj
