...
class GetValidationKeyResponseDto(BaseModel):
    """
    GetValidationKeyResponseDto
    """ # noqa: E501
    data: List[ValidationKeyDto] = Field(description="Response object for getting external validation keys.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ValidationKeyDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "next": obj.get("next")
        })
        return _obj
