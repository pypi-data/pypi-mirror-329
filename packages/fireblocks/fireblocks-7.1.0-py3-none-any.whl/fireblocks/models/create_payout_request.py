...
class CreatePayoutRequest(BaseModel):
    ...
    instruction_set: List[PayoutInstruction] = Field(alias="instructionSet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paymentAccount": PaymentAccount.from_dict(obj["paymentAccount"]) if obj.get("paymentAccount") is not None else None,
            "instructionSet": [PayoutInstruction.from_dict(_item) for _item in obj["instructionSet"]] if obj.get("instructionSet") is not None else None
        })
        return _obj
