...
class ListOwnedCollectionsResponse(BaseModel):
    """
    ListOwnedCollectionsResponse
    """ # noqa: E501
    paging: Optional[Paging] = None
    data: Optional[List[CollectionOwnershipResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CollectionOwnershipResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
