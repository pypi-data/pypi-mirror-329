...
class DisbursementOperationPreviewOutput(BaseModel):
    """
    DisbursementOperationPreviewOutput
    """ # noqa: E501
    instruction_set: List[DisbursementOperationPreviewOutputInstructionSetInner] = Field(alias="instructionSet")
    __properties: ClassVar[List[str]] = ["instructionSet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instructionSet": [DisbursementOperationPreviewOutputInstructionSetInner.from_dict(_item) for _item in obj["instructionSet"]] if obj.get("instructionSet") is not None else None
        })
        return _obj
