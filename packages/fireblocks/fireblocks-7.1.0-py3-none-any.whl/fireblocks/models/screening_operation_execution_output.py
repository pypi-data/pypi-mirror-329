...
class ScreeningOperationExecutionOutput(BaseModel):
    """
    ScreeningOperationExecutionOutput
    """ # noqa: E501
    verdicts: List[ScreeningVerdict]
    __properties: ClassVar[List[str]] = ["verdicts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "verdicts": [ScreeningVerdict.from_dict(_item) for _item in obj["verdicts"]] if obj.get("verdicts") is not None else None
        })
        return _obj
