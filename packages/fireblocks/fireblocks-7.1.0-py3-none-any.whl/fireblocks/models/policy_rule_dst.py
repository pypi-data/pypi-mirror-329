...
class PolicyRuleDst(BaseModel):
    """
    Defines the destination accounts the rule allows transfers to
    """ # noqa: E501
    ids: Optional[List[Annotated[List[SrcOrDestAttributesInner], Field(min_length=1, max_length=3)]]] = Field(default=None, description="A set of ids in a tuple format")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ids": [
                    [SrcOrDestAttributesInner.from_dict(_inner_item) for _inner_item in _item]
