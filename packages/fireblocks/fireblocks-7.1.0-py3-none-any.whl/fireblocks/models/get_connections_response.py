...
class GetConnectionsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[SessionDTO] = Field(description="Array with the requested Web3 connection's data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SessionDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
