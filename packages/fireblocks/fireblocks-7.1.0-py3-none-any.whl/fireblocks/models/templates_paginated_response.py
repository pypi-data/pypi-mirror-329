...
class TemplatesPaginatedResponse(BaseModel):
    """
    TemplatesPaginatedResponse
    """ # noqa: E501
    data: List[LeanContractDto] = Field(description="The data of the current page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [LeanContractDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "next": obj.get("next")
        })
        return _obj
