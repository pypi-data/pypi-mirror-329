...
class DisbursementOperationExecutionParamsExecutionParams(BaseModel):
    """
    ...
    instruction_set: Optional[List[DisbursementInstruction]] = Field(default=None, alias="instructionSet")
    __properties: ClassVar[List[str]] = ["amount", "paymentAccount", "instructionSet"]
