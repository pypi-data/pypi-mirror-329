...
class ComplianceScreeningConfigurationApi:
    ...
    @validate_call
    def get_aml_screening_configuration(
        self,
    ...
    def _get_aml_screening_configuration_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def get_screening_configuration(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_screening_configuration_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
