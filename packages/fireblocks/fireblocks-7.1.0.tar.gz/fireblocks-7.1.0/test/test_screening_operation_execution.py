...
class TestScreeningOperationExecution(unittest.TestCase):
    """ScreeningOperationExecution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScreeningOperationExecution:
        """Test ScreeningOperationExecution
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ScreeningOperationExecution`
        """
        model = ScreeningOperationExecution()
        if include_optional:
            return ScreeningOperationExecution(
    ...
    def testScreeningOperationExecution(self):
        """Test ScreeningOperationExecution"""
