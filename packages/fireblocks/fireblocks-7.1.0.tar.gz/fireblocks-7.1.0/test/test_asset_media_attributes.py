...
class TestAssetMediaAttributes(unittest.TestCase):
    """AssetMediaAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetMediaAttributes:
        ...
        """
        model = AssetMediaAttributes()
        if include_optional:
            return AssetMediaAttributes(
                monochrome = True
            )
        else:
            return AssetMediaAttributes(
    ...
    def testAssetMediaAttributes(self):
        """Test AssetMediaAttributes"""
