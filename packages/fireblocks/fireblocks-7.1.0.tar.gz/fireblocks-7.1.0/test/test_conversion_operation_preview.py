...
class TestConversionOperationPreview(unittest.TestCase):
    """ConversionOperationPreview unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversionOperationPreview:
        """Test ConversionOperationPreview
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConversionOperationPreview`
        """
        model = ConversionOperationPreview()
        if include_optional:
            return ConversionOperationPreview(
    ...
    def testConversionOperationPreview(self):
        """Test ConversionOperationPreview"""
