...
class TestCollectionOwnershipResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionOwnershipResponse:
        """Test CollectionOwnershipResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CollectionOwnershipResponse`
        """
        model = CollectionOwnershipResponse()
        if include_optional:
    ...
    def testCollectionOwnershipResponse(self):
        """Test CollectionOwnershipResponse"""
