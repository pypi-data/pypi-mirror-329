...
class TestListBlockchainsResponse(unittest.TestCase):
    """ListBlockchainsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListBlockchainsResponse:
        """Test ListBlockchainsResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ListBlockchainsResponse`
        """
        model = ListBlockchainsResponse()
        if include_optional:
    ...
    def testListBlockchainsResponse(self):
        """Test ListBlockchainsResponse"""
