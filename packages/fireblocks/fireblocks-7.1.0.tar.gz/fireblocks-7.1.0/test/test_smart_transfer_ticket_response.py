...
class TestSmartTransferTicketResponse(unittest.TestCase):
    """SmartTransferTicketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmartTransferTicketResponse:
        """Test SmartTransferTicketResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SmartTransferTicketResponse`
        """
        model = SmartTransferTicketResponse()
        if include_optional:
            return SmartTransferTicketResponse(
                message = 'Success',
                data = fireblocks.models.smart_transfer_ticket.SmartTransferTicket(
    ...
    def testSmartTransferTicketResponse(self):
        """Test SmartTransferTicketResponse"""
