...
class TestWorkflowExecutionOperation(unittest.TestCase):
    """WorkflowExecutionOperation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowExecutionOperation:
        """Test WorkflowExecutionOperation
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `WorkflowExecutionOperation`
        """
        model = WorkflowExecutionOperation()
        if include_optional:
            return WorkflowExecutionOperation(
                operation_id = '',
                status = 'PENDING',
    ...
    def testWorkflowExecutionOperation(self):
        """Test WorkflowExecutionOperation"""
