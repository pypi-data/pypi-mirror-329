...
class TestUpdateVaultAccountAssetAddressRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateVaultAccountAssetAddressRequest:
        ...
        """
        model = UpdateVaultAccountAssetAddressRequest()
        if include_optional:
    ...
    def testUpdateVaultAccountAssetAddressRequest(self):
        """Test UpdateVaultAccountAssetAddressRequest"""
