...
class TestPaginatedAssetWalletResponsePaging(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedAssetWalletResponsePaging:
        ...
        """
        model = PaginatedAssetWalletResponsePaging()
        if include_optional:
    ...
    def testPaginatedAssetWalletResponsePaging(self):
        """Test PaginatedAssetWalletResponsePaging"""
