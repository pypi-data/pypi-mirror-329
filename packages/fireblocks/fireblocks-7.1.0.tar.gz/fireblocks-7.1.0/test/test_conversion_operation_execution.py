...
class TestConversionOperationExecution(unittest.TestCase):
    """ConversionOperationExecution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversionOperationExecution:
        """Test ConversionOperationExecution
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConversionOperationExecution`
        """
        model = ConversionOperationExecution()
        if include_optional:
            return ConversionOperationExecution(
    ...
    def testConversionOperationExecution(self):
        """Test ConversionOperationExecution"""
