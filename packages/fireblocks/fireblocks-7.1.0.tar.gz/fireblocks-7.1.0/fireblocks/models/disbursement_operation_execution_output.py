...
class DisbursementOperationExecutionOutput(BaseModel):
    """
    DisbursementOperationExecutionOutput
    """ # noqa: E501
    instruction_set: List[DisbursementInstructionOutput] = Field(alias="instructionSet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instructionSet": [DisbursementInstructionOutput.from_dict(_item) for _item in obj["instructionSet"]] if obj.get("instructionSet") is not None else None
        })
        return _obj
