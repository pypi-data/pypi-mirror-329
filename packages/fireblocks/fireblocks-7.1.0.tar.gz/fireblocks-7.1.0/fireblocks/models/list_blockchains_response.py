...
class ListBlockchainsResponse(BaseModel):
    """
    ListBlockchainsResponse
    """ # noqa: E501
    data: List[BlockchainResponse] = Field(description="The data of the current page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BlockchainResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "next": obj.get("next")
        })
        return _obj
