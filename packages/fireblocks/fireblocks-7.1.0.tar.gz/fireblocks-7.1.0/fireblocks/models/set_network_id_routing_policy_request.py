...
class SetNetworkIdRoutingPolicyRequest(BaseModel):
    """
    SetNetworkIdRoutingPolicyRequest
    """ # noqa: E501
    routing_policy: Dict[str, NetworkIdRoutingPolicyValue] = Field(alias="routingPolicy")
    __properties: ClassVar[List[str]] = ["routingPolicy"]
