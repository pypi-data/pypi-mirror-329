...
class GetSigningKeyResponseDto(BaseModel):
    """
    GetSigningKeyResponseDto
    """ # noqa: E501
    data: List[SigningKeyDto] = Field(description="Response object for getting external signing keys.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SigningKeyDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "next": obj.get("next")
        })
        return _obj
