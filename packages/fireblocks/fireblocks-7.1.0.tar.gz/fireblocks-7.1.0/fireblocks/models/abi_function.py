...
class AbiFunction(BaseModel):
    ...
    def state_mutability_validate_enum(cls, value):
        ...
        if value not in set(['pure', 'view', 'nonpayable', 'payable']):
            raise ValueError("must be one of enum values ('pure', 'view', 'nonpayable', 'payable')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "inputs": [Parameter.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None,
