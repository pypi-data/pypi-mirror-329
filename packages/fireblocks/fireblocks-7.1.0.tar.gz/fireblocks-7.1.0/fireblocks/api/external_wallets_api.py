...
class ExternalWalletsApi:
    ...
    @validate_call
    def add_asset_to_external_wallet(
        self,
        ...
        add_asset_to_external_wallet_request: Optional[AddAssetToExternalWalletRequest] = None,
    ...
    def _add_asset_to_external_wallet_serialize(
        self,
        wallet_id,
        asset_id,
        idempotency_key,
        ...
        if add_asset_to_external_wallet_request is not None:
            _body_params = add_asset_to_external_wallet_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/external_wallets/{walletId}/{assetId}',
    ...
    def _create_external_wallet_serialize(
        self,
        idempotency_key,
    ...
    def _delete_external_wallet_serialize(
        self,
        wallet_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/external_wallets/{walletId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_external_wallet_serialize(
        self,
        wallet_id,
        _request_auth,
        _content_type,
    ...
    def _get_external_wallet_asset_serialize(
        self,
        wallet_id,
        asset_id,
        _request_auth,
    ...
    def _get_external_wallets_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def remove_asset_from_external_wallet(
        self,
        wallet_id: Annotated[StrictStr, Field(description="The ID of the wallet")],
    ...
    def _remove_asset_from_external_wallet_serialize(
        self,
        wallet_id,
        asset_id,
        _request_auth,
    ...
    def _set_external_wallet_customer_ref_id_serialize(
        self,
        wallet_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/external_wallets/{walletId}/set_customer_ref_id',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
