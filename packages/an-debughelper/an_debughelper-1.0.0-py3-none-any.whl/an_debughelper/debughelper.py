# -*- coding: utf-8 -*-
"""DBHL_20250223_00.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16BPz_kzLjzdNgol6EENR0hwywdgZ-Yl1
...
2025/02/23 1.0.00 2つ以上のインスタンスにDebugHelperを設置しても、問題なくログを出力できるようにした。
```
...
class DebugHelper:
    def __init__(self, instance_name="default", default_log_folder=None):
