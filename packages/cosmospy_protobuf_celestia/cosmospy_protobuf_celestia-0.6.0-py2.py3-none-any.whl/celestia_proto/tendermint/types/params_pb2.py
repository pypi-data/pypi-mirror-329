...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'Z7github.com/tendermint/tendermint/proto/tendermint/types\xa8\xe2\x1e\x01'
    _globals['_CONSENSUSPARAMS'].fields_by_name['block']._loaded_options = None
    _globals['_CONSENSUSPARAMS'].fields_by_name['block']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CONSENSUSPARAMS'].fields_by_name['evidence']._loaded_options = None
    _globals['_CONSENSUSPARAMS'].fields_by_name['evidence']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CONSENSUSPARAMS'].fields_by_name['validator']._loaded_options = None
    _globals['_CONSENSUSPARAMS'].fields_by_name['validator']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CONSENSUSPARAMS'].fields_by_name['version']._loaded_options = None
    _globals['_CONSENSUSPARAMS'].fields_by_name['version']._serialized_options = b'\xc8\xde\x1f\x00'
