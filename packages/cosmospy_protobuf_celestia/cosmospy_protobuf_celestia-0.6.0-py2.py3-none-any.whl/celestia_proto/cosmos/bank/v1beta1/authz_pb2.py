...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SENDAUTHORIZATION'].fields_by_name['spend_limit']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_SENDAUTHORIZATION']._loaded_options = None
    _globals['_SENDAUTHORIZATION']._serialized_options = b'\xca\xb4-\rAuthorization'
