...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BASICALLOWANCE'].fields_by_name['spend_limit']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    ...
    _globals['_BASICALLOWANCE']._serialized_options = b'\xca\xb4-\rFeeAllowanceI'
    _globals['_PERIODICALLOWANCE'].fields_by_name['basic']._loaded_options = None
    _globals['_PERIODICALLOWANCE'].fields_by_name['basic']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_PERIODICALLOWANCE'].fields_by_name['period']._loaded_options = None
    _globals['_PERIODICALLOWANCE'].fields_by_name['period']._serialized_options = b'\xc8\xde\x1f\x00\x98\xdf\x1f\x01'
    _globals['_PERIODICALLOWANCE'].fields_by_name['period_spend_limit']._loaded_options = None
    _globals['_PERIODICALLOWANCE'].fields_by_name['period_spend_limit']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_PERIODICALLOWANCE'].fields_by_name['period_can_spend']._loaded_options = None
    _globals['_PERIODICALLOWANCE'].fields_by_name['period_can_spend']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_PERIODICALLOWANCE'].fields_by_name['period_reset']._loaded_options = None
    _globals['_PERIODICALLOWANCE'].fields_by_name['period_reset']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
    _globals['_PERIODICALLOWANCE']._loaded_options = None
    _globals['_PERIODICALLOWANCE']._serialized_options = b'\xca\xb4-\rFeeAllowanceI'
    _globals['_ALLOWEDMSGALLOWANCE'].fields_by_name['allowance']._loaded_options = None
    _globals['_ALLOWEDMSGALLOWANCE'].fields_by_name['allowance']._serialized_options = b'\xca\xb4-\rFeeAllowanceI'
    _globals['_ALLOWEDMSGALLOWANCE']._loaded_options = None
    _globals['_ALLOWEDMSGALLOWANCE']._serialized_options = b'\x88\xa0\x1f\x00\xca\xb4-\rFeeAllowanceI'
    _globals['_GRANT'].fields_by_name['allowance']._loaded_options = None
    _globals['_GRANT'].fields_by_name['allowance']._serialized_options = b'\xca\xb4-\rFeeAllowanceI'
