...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GASINFO'].fields_by_name['gas_wanted']._loaded_options = None
    _globals['_GASINFO'].fields_by_name['gas_wanted']._serialized_options = b'\xf2\xde\x1f\x11yaml:"gas_wanted"'
    _globals['_GASINFO'].fields_by_name['gas_used']._loaded_options = None
    _globals['_GASINFO'].fields_by_name['gas_used']._serialized_options = b'\xf2\xde\x1f\x0fyaml:"gas_used"'
    ...
    _globals['_MSGDATA']._serialized_options = b'\x80\xdc \x01'
    _globals['_TXMSGDATA']._loaded_options = None
    _globals['_TXMSGDATA']._serialized_options = b'\x80\xdc \x01'
    _globals['_SEARCHTXSRESULT'].fields_by_name['total_count']._loaded_options = None
    _globals['_SEARCHTXSRESULT'].fields_by_name['total_count']._serialized_options = b'\xea\xde\x1f\x0btotal_count\xf2\xde\x1f\x12yaml:"total_count"'
    _globals['_SEARCHTXSRESULT'].fields_by_name['page_number']._loaded_options = None
    _globals['_SEARCHTXSRESULT'].fields_by_name['page_number']._serialized_options = b'\xea\xde\x1f\x0bpage_number\xf2\xde\x1f\x12yaml:"page_number"'
    _globals['_SEARCHTXSRESULT'].fields_by_name['page_total']._loaded_options = None
    _globals['_SEARCHTXSRESULT'].fields_by_name['page_total']._serialized_options = b'\xea\xde\x1f\npage_total\xf2\xde\x1f\x11yaml:"page_total"'
