...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BASEACCOUNT'].fields_by_name['pub_key']._serialized_options = b'\xea\xde\x1f\x14public_key,omitempty\xf2\xde\x1f\x11yaml:"public_key"'
    _globals['_BASEACCOUNT'].fields_by_name['account_number']._loaded_options = None
    _globals['_BASEACCOUNT'].fields_by_name['account_number']._serialized_options = b'\xf2\xde\x1f\x15yaml:"account_number"'
    _globals['_BASEACCOUNT']._loaded_options = None
    _globals['_BASEACCOUNT']._serialized_options = b'\x88\xa0\x1f\x00\x98\xa0\x1f\x00\xe8\xa0\x1f\x00\xca\xb4-\x08AccountI'
    _globals['_MODULEACCOUNT'].fields_by_name['base_account']._loaded_options = None
    _globals['_MODULEACCOUNT'].fields_by_name['base_account']._serialized_options = b'\xd0\xde\x1f\x01\xf2\xde\x1f\x13yaml:"base_account"'
    _globals['_MODULEACCOUNT']._loaded_options = None
    _globals['_MODULEACCOUNT']._serialized_options = b'\x88\xa0\x1f\x00\x98\xa0\x1f\x00\xca\xb4-\x0eModuleAccountI'
    _globals['_PARAMS'].fields_by_name['max_memo_characters']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['max_memo_characters']._serialized_options = b'\xf2\xde\x1f\x1ayaml:"max_memo_characters"'
    _globals['_PARAMS'].fields_by_name['tx_sig_limit']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['tx_sig_limit']._serialized_options = b'\xf2\xde\x1f\x13yaml:"tx_sig_limit"'
    _globals['_PARAMS'].fields_by_name['tx_size_cost_per_byte']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['tx_size_cost_per_byte']._serialized_options = b'\xf2\xde\x1f\x1cyaml:"tx_size_cost_per_byte"'
    _globals['_PARAMS'].fields_by_name['sig_verify_cost_ed25519']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['sig_verify_cost_ed25519']._serialized_options = b'\xe2\xde\x1f\x14SigVerifyCostED25519\xf2\xde\x1f\x1eyaml:"sig_verify_cost_ed25519"'
    _globals['_PARAMS'].fields_by_name['sig_verify_cost_secp256k1']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['sig_verify_cost_secp256k1']._serialized_options = b'\xe2\xde\x1f\x16SigVerifyCostSecp256k1\xf2\xde\x1f yaml:"sig_verify_cost_secp256k1"'
    _globals['_PARAMS']._loaded_options = None
    _globals['_PARAMS']._serialized_options = b'\x98\xa0\x1f\x00\xe8\xa0\x1f\x01'
