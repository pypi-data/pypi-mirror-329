...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/core/connection/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYCONNECTIONCLIENTSTATEREQUEST'].fields_by_name['connection_id']._loaded_options = None
    ...
    _globals['_QUERYCONNECTIONCONSENSUSSTATEREQUEST'].fields_by_name['connection_id']._loaded_options = None
