...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'interchain_security/ccv/v1/ccv.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'Z4github.com/cosmos/interchain-security/v2/x/ccv/types'
    _globals['_CONSUMERPACKETDATATYPE']._loaded_options = None
    _globals['_CONSUMERPACKETDATATYPE']._serialized_options = b'\x88\xa3\x1e\x00'
    _globals['_CONSUMERPACKETDATATYPE'].values_by_name['CONSUMER_PACKET_TYPE_UNSPECIFIED']._loaded_options = None
    _globals['_CONSUMERPACKETDATATYPE'].values_by_name['CONSUMER_PACKET_TYPE_UNSPECIFIED']._serialized_options = b'\x8a\x9d \x11UnspecifiedPacket'
    _globals['_CONSUMERPACKETDATATYPE'].values_by_name['CONSUMER_PACKET_TYPE_SLASH']._loaded_options = None
    _globals['_CONSUMERPACKETDATATYPE'].values_by_name['CONSUMER_PACKET_TYPE_SLASH']._serialized_options = b'\x8a\x9d \x0bSlashPacket'
    _globals['_CONSUMERPACKETDATATYPE'].values_by_name['CONSUMER_PACKET_TYPE_VSCM']._loaded_options = None
    _globals['_CONSUMERPACKETDATATYPE'].values_by_name['CONSUMER_PACKET_TYPE_VSCM']._serialized_options = b'\x8a\x9d \x10VscMaturedPacket'
    _globals['_VALIDATORSETCHANGEPACKETDATA'].fields_by_name['validator_updates']._loaded_options = None
    _globals['_VALIDATORSETCHANGEPACKETDATA'].fields_by_name['validator_updates']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x18yaml:"validator_updates"'
    _globals['_VALIDATORSETCHANGEPACKETS'].fields_by_name['list']._loaded_options = None
    _globals['_VALIDATORSETCHANGEPACKETS'].fields_by_name['list']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_SLASHPACKETDATA'].fields_by_name['validator']._loaded_options = None
    _globals['_SLASHPACKETDATA'].fields_by_name['validator']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x10yaml:"validator"'
    _globals['_CONSUMERPACKETDATALIST'].fields_by_name['list']._loaded_options = None
    _globals['_CONSUMERPACKETDATALIST'].fields_by_name['list']._serialized_options = b'\xc8\xde\x1f\x00'
