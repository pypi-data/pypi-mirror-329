...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENESISSTATE'].fields_by_name['last_total_power']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Int\xf2\xde\x1f\x17yaml:"last_total_power"'
    _globals['_GENESISSTATE'].fields_by_name['last_validator_powers']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['last_validator_powers']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x1cyaml:"last_validator_powers"'
    _globals['_GENESISSTATE'].fields_by_name['validators']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['validators']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['delegations']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['delegations']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['unbonding_delegations']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['unbonding_delegations']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x1cyaml:"unbonding_delegations"'
    _globals['_GENESISSTATE'].fields_by_name['redelegations']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['redelegations']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['tokenize_share_records']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['tokenize_share_records']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['total_liquid_staked_tokens']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['total_liquid_staked_tokens']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Int\xf2\xde\x1f!yaml:"total_liquid_staked_tokens"'
    _globals['_GENESISSTATE'].fields_by_name['tokenize_share_locks']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['tokenize_share_locks']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_TOKENIZESHARELOCK'].fields_by_name['completion_time']._loaded_options = None
    _globals['_TOKENIZESHARELOCK'].fields_by_name['completion_time']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x16yaml:"completion_time"\x90\xdf\x1f\x01'
