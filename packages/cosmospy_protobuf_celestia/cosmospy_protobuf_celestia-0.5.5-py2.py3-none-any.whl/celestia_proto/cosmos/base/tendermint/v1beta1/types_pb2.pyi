...
class Block(_message.Message):
    __slots__ = ('header', 'data', 'last_commit')
    ...
    def __init__(self, header: _Optional[_Union[Header, _Mapping]]=..., data: _Optional[_Union[_types_pb2.Data, _Mapping]]=..., last_commit: _Optional[_Union[_types_pb2.Commit, _Mapping]]=...) -> None:
        ...
