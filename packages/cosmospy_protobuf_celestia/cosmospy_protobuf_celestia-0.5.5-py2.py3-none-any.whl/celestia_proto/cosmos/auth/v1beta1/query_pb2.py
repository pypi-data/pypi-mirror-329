...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYACCOUNTSRESPONSE'].fields_by_name['accounts']._serialized_options = b'\xca\xb4-\x08AccountI'
    ...
    _globals['_QUERYACCOUNTRESPONSE'].fields_by_name['account']._serialized_options = b'\xca\xb4-\x08AccountI'
    ...
    _globals['_QUERYMODULEACCOUNTBYNAMERESPONSE'].fields_by_name['account']._serialized_options = b'\xca\xb4-\x0eModuleAccountI'
    _globals['_QUERY'].methods_by_name['Accounts']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Accounts']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1f\x12\x1d/cosmos/auth/v1beta1/accounts'
    _globals['_QUERY'].methods_by_name['Account']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Account']._serialized_options = b"\x82\xd3\xe4\x93\x02)\x12'/cosmos/auth/v1beta1/accounts/{address}"
    _globals['_QUERY'].methods_by_name['Params']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1d\x12\x1b/cosmos/auth/v1beta1/params'
    _globals['_QUERY'].methods_by_name['ModuleAccountByName']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ModuleAccountByName']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/cosmos/auth/v1beta1/module_accounts/{name}'
