...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYEVIDENCEREQUEST'].fields_by_name['evidence_hash']._serialized_options = b'\xfa\xde\x1f4github.com/tendermint/tendermint/libs/bytes.HexBytes'
    _globals['_QUERY'].methods_by_name['Evidence']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Evidence']._serialized_options = b'\x82\xd3\xe4\x93\x023\x121/cosmos/evidence/v1beta1/evidence/{evidence_hash}'
