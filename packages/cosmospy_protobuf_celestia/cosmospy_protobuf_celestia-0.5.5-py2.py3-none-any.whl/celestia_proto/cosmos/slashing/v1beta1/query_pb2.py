...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYSIGNINGINFORESPONSE'].fields_by_name['val_signing_info']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYSIGNINGINFOSRESPONSE'].fields_by_name['info']._loaded_options = None
    _globals['_QUERYSIGNINGINFOSRESPONSE'].fields_by_name['info']._serialized_options = b'\xc8\xde\x1f\x00'
