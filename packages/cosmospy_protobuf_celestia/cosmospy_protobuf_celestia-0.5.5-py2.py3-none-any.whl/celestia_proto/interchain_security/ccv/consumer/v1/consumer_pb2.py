...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'interchain_security/ccv/consumer/v1/consumer.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PARAMS'].fields_by_name['transfer_timeout_period']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['transfer_timeout_period']._serialized_options = b'\xc8\xde\x1f\x00\x98\xdf\x1f\x01'
    _globals['_PARAMS'].fields_by_name['unbonding_period']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['unbonding_period']._serialized_options = b'\xc8\xde\x1f\x00\x98\xdf\x1f\x01'
    _globals['_CROSSCHAINVALIDATOR'].fields_by_name['pubkey']._loaded_options = None
    _globals['_CROSSCHAINVALIDATOR'].fields_by_name['pubkey']._serialized_options = b'\xf2\xde\x1f\x17yaml:"consensus_pubkey"\xca\xb4-\x14cosmos.crypto.PubKey'
    _globals['_MATURINGVSCPACKET'].fields_by_name['maturity_time']._loaded_options = None
    _globals['_MATURINGVSCPACKET'].fields_by_name['maturity_time']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
