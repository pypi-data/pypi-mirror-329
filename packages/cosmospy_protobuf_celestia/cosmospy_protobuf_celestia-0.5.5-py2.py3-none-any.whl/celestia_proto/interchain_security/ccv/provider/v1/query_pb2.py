...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'interchain_security/ccv/provider/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYCONSUMERGENESISRESPONSE'].fields_by_name['genesis_state']._loaded_options = None
    _globals['_QUERYCONSUMERGENESISRESPONSE'].fields_by_name['genesis_state']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYVALIDATORCONSUMERADDRREQUEST'].fields_by_name['provider_address']._loaded_options = None
    _globals['_QUERYVALIDATORCONSUMERADDRREQUEST'].fields_by_name['provider_address']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"address"'
    _globals['_QUERYVALIDATORCONSUMERADDRREQUEST']._loaded_options = None
    _globals['_QUERYVALIDATORCONSUMERADDRREQUEST']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_QUERYVALIDATORPROVIDERADDRREQUEST'].fields_by_name['consumer_address']._loaded_options = None
    _globals['_QUERYVALIDATORPROVIDERADDRREQUEST'].fields_by_name['consumer_address']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"address"'
    _globals['_QUERYVALIDATORPROVIDERADDRREQUEST']._loaded_options = None
    _globals['_QUERYVALIDATORPROVIDERADDRREQUEST']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_QUERYTHROTTLESTATERESPONSE'].fields_by_name['next_replenish_candidate']._loaded_options = None
    _globals['_QUERYTHROTTLESTATERESPONSE'].fields_by_name['next_replenish_candidate']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
    _globals['_QUERYTHROTTLEDCONSUMERPACKETDATARESPONSE'].fields_by_name['packetDataInstances']._loaded_options = None
    _globals['_QUERYTHROTTLEDCONSUMERPACKETDATARESPONSE'].fields_by_name['packetDataInstances']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_THROTTLEDSLASHPACKET'].fields_by_name['global_entry']._loaded_options = None
    _globals['_THROTTLEDSLASHPACKET'].fields_by_name['global_entry']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_THROTTLEDSLASHPACKET'].fields_by_name['data']._loaded_options = None
    _globals['_THROTTLEDSLASHPACKET'].fields_by_name['data']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERY'].methods_by_name['QueryConsumerGenesis']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryConsumerGenesis']._serialized_options = b'\x82\xd3\xe4\x93\x02?\x12=/interchain_security/ccv/provider/consumer_genesis/{chain_id}'
    _globals['_QUERY'].methods_by_name['QueryConsumerChains']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryConsumerChains']._serialized_options = b'\x82\xd3\xe4\x93\x023\x121/interchain_security/ccv/provider/consumer_chains'
    _globals['_QUERY'].methods_by_name['QueryConsumerChainStarts']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryConsumerChainStarts']._serialized_options = b'\x82\xd3\xe4\x93\x02B\x12@/interchain_security/ccv/provider/consumer_chain_start_proposals'
    _globals['_QUERY'].methods_by_name['QueryConsumerChainStops']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryConsumerChainStops']._serialized_options = b'\x82\xd3\xe4\x93\x02A\x12?/interchain_security/ccv/provider/consumer_chain_stop_proposals'
    _globals['_QUERY'].methods_by_name['QueryValidatorConsumerAddr']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryValidatorConsumerAddr']._serialized_options = b'\x82\xd3\xe4\x93\x02;\x129/interchain_security/ccv/provider/validator_consumer_addr'
    _globals['_QUERY'].methods_by_name['QueryValidatorProviderAddr']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryValidatorProviderAddr']._serialized_options = b'\x82\xd3\xe4\x93\x02;\x129/interchain_security/ccv/provider/validator_provider_addr'
    _globals['_QUERY'].methods_by_name['QueryThrottleState']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryThrottleState']._serialized_options = b'\x82\xd3\xe4\x93\x022\x120/interchain_security/ccv/provider/throttle_state'
    _globals['_QUERY'].methods_by_name['QueryThrottledConsumerPacketData']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryThrottledConsumerPacketData']._serialized_options = b'\x82\xd3\xe4\x93\x02<\x12:/interchain_security/ccv/provider/pending_consumer_packets'
    _globals['_QUERY'].methods_by_name['QueryRegisteredConsumerRewardDenoms']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryRegisteredConsumerRewardDenoms']._serialized_options = b'\x82\xd3\xe4\x93\x02E\x12C/interchain_security/ccv/provider/registered_consumer_reward_denoms'
