...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'interchain_security/ccv/provider/v1/provider.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONSUMERADDITIONPROPOSAL'].fields_by_name['initial_height']._loaded_options = None
    _globals['_CONSUMERADDITIONPROPOSAL'].fields_by_name['initial_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CONSUMERADDITIONPROPOSAL'].fields_by_name['spawn_time']._loaded_options = None
    _globals['_CONSUMERADDITIONPROPOSAL'].fields_by_name['spawn_time']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
    _globals['_CONSUMERADDITIONPROPOSAL'].fields_by_name['unbonding_period']._loaded_options = None
    _globals['_CONSUMERADDITIONPROPOSAL'].fields_by_name['unbonding_period']._serialized_options = b'\xc8\xde\x1f\x00\x98\xdf\x1f\x01'
    _globals['_CONSUMERADDITIONPROPOSAL'].fields_by_name['ccv_timeout_period']._loaded_options = None
    ...
    _globals['_CONSUMERADDITIONPROPOSAL'].fields_by_name['transfer_timeout_period']._loaded_options = None
