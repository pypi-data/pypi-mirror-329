...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/lightclients/solomachine/v1/solomachine.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CLIENTSTATE'].fields_by_name['frozen_sequence']._loaded_options = None
    ...
    _globals['_CLIENTSTATE'].fields_by_name['allow_update_after_proposal']._loaded_options = None
    ...
    _globals['_SIGNATUREANDDATA'].fields_by_name['data_type']._loaded_options = None
    ...
    _globals['_SIGNBYTES'].fields_by_name['data_type']._loaded_options = None
    ...
    _globals['_CLIENTSTATEDATA'].fields_by_name['client_state']._loaded_options = None
    ...
    _globals['_CONSENSUSSTATEDATA'].fields_by_name['consensus_state']._loaded_options = None
    ...
    _globals['_NEXTSEQUENCERECVDATA'].fields_by_name['next_seq_recv']._loaded_options = None
