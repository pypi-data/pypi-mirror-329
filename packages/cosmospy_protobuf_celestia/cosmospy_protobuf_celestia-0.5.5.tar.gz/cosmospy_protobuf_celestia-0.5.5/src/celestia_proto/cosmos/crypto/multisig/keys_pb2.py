...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/crypto/multisig/keys.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LEGACYAMINOPUBKEY'].fields_by_name['threshold']._loaded_options = None
    _globals['_LEGACYAMINOPUBKEY'].fields_by_name['threshold']._serialized_options = b'\xf2\xde\x1f\x10yaml:"threshold"'
    _globals['_LEGACYAMINOPUBKEY'].fields_by_name['public_keys']._loaded_options = None
    _globals['_LEGACYAMINOPUBKEY'].fields_by_name['public_keys']._serialized_options = b'\xe2\xde\x1f\x07PubKeys\xf2\xde\x1f\x0eyaml:"pubkeys"'
    _globals['_LEGACYAMINOPUBKEY']._loaded_options = None
    _globals['_LEGACYAMINOPUBKEY']._serialized_options = b'\x88\xa0\x1f\x00'
