...
class Proposal(_message.Message):
    __slots__ = ('id', 'messages', 'status', 'final_tally_result', 'submit_time', 'deposit_end_time', 'total_deposit', 'voting_start_time', 'voting_end_time', 'metadata')
