...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGGRANT'].fields_by_name['grant']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_MSGEXEC'].fields_by_name['msgs']._loaded_options = None
    _globals['_MSGEXEC'].fields_by_name['msgs']._serialized_options = b'\xca\xb4-\x1csdk.Msg, authz.Authorization'
