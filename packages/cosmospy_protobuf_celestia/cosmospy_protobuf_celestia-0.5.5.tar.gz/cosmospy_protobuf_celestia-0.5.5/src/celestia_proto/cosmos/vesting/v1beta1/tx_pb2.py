...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGCREATEVESTINGACCOUNT'].fields_by_name['from_address']._serialized_options = b'\xf2\xde\x1f\x13yaml:"from_address"'
    _globals['_MSGCREATEVESTINGACCOUNT'].fields_by_name['to_address']._loaded_options = None
    _globals['_MSGCREATEVESTINGACCOUNT'].fields_by_name['to_address']._serialized_options = b'\xf2\xde\x1f\x11yaml:"to_address"'
    _globals['_MSGCREATEVESTINGACCOUNT'].fields_by_name['amount']._loaded_options = None
    _globals['_MSGCREATEVESTINGACCOUNT'].fields_by_name['amount']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_MSGCREATEVESTINGACCOUNT'].fields_by_name['end_time']._loaded_options = None
    _globals['_MSGCREATEVESTINGACCOUNT'].fields_by_name['end_time']._serialized_options = b'\xf2\xde\x1f\x0fyaml:"end_time"'
    _globals['_MSGCREATEVESTINGACCOUNT']._loaded_options = None
    _globals['_MSGCREATEVESTINGACCOUNT']._serialized_options = b'\xe8\xa0\x1f\x01'
