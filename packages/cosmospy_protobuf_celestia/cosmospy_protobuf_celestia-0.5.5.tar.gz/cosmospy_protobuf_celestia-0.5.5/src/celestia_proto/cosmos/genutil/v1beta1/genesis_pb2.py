...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENESISSTATE'].fields_by_name['gen_txs']._serialized_options = b'\xea\xde\x1f\x06gentxs\xf2\xde\x1f\ryaml:"gentxs"\xfa\xde\x1f\x18encoding/json.RawMessage'
