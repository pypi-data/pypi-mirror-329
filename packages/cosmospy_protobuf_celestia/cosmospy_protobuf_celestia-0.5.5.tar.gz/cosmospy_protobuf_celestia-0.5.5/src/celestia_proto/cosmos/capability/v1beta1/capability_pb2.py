...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CAPABILITY'].fields_by_name['index']._serialized_options = b'\xf2\xde\x1f\x0cyaml:"index"'
    ...
    _globals['_OWNER'].fields_by_name['module']._serialized_options = b'\xf2\xde\x1f\ryaml:"module"'
    _globals['_OWNER'].fields_by_name['name']._loaded_options = None
    _globals['_OWNER'].fields_by_name['name']._serialized_options = b'\xf2\xde\x1f\x0byaml:"name"'
