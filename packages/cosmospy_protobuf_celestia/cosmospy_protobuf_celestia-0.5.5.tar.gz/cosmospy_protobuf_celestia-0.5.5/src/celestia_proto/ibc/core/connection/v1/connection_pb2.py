...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/core/connection/v1/connection.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONNECTIONEND'].fields_by_name['client_id']._loaded_options = None
    ...
    _globals['_CONNECTIONEND'].fields_by_name['delay_period']._loaded_options = None
    ...
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['id']._loaded_options = None
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['id']._serialized_options = b'\xf2\xde\x1f\tyaml:"id"'
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['client_id']._loaded_options = None
    ...
    _globals['_IDENTIFIEDCONNECTION'].fields_by_name['delay_period']._loaded_options = None
    ...
    _globals['_COUNTERPARTY'].fields_by_name['client_id']._loaded_options = None
    _globals['_COUNTERPARTY'].fields_by_name['client_id']._serialized_options = b'\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_COUNTERPARTY'].fields_by_name['connection_id']._loaded_options = None
    ...
    _globals['_CONNECTIONPATHS'].fields_by_name['client_id']._loaded_options = None
    ...
    _globals['_PARAMS'].fields_by_name['max_expected_time_per_block']._loaded_options = None
