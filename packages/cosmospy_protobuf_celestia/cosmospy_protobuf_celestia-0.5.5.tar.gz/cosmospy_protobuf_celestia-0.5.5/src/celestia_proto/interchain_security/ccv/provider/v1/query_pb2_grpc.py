...
if _version_not_supported:
    raise RuntimeError(f'The grpc package installed is at version {GRPC_VERSION},' + f' but the generated code in interchain_security/ccv/provider/v1/query_pb2_grpc.py depends on' + f' grpcio>={GRPC_GENERATED_VERSION}.' + f' Please upgrade your grpc module to grpcio>={GRPC_GENERATED_VERSION}' + f' or downgrade your generated code using grpcio-tools<={GRPC_VERSION}.')
...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.QueryConsumerGenesis = channel.unary_unary('/interchain_security.ccv.provider.v1.Query/QueryConsumerGenesis', request_serializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerGenesisRequest.SerializeToString, response_deserializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerGenesisResponse.FromString, _registered_method=True)
        self.QueryConsumerChains = channel.unary_unary('/interchain_security.ccv.provider.v1.Query/QueryConsumerChains', request_serializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerChainsRequest.SerializeToString, response_deserializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerChainsResponse.FromString, _registered_method=True)
        self.QueryConsumerChainStarts = channel.unary_unary('/interchain_security.ccv.provider.v1.Query/QueryConsumerChainStarts', request_serializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerChainStartProposalsRequest.SerializeToString, response_deserializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerChainStartProposalsResponse.FromString, _registered_method=True)
        self.QueryConsumerChainStops = channel.unary_unary('/interchain_security.ccv.provider.v1.Query/QueryConsumerChainStops', request_serializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerChainStopProposalsRequest.SerializeToString, response_deserializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerChainStopProposalsResponse.FromString, _registered_method=True)
        self.QueryValidatorConsumerAddr = channel.unary_unary('/interchain_security.ccv.provider.v1.Query/QueryValidatorConsumerAddr', request_serializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryValidatorConsumerAddrRequest.SerializeToString, response_deserializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryValidatorConsumerAddrResponse.FromString, _registered_method=True)
        self.QueryValidatorProviderAddr = channel.unary_unary('/interchain_security.ccv.provider.v1.Query/QueryValidatorProviderAddr', request_serializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryValidatorProviderAddrRequest.SerializeToString, response_deserializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryValidatorProviderAddrResponse.FromString, _registered_method=True)
        self.QueryThrottleState = channel.unary_unary('/interchain_security.ccv.provider.v1.Query/QueryThrottleState', request_serializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryThrottleStateRequest.SerializeToString, response_deserializer=interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryThrottleStateResponse.FromString, _registered_method=True)
...
def add_QueryServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('interchain_security.ccv.provider.v1.Query', rpc_method_handlers)
...
class Query(object):
    ...
    def QueryConsumerGenesis(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/interchain_security.ccv.provider.v1.Query/QueryConsumerGenesis', interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerGenesisRequest.SerializeToString, interchain__security_dot_ccv_dot_provider_dot_v1_dot_query__pb2.QueryConsumerGenesisResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)
