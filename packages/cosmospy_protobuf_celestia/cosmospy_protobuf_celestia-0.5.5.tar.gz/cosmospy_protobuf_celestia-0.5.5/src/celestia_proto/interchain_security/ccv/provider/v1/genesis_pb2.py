...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'interchain_security/ccv/provider/v1/genesis.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENESISSTATE'].fields_by_name['consumer_states']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['consumer_states']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x16yaml:"consumer_states"'
    _globals['_GENESISSTATE'].fields_by_name['unbonding_ops']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['unbonding_ops']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['valset_update_id_to_height']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['valset_update_id_to_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['consumer_addition_proposals']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['consumer_addition_proposals']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['consumer_removal_proposals']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['consumer_removal_proposals']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_GENESISSTATE'].fields_by_name['validator_consumer_pubkeys']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['validator_consumer_pubkeys']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['validators_by_consumer_addr']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['validators_by_consumer_addr']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['consumer_addrs_to_prune']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['consumer_addrs_to_prune']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CONSUMERSTATE'].fields_by_name['consumer_genesis']._loaded_options = None
    _globals['_CONSUMERSTATE'].fields_by_name['consumer_genesis']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CONSUMERSTATE'].fields_by_name['pending_valset_changes']._loaded_options = None
    _globals['_CONSUMERSTATE'].fields_by_name['pending_valset_changes']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CONSUMERSTATE'].fields_by_name['unbonding_ops_index']._loaded_options = None
    _globals['_CONSUMERSTATE'].fields_by_name['unbonding_ops_index']._serialized_options = b'\xc8\xde\x1f\x00'
