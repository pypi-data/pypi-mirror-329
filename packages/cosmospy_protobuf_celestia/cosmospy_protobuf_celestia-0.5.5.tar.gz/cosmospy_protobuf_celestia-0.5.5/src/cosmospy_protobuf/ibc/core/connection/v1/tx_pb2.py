...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/core/connection/v1/tx.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGCONNECTIONOPENINIT'].fields_by_name['client_id']._loaded_options = None
    ...
    _globals['_MSGCONNECTIONOPENINIT'].fields_by_name['delay_period']._loaded_options = None
    ...
    _globals['_MSGCONNECTIONOPENTRY'].fields_by_name['client_id']._loaded_options = None
    ...
    _globals['_MSGCONNECTIONOPENTRY'].fields_by_name['delay_period']._loaded_options = None
    _globals['_MSGCONNECTIONOPENTRY'].fields_by_name['delay_period']._serialized_options = b'\xf2\xde\x1f\x13yaml:"delay_period"'
    _globals['_MSGCONNECTIONOPENTRY'].fields_by_name['counterparty_versions']._loaded_options = None
    ...
    _globals['_MSGCONNECTIONOPENTRY'].fields_by_name['proof_init']._loaded_options = None
    ...
    _globals['_MSGCONNECTIONOPENACK'].fields_by_name['connection_id']._loaded_options = None
    _globals['_MSGCONNECTIONOPENACK'].fields_by_name['connection_id']._serialized_options = b'\xf2\xde\x1f\x14yaml:"connection_id"'
    _globals['_MSGCONNECTIONOPENACK'].fields_by_name['counterparty_connection_id']._loaded_options = None
    ...
    _globals['_MSGCONNECTIONOPENACK'].fields_by_name['proof_try']._loaded_options = None
    ...
    _globals['_MSGCONNECTIONOPENCONFIRM'].fields_by_name['connection_id']._loaded_options = None
    _globals['_MSGCONNECTIONOPENCONFIRM'].fields_by_name['connection_id']._serialized_options = b'\xf2\xde\x1f\x14yaml:"connection_id"'
    _globals['_MSGCONNECTIONOPENCONFIRM'].fields_by_name['proof_ack']._loaded_options = None
