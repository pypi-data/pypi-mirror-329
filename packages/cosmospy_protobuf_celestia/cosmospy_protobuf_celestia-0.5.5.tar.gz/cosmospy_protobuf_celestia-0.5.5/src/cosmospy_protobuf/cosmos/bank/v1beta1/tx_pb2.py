...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGSEND'].fields_by_name['from_address']._serialized_options = b'\xf2\xde\x1f\x13yaml:"from_address"'
    _globals['_MSGSEND'].fields_by_name['to_address']._loaded_options = None
    _globals['_MSGSEND'].fields_by_name['to_address']._serialized_options = b'\xf2\xde\x1f\x11yaml:"to_address"'
    _globals['_MSGSEND'].fields_by_name['amount']._loaded_options = None
    _globals['_MSGSEND'].fields_by_name['amount']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_MSGSEND']._loaded_options = None
    _globals['_MSGSEND']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGMULTISEND'].fields_by_name['inputs']._loaded_options = None
    _globals['_MSGMULTISEND'].fields_by_name['inputs']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_MSGMULTISEND'].fields_by_name['outputs']._loaded_options = None
    _globals['_MSGMULTISEND'].fields_by_name['outputs']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_MSGMULTISEND']._loaded_options = None
    _globals['_MSGMULTISEND']._serialized_options = b'\xe8\xa0\x1f\x00'
