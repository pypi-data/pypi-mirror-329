...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGVERIFYINVARIANT'].fields_by_name['invariant_module_name']._loaded_options = None
    _globals['_MSGVERIFYINVARIANT'].fields_by_name['invariant_module_name']._serialized_options = b'\xf2\xde\x1f\x1cyaml:"invariant_module_name"'
    _globals['_MSGVERIFYINVARIANT'].fields_by_name['invariant_route']._loaded_options = None
    _globals['_MSGVERIFYINVARIANT'].fields_by_name['invariant_route']._serialized_options = b'\xf2\xde\x1f\x16yaml:"invariant_route"'
    _globals['_MSGVERIFYINVARIANT']._loaded_options = None
    _globals['_MSGVERIFYINVARIANT']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
