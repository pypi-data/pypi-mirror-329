...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENESISOWNERS'].fields_by_name['index_owners']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x13yaml:"index_owners"'
    _globals['_GENESISSTATE'].fields_by_name['owners']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['owners']._serialized_options = b'\xc8\xde\x1f\x00'
