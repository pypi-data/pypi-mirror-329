...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_EQUIVOCATION'].fields_by_name['time']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
    _globals['_EQUIVOCATION'].fields_by_name['consensus_address']._loaded_options = None
    _globals['_EQUIVOCATION'].fields_by_name['consensus_address']._serialized_options = b'\xf2\xde\x1f\x18yaml:"consensus_address"'
    _globals['_EQUIVOCATION']._loaded_options = None
    _globals['_EQUIVOCATION']._serialized_options = b'\x88\xa0\x1f\x00\x98\xa0\x1f\x00\xe8\xa0\x1f\x00'
