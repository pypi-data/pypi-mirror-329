...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYPROPOSALRESPONSE'].fields_by_name['proposal']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_QUERYPROPOSALSRESPONSE'].fields_by_name['proposals']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_QUERYVOTERESPONSE'].fields_by_name['vote']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYVOTESRESPONSE'].fields_by_name['votes']._loaded_options = None
    _globals['_QUERYVOTESRESPONSE'].fields_by_name['votes']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['voting_params']._loaded_options = None
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['voting_params']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['deposit_params']._loaded_options = None
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['deposit_params']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['tally_params']._loaded_options = None
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['tally_params']._serialized_options = b'\xc8\xde\x1f\x00'
