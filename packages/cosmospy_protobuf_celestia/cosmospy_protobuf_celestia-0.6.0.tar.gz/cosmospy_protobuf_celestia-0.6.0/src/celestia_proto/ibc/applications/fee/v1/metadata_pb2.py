...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/applications/fee/v1/metadata.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_METADATA'].fields_by_name['fee_version']._loaded_options = None
    _globals['_METADATA'].fields_by_name['fee_version']._serialized_options = b'\xf2\xde\x1f\x12yaml:"fee_version"'
    _globals['_METADATA'].fields_by_name['app_version']._loaded_options = None
