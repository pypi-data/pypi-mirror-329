...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'interchain_security/ccv/consumer/v1/genesis.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'Z=github.com/cosmos/interchain-security/v2/x/ccv/consumer/types'
    ...
    _globals['_GENESISSTATE'].fields_by_name['maturing_packets']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['maturing_packets']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['initial_val_set']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['initial_val_set']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['height_to_valset_update_id']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['height_to_valset_update_id']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['outstanding_downtime_slashing']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['outstanding_downtime_slashing']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['pending_consumer_packets']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['pending_consumer_packets']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['last_transmission_block_height']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['last_transmission_block_height']._serialized_options = b'\xc8\xde\x1f\x00'
