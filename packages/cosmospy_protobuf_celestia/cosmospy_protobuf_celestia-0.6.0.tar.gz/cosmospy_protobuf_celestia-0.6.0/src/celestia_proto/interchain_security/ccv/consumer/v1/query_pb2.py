...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'interchain_security/ccv/consumer/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERY'].methods_by_name['QueryNextFeeDistribution']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryNextFeeDistribution']._serialized_options = b'\x82\xd3\xe4\x93\x029\x127/interchain_security/ccv/consumer/next-fee-distribution'
    _globals['_QUERY'].methods_by_name['QueryParams']._loaded_options = None
    _globals['_QUERY'].methods_by_name['QueryParams']._serialized_options = b'\x82\xd3\xe4\x93\x02*\x12(/interchain_security/ccv/consumer/params'
