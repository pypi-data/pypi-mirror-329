...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGSETWITHDRAWADDRESS'].fields_by_name['delegator_address']._serialized_options = b'\xf2\xde\x1f\x18yaml:"delegator_address"'
    _globals['_MSGSETWITHDRAWADDRESS'].fields_by_name['withdraw_address']._loaded_options = None
    _globals['_MSGSETWITHDRAWADDRESS'].fields_by_name['withdraw_address']._serialized_options = b'\xf2\xde\x1f\x17yaml:"withdraw_address"'
    _globals['_MSGSETWITHDRAWADDRESS']._loaded_options = None
    _globals['_MSGSETWITHDRAWADDRESS']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGWITHDRAWDELEGATORREWARD'].fields_by_name['delegator_address']._loaded_options = None
    _globals['_MSGWITHDRAWDELEGATORREWARD'].fields_by_name['delegator_address']._serialized_options = b'\xf2\xde\x1f\x18yaml:"delegator_address"'
    _globals['_MSGWITHDRAWDELEGATORREWARD'].fields_by_name['validator_address']._loaded_options = None
    _globals['_MSGWITHDRAWDELEGATORREWARD'].fields_by_name['validator_address']._serialized_options = b'\xf2\xde\x1f\x18yaml:"validator_address"'
    _globals['_MSGWITHDRAWDELEGATORREWARD']._loaded_options = None
    _globals['_MSGWITHDRAWDELEGATORREWARD']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGWITHDRAWVALIDATORCOMMISSION'].fields_by_name['validator_address']._loaded_options = None
    _globals['_MSGWITHDRAWVALIDATORCOMMISSION'].fields_by_name['validator_address']._serialized_options = b'\xf2\xde\x1f\x18yaml:"validator_address"'
    _globals['_MSGWITHDRAWVALIDATORCOMMISSION']._loaded_options = None
    _globals['_MSGWITHDRAWVALIDATORCOMMISSION']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGWITHDRAWTOKENIZESHARERECORDREWARD'].fields_by_name['owner_address']._loaded_options = None
    _globals['_MSGWITHDRAWTOKENIZESHARERECORDREWARD'].fields_by_name['owner_address']._serialized_options = b'\xf2\xde\x1f\x14yaml:"owner_address"'
    _globals['_MSGWITHDRAWTOKENIZESHARERECORDREWARD']._loaded_options = None
    _globals['_MSGWITHDRAWTOKENIZESHARERECORDREWARD']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGWITHDRAWALLTOKENIZESHARERECORDREWARD'].fields_by_name['owner_address']._loaded_options = None
    _globals['_MSGWITHDRAWALLTOKENIZESHARERECORDREWARD'].fields_by_name['owner_address']._serialized_options = b'\xf2\xde\x1f\x14yaml:"owner_address"'
    _globals['_MSGWITHDRAWALLTOKENIZESHARERECORDREWARD']._loaded_options = None
    _globals['_MSGWITHDRAWALLTOKENIZESHARERECORDREWARD']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGFUNDCOMMUNITYPOOL'].fields_by_name['amount']._loaded_options = None
    _globals['_MSGFUNDCOMMUNITYPOOL'].fields_by_name['amount']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_MSGFUNDCOMMUNITYPOOL']._loaded_options = None
    _globals['_MSGFUNDCOMMUNITYPOOL']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
