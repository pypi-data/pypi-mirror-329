...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_STAKEAUTHORIZATION']._serialized_options = b'\xca\xb4-\rAuthorization'
    _globals['_AUTHORIZATIONTYPE']._serialized_start = 547
    _globals['_AUTHORIZATIONTYPE']._serialized_end = 705
    _globals['_STAKEAUTHORIZATION']._serialized_start = 144
    _globals['_STAKEAUTHORIZATION']._serialized_end = 544
    _globals['_STAKEAUTHORIZATION_VALIDATORS']._serialized_start = 482
    _globals['_STAKEAUTHORIZATION_VALIDATORS']._serialized_end = 511