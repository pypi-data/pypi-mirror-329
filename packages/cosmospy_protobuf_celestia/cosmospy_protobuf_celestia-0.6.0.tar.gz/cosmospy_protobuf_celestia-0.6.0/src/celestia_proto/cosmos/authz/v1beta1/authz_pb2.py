...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENERICAUTHORIZATION']._serialized_options = b'\xca\xb4-\rAuthorization'
    _globals['_GRANT'].fields_by_name['authorization']._loaded_options = None
    _globals['_GRANT'].fields_by_name['authorization']._serialized_options = b'\xca\xb4-\rAuthorization'
    _globals['_GRANT'].fields_by_name['expiration']._loaded_options = None
    _globals['_GRANT'].fields_by_name['expiration']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
    _globals['_GRANTAUTHORIZATION'].fields_by_name['authorization']._loaded_options = None
    _globals['_GRANTAUTHORIZATION'].fields_by_name['authorization']._serialized_options = b'\xca\xb4-\rAuthorization'
    _globals['_GRANTAUTHORIZATION'].fields_by_name['expiration']._loaded_options = None
    _globals['_GRANTAUTHORIZATION'].fields_by_name['expiration']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
