...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DEPOSIT'].fields_by_name['amount']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_PROPOSAL'].fields_by_name['total_deposit']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_TALLYPARAMS'].fields_by_name['quorum']._serialized_options = b'\xea\xde\x1f\x10quorum,omitempty\xd2\xb4-\ncosmos.Dec'
    _globals['_TALLYPARAMS'].fields_by_name['threshold']._loaded_options = None
    _globals['_TALLYPARAMS'].fields_by_name['threshold']._serialized_options = b'\xea\xde\x1f\x13threshold,omitempty\xd2\xb4-\ncosmos.Dec'
    _globals['_TALLYPARAMS'].fields_by_name['veto_threshold']._loaded_options = None
    _globals['_TALLYPARAMS'].fields_by_name['veto_threshold']._serialized_options = b'\xea\xde\x1f\x18veto_threshold,omitempty\xd2\xb4-\ncosmos.Dec'
    _globals['_VOTEOPTION']._serialized_start = 1687
    _globals['_VOTEOPTION']._serialized_end = 1824
    _globals['_PROPOSALSTATUS']._serialized_start = 1827
    _globals['_PROPOSALSTATUS']._serialized_end = 2033
    _globals['_WEIGHTEDVOTEOPTION']._serialized_start = 215
    _globals['_WEIGHTEDVOTEOPTION']._serialized_end = 310
    _globals['_DEPOSIT']._serialized_start = 312
    _globals['_DEPOSIT']._serialized_end = 436
    _globals['_PROPOSAL']._serialized_start = 439
    _globals['_PROPOSAL']._serialized_end = 913
    _globals['_TALLYRESULT']._serialized_start = 916
    _globals['_TALLYRESULT']._serialized_end = 1081
    _globals['_VOTE']._serialized_start = 1084
    _globals['_VOTE']._serialized_end = 1228
    _globals['_DEPOSITPARAMS']._serialized_start = 1231
    _globals['_DEPOSITPARAMS']._serialized_end = 1418
    _globals['_VOTINGPARAMS']._serialized_start = 1420
    _globals['_VOTINGPARAMS']._serialized_end = 1490
    _globals['_TALLYPARAMS']._serialized_start = 1493
    _globals['_TALLYPARAMS']._serialized_end = 1684