...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PARAMS'].fields_by_name['send_enabled']._serialized_options = b'\xf2\xde\x1f\x1dyaml:"send_enabled,omitempty"'
    _globals['_PARAMS'].fields_by_name['default_send_enabled']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['default_send_enabled']._serialized_options = b'\xf2\xde\x1f%yaml:"default_send_enabled,omitempty"'
    ...
    _globals['_INPUT'].fields_by_name['coins']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_INPUT']._loaded_options = None
    _globals['_INPUT']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_OUTPUT'].fields_by_name['coins']._loaded_options = None
    _globals['_OUTPUT'].fields_by_name['coins']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    ...
    _globals['_SUPPLY'].fields_by_name['total']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_SUPPLY']._loaded_options = None
    _globals['_SUPPLY']._serialized_options = b'\x18\x01\x88\xa0\x1f\x00\xe8\xa0\x1f\x01\xca\xb4-8*github.com/cosmos/cosmos-sdk/x/bank/legacy/v040.SupplyI'
