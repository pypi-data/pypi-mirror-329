...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYALLBALANCESRESPONSE'].fields_by_name['balances']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    ...
    _globals['_QUERYSPENDABLEBALANCESRESPONSE'].fields_by_name['balances']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    ...
    _globals['_QUERYTOTALSUPPLYRESPONSE'].fields_by_name['supply']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_QUERYSUPPLYOFRESPONSE'].fields_by_name['amount']._loaded_options = None
    _globals['_QUERYSUPPLYOFRESPONSE'].fields_by_name['amount']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_QUERYDENOMSMETADATARESPONSE'].fields_by_name['metadatas']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYDENOMMETADATARESPONSE'].fields_by_name['metadata']._loaded_options = None
    _globals['_QUERYDENOMMETADATARESPONSE'].fields_by_name['metadata']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERY'].methods_by_name['Balance']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Balance']._serialized_options = b'\x82\xd3\xe4\x93\x022\x120/cosmos/bank/v1beta1/balances/{address}/by_denom'
    _globals['_QUERY'].methods_by_name['AllBalances']._loaded_options = None
    _globals['_QUERY'].methods_by_name['AllBalances']._serialized_options = b"\x82\xd3\xe4\x93\x02)\x12'/cosmos/bank/v1beta1/balances/{address}"
    _globals['_QUERY'].methods_by_name['SpendableBalances']._loaded_options = None
    _globals['_QUERY'].methods_by_name['SpendableBalances']._serialized_options = b'\x82\xd3\xe4\x93\x023\x121/cosmos/bank/v1beta1/spendable_balances/{address}'
    _globals['_QUERY'].methods_by_name['TotalSupply']._loaded_options = None
    _globals['_QUERY'].methods_by_name['TotalSupply']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1d\x12\x1b/cosmos/bank/v1beta1/supply'
    _globals['_QUERY'].methods_by_name['SupplyOf']._loaded_options = None
    _globals['_QUERY'].methods_by_name['SupplyOf']._serialized_options = b'\x82\xd3\xe4\x93\x02%\x12#/cosmos/bank/v1beta1/supply/{denom}'
    _globals['_QUERY'].methods_by_name['Params']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1d\x12\x1b/cosmos/bank/v1beta1/params'
    _globals['_QUERY'].methods_by_name['DenomMetadata']._loaded_options = None
    _globals['_QUERY'].methods_by_name['DenomMetadata']._serialized_options = b'\x82\xd3\xe4\x93\x02.\x12,/cosmos/bank/v1beta1/denoms_metadata/{denom}'
    _globals['_QUERY'].methods_by_name['DenomsMetadata']._loaded_options = None
    _globals['_QUERY'].methods_by_name['DenomsMetadata']._serialized_options = b'\x82\xd3\xe4\x93\x02&\x12$/cosmos/bank/v1beta1/denoms_metadata'
