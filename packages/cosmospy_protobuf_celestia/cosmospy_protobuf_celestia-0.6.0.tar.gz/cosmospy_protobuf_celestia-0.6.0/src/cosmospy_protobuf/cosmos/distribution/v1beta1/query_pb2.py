...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYTOKENIZESHARERECORDREWARDREQUEST'].fields_by_name['owner_address']._serialized_options = b'\xf2\xde\x1f\x14yaml:"owner_address"'
    _globals['_QUERYTOKENIZESHARERECORDREWARDREQUEST']._loaded_options = None
    _globals['_QUERYTOKENIZESHARERECORDREWARDREQUEST']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_QUERYTOKENIZESHARERECORDREWARDRESPONSE'].fields_by_name['rewards']._loaded_options = None
    _globals['_QUERYTOKENIZESHARERECORDREWARDRESPONSE'].fields_by_name['rewards']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYTOKENIZESHARERECORDREWARDRESPONSE'].fields_by_name['total']._loaded_options = None
    _globals['_QUERYTOKENIZESHARERECORDREWARDRESPONSE'].fields_by_name['total']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f+github.com/cosmos/cosmos-sdk/types.DecCoins'
    ...
    _globals['_QUERY'].methods_by_name['TokenizeShareRecordReward']._serialized_options = b'\x82\xd3\xe4\x93\x02L\x12J/cosmos/distribution/v1beta1/{owner_address}/tokenize_share_record_rewards'
