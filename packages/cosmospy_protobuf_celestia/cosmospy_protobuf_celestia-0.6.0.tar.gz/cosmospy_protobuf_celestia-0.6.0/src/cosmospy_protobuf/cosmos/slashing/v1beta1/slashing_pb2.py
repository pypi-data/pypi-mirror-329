...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_VALIDATORSIGNINGINFO'].fields_by_name['start_height']._serialized_options = b'\xf2\xde\x1f\x13yaml:"start_height"'
    _globals['_VALIDATORSIGNINGINFO'].fields_by_name['index_offset']._loaded_options = None
    _globals['_VALIDATORSIGNINGINFO'].fields_by_name['index_offset']._serialized_options = b'\xf2\xde\x1f\x13yaml:"index_offset"'
    _globals['_VALIDATORSIGNINGINFO'].fields_by_name['jailed_until']._loaded_options = None
    _globals['_VALIDATORSIGNINGINFO'].fields_by_name['jailed_until']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x13yaml:"jailed_until"\x90\xdf\x1f\x01'
    _globals['_VALIDATORSIGNINGINFO'].fields_by_name['missed_blocks_counter']._loaded_options = None
    _globals['_VALIDATORSIGNINGINFO'].fields_by_name['missed_blocks_counter']._serialized_options = b'\xf2\xde\x1f\x1cyaml:"missed_blocks_counter"'
    ...
    _globals['_PARAMS'].fields_by_name['signed_blocks_window']._serialized_options = b'\xf2\xde\x1f\x1byaml:"signed_blocks_window"'
    _globals['_PARAMS'].fields_by_name['min_signed_per_window']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['min_signed_per_window']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Dec\xf2\xde\x1f\x1cyaml:"min_signed_per_window"'
    _globals['_PARAMS'].fields_by_name['downtime_jail_duration']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['downtime_jail_duration']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x1dyaml:"downtime_jail_duration"\x98\xdf\x1f\x01'
    _globals['_PARAMS'].fields_by_name['slash_fraction_double_sign']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['slash_fraction_double_sign']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Dec\xf2\xde\x1f!yaml:"slash_fraction_double_sign"'
    _globals['_PARAMS'].fields_by_name['slash_fraction_downtime']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['slash_fraction_downtime']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Dec\xf2\xde\x1f\x1eyaml:"slash_fraction_downtime"'
