...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/applications/interchain_accounts/controller/v1/controller.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PARAMS'].fields_by_name['controller_enabled']._loaded_options = None
