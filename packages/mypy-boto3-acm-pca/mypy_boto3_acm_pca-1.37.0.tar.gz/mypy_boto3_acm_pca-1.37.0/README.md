...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-acm-pca)](https://pypistats.org/packages/mypy-boto3-acm-pca)
...
`mypy-boto3-acm-pca` dependency in production. However, there is an issue in
