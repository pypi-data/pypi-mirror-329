<a id="types-boto3-lex-models"></a>

# types-boto3-lex-models

[![PyPI - types-boto3-lex-models](https://img.shields.io/pypi/v/types-boto3-lex-models.svg?color=blue)](https://pypi.org/project/types-boto3-lex-models/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-lex-models.svg?color=blue)](https://pypi.org/project/types-boto3-lex-models/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-lex-models)](https://pypistats.org/packages/types-boto3-lex-models)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 LexModelBuildingService 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-lex-models docs](https://youtype.github.io/types_boto3_docs/types_boto3_lex_models/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-lex-models](#types-boto3-lex-models)
...
- Install `types-boto3[lex-models]` in your environment:
...
- Install `types-boto3[lex-models]` with services you use in your environment:
...
`types-boto3-lex-models` dependency in production. However, there is an issue
...
from types_boto3_lex_models import LexModelBuildingServiceClient
...
`types_boto3_lex_models.paginator` module contains type annotations for all
paginators.
...
`types_boto3_lex_models.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `LexModelBuildingService` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_lex_models/literals/).
...
`types_boto3_lex_models.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `LexModelBuildingService` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_lex_models/type_defs/).
...
`types-boto3-lex-models` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_lex_models/)
