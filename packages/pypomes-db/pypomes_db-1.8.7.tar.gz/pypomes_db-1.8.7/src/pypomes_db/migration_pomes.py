        ...
        if not op_errors:
            ...
            try:
                ...
                if offset_count:
                    ...
                    curr_stmt = curr_stmt.replace(" OFFSET @offset", "", 1)\
                                         .replace("@limit", str(curr_limit), 1)\
                    ...
                    while pos_from < len(rows_in):
                        ...
                        if logger:
                            logger.debug(msg=f"Migrated {result} tuples, "
                                             ...
                                             f"to {target_engine}.{target_table}")
                    # read the next batch
                    if batch_size_in or limit_count > result:
    ...
    if curr_source_conn and curr_target_conn:
        ...
        try:
            ...
            while next_rs:
                ...
                if next_rs and (batch_size or limit_count > result):
    ...
    if curr_conn:
        ...
        try:
            ...
            while next_rs:
                ...
                # adjust the new offset and limit
                if next_rs and (batch_size or limit_count > lob_count):
