 ...
 */
const nvcompAlignmentRequirements_t nvcompBatchedGzipDecompressRequiredAlignments = {
 ...
 * batch.
 * @param[in] format_opts The Gzip compression options to use.
 ...
 * `nvcompBatchedGzipDecompressRequiredAlignments.input`.
 ...
 * Must be aligned to the value in `nvcompBatchedGzipDecompressRequiredAlignments.temp`.
 ...
 * `nvcompBatchedGzipDecompressRequiredAlignments.output`.
