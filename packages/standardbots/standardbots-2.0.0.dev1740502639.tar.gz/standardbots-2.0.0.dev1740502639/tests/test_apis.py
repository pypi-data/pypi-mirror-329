...
def approx_equal(a, b, precision=3):
...
class TestPostEquipmentEndEffectorControl:
    ...
    def test_3fg15_movement_live(
        ...
        with client.connection():
            ...
            config = client.equipment.get_gripper_configuration()
            assert config.data.onrobot_3fg15.diameter == min_diameter_meters
...
class TestPostRecoveryRecover:
    ...
    def test_not_need_to_recover(self, client_live: StandardBotsRobot) -> None:
    ...
    def test_recoverable_flow_basic(self, client_live: StandardBotsRobot) -> None:
...
class TestPostIO:
    ...
    def test_basic_sim(self, client_sim: StandardBotsRobot) -> None:
        ...
        client = client_sim
        initial_state = models.IOStateUpdateRequest(state={"Output 1": "high"})
        final_state = models.IOStateUpdateRequest(state={"Output 1": "low"})
        ...
        with client.connection():
            ...
            if response.isNotOk():
                ...
                assert isinstance(data, models.IOStateResponse)
                assert data.state["Output 1"] == "low"
