...
reddit_posts = reddit_scraper.get_posts(query="AI", subreddit="technology", time_filter="week", limit=10)
...
async def fetch_twitter_posts():
    ...
    posts = await twitter_scraper.get_posts(query="AI technology", limit=10)
    return posts
