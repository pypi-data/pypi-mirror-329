...
from py_iztro.models import GenderType, LangueType, TimeIndexType, AstrolabeModel
...
class Astro:
    ...
    def by_solar(
        ...
        Args:
            ...
            time_index: 出生时辰序号【0~12】0为早子时，1为丑时，2为寅时，3为卯时，4为辰时，5为巳时，6为午时，7为未时，8为申时，9为酉时，10为戌时，11为亥时，12为晚子时
            gender: 性别【男|女】
...
def main():
    ...
    print(result.horoscope("2025-01-01").model_dump_json(by_alias=True, indent=4))
