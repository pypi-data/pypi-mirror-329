...
class Tool:
    ...
    def add_input_multiple_choice(self, id_: str, options: Options_type, default: List[str], title: str = ""):
        """
    ...
    def add_line(self):
        """
        Adds an horizontal line to divide settings' sections.
        """
    ...
    def test_docker_with_args(
        ...
        os.chdir(local_folder)  # move here to create the Dockerfile and requirements.txt
