...
class CalculateBottomholePressure(UnitModuleAbstract):
    ...
    def update_model_parameter(self, timestamp):
        ...
        well_param = dict()
        well_param['soil_temperature'] = self.unit.parameters['property'][well_index][
            'injectionwell_soil_temperature']

        well_traj = self.unit.parameters['property'][well_index]['injectionwell_trajectory_table']
        friction_correlation = self.unit.parameters['property'][well_index][
