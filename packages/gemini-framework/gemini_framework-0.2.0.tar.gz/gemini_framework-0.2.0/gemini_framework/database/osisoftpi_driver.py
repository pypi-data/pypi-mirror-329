...
class OsisoftPIDriver(DatabaseDriverAbstract):
    """ database driver based on OSISOFTPI"""
    ...
    def read_data(self, pi_af_tagname, start_time, end_time):
    ...
    def _get_AF_interpolated_values(self, pi_af_tagname, start_time, end_time):
        ...
        if response.status_code == 200:
            ...
            url = urlparse(self.parameters['url'] + '/streams/' + data['WebId'] +
                           ...
                           '&interval=' + self.parameters['interval'] + 's')
