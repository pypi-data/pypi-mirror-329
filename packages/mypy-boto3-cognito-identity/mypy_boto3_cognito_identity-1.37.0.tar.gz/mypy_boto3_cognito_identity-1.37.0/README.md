...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-cognito-identity)](https://pypistats.org/packages/mypy-boto3-cognito-identity)
...
`mypy-boto3-cognito-identity` dependency in production. However, there is an
