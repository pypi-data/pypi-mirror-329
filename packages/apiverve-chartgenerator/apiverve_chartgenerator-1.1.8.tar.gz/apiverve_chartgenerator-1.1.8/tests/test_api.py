...
class TestChartgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ChartgeneratorAPIClient(self.api_key)

    @patch('apiverve_chartgenerator.apiClient.requests.get')
