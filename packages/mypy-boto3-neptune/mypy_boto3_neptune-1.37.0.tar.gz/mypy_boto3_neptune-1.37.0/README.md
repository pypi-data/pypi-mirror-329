...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-neptune)](https://pypistats.org/packages/mypy-boto3-neptune)
...
`mypy-boto3-neptune` dependency in production. However, there is an issue in
