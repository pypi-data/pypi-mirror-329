...
from connector.generated.models.jwt_credential import JWTCredential
...
class AuthCredential(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the authentication schema.")
    ...
    jwt: Optional[JWTCredential] = Field(default=None, description="JWT credentials, if using JWT.")
    __properties: ClassVar[List[str]] = ["id", "oauth", "oauth_client_credentials", "basic", "token", "jwt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jwt": JWTCredential.from_dict(obj["jwt"]) if obj.get("jwt") is not None else None
        })
        return _obj
