...
#define SWAT_OBSERVER_TYPE_ID_ENCODE(value) \
  ((uint32_t) ((value) & SWAT_OBSERVER_TYPE_ID_MASK) << SWAT_OBSERVER_TYPE_ID_OFFSET)
...
#define SWAT_OBSERVER_CORE_ENCODE(value)    \
  ((uint32_t) ((value) & SWAT_OBSERVER_CORE_MASK) << SWAT_OBSERVER_CORE_OFFSET)
...
#define SWAT_OBSERVER_U8_VALUE_ENCODE(value) \
  ((uint32_t) ((value) & SWAT_OBSERVER_U8_VALUE_MASK) << SWAT_OBSERVER_U8_VALUE_OFFSET)
...
// SWAT_observe_u32({{ signal.type_id_name }}, SWAT_OBSERVER_TYPE_ID_{{ signal.type_id_name.upper() }}, core_id);
{% endfor %} {# signals #}
