...
import cv2
from albumentations import Compose, RandomRotate90, Blur, RandomBrightnessContrast, RandomGamma, Sharpen, HorizontalFlip, VerticalFlip, CLAHE, HueSaturationValue, ShiftScaleRotate, BboxParams
from albumentations import RandomContrast  # New transform for contrast adjustments
...
def get_transform(selected_augmentations, annotation_format):
    ...
    if selected_augmentations.get('contrast'):
        transformations.append(RandomContrast(p=0.5))
