...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-migrationhubstrategy)](https://pypistats.org/packages/mypy-boto3-migrationhubstrategy)
...
`mypy-boto3-migrationhubstrategy` dependency in production. However, there is
