    ...
    def _wrap_gradio_launch(self, callable):
        ...
        def print_error():
            print(
                ...
                + ":\t  Running in Colab is not possible without providing a valid rtc_configuration. "
                + "See "
                + click.style(
                    "https://fastrtc.org/pr-preview/pr-60/deployment/", fg="cyan"
                )
        ...
        def check_colab_or_spaces(app: FastAPI):
