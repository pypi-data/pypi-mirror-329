...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kinesis-video-webrtc-storage)](https://pypistats.org/packages/mypy-boto3-kinesis-video-webrtc-storage)
...
`mypy-boto3-kinesis-video-webrtc-storage` dependency in production. However,
