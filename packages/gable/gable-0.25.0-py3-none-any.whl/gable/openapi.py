...
class Contract(BaseModel):
    ...
    dataAssetResourceName: StructuredDataAssetResourceName
...
class DataAssetField(BaseModel):
    ...
    piiCategory: Optional[PiiCategory] = Field(
        default=None, description="type of pii detected in the column name"
    )
