...
class AppstorescraperAPIClient:
    def __init__(self, api_key, secure=True):
        """
        Initialize the AppstorescraperAPIClient with the API key and secure flag
        ...
        self.secure = secure
        self.base_url = 'https://api.apiverve.com/v1/appstorescraper'
        self.headers = {
