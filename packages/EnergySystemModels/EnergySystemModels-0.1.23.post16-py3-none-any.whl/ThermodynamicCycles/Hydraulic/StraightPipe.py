...
class Object :
    ...
    def calculate(self):
        ...
        self.df = pd.DataFrame({'StraightPipe': [self.Timestamp,self.Inlet.fluid,round(self.Ti_degC,1),round(self.Inlet.F,3),round(self.Inlet.h,0),round(self.Outlet.h,0),round(self.A,3),round(self.V,3),round(self.Re,0),round(self.delta_P,1)], },
