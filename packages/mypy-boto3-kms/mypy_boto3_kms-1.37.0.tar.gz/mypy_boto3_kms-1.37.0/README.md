...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kms)](https://pypistats.org/packages/mypy-boto3-kms)
...
`mypy-boto3-kms` dependency in production. However, there is an issue in
