<a id="types-boto3-cloudwatch"></a>

# types-boto3-cloudwatch

[![PyPI - types-boto3-cloudwatch](https://img.shields.io/pypi/v/types-boto3-cloudwatch.svg?color=blue)](https://pypi.org/project/types-boto3-cloudwatch/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-cloudwatch.svg?color=blue)](https://pypi.org/project/types-boto3-cloudwatch/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-cloudwatch)](https://pypistats.org/packages/types-boto3-cloudwatch)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 CloudWatch 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-cloudwatch docs](https://youtype.github.io/types_boto3_docs/types_boto3_cloudwatch/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-cloudwatch](#types-boto3-cloudwatch)
...
- Install `types-boto3[cloudwatch]` in your environment:
...
- Install `types-boto3[cloudwatch]` with services you use in your environment:
...
`types-boto3-cloudwatch` dependency in production. However, there is an issue
...
`types_boto3_cloudwatch.paginator` module contains type annotations for all
paginators.
...
`types_boto3_cloudwatch.waiter` module contains type annotations for all
waiters.
...
from types_boto3_cloudwatch import CloudWatchClient
from types_boto3_cloudwatch.waiter import AlarmExistsWaiter, CompositeAlarmExistsWaiter
...
`types_boto3_cloudwatch.service_resource` module contains type annotations for
all resources.
...
from types_boto3_cloudwatch import CloudWatchServiceResource
from types_boto3_cloudwatch.service_resource import Alarm, Metric
...
from types_boto3_cloudwatch import CloudWatchServiceResource
from types_boto3_cloudwatch.service_resource import (
...
`types_boto3_cloudwatch.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `CloudWatch` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_cloudwatch/literals/).
...
`types_boto3_cloudwatch.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `CloudWatch` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_cloudwatch/type_defs/).
...
`types-boto3-cloudwatch` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_cloudwatch/)
