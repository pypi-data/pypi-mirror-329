...
class TestDummyChallenge(unittest.TestCase):
    """DummyChallenge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DummyChallenge:
        """Test DummyChallenge
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DummyChallenge`
        """
        model = DummyChallenge()
        if include_optional:
