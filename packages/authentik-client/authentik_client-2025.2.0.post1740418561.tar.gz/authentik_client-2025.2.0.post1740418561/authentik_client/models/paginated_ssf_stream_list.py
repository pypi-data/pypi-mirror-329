...
class PaginatedSSFStreamList(BaseModel):
    """
    PaginatedSSFStreamList
    """ # noqa: E501
    pagination: Pagination
    results: List[SSFStream]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [SSFStream.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
