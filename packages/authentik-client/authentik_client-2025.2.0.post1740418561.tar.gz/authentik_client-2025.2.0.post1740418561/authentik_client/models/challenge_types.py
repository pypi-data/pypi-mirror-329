...
class ChallengeTypes(BaseModel):
    ...
    # data type: AuthenticatorEmailChallenge
    oneof_schema_4_validator: Optional[AuthenticatorEmailChallenge] = None
    # data type: AuthenticatorSMSChallenge
    oneof_schema_5_validator: Optional[AuthenticatorSMSChallenge] = None
    # data type: AuthenticatorStaticChallenge
    oneof_schema_6_validator: Optional[AuthenticatorStaticChallenge] = None
    # data type: AuthenticatorTOTPChallenge
    oneof_schema_7_validator: Optional[AuthenticatorTOTPChallenge] = None
    # data type: AuthenticatorValidationChallenge
    oneof_schema_8_validator: Optional[AuthenticatorValidationChallenge] = None
    # data type: AuthenticatorWebAuthnChallenge
    oneof_schema_9_validator: Optional[AuthenticatorWebAuthnChallenge] = None
    # data type: AutosubmitChallenge
    oneof_schema_10_validator: Optional[AutosubmitChallenge] = None
    # data type: CaptchaChallenge
    oneof_schema_11_validator: Optional[CaptchaChallenge] = None
    # data type: ConsentChallenge
    oneof_schema_12_validator: Optional[ConsentChallenge] = None
    ...
    oneof_schema_18_validator: Optional[OAuthDeviceCodeChallenge] = None
    # data type: OAuthDeviceCodeFinishChallenge
    oneof_schema_19_validator: Optional[OAuthDeviceCodeFinishChallenge] = None
    # data type: PasswordChallenge
    oneof_schema_20_validator: Optional[PasswordChallenge] = None
    # data type: PlexAuthenticationChallenge
    oneof_schema_21_validator: Optional[PlexAuthenticationChallenge] = None
    # data type: PromptChallenge
    oneof_schema_22_validator: Optional[PromptChallenge] = None
    # data type: RedirectChallenge
    oneof_schema_23_validator: Optional[RedirectChallenge] = None
    # data type: SessionEndChallenge
    oneof_schema_24_validator: Optional[SessionEndChallenge] = None
    # data type: ShellChallenge
    oneof_schema_25_validator: Optional[ShellChallenge] = None
    # data type: UserLoginChallenge
    oneof_schema_26_validator: Optional[UserLoginChallenge] = None
    ...
    one_of_schemas: List[str] = Field(default=Literal["AccessDeniedChallenge", "AppleLoginChallenge", "AuthenticatorDuoChallenge", "AuthenticatorEmailChallenge", "AuthenticatorSMSChallenge", "AuthenticatorStaticChallenge", "AuthenticatorTOTPChallenge", "AuthenticatorValidationChallenge", "AuthenticatorWebAuthnChallenge", "AutosubmitChallenge", "CaptchaChallenge", "ConsentChallenge", "DummyChallenge", "EmailChallenge", "FlowErrorChallenge", "FrameChallenge", "IdentificationChallenge", "OAuthDeviceCodeChallenge", "OAuthDeviceCodeFinishChallenge", "PasswordChallenge", "PlexAuthenticationChallenge", "PromptChallenge", "RedirectChallenge", "SessionEndChallenge", "ShellChallenge", "UserLoginChallenge"])
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, AuthenticatorDuoChallenge):
            ...
            match += 1
        # validate data type: AuthenticatorEmailChallenge
        if not isinstance(v, AuthenticatorEmailChallenge):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AuthenticatorEmailChallenge`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into AuthenticatorEmailChallenge
        try:
            instance.actual_instance = AuthenticatorEmailChallenge.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
