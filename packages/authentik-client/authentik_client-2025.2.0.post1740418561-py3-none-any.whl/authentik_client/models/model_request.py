...
class ModelRequest(BaseModel):
    ...
    one_of_schemas: List[str] = Field(default=Literal["GoogleWorkspaceProviderRequest", "LDAPProviderRequest", "MicrosoftEntraProviderRequest", "OAuth2ProviderRequest", "ProxyProviderRequest", "RACProviderRequest", "RadiusProviderRequest", "SAMLProviderRequest", "SCIMProviderRequest", "SSFProviderRequest"])
