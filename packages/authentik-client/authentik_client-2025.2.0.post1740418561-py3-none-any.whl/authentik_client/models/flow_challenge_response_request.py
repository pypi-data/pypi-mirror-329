...
class FlowChallengeResponseRequest(BaseModel):
    ...
    # data type: AuthenticatorEmailChallengeResponseRequest
    oneof_schema_3_validator: Optional[AuthenticatorEmailChallengeResponseRequest] = None
    # data type: AuthenticatorSMSChallengeResponseRequest
    oneof_schema_4_validator: Optional[AuthenticatorSMSChallengeResponseRequest] = None
    # data type: AuthenticatorStaticChallengeResponseRequest
    oneof_schema_5_validator: Optional[AuthenticatorStaticChallengeResponseRequest] = None
    # data type: AuthenticatorTOTPChallengeResponseRequest
    oneof_schema_6_validator: Optional[AuthenticatorTOTPChallengeResponseRequest] = None
    # data type: AuthenticatorValidationChallengeResponseRequest
    oneof_schema_7_validator: Optional[AuthenticatorValidationChallengeResponseRequest] = None
    # data type: AuthenticatorWebAuthnChallengeResponseRequest
    oneof_schema_8_validator: Optional[AuthenticatorWebAuthnChallengeResponseRequest] = None
    # data type: AutoSubmitChallengeResponseRequest
    oneof_schema_9_validator: Optional[AutoSubmitChallengeResponseRequest] = None
    # data type: CaptchaChallengeResponseRequest
    oneof_schema_10_validator: Optional[CaptchaChallengeResponseRequest] = None
    # data type: ConsentChallengeResponseRequest
    oneof_schema_11_validator: Optional[ConsentChallengeResponseRequest] = None
    ...
    oneof_schema_16_validator: Optional[OAuthDeviceCodeChallengeResponseRequest] = None
    # data type: OAuthDeviceCodeFinishChallengeResponseRequest
    oneof_schema_17_validator: Optional[OAuthDeviceCodeFinishChallengeResponseRequest] = None
    # data type: PasswordChallengeResponseRequest
    oneof_schema_18_validator: Optional[PasswordChallengeResponseRequest] = None
    # data type: PlexAuthenticationChallengeResponseRequest
    oneof_schema_19_validator: Optional[PlexAuthenticationChallengeResponseRequest] = None
    # data type: PromptChallengeResponseRequest
    oneof_schema_20_validator: Optional[PromptChallengeResponseRequest] = None
    # data type: RedirectChallengeResponseRequest
    oneof_schema_21_validator: Optional[RedirectChallengeResponseRequest] = None
    # data type: UserLoginChallengeResponseRequest
    oneof_schema_22_validator: Optional[UserLoginChallengeResponseRequest] = None
    ...
    one_of_schemas: List[str] = Field(default=Literal["AppleChallengeResponseRequest", "AuthenticatorDuoChallengeResponseRequest", "AuthenticatorEmailChallengeResponseRequest", "AuthenticatorSMSChallengeResponseRequest", "AuthenticatorStaticChallengeResponseRequest", "AuthenticatorTOTPChallengeResponseRequest", "AuthenticatorValidationChallengeResponseRequest", "AuthenticatorWebAuthnChallengeResponseRequest", "AutoSubmitChallengeResponseRequest", "CaptchaChallengeResponseRequest", "ConsentChallengeResponseRequest", "DummyChallengeResponseRequest", "EmailChallengeResponseRequest", "FrameChallengeResponseRequest", "IdentificationChallengeResponseRequest", "OAuthDeviceCodeChallengeResponseRequest", "OAuthDeviceCodeFinishChallengeResponseRequest", "PasswordChallengeResponseRequest", "PlexAuthenticationChallengeResponseRequest", "PromptChallengeResponseRequest", "RedirectChallengeResponseRequest", "UserLoginChallengeResponseRequest"])
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, AuthenticatorDuoChallengeResponseRequest):
            ...
            match += 1
        # validate data type: AuthenticatorEmailChallengeResponseRequest
        if not isinstance(v, AuthenticatorEmailChallengeResponseRequest):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AuthenticatorEmailChallengeResponseRequest`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into AuthenticatorEmailChallengeResponseRequest
        try:
            instance.actual_instance = AuthenticatorEmailChallengeResponseRequest.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
