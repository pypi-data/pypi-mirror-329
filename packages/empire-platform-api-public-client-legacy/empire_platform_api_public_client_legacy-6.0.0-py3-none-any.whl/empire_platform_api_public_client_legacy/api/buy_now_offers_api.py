...
class BuyNowOffersApi:
    ...
    @validate_arguments
    def purchase_buy_now_offer(self, purchase_buy_now_offer : PurchaseBuyNowOffer, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.purchase_buy_now_offer(purchase_buy_now_offer, async_req=True)
        >>> result = thread.get()

        :param purchase_buy_now_offer: (required)
        :type purchase_buy_now_offer: PurchaseBuyNowOffer
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.purchase_buy_now_offer_with_http_info(purchase_buy_now_offer, **kwargs)  # noqa: E501

    @validate_arguments
    def purchase_buy_now_offer_with_http_info(self, purchase_buy_now_offer : PurchaseBuyNowOffer, **kwargs) -> ApiResponse:  # noqa: E501
        """purchase_buy_now_offer  # noqa: E501
        ...
        >>> thread = api.purchase_buy_now_offer_with_http_info(purchase_buy_now_offer, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['purchase_buy_now_offer'] is not None:
            _body_params = _params['purchase_buy_now_offer']
