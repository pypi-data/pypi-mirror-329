...
class PurchaseBuyNowOfferMtus(BaseModel):
    """
    PurchaseBuyNowOfferMtus
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseBuyNowOfferMtus:
        """Create an instance of PurchaseBuyNowOfferMtus from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseBuyNowOfferMtus:
        """Create an instance of PurchaseBuyNowOfferMtus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseBuyNowOfferMtus.parse_obj(obj)

        _obj = PurchaseBuyNowOfferMtus.parse_obj({
