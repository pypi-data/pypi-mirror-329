...
class TempStorageInput(BaseModel):
    ...
    quad_constraint_weights_file: FileUrls = Field(alias="quad_constraint_weights.npy")
    quad_constraint_bounds_file: FileUrls = Field(alias="quad_constraint_bounds.npy")
    quad_constraint_linear_weights_file: FileUrls = Field(alias="quad_constraint_linear_weights.npy")
