...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-networkmonitor)](https://pypistats.org/packages/mypy-boto3-networkmonitor)
...
`mypy-boto3-networkmonitor` dependency in production. However, there is an
