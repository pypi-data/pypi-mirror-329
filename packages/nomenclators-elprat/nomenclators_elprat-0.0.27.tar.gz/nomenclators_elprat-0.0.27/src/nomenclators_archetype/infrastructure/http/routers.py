...
R = TypeVar('R', bound=SchemaSimpleNomenclatorResponse, covariant=True)
# Creator class representation
C = TypeVar('C', bound=SchemaSimpleNomenclatorCreator, contravariant=True)
# Updater class representation
U = TypeVar('U', bound=SchemaSimpleNomenclatorUpdater, contravariant=True)
