...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mq)](https://pypistats.org/packages/mypy-boto3-mq)
...
`mypy-boto3-mq` dependency in production. However, there is an issue in
