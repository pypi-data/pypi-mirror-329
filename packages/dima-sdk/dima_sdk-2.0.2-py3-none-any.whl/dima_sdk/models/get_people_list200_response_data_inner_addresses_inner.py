...
class GetPeopleList200ResponseDataInnerAddressesInner(BaseModel):
    """
    GetPeopleList200ResponseDataInnerAddressesInner
    """ # noqa: E501
    region: Optional[StrictStr] = Field(default=None, description="Region code.")
    ...
    street_address: Optional[StrictStr] = Field(default=None, description="Street and number.", alias="streetAddress")
    __properties: ClassVar[List[str]] = ["region", "country", "locality", "postalCode", "streetAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPeopleList200ResponseDataInnerAddressesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPeopleList200ResponseDataInnerAddressesInner from a dict"""
        if obj is None:
            return None
