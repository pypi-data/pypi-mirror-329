...
class debug_framework:
    ...
    def __init__(self, vf, project, entity, update_type, stage_done, scrap, tools):  
        self.vf = vf
...
class rest:
    ...
    def create_project(self, name, fields):
        ...
        request = self.HTTPSession.request(method="POST", url=self.VFAPIURL_ENTITY, body=json.dumps(data), headers=self.get_auth_headers())
