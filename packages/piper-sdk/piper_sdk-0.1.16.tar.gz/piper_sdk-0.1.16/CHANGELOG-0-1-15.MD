...
### 2.1 Compare with the previous version

Compared to version 0.1.14, a fix was applied in the SendCanMessage function inside the hardware/can_encapsulation.py/C_STD_CAN class, addressing an issue where the base_state was None when calling the is_can_bus_ok function.
