...
Compared to version 0.1.13, the GetFK function was modified to include a mode parameter (mode: Literal["feedback", "control"] = "feedback") to select the source of the robotic arm's forward kinematics joint data:
