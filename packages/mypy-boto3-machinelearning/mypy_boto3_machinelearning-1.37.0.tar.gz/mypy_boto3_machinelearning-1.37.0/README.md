...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-machinelearning)](https://pypistats.org/packages/mypy-boto3-machinelearning)
...
`mypy-boto3-machinelearning` dependency in production. However, there is an
