...
class CodeRunner:
    def __init__(self, experiment_id: str, logger):
    ...
    def prepare_data_from_minio(self,dataset_id):
        """
    ...
    def build_docker_image(self):
        self.docker_client.images.build(
            ...
            labels={"img_raise": "This image will be removed after execution"},
        )
