"""
Setup script for mypy-boto3-geo-places.
...
setup(
    ...
    version="1.37.0",
    packages=["mypy_boto3_geo_places"],
    url="https://github.com/youtype/mypy_boto3_builder",
    license="MIT License",
    author="Vlad Emelianov",
    author_email="vlad.emelianov.nz@gmail.com",
    description="Type annotations for boto3 LocationServicePlacesV2 1.37.0 service generated with mypy-boto3-builder 8.9.2",
    classifiers=[
    ...
    package_data={"mypy_boto3_geo_places": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
