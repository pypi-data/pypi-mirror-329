...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-artifact)](https://pypistats.org/packages/mypy-boto3-artifact)
...
`mypy-boto3-artifact` dependency in production. However, there is an issue in
...
from mypy_boto3_artifact import ArtifactClient
from mypy_boto3_artifact.paginator import ListCustomerAgreementsPaginator, ListReportsPaginator
