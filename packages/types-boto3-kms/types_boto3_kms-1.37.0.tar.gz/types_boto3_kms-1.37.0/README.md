<a id="types-boto3-kms"></a>

# types-boto3-kms

[![PyPI - types-boto3-kms](https://img.shields.io/pypi/v/types-boto3-kms.svg?color=blue)](https://pypi.org/project/types-boto3-kms/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-kms.svg?color=blue)](https://pypi.org/project/types-boto3-kms/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-kms)](https://pypistats.org/packages/types-boto3-kms)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 KMS 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-kms docs](https://youtype.github.io/types_boto3_docs/types_boto3_kms/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-kms](#types-boto3-kms)
...
- Install `types-boto3[kms]` in your environment:
...
- Install `types-boto3[kms]` with services you use in your environment:
...
`types-boto3-kms` dependency in production. However, there is an issue in
...
`types_boto3_kms.paginator` module contains type annotations for all
paginators.
...
`types_boto3_kms.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `KMS` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_kms/literals/).
...
`types_boto3_kms.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `KMS` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_kms/type_defs/).
...
`types-boto3-kms` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_kms/)
