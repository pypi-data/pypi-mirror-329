<a id="types-boto3-appmesh"></a>

# types-boto3-appmesh

[![PyPI - types-boto3-appmesh](https://img.shields.io/pypi/v/types-boto3-appmesh.svg?color=blue)](https://pypi.org/project/types-boto3-appmesh/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-appmesh.svg?color=blue)](https://pypi.org/project/types-boto3-appmesh/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-appmesh)](https://pypistats.org/packages/types-boto3-appmesh)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 AppMesh 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-appmesh docs](https://youtype.github.io/types_boto3_docs/types_boto3_appmesh/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-appmesh](#types-boto3-appmesh)
...
- Install `types-boto3[appmesh]` in your environment:
...
- Install `types-boto3[appmesh]` with services you use in your environment:
...
`types-boto3-appmesh` dependency in production. However, there is an issue in
...
from types_boto3_appmesh import AppMeshClient
...
`types_boto3_appmesh.paginator` module contains type annotations for all
paginators.
...
`types_boto3_appmesh.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `AppMesh` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_appmesh/literals/).
...
`types_boto3_appmesh.type_defs` module contains structures and shapes assembled
to typed dictionaries and unions for additional type checking.

Full list of `AppMesh` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_appmesh/type_defs/).
...
`types-boto3-appmesh` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_appmesh/)
