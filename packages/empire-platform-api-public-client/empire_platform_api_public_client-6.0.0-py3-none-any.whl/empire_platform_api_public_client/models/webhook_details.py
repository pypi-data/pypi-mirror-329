...
class WebhookDetails(BaseModel):
    ...
    signing_secret_masked: StrictStr = Field(alias="signingSecretMasked")
    __properties: ClassVar[List[str]] = ["id", "url", "eventTypes", "signingSecretMasked"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signingSecretMasked": obj.get("signingSecretMasked")
        })
        return _obj
