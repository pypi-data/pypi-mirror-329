...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-lookoutvision)](https://pypistats.org/packages/mypy-boto3-lookoutvision)
...
`mypy-boto3-lookoutvision` dependency in production. However, there is an issue
