%shared_ptr(snde::math_parameter);
snde_rawaccessible(snde::math_parameter);

%shared_ptr(snde::math_parameter_string_const);
snde_rawaccessible(snde::math_parameter_string_const);
...
%shared_ptr(snde::math_parameter_sndeindex_const);
snde_rawaccessible(snde::math_parameter_sndeindex_const);

%shared_ptr(snde::math_parameter_double_const);
snde_rawaccessible(snde::math_parameter_double_const);

%shared_ptr(snde::math_parameter_bool_const);
snde_rawaccessible(snde::math_parameter_bool_const);

%shared_ptr(snde::math_parameter_vector_const);
snde_rawaccessible(snde::math_parameter_vector_const);

%shared_ptr(snde::math_parameter_orientation_const);
snde_rawaccessible(snde::math_parameter_orientation_const);
...
%template(snde_math_parameter_vector) std::vector<std::shared_ptr<snde::math_parameter>>;
