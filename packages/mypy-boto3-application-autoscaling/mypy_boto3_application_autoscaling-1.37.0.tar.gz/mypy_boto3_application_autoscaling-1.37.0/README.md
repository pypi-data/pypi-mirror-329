...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-application-autoscaling)](https://pypistats.org/packages/mypy-boto3-application-autoscaling)
...
`mypy-boto3-application-autoscaling` dependency in production. However, there
