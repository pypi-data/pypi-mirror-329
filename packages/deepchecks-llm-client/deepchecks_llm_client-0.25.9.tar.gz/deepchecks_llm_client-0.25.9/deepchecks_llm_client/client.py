...
class DeepchecksLLMClient:
    ...
    def create_app_version(
        ...
        return self.api.create_application_version(
            ...
            additional_fields=[{key: value} for key, value in additional_fields.items()] if additional_fields else []
        )
    ...
    def update_application_version(
        ...
        description: t.Optional[str] = None,
        additional_fields: t.Optional[t.List[dict]] = None,
    ):
        """Create a new application.
    ...
    @HandleExceptions(logger)
    def update_application_config(self, app_name: str, file):
        """Update the auto-annotation YAML configuration file for the interaction type that is related to the application kind.

        From version 0.22.0 config yaml is managed "per interaction type" instead of "application level".
        This method is deprecated, please use update_interaction_type_config() instead.
        ...
        """
        app_id = self._get_application_id(app_name)
        self.api.update_application_config(application_id=app_id, file=file)
    ...
    @HandleExceptions(logger)
    def get_application_config(self, app_name: str, file_save_path: t.Union[str, None] = None) -> str:
        """Write the auto-annotation YAML configuration file to the interaction type that is related to the application kind.

        From version 0.22.0 config yaml is managed "per interaction type" instead of "application level".
        This method is deprecated, please use get_interaction_type_config() instead.    
        ...
        """
        app_id = self._get_application_id(app_name)
        return self.api.get_application_config(application_id=app_id, file_save_path=file_save_path)
    ...
    def get_custom_properties(self, app_name: str, interaction_type: t.Optional[str] = None) -> t.List[CustomPropertyType]:
        ...
        """
        app_id = self._get_application_id(app_name)
        custom_props = self.api.get_custom_properties_definitions(application_id=app_id, interaction_type=interaction_type)
        return [
            CustomPropertyType(
    ...
    def update_custom_property(
            ...
            new_property_name: t.Optional[str] = None,
            description: t.Optional[str] = None,
        ...
        new_property_name : str, optional
        ...
        force_update : bool, default False
            This means that renaming a custom property in type A will also rename
            the property defined with the same name in type B, if it exists.
            If force_update is set to False and more than one type has the same property, an error will be raised.
        ...
        self.api.update_custom_property_definition(
            ...
            new_name=new_property_name if new_property_name else old_property_name,
            description=description,
            force_update=force_update,
        )

    def delete_custom_property(self, app_name: str, property_name: str):
        ...
        """
        app_id = self._get_application_id(app_name)
        self.api.delete_custom_property_definition(application_id=app_id, name=property_name)
    ...
    def create_interaction_type(
        ...
        app_name: str,
        name: str,
        copy_from_interaction_type_id: t.Optional[str] = None,
    ) -> int:
        ...
        copy_from_interaction_type_id : str, optional
        ...
        create_interaction_response = self.api.create_interaction_type(
            app_id=app_id,
            name=name,
            copy_from_interaction_type_id=copy_from_interaction_type_id,
        )
    ...
    def get_interaction_types(self, app_name: str) -> t.List[InteractionType]:
        ...
        return [
            InteractionType(
                ...
                is_builtin_type=interaction_type["is_builtin_type"],
                is_active=interaction_type["is_active"],
