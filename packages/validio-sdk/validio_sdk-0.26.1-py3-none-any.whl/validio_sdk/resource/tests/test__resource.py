...
from validio_sdk.resource.windows import WindowTimeUnit
...
def test__should_build_resource_graph_from_resource_constructors() -> None:
    ...
    segmentations.Segmentation(name="seg4", source=s3)
    segmentations.Segmentation(name="seg5", source=s3)
    ...
    seg2 = segmentations.Segmentation(name="seg2", source=s2)
