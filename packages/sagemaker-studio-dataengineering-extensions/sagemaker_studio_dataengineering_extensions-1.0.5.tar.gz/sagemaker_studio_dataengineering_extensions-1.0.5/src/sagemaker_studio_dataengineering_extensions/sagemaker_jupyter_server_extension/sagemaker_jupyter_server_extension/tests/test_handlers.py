...
from sagemaker_jupyter_server_extension.tests.test_connection_utils import load_test_file_path, get_json_from_file, \
    ordered
...
async def test_get_connection(jp_fetch):
    with open(load_test_file_path('connection_utils_test/test_metadata.json'), 'r') as f:
