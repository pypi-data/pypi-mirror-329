...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-cur)](https://pypistats.org/packages/mypy-boto3-cur)
...
`mypy-boto3-cur` dependency in production. However, there is an issue in
