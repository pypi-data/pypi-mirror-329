...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iotdeviceadvisor)](https://pypistats.org/packages/mypy-boto3-iotdeviceadvisor)
...
`mypy-boto3-iotdeviceadvisor` dependency in production. However, there is an
