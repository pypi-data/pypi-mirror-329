...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kafkaconnect)](https://pypistats.org/packages/mypy-boto3-kafkaconnect)
...
`mypy-boto3-kafkaconnect` dependency in production. However, there is an issue
