...
class Requirements(object):
    ...
    def get():
        ...
        :return:
        """
        requirements = ["m-formatter-logging", "m-filetypes", "python_calamine==0.1.7", "m-monitor"]
        return requirements
...
setup(
    ...
    name="m-validate-import-file" + run_mode,  # Required
    ...
    description="Mobio Validate Import File Libs",  # Optional
    ...
    # larger catalog.
    keywords="mobio, validate-import-file, contact spam",  # Optional
    ...
    #
    packages=['mobio/libs/validate_import_file'],
