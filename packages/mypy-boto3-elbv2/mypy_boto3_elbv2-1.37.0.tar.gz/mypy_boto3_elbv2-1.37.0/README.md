...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-elbv2)](https://pypistats.org/packages/mypy-boto3-elbv2)
...
`mypy-boto3-elbv2` dependency in production. However, there is an issue in
