...
class han:
	...
	def count_word_in_selection(self):
		...
		:return:
		"""
		aaa = self.read_text_in_selection()
	...
	def delete_nth_para_from_start_of_doc(self, input_no):
		...
		:return:
		"""
		self.move_cursor_to_nth_para_from_start_of_doc(input_no - 1)
	...
	def set_basic_font_style(self, **input_dic):
		...
		if "color" in input_dic.keys():
			self.vars["han"]["rgb_int"] = self.color.change_scolor_to_rgbint(input_dic["color"])
	...
	def set_font_border_in_selection(self):
		"""
		테두리 그리기
	...
	def set_font_center_in_selection(self):
		"""
		가운데 정렬
	...
	def set_font_color_in_selection_by_scolor(self, input_scolor):
		...
		self.set_font_color_in_selection_by_rgb(input_rgb)

	def set_font_left_in_selection(self):
		"""
		왼쪽 정렬
	...
	def set_font_right_in_selection(self):
		"""
		오른쪽 정렬
	...
	def set_font_size_down_in_selection(self, input_step=1):
		"""
		폰트크기 n단계 줄이기
	...
	def set_font_size_up_in_selection(self, input_step=1):
		"""
		폰트크기 n단계 키우기
	...
	def set_font_strikethrough_in_selection(self):
		"""
		선택영역의 글자들에 대해서 취소선
	...
	def set_font_underline_in_selection(self):
		"""
		선택영역의 글자들에 대해서 밑줄적용
	...
	# self.han_program.SetTextFile(input_text, "TEXT", "insertfile") #이것을 사용하면, 팝업창이 나타난다
	...
	def write_text_at_end_of_selection_old(self, input_text="aaaaaaaa"):
		"""
		...
		if self.vars["han"]["apply_basic_font"] == True:
