...
class RegScaleModel(BaseModel, ABC):
    ...
    def _perform_create(self: T) -> T:
        ...
        response = self._api_handler.post(endpoint=endpoint, data=self.dict(), headers=self._get_headers())
    ...
    def _perform_save(self: T) -> T:
        ...
        response = self._api_handler.put(endpoint=endpoint, data=self.dict(), headers=self._get_headers())
