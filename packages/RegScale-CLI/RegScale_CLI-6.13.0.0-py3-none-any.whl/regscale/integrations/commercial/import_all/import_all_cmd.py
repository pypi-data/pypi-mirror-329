...
from regscale.core.app.utils.file_utils import get_files_by_folder, download_from_s3
...
def import_all_scans(
    ...
    from regscale.integrations.commercial.trivy import import_trivy_scans
...
def import_scans(imports_to_process: dict, scan_folders: dict, regscale_ssp_id: int, scan_date: datetime) -> None:
    ...
    for scan_type, import_detail in imports_to_process.items():
        ...
        ctx.invoke(
            ...
            regscale_ssp_id=regscale_ssp_id,
            scan_date=scan_date,
            mappings_path=import_detail.get("custom_mapping") or Path.cwd() / "mappings" / scan_type,
        )
