...
from regscale.integrations.commercial.awsv2.inventory.base import DateTimeEncoder
...
def issue_due_date(
    ...
    :param int critcal: Days until due for high severity issues. Default is 30.
