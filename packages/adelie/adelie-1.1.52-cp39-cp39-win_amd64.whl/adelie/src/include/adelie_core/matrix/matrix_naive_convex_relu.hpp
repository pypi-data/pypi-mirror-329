...
#ifndef ADELIE_CORE_MATRIX_NAIVE_CONVEX_RELU_DENSE_TP
#define ADELIE_CORE_MATRIX_NAIVE_CONVEX_RELU_DENSE_TP \
    template <class DenseType, class MaskType, class IndexType>
#endif
#ifndef ADELIE_CORE_MATRIX_NAIVE_CONVEX_RELU_DENSE
#define ADELIE_CORE_MATRIX_NAIVE_CONVEX_RELU_DENSE \
    MatrixNaiveConvexReluDense<DenseType, MaskType, IndexType>
#endif

#ifndef ADELIE_CORE_MATRIX_NAIVE_CONVEX_RELU_SPARSE_TP
#define ADELIE_CORE_MATRIX_NAIVE_CONVEX_RELU_SPARSE_TP \
    template <class SparseType, class MaskType, class IndexType>
#endif
#ifndef ADELIE_CORE_MATRIX_NAIVE_CONVEX_RELU_SPARSE
#define ADELIE_CORE_MATRIX_NAIVE_CONVEX_RELU_SPARSE \
    MatrixNaiveConvexReluSparse<SparseType, MaskType, IndexType>
#endif
