...
class MinecraftAgent:
    ...
    def __init__(self, api_client: KradleAPI, participant_id: Optional[str] = None, session_id: Optional[str] = None, memory: Optional[StandardMemory] = StandardMemory(), action_delay: int = 100):
        # Basic configuration
