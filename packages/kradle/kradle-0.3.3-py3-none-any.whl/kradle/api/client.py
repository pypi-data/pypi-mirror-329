...
from .resources import AgentAPI, SessionAPI, LogAPI

    
DEFAULT_BASE_URL = "https://app.kradle.ai/"
...
class KradleAPI:
    ...
    def _init_client(self):
        ...
        self.sessions = SessionAPI(self.http)
    ...
    def _get_headers(self) -> Dict[str, str]:
        ...
        if self.api_key:
            headers["kradle-api-key"] = self.api_key

            # TODO: switch to this once the API is updated
