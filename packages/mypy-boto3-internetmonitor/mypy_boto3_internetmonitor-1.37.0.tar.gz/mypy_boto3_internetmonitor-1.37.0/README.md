...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-internetmonitor)](https://pypistats.org/packages/mypy-boto3-internetmonitor)
...
`mypy-boto3-internetmonitor` dependency in production. However, there is an
