...
import hexdoc_hexgender

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexGenderPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexGenderModPlugin(branch=branch)


class HexGenderModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexgender"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexgender, "_templates"
