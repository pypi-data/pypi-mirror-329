...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-dax)](https://pypistats.org/packages/mypy-boto3-dax)
...
`mypy-boto3-dax` dependency in production. However, there is an issue in
