...
def build_graph_for_failure_groups(
    ...
    max_nodes: int = 10000,
) -> Tuple[mapper.DisjointPartitionGraph, int, mapper.MultiResolutionGraph]:
    ...
    N = len(data)
    for graph_level in multires_graph.levels:
    ...
    return graph_level, n_edges, multires_graph
...
def find_failure_groups_superlevel_auto(
    ...
    graph: Optional[mapper.DisjointPartitionGraph] = None,
    ...
    if graph is None:
        ...
        graph, n_edges, full_graph = build_graph_for_failure_groups(
    ...
    if full_graph:
        ...
        params["graph_level"] = list(full_graph.levels).index(graph)
