...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kafka)](https://pypistats.org/packages/mypy-boto3-kafka)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 Kafka 1.37.0](https://pypi.org/project/boto3/)
...
`mypy-boto3-kafka` dependency in production. However, there is an issue in
