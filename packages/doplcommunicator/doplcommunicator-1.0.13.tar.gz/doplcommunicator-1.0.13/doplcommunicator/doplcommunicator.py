...
class DoplCommunicator:
    ...
    def __init__(self, url, update_frequency=125):
        ...
        self.__controller_data = ControllerData(False, Vector3(0, 0, 0), Quaternion(0, 0, 0, 1), Vector3(0, 0, 0))
