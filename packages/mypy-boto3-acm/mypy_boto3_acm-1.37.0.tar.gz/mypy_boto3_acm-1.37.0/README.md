...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-acm)](https://pypistats.org/packages/mypy-boto3-acm)
...
`mypy-boto3-acm` dependency in production. However, there is an issue in
