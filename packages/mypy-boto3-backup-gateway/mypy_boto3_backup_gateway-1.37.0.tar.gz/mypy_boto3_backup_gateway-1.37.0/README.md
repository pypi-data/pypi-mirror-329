...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-backup-gateway)](https://pypistats.org/packages/mypy-boto3-backup-gateway)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 BackupGateway 1.37.0](https://pypi.org/project/boto3/) compatible with
...
`mypy-boto3-backup-gateway` dependency in production. However, there is an
