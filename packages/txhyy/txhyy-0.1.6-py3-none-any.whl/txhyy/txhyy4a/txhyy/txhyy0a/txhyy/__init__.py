...
leibniz: Callable[[int], float] = count.leibniz
machin: Callable[[int], float] = count.machin
ramanujan: Callable[[int], float] = count.ramanujan
bbp: Callable[[int], float] = count.bbp
factorial: Callable[[int], float] = count.factorial
sin: Callable[[float], float] = count.sin
cos: Callable[[float], float] = count.cos
tan: Callable[[float], float] = count.tan
cot: Callable[[float], float] = count.cot
