...
class Test_Signer(unittest.TestCase):
    def test_signTx(self):
        ...
        with open(os.path.join("w3off", "test", "data", "keystore-test.json")) as f:
...
class Test_Vault(unittest.TestCase):
    ...
    def test_pkey_from_keystore(self):
        with open(os.path.join("w3off", "test", "data", "keystore-test2.json")) as f:
        ...
        with open(os.path.join("w3off", "test", "data", "keystore-default.json")) as f:
            keystore2 = json.load(f)
