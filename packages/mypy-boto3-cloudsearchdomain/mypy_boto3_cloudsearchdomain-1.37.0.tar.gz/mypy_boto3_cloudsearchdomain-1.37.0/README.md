...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-cloudsearchdomain)](https://pypistats.org/packages/mypy-boto3-cloudsearchdomain)
...
`mypy-boto3-cloudsearchdomain` dependency in production. However, there is an
