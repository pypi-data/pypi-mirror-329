...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_func_connect_with_signer() != 56336:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_func_set_logger() != 16687:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_accept_payment_proposed_fees() != 8720:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_fetch_onchain_limits() != 59115:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_fetch_payment_proposed_fees() != 23582:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_lnurl_withdraw() != 45238:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_parse() != 65160:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_buy_bitcoin() != 3072:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_bindingliquidsdk_prepare_lnurl_pay() != 62389:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_logger_log() != 54784:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_signer_xpub() != 39767:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_signer_derive_xpub() != 59515:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_signer_sign_ecdsa() != 21427:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_signer_sign_ecdsa_recoverable() != 9552:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_signer_slip77_master_blinding_key() != 56356:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_signer_hmac_sha256() != 52627:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_signer_ecies_encrypt() != 8960:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_liquid_bindings_checksum_method_signer_ecies_decrypt() != 32966:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_init_callback_signer.argtypes = (
    _UNIFFI_FOREIGN_CALLBACK_T,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_init_callback_signer.restype = None
...
class BindingLiquidSdk:
    ...
    _UniffiConverterTypePaymentError,_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_accept_payment_proposed_fees,self._pointer,
    ...
    def fetch_payment_proposed_fees(self, req: "FetchPaymentProposedFeesRequest") -> "FetchPaymentProposedFeesResponse":
        ...
        return _UniffiConverterTypeFetchPaymentProposedFeesResponse.lift(
            _rust_call_with_error(
    _UniffiConverterTypeSdkError,_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_fetch_payment_proposed_fees,self._pointer,
    ...
    def parse(self, input: "str") -> "InputType":
        ...
        return _UniffiConverterTypeInputType.lift(
            _rust_call_with_error(
    _UniffiConverterTypePaymentError,_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_parse,self._pointer,
    ...
    def prepare_lnurl_pay(self, req: "PrepareLnUrlPayRequest") -> "PrepareLnUrlPayResponse":
        ...
        return _UniffiConverterTypePrepareLnUrlPayResponse.lift(
            _rust_call_with_error(
    _UniffiConverterTypeLnUrlPayError,_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_method_bindingliquidsdk_prepare_lnurl_pay,self._pointer,
...
class AesSuccessActionData:
    description: "str";ciphertext: "str";iv: "str";
...
class AssetBalance:
    asset_id: "str";balance_sat: "int";name: "typing.Optional[str]";ticker: "typing.Optional[str]";balance: "typing.Optional[float]";
...
class AssetInfo:
    name: "str";ticker: "str";amount: "float";
...
class AssetMetadata:
    asset_id: "str";name: "str";ticker: "str";precision: "int";
...
class BlockchainInfo:
    liquid_tip: "int";bitcoin_tip: "int";
...
class Config:
    liquid_electrum_url: "str";bitcoin_electrum_url: "str";mempoolspace_url: "str";working_dir: "str";network: "LiquidNetwork";payment_timeout_sec: "int";sync_service_url: "typing.Optional[str]";breez_api_key: "typing.Optional[str]";cache_dir: "typing.Optional[str]";zero_conf_max_amount_sat: "typing.Optional[int]";use_default_external_input_parsers: "bool";external_input_parsers: "typing.Optional[typing.List[ExternalInputParser]]";onchain_fee_rate_leeway_sat_per_vbyte: "typing.Optional[int]";asset_metadata: "typing.Optional[typing.List[AssetMetadata]]";
...
class ConnectRequest:
    config: "Config";mnemonic: "typing.Optional[str]";passphrase: "typing.Optional[str]";seed: "typing.Optional[typing.List[int]]";
...
class ExternalInputParser:
    provider_id: "str";input_regex: "str";parser_url: "str";
...
class FetchPaymentProposedFeesResponse:
    swap_id: "str";fees_sat: "int";payer_amount_sat: "int";receiver_amount_sat: "int";
...
class GetInfoResponse:
    wallet_info: "WalletInfo";blockchain_info: "BlockchainInfo";
...
class LnOffer:
    offer: "str";chains: "typing.List[str]";paths: "typing.List[LnOfferBlindedPath]";description: "typing.Optional[str]";signing_pubkey: "typing.Optional[str]";min_amount: "typing.Optional[Amount]";absolute_expiry: "typing.Optional[int]";issuer: "typing.Optional[str]";
...
class LiquidAddressData:
    address: "str";network: "Network";asset_id: "typing.Optional[str]";amount: "typing.Optional[float]";amount_sat: "typing.Optional[int]";label: "typing.Optional[str]";message: "typing.Optional[str]";
...
class ListPaymentsRequest:
    filters: "typing.Optional[typing.List[PaymentType]]";states: "typing.Optional[typing.List[PaymentState]]";from_timestamp: "typing.Optional[int]";to_timestamp: "typing.Optional[int]";offset: "typing.Optional[int]";limit: "typing.Optional[int]";details: "typing.Optional[ListPaymentDetails]";sort_ascending: "typing.Optional[bool]";
...
class LnUrlInfo:
    ln_address: "typing.Optional[str]";lnurl_pay_comment: "typing.Optional[str]";lnurl_pay_domain: "typing.Optional[str]";lnurl_pay_metadata: "typing.Optional[str]";lnurl_pay_success_action: "typing.Optional[SuccessActionProcessed]";lnurl_pay_unprocessed_success_action: "typing.Optional[SuccessAction]";lnurl_withdraw_endpoint: "typing.Optional[str]";
...
class Payment:
    timestamp: "int";amount_sat: "int";fees_sat: "int";payment_type: "PaymentType";status: "PaymentState";details: "PaymentDetails";swapper_fees_sat: "typing.Optional[int]";destination: "typing.Optional[str]";tx_id: "typing.Optional[str]";unblinding_data: "typing.Optional[str]";
...
class PrepareLnUrlPayRequest:
    data: "LnUrlPayRequestData";amount: "PayAmount";bip353_address: "typing.Optional[str]";comment: "typing.Optional[str]";validate_success_action_url: "typing.Optional[bool]";
...
class PrepareLnUrlPayResponse:
    destination: "SendDestination";fees_sat: "int";data: "LnUrlPayRequestData";comment: "typing.Optional[str]";success_action: "typing.Optional[SuccessAction]";
...
class PreparePayOnchainRequest:
    amount: "PayAmount";fee_rate_sat_per_vbyte: "typing.Optional[int]";
...
class PrepareReceiveRequest:
    payment_method: "PaymentMethod";amount: "typing.Optional[ReceiveAmount]";
...
class PrepareReceiveResponse:
    payment_method: "PaymentMethod";fees_sat: "int";amount: "typing.Optional[ReceiveAmount]";min_payer_amount_sat: "typing.Optional[int]";max_payer_amount_sat: "typing.Optional[int]";swapper_feerate: "typing.Optional[float]";
...
class PrepareRefundResponse:
    tx_vsize: "int";tx_fee_sat: "int";last_refund_tx_id: "typing.Optional[str]";
...
class PrepareSendRequest:
    destination: "str";amount: "typing.Optional[PayAmount]";
...
class RefundableSwap:
    swap_address: "str";timestamp: "int";amount_sat: "int";last_refund_tx_id: "typing.Optional[str]";
...
class WalletInfo:
    balance_sat: "int";pending_send_sat: "int";pending_receive_sat: "int";fingerprint: "str";pubkey: "str";asset_balances: "typing.List[AssetBalance]";
...
class Amount:
    ...
    class BITCOIN:
        ...
        def __eq__(self, other):
            ...
            return True
    class CURRENCY:
        iso4217_code: "str";fractional_amount: "int";
...
class InputType:
    ...
    class BOLT11:
        ...
        def __eq__(self, other):
            ...
            return True
    class BOLT12_OFFER:
        offer: "LnOffer";bip353_address: "typing.Optional[str]";
    ...
    class URL:
        ...
        def __eq__(self, other):
            ...
            return True
    class LN_URL_PAY:
        data: "LnUrlPayRequestData";bip353_address: "typing.Optional[str]";
...
class ListPaymentDetails:
    ...
    # Each enum variant is a nested class of the enum itself.
    class LIQUID:
        asset_id: "typing.Optional[str]";destination: "typing.Optional[str]";
...
class PayAmount:
    ...
    class BITCOIN:
        ...
        def __eq__(self, other):
            ...
            return True
    class ASSET:
        asset_id: "str";receiver_amount: "float";
...
class PaymentDetails:
    ...
    class LIGHTNING:
        ...
        def __eq__(self, other):
            ...
            return True
    class LIQUID:
        asset_id: "str";destination: "str";description: "str";asset_info: "typing.Optional[AssetInfo]";
        ...
        def __eq__(self, other):
            ...
            return True
    class BITCOIN:
        swap_id: "str";description: "str";auto_accepted_fees: "bool";bitcoin_expiration_blockheight: "typing.Optional[int]";liquid_expiration_blockheight: "typing.Optional[int]";claim_tx_id: "typing.Optional[str]";refund_tx_id: "typing.Optional[str]";refund_tx_amount_sat: "typing.Optional[int]";
...
class ReceiveAmount:
    ...
    class BITCOIN:
        ...
        def __eq__(self, other):
            ...
            return True
    class ASSET:
        asset_id: "str";payer_amount: "typing.Optional[float]";
...
class SendDestination:
    ...
    class LIQUID_ADDRESS:
        ...
        def __eq__(self, other):
            ...
            return True
    class BOLT11:
        invoice: "LnInvoice";bip353_address: "typing.Optional[str]";
        ...
        def __eq__(self, other):
            ...
            return True
    class BOLT12:
        offer: "LnOffer";receiver_amount_sat: "int";bip353_address: "typing.Optional[str]";
...
def py_foreignCallbackCallbackInterfaceSigner(handle, method, args_data, args_len, buf_ptr):
    ...
    def invoke_xpub(python_callback, args_stream, buf_ptr):
        def makeCall():
            return python_callback.xpub()
        ...
        try:
            ...
            with _UniffiRustBuffer.alloc_with_builder() as builder:
                _UniffiConverterTypeSignerError.write(e, builder)
                buf_ptr[0] = builder.finalize()
            return _UNIFFI_CALLBACK_ERROR

    
    def invoke_derive_xpub(python_callback, args_stream, buf_ptr):
        def makeCall():return python_callback.derive_xpub(
    ...
    def invoke_sign_ecdsa(python_callback, args_stream, buf_ptr):
        def makeCall():return python_callback.sign_ecdsa(
    ...
    def invoke_sign_ecdsa_recoverable(python_callback, args_stream, buf_ptr):
        def makeCall():return python_callback.sign_ecdsa_recoverable(
                _UniffiConverterSequenceUInt8.read(args_stream)
                )
    ...
    def invoke_slip77_master_blinding_key(python_callback, args_stream, buf_ptr):
        def makeCall():
            return python_callback.slip77_master_blinding_key()
    ...
    def invoke_hmac_sha256(python_callback, args_stream, buf_ptr):
        def makeCall():return python_callback.hmac_sha256(
                _UniffiConverterSequenceUInt8.read(args_stream), 
                _UniffiConverterString.read(args_stream)
                )
    ...
    def invoke_ecies_encrypt(python_callback, args_stream, buf_ptr):
        def makeCall():return python_callback.ecies_encrypt(
                _UniffiConverterSequenceUInt8.read(args_stream)
                )
    ...
    def invoke_ecies_decrypt(python_callback, args_stream, buf_ptr):
        def makeCall():return python_callback.ecies_decrypt(
                _UniffiConverterSequenceUInt8.read(args_stream)
                )
    ...
    if method == 1:
        ...
        # See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs` for details
        try:
            return invoke_xpub(cb, _UniffiRustBufferStream(args_data, args_len), buf_ptr)
        except BaseException as e:
            # Catch unexpected errors
            try:
                # Try to serialize the exception into a String
    ...
    if method == 2:
        ...
        # See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs` for details
        try:
            return invoke_derive_xpub(cb, _UniffiRustBufferStream(args_data, args_len), buf_ptr)
        except BaseException as e:
            # Catch unexpected errors
            try:
                # Try to serialize the exception into a String
    ...
    if method == 3:
        ...
        # See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs` for details
        try:
            return invoke_sign_ecdsa(cb, _UniffiRustBufferStream(args_data, args_len), buf_ptr)
        except BaseException as e:
            # Catch unexpected errors
            try:
                # Try to serialize the exception into a String
    ...
    if method == 4:
        ...
        # See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs` for details
        try:
            return invoke_sign_ecdsa_recoverable(cb, _UniffiRustBufferStream(args_data, args_len), buf_ptr)
        except BaseException as e:
            # Catch unexpected errors
            try:
                # Try to serialize the exception into a String
    ...
    if method == 5:
        ...
        # See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs` for details
        try:
            return invoke_slip77_master_blinding_key(cb, _UniffiRustBufferStream(args_data, args_len), buf_ptr)
        except BaseException as e:
            # Catch unexpected errors
            try:
                # Try to serialize the exception into a String
    ...
    if method == 6:
        ...
        # See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs` for details
        try:
            return invoke_hmac_sha256(cb, _UniffiRustBufferStream(args_data, args_len), buf_ptr)
        except BaseException as e:
            # Catch unexpected errors
            try:
                # Try to serialize the exception into a String
    ...
    if method == 7:
        ...
        # See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs` for details
        try:
            return invoke_ecies_encrypt(cb, _UniffiRustBufferStream(args_data, args_len), buf_ptr)
        except BaseException as e:
            # Catch unexpected errors
            try:
                # Try to serialize the exception into a String
    ...
    if method == 8:
        ...
        # See docs of ForeignCallback in `uniffi_core/src/ffi/foreigncallbacks.rs` for details
        try:
            return invoke_ecies_decrypt(cb, _UniffiRustBufferStream(args_data, args_len), buf_ptr)
        except BaseException as e:
            # Catch unexpected errors
            try:
                # Try to serialize the exception into a String
...
_rust_call(lambda err: _UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_init_callback_signer(foreignCallbackCallbackInterfaceSigner, err))
...
def connect_with_signer(req: "ConnectWithSignerRequest",signer: "Signer") -> "BindingLiquidSdk":
    ...
    return _UniffiConverterTypeBindingLiquidSdk.lift(_rust_call_with_error(_UniffiConverterTypeSdkError,_UniffiLib.uniffi_breez_sdk_liquid_bindings_fn_func_connect_with_signer,
