...
_release_version: str = '0.5.1'

# The following line is overwritten by build scripts in distributions &
# releases. Do not modify this manually, or jax/jaxlib build will fail.
_git_hash: str = '9de3c4dfd47ead1f392f650695c4d8a3a36bfe5c'
...
def _write_version(fname: str) -> None:
  ...
  old_version_string = "_release_version: str = '0.5.1'"
  ...
  if githash:
    old_githash_string = "_git_hash: str = '9de3c4dfd47ead1f392f650695c4d8a3a36bfe5c'"
