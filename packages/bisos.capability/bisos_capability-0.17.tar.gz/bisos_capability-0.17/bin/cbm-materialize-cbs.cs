...
(setq  b:py:cs:csuList
  (list
   ...
   "bisos.capability.cbm_csu"
 ))
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.capability.cbm_csu |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.capability.cbm_csu', ]
