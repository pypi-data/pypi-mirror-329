...
(setq  b:py:cs:csuList
  (list
   ...
   "bisos.capability.cba_csu"
   "bisos.capability.cba_sysd_csu"
 ))
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.capability.cba_csu | bisos.capability.cba_sysd_csu |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.capability.cba_csu', 'bisos.capability.cba_sysd_csu', ]
