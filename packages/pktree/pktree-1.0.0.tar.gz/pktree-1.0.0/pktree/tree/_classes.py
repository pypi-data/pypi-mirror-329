...
class BaseDecisionTree(MultiOutputMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def _fit(
        ...
        # print(type(splitter))
        # print("Number of times feature 0 has been seen: ", splitter.counter_seen)
        # print("Number of nodes: ", splitter.counter_node)
        # print("Proportion: ", splitter.counter_seen/splitter.counter_node)
