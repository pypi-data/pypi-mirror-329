...
class BaseEnsemble(MetaEstimatorMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def _make_estimator(self, append=True, random_state=None, w_prior=None, pk_configuration="standard", k=1, v=1, pk_function="reciprocal"):
        ...
        estimator_valid_params = estimator.get_params()
        filtered_params = {p: getattr(self, p) for p in self.estimator_params if p in estimator_valid_params}
        ...
        if w_prior is not None:
            estimator.set_params(w_prior=w_prior)
