...
class RunResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunResponseDto:
        """Create an instance of RunResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RunResponseDto.parse_obj(obj)

        _obj = RunResponseDto.parse_obj(
            {
