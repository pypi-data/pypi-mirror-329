...
class GetLatestRunLogResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetLatestRunLogResponseDto:
        """Create an instance of GetLatestRunLogResponseDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetLatestRunLogResponseDto:
        """Create an instance of GetLatestRunLogResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetLatestRunLogResponseDto.parse_obj(obj)

        _obj = GetLatestRunLogResponseDto.parse_obj(
            {
