...
class CreateArtifactVersionResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateArtifactVersionResponseDto:
        """Create an instance of CreateArtifactVersionResponseDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateArtifactVersionResponseDto:
        """Create an instance of CreateArtifactVersionResponseDto from a dict"""
        if obj is None:
            return None
