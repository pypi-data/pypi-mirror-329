...
class CreateMultiPartUploadForDatasetResponseDto(BaseModel):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMultiPartUploadForDatasetResponseDto:
        """Create an instance of CreateMultiPartUploadForDatasetResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMultiPartUploadForDatasetResponseDto.parse_obj(obj)

        _obj = CreateMultiPartUploadForDatasetResponseDto.parse_obj(
            {
