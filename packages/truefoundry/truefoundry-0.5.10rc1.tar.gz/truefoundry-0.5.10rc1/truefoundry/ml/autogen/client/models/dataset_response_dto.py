...
class DatasetResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatasetResponseDto:
    ...
    def to_dict(self):
        ...
        # override the default output from truefoundry.pydantic_v1 by calling `to_dict()` of dataset
        if self.dataset:
            _dict["dataset"] = self.dataset.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> DatasetResponseDto:
        """Create an instance of DatasetResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatasetResponseDto.parse_obj(obj)

        _obj = DatasetResponseDto.parse_obj(
            {
                "dataset": DatasetDto.from_dict(obj.get("dataset"))
