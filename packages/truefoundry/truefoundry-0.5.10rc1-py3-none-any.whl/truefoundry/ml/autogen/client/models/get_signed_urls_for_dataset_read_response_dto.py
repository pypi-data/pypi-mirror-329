...
class GetSignedURLsForDatasetReadResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSignedURLsForDatasetReadResponseDto:
        """Create an instance of GetSignedURLsForDatasetReadResponseDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSignedURLsForDatasetReadResponseDto:
        """Create an instance of GetSignedURLsForDatasetReadResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSignedURLsForDatasetReadResponseDto.parse_obj(obj)

        _obj = GetSignedURLsForDatasetReadResponseDto.parse_obj(
            {
                "signed_urls": [
