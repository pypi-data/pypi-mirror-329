...
class GetSignedURLsForDatasetWriteResponseDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetSignedURLsForDatasetWriteResponseDto:
        """Create an instance of GetSignedURLsForDatasetWriteResponseDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSignedURLsForDatasetWriteResponseDto:
        """Create an instance of GetSignedURLsForDatasetWriteResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetSignedURLsForDatasetWriteResponseDto.parse_obj(obj)

        _obj = GetSignedURLsForDatasetWriteResponseDto.parse_obj(
            {
                "signed_urls": [
