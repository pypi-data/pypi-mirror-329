...
class RunDataDto(BaseModel):
    ...
    __properties = ["metrics", "params", "tags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunDataDto:
        """Create an instance of RunDataDto from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunDataDto:
        """Create an instance of RunDataDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RunDataDto.parse_obj(obj)

        _obj = RunDataDto.parse_obj(
            {
