...
class AssistantMessage(BaseModel):
    """
    +usage=Assistant message +docs=Defines the structure of an assistant message, including role and content +label=Assistant Message  # noqa: E501
    """

    role: StrictStr = Field(...)
    content: Content = Field(...)
    name: Optional[StrictStr] = Field(
        default=None, description="+label=Name +usage=Name of the assistant message"
    )
