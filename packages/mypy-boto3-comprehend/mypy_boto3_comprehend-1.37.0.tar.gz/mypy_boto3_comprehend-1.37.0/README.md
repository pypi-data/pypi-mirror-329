...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-comprehend)](https://pypistats.org/packages/mypy-boto3-comprehend)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 Comprehend 1.37.0](https://pypi.org/project/boto3/)
...
`mypy-boto3-comprehend` dependency in production. However, there is an issue in
