...
async def main(
    ...
    jobs_data, check_data = parse_yaml(rendered, production_name, None)
    validate_yaml(jobs_data, check_data, None, production_name)  # NOOP
...
def parse_args():
    ...
    parser.add_argument("production_name", type=str)
