...
class TestPaginatedDomainResponseList(unittest.TestCase):
    """PaginatedDomainResponseList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedDomainResponseList:
        """Test PaginatedDomainResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedDomainResponseList`
        """
        model = PaginatedDomainResponseList()
        if include_optional:
