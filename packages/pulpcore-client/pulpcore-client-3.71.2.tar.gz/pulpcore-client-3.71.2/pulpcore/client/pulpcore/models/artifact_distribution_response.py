...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_created", "name", "no_content_change_since", "pulp_last_updated", "base_path", "content_guard", "hidden", "pulp_labels", "base_url", "pulp_href", "prn"]
