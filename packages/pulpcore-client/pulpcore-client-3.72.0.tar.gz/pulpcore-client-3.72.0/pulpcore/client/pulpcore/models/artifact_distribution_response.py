...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "no_content_change_since", "base_path", "pulp_labels", "hidden", "pulp_last_updated", "base_url", "name", "prn", "pulp_created", "pulp_href"]
