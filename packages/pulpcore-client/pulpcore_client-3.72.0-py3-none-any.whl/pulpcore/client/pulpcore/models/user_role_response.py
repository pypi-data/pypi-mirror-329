...
class UserRoleResponse(BaseModel):
    ...
    role: StrictStr
    content_object: Optional[StrictStr] = Field(description="pulp_href of the object for which role permissions should be asserted. If set to 'null', permissions will act on either domain or model-level.")
