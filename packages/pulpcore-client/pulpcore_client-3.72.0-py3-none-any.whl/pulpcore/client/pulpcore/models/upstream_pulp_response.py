...
class UpstreamPulpResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "name", "base_url", "api_root", "domain", "ca_cert", "client_cert", "tls_validation", "hidden_fields", "q_select", "last_replication"]
