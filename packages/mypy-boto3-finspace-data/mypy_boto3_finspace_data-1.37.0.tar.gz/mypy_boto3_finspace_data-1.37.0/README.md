...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-finspace-data)](https://pypistats.org/packages/mypy-boto3-finspace-data)
...
`mypy-boto3-finspace-data` dependency in production. However, there is an issue
