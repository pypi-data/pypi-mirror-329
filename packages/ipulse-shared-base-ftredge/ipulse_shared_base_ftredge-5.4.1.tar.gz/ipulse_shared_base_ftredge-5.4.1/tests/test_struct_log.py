...
class TestPipelineLog(unittest.TestCase):
    ...
    def test_pipeline_log(self):
        test_cases = [
            ...
            {"alert":"fddf", "log_review_status": ReviewStatus.OPEN},
            {"action":"PERSIST", "log_review_status": ReviewStatus.CLOSED},
            {"action":"persist", "log_review_status": ReviewStatus.CLOSED},
            {"level":"CRITICAL", "log_review_status": ReviewStatus.CLOSED},
            {"level":50, "log_review_status": ReviewStatus.CLOSED},
