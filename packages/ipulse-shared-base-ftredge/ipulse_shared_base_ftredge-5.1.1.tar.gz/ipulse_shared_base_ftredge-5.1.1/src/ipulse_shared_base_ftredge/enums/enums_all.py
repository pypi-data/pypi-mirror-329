...
class ComputeResource(Resource):
    ...
    COMPUTE_CLOUD_RUN = "cloud_run"
    COMPUTE_CLOUD_COMPUTE_ENGINE = "cloud_compute_engine"
...
class Action(Enum):
   ...
   # TRANSFORM ACTIONS (4000-4999)
    ...
    PERSIST_CREATE_TABLE_FROM_JSON = 5075
    PERSIST_CREATE_TABLE_FROM_JSON_TEMP = 5076
    ...
    PERSIST_MERGE = 5110
    PERSIST_MERGE_BATCH = 5111
    PERSIST_MERGE_QUERY = 5112
    PERSIST_RENAME = 5120
    PERSIST_RENAME_BATCH = 5121
    PERSIST_MOVE = 5130
