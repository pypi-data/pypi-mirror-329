...
def apply_knative_service(service_name: str, yaml_file_path: str, sanitised_project_name: str,
                                      ...
                                      context_name: Optional[str] = None, secrets: List[str] = [], enable_efs: bool = False, concurrency: int = 100, readiness: Optional[Dict] = None):
    ...
    if gpus > 2:
        ...
        yaml_dict['spec']['template']['metadata']['annotations']['autoscaling.knative.dev/scale-down-delay'] = '15m'
    ...
    if readiness:
        yaml_dict['spec']['template']['spec']['containers'][0]['readinessProbe'] = readiness
