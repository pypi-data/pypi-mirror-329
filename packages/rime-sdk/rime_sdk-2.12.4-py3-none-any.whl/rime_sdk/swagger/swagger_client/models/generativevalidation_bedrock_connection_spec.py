...
class GenerativevalidationBedrockConnectionSpec(object):
    ...
    def __init__(self, model_id=None, response_json_path=None, body_template=None, assume_role_arn=None, aws_access_key=None, inference_config=None, additional_config=None):  # noqa: E501
