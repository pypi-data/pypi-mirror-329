...
[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_elasticache/client/)
...
class ElastiCacheClient(AioBaseClient):
    ...
    async def create_user(self, **kwargs: Unpack[CreateUserMessageTypeDef]) -> UserResponseTypeDef:
        """
    ...
    async def delete_user(self, **kwargs: Unpack[DeleteUserMessageTypeDef]) -> UserResponseTypeDef:
        """
    ...
    async def modify_user(self, **kwargs: Unpack[ModifyUserMessageTypeDef]) -> UserResponseTypeDef:
        """
