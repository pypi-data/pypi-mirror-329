...
from project.sparta_0c8b5020ad.sparta_98d93fe84a.qube_8d4f2124f6 import sparta_0c21ad3250
from project.sparta_0c8b5020ad.sparta_2b5b2a60e0.qube_979597c799 import convert_to_dataframe,convert_dataframe_to_json
...
class Spartaqube:
	...
	def sparta_8540caff88(A,widget_id):B={_D:'get_widget_data',_B:widget_id};return sparta_0c21ad3250(B,A.user_obj)
	def sparta_e4dba2f55d(A,widget_id):B={_D:'has_widget_id',_B:widget_id};return sparta_0c21ad3250(B,A.user_obj)
	...
	def plot(V,*W,**A):
		...
		if E is _A:
			L=sparta_66b74c09bc(b_return_type_id=_C)
	...
	def sparta_37623950a5(B,*C,**A):
		if _B in A:return B.plot(*C,**A)
		raise Exception('Missing widget_id')
	def sparta_92dec8e5a3(A,connector_id):B={_D:'get_connector_tables',_H:connector_id};return sparta_0c21ad3250(B,A.user_obj)
	def sparta_1ec7ae779d(I,connector_id,table=_A,sql_query=_A,output_format=_A,dynamic_inputs=_A):
		...
		A['dynamic_inputs']=H;B=sparta_0c21ad3250(A,I.user_obj);C=False
		if F is _A:C=_C
		...
		return B
	def apply_method(B,method_name,*D,**C):A=C;A[_D]=method_name;return sparta_0c21ad3250(A,B.user_obj)
