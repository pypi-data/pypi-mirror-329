...
def sparta_d4bdaacfd0(user_obj):
	B=user_obj
	...
	return A
def sparta_973fc6080e(json_data,user_obj):
...
def sparta_cf8da2719a(json_data,user_obj):
...
def sparta_bc6f7ab657(json_data,user_obj):
	...
	return{_C:1}
def sparta_8faac4b9c5(json_data,user_obj):
