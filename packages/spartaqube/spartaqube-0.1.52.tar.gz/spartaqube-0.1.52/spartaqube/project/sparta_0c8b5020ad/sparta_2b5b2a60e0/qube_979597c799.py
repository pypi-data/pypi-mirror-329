...
main_api=sparta_2ad3e84b6e()['api']
...
def sparta_2d3e41973b(path):A=Path(path).resolve();return str(A)
def sparta_f83c8936be(textOutputArr):
	A=textOutputArr
	...
	return A
def sparta_cdab43a83c(input2JsonEncode,dateFormat=None):
...
def sparta_b66cfd06d2(file_path):
	A=file_path
