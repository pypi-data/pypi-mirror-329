...
from project.sparta_0c8b5020ad.sparta_ff964033dc.qube_7f42fde550 import IPythonKernel
from project.sparta_0c8b5020ad.sparta_87e47ed0f0.qube_309f5f7fdb import ReceiverKernel
from project.logger_config import logger
def sparta_be4406dcb6(file_path,text):
	A=file_path
	try:
...
def sparta_937cecfcb9(api_key,worker_port,venv_str):
...
if __name__=='__main__':api_key=sys.argv[1];worker_port=sys.argv[2];venv_str=sys.argv[3];sparta_937cecfcb9(api_key,worker_port,venv_str)