...
from project.sparta_8da3d59761.qube_e7483c0ba7 import timeout
from project.sparta_0c8b5020ad.sparta_2b5b2a60e0.qube_979597c799 import convert_to_dataframe,sparta_2d3e41973b
from project.logger_config import logger
B_DEBUG=_B
SEND_INTERVAL=.8
def sparta_8d7e9fac2d():return conf_settings.DEFAULT_TIMEOUT
...
def sparta_be4406dcb6(file_path=_A,text=_A):
	A=file_path
...
class IPythonKernel:
	...
	def initialize_kernel(B):
		...
		A+='django.setup()\n';D=sparta_2ad3e84b6e()['project'];E=sparta_2ad3e84b6e()['project/core/api'];A+=f'sys.path.insert(0, r"{str(D)}")\n';A+=f'sys.path.insert(0, r"{str(E)}")\n';A+=f'os.environ["api_key"] = "{B.api_key}"\n'
	...
	def sparta_275e257c51(A,kernel_variable):
	...
	def sparta_3ac9ecc5a9(A,name,value,websocket=_A):
	...
	def sparta_8106b58686(A,nameVar):
