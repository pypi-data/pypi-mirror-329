...
class ApiWebserviceWS(WebsocketConsumer):
	def create_kernel_in_global_kernel_manager(A,kernel_manager_uuid):from project.sparta_0c8b5020ad.sparta_87e47ed0f0 import qube_40c1566c0a as B;C=2;D='';E=A.user;F=B.SqKernelManager(kernel_manager_uuid,C,D,E);F.create_kernel()
	def sparta_d0aba80dc0(B,kernel_manager_uuid):
	...
	async def create_kernel(A):B=sparta_ad7cac9d75(A.user);return await IPythonKernel(api_key=B,django_settings_module='app.settings')
