...
from project.sparta_662ef67a08.sparta_dbb6ae3cca.qube_38ccf7dba7 import sparta_65c622b94c
from project.sparta_662ef67a08.sparta_bc02ea2c9b.qube_2ac5797abc import convert_to_dataframe,convert_dataframe_to_json
...
class Spartaqube:
	...
	def sparta_9f68230ff7(A,widget_id):B={_D:'get_widget_data',_B:widget_id};return sparta_65c622b94c(B,A.user_obj)
	def sparta_de2acc947a(A,widget_id):B={_D:'has_widget_id',_B:widget_id};return sparta_65c622b94c(B,A.user_obj)
	...
	def plot(V,*W,**A):
		...
		if E is _A:
			L=sparta_130c38b847(b_return_type_id=_C)
	...
	def sparta_08ad547b3e(B,*C,**A):
		if _B in A:return B.plot(*C,**A)
		raise Exception('Missing widget_id')
	def sparta_97e69af87d(A,connector_id):B={_D:'get_connector_tables',_H:connector_id};return sparta_65c622b94c(B,A.user_obj)
	def sparta_b85ae9be8f(I,connector_id,table=_A,sql_query=_A,output_format=_A,dynamic_inputs=_A):
		...
		A['dynamic_inputs']=H;B=sparta_65c622b94c(A,I.user_obj);C=False
		if F is _A:C=_C
		...
		return B
	def apply_method(B,method_name,*D,**C):A=C;A[_D]=method_name;return sparta_65c622b94c(A,B.user_obj)
