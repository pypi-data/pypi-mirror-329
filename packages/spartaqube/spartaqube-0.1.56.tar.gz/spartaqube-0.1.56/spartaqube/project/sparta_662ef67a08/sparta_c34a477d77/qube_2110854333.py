...
def sparta_6498df307c(json_data,userObj):
	B=json_data[_C]
	if int(B)==1:
	...
	try:G,H=sparta_ce82a2a43e(A,B);D={_A:1,_D:H,_E:G,_B:A}
	except:D={_A:-1,_F:_G}
	return D
def sparta_7a35df8c29(json_data,userObj):
	A=json_data
	try:D=A[_B];E=A[_C];B=os.path.dirname(D);F,G=sparta_ce82a2a43e(B,E);C={_A:1,_D:G,_E:F,_B:B}
	except:C={_A:-1,_F:_G}
	return C
def sparta_4394b8ddf5(json_data,userObj):
	A=json_data
	try:B=A[_B];D=A[_C];E,F=sparta_ce82a2a43e(B,D);C={_A:1,_D:F,_E:E,_B:B}
	except:C={_A:-1,_F:_G}
	return C
def sparta_ce82a2a43e(currentPath,typeexplorer=None):
...
def sparta_19dff4946f(currentPath):
