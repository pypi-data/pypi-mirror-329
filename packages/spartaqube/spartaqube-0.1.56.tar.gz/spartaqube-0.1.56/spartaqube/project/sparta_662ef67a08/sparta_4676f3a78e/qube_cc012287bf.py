...
def sparta_98e33df534(user_obj):
	B=user_obj
	...
	return A
def sparta_7224f6e369(json_data,user_obj):
...
def sparta_09d5dc8d92(json_data,user_obj):
...
def sparta_0c1450fb03(json_data,user_obj):
	...
	return{_C:1}
def sparta_0830f898c8(json_data,user_obj):
