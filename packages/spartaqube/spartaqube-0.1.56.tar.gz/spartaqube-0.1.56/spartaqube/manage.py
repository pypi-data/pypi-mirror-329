...
def sparta_95592f1601():
    ...
    django_port = sparta_3a761e9954(sys.argv)
    app_data_dict = {'default_port': django_port}
    current_path = os.path.dirname(__file__)
    api_path = os.path.join(current_path, 'api')
    with open(os.path.join(api_path, 'app_data_asgi.json'), 'w') as json_file:
