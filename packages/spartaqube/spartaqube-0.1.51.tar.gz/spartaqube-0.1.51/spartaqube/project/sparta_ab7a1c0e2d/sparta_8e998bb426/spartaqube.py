...
from project.sparta_ab7a1c0e2d.sparta_8e998bb426.qube_6d2235284c import sparta_f2462b6496
from project.sparta_ab7a1c0e2d.sparta_4fc6cad494.qube_01c35b57ea import convert_to_dataframe,convert_dataframe_to_json
...
class Spartaqube:
	...
	def sparta_aafeb573ef(A,widget_id):B={_D:'get_widget_data',_B:widget_id};return sparta_f2462b6496(B,A.user_obj)
	def sparta_ee3d4bcb25(A,widget_id):B={_D:'has_widget_id',_B:widget_id};return sparta_f2462b6496(B,A.user_obj)
	...
	def plot(V,*W,**A):
		...
		if E is _A:
			L=sparta_282fe25a50(b_return_type_id=_C)
	...
	def sparta_7248f2d76c(B,*C,**A):
		if _B in A:return B.plot(*C,**A)
		raise Exception('Missing widget_id')
	def sparta_92e5803d6e(A,connector_id):B={_D:'get_connector_tables',_H:connector_id};return sparta_f2462b6496(B,A.user_obj)
	def sparta_21edce90c5(I,connector_id,table=_A,sql_query=_A,output_format=_A,dynamic_inputs=_A):
		...
		A['dynamic_inputs']=H;B=sparta_f2462b6496(A,I.user_obj);C=False
		if F is _A:C=_C
		...
		return B
	def apply_method(B,method_name,*D,**C):A=C;A[_D]=method_name;return sparta_f2462b6496(A,B.user_obj)
