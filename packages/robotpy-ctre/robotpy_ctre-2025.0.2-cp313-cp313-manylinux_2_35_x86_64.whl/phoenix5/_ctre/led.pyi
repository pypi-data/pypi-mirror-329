...
class CANdle:
    ...
    def __init__(self, deviceId: int, canbus: str = '') -> None:
        ...
        """
    def animate(self, animation: Animation, animSlot: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        """
    def clearStickyFaults(self, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        """
    def configAllSettings(self, allConfigs: CANdleConfiguration, timeoutMs: int = 50) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def configBrightnessScalar(self, brightness: float, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def configFactoryDefault(self, timeoutMs: int = 50) -> phoenix5._ctre.ErrorCode:
        """
    ...
    def configGetCustomParam(self, paramIndex: int, timeoutMs: int = 0) -> int:
        ...
        """
    def configGetParameter(self, param: phoenix5._ctre.ParamEnum, ordinal: int, timeoutMs: int = 0) -> float:
        """
        ...
        """
    def configLEDType(self, type: LEDStripType, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode generated by function. OK indicates no error.
        """
    def configLOSBehavior(self, disableWhenLOS: bool, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode generated by function. OK indicates no error.
        """
    def configSetCustomParam(self, paramIndex: int, value: int, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def configSetParameter(self, param: phoenix5._ctre.ParamEnum, value: float, subValue: int = 0, ordinal: int = 0, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def configStatusLedState(self, disableWhenRunning: bool, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def configV5Enabled(self, v5Enabled: bool, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode generated by function. OK indicates no error.
        """
    def configVBatOutput(self, mode: VBatOutputMode, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
    ...
    def hasResetOccurred(self) -> bool:
        ...
        """
    def modulateVBatOutput(self, dutyCyclePrcnt: float) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode generated by function. OK indicates no error.
        """
    def setControlFramePeriod(self, frame: CANdleControlFrame, periodMs: int) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: Error Code generated by function. 0 indicates no error.
        """
    def setLEDs(self, r: int, g: int, b: int, w: int = 0, startIdx: int = 0, count: int = 512) -> phoenix5._ctre.ErrorCode:
        """
        ...
        :returns: ErrorCode generated by function. OK indicates no error.
        """
    def setStatusFramePeriod(self, frame: CANdleStatusFrame, periodMs: int, timeoutMs: int = 0) -> phoenix5._ctre.ErrorCode:
        """
...
class ColorFlowAnimation(BaseTwoSizeAnimation):
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, r: int, g: int, b: int, w: int, speed: float = 1, numLed: int = -1, direction: ColorFlowAnimation.Direction = ..., ledOffset: int = 0) -> None:
        """
...
class LarsonAnimation(BaseTwoSizeAnimation):
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, r: int, g: int, b: int, w: int = 0, speed: float = 1, numLed: int = -1, mode: LarsonAnimation.BounceMode = ..., size: int = 2, ledOffset: int = 0) -> None:
        """
...
class TwinkleAnimation(BaseTwoSizeAnimation):
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, r: int, g: int, b: int, w: int = 0, speed: float = 1, numLed: int = -1, divider: TwinkleAnimation.TwinklePercent = ..., ledOffset: int = 0) -> None:
        """
...
class TwinkleOffAnimation(BaseTwoSizeAnimation):
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, r: int, g: int, b: int, w: int = 0, speed: float = 1, numLed: int = -1, divider: TwinkleOffAnimation.TwinkleOffPercent = ..., ledOffset: int = 0) -> None:
        """
        Constructor for a TwinkleAnimation
