...
setup(
    name='invoicetopdf',  # * Your package will have this name
    ...
    author='Eat Tren Clen Hard',  # Your name
    author_email='mail@cldweb.tk',  # Your email
    url='https://cldweb.tk',  # Homepage of your library (e.g. github or your website)
