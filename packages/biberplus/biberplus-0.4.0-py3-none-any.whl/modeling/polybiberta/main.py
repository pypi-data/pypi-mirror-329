...
from src.custom_training.multilingual_finetuning.models import XLMStyleMLM


def argument_parser():
    parser = argparse.ArgumentParser()

    parser.add_argument('--en_train_file', default='/shared/3/projects/hiatus/tagged_data/mlm_finetuning/train.jsonl',
                        type=str)
    parser.add_argument('--en_dev_file', default='/shared/3/projects/hiatus/tagged_data/mlm_finetuning/dev.jsonl',
                        type=str)
    parser.add_argument('--train_file', default='/shared/3/projects/hiatus/multilingual/train.jsonl', type=str)
    parser.add_argument('--dev_file', default='/shared/3/projects/hiatus/multilingual/dev.jsonl', type=str)
    parser.add_argument('--out_dir', type=str, default='/shared/3/projects/hiatus/models/multilingual/')
    parser.add_argument('--pretrained_model', default='xlm-roberta-base', type=str)
    ...
    parser.add_argument('--project_name', default='multilingual-style-mlm', type=str)
...
if __name__ == '__main__':
    ...
    model = XLMStyleMLM(args, wandb=wb)
    model.train_model()
    model.evaluate()
