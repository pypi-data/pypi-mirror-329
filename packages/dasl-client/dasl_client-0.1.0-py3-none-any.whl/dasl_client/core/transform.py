...
class TransformMixin(BaseMixin):
    ...
    def get_transform(self, name: str) -> CoreV1Transform:
        ...
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_get_transform(
            workspace, name
        )
    ...
    def delete_transform(self, name: str) -> None:
        ...
        auth = self.auth.client()
        workspace = self.auth.workspace()
        openapi_client.CoreV1Api(auth).core_v1_alpha1_delete_transform(
            workspace, name
        )
    ...
    def list_transforms(
        ...
        auth = self.auth.client()
        workspace = self.auth.workspace()
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_list_transforms(
    ...
    def create_transform(
        ...
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_create_transform(
            workspace, request
        )
    ...
    def replace_transform(
        ...
        meta = CommonV1ObjectMeta(name=name, workspace=workspace)
        request = CoreV1Transform(metadata=meta, spec=spec)
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_replace_transform(
