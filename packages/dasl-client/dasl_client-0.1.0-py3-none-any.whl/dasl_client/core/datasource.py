...
class DatasourceMixin(BaseMixin):
    ...
    def get_datasource(self, name: str) -> CoreV1DataSource:
        ...
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_get_data_source(
            workspace, name
        )
    ...
    def delete_datasource(self, name: str) -> None:
        ...
        auth = self.auth.client()
        workspace = self.auth.workspace()
        openapi_client.CoreV1Api(auth).core_v1_alpha1_delete_data_source(
            workspace, name
        )
    ...
    def list_datasources(
        ...
        auth = self.auth.client()
        workspace = self.auth.workspace()
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_list_data_sources(
    ...
    def create_datasource(
        ...
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_create_data_source(
            workspace, request
        )
    ...
    def replace_datasource(
        ...
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_replace_data_source(
