...
class RuleMixin(BaseMixin):
    ...
    def get_rule(self, name: str) -> CoreV1Rule:
        ...
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_get_rule(
            workspace, name
        )
    ...
    def delete_rule(self, name: str) -> None:
        ...
        auth = self.auth.client()
        workspace = self.auth.workspace()
        openapi_client.CoreV1Api(auth).core_v1_alpha1_delete_rule(workspace, name)
    ...
    def list_rules(
        ...
        auth = self.auth.client()
        workspace = self.auth.workspace()
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_list_rules(
    ...
    def create_rule(
        ...
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_create_rule(
            workspace, request
        )
    ...
    def replace_rule(
        ...
        request = CoreV1Rule(metadata=meta, spec=spec)
        return openapi_client.CoreV1Api(auth).core_v1_alpha1_replace_rule(
