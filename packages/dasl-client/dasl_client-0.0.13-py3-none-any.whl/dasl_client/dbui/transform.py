from dasl_api import (
    ...
    DbuiV1alpha1TransformRequestInput,
    CoreV1alpha1DataSourceAutoloaderSpec,
    DbuiV1alpha1TransformRequestTransformsInner,
    DbuiV1alpha1TransformResponse,
)
...
class AdhocTransform(BaseMixin):
    ...
    def adhoc_transform(
        ...
        warehouse: str,
        preset: str,
        transforms: List[DbuiV1alpha1TransformRequestTransformsInner],
        input: Optional[DbuiV1alpha1TransformRequestInput] = None,
        autoloader_input: Optional[CoreV1alpha1DataSourceAutoloaderSpec] = None,
    ) -> DbuiV1alpha1TransformResponse:
        """
        ...
        :return: a DbuiV1alpha1TransformResponse object containing the results after running the transforms.
        ...
        request = DbuiV1alpha1TransformRequest(
            input=input,
            autoloader_input=autoloader_input,
            use_preset=preset,
            transforms=transforms,
        )
        return openapi_client.DbuiV1alpha1Api(auth).dbui_v1_alpha1_transform(
