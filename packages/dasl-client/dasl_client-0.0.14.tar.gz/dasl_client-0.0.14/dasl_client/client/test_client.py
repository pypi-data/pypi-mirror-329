...
from dasl_api import (
    ...
    WorkspaceV1alpha1WorkspaceConfigSpecObservablesKindsInner,
    WorkspaceV1alpha1WorkspaceConfigSpecDefaultConfig,
    WorkspaceV1alpha1DefaultConfig,
    CoreV1alpha1Schedule,
    CoreV1alpha1RuleSpecInput,
    CoreV1alpha1RuleSpecOutput,
    CoreV1alpha1RuleSpecInputStream,
    CoreV1alpha1RuleSpecInputStreamTablesInner,
    CoreV1alpha1RuleObservable,
    CoreV1alpha1RuleObservableRisk,
    CoreV1alpha1DataSourceSpecSilver,
    CoreV1alpha1DataSourceSpecGold,
    CoreV1alpha1DataSourceSpecSilverPreTransform,
    CoreV1alpha1DataSourceSpecBronze,
)
...
class MyTestCase(unittest.TestCase):
    ...
    def create_workspace(self, email) -> Client:
        ...
        workspace.put_config(
            ...
            observables=WorkspaceV1alpha1WorkspaceConfigSpecObservables(
                kinds=[
                    WorkspaceV1alpha1WorkspaceConfigSpecObservablesKindsInner(
                        name="ip_source",
                        sql_type="string",
            ...
            default_config=WorkspaceV1alpha1WorkspaceConfigSpecDefaultConfig(
                datasources=WorkspaceV1alpha1DefaultConfig(
                ...
                transforms=WorkspaceV1alpha1DefaultConfig(
                ...
                rules=WorkspaceV1alpha1DefaultConfig(
                ...
                var_global=WorkspaceV1alpha1DefaultConfig(
                    bronze_schema="bronze",
                    silver_schema="silver",
                    gold_schema="gold",
                    catalog_name="default",
    ...
    def test_create_rule(self):
        ...
        workspace.create_rule(
            name=rule_name_1,
            schedule=CoreV1alpha1Schedule(at_least_every="2h"),
            input=CoreV1alpha1RuleSpecInput(
                stream=CoreV1alpha1RuleSpecInputStream(
                    filter="ip_count > 999",
                    tables=[
                        CoreV1alpha1RuleSpecInputStreamTablesInner(
            ...
            observables=[
                CoreV1alpha1RuleObservable(
                    ...
                    value="ip_count",
                    relationship="tenant",
                    risk=CoreV1alpha1RuleObservableRisk(
    ...
    def test_create_datasource(self):
        ...
        s = CoreV1alpha1DataSourceSpecSilver(
            pre_transform=CoreV1alpha1DataSourceSpecSilverPreTransform(
        ...
        workspace.create_datasource(
            ...
            source_type="route53",
            use_preset="aws",
            bronze=CoreV1alpha1DataSourceSpecBronze(bronze_table="aws_route53_data"),
            silver=CoreV1alpha1DataSourceSpecSilver(
                pre_transform=CoreV1alpha1DataSourceSpecSilverPreTransform(
                    use_preset="aws_sec_lake_route53",
                )
            ),
            gold=CoreV1alpha1DataSourceSpecGold(),
        )
