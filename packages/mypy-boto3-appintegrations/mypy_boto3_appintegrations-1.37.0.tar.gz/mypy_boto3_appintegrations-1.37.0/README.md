...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-appintegrations)](https://pypistats.org/packages/mypy-boto3-appintegrations)
...
`mypy-boto3-appintegrations` dependency in production. However, there is an
