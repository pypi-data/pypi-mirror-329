...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-codeguruprofiler)](https://pypistats.org/packages/mypy-boto3-codeguruprofiler)
...
`mypy-boto3-codeguruprofiler` dependency in production. However, there is an
