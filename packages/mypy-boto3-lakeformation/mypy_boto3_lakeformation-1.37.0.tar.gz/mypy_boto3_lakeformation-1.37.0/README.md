...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-lakeformation)](https://pypistats.org/packages/mypy-boto3-lakeformation)
...
`mypy-boto3-lakeformation` dependency in production. However, there is an issue
