...
class CommandLineInterfaceApi:
    ...
    def execute_cli_command(
        ...
        This is an asynchronous operation to execute CLI commands in the Security Cloud Control tenant.
    ...
    def execute_cli_macro(
        ...
        This is an asynchronous operation to execute CLI macro command in the Security Cloud Control tenant.
    ...
    def _execute_cli_macro_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/cli/executeMacro',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_cli_macro(
        ...
        Get a Security Cloud Control CLI Macro by UID. Note: This operation only returns the SCC CLI Macro. For executing the SCC CLI Macro, refer to the [Execute CLI Macro Operation](https://developer.cisco.com/docs/cisco-security-cloud-control/execute-cli-macro-command/)
