...
from segnivo_sdk.api_response import ApiResponse, T as ApiResponseT
import segnivo_sdk.models
from segnivo_sdk import rest
from segnivo_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.7.14/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(segnivo_sdk.models, klass)
