...
import dart_physics.new_server2 as new_server2 
# import warnings
...
def run_server():
    new_server2.app.run(host='0.0.0.0', port=5012)
...
class MJTeleop: 
    ...
    def __init__(self, task, robot, headless = False, avp = False): 
        ...
        dexhub.init(
            "mujoco_log_test", 
            dexhub.arms.FR3, 
            dexhub.grippers.PANDA_HAND, 
            dexhub.control_modes.POSITION, 
            teleop = True
        )
        ...
        if control_message is not None: 
            ...
            if "switch_task" in control_message:
                ...
                try:
                    ...
                    print("There's no viewer to close.")
                    pass 
            ...
            if control_message is not None:
                ...
                if "save" in control_message:

                    if ":" in control_message:
                        api_key = control_message.split(":")[1]
                    else:
                        api_key = None
                ...
                elif "stop_recording" in control_message:
