...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-freetier)](https://pypistats.org/packages/mypy-boto3-freetier)
...
`mypy-boto3-freetier` dependency in production. However, there is an issue in
