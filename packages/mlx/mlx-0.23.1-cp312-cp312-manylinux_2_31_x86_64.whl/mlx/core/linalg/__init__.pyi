...
def eigh(a: mlx.core.array, UPLO: str = 'L', *, stream: mlx.core.Stream | mlx.core.Device | None = None) -> tuple:
    """
...
def eigvalsh(a: mlx.core.array, UPLO: str = 'L', *, stream: mlx.core.Stream | mlx.core.Device | None = None) -> mlx.core.array:
    """
