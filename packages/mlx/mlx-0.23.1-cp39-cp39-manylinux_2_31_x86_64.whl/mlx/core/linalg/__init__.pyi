...
def eigh(a: mlx.core.array, UPLO: str = 'L', *, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> tuple:
    """
...
def eigvalsh(a: mlx.core.array, UPLO: str = 'L', *, stream: Optional[Union[mlx.core.Stream, mlx.core.Device]] = None) -> mlx.core.array:
    """
