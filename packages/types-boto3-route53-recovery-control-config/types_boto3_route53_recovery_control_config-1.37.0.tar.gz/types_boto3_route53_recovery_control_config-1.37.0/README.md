<a id="types-boto3-route53-recovery-control-config"></a>

# types-boto3-route53-recovery-control-config

[![PyPI - types-boto3-route53-recovery-control-config](https://img.shields.io/pypi/v/types-boto3-route53-recovery-control-config.svg?color=blue)](https://pypi.org/project/types-boto3-route53-recovery-control-config/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-route53-recovery-control-config.svg?color=blue)](https://pypi.org/project/types-boto3-route53-recovery-control-config/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-route53-recovery-control-config)](https://pypistats.org/packages/types-boto3-route53-recovery-control-config)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 Route53RecoveryControlConfig 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-route53-recovery-control-config docs](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-route53-recovery-control-config](#types-boto3-route53-recovery-control-config)
...
- Install `types-boto3[route53-recovery-control-config]` in your environment:
...
- Install `types-boto3[route53-recovery-control-config]` with services you use
  in your environment:
...
`types-boto3-route53-recovery-control-config` dependency in production.
...
from types_boto3_route53_recovery_control_config import Route53RecoveryControlConfigClient
...
`types_boto3_route53_recovery_control_config.paginator` module contains type
...
`types_boto3_route53_recovery_control_config.waiter` module contains type
...
`types_boto3_route53_recovery_control_config.literals` module contains literals
extracted from shapes that can be used in user code for type checking.

Full list of `Route53RecoveryControlConfig` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/literals/).
...
`types_boto3_route53_recovery_control_config.type_defs` module contains
structures and shapes assembled to typed dictionaries and unions for additional
type checking.

Full list of `Route53RecoveryControlConfig` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/type_defs/).
...
`types-boto3-route53-recovery-control-config` version is the same as related
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_route53_recovery_control_config/)
