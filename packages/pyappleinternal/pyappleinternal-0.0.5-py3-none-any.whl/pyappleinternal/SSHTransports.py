...
from pyappleinternal.authorized_key import make_authorized_key
import sys
...
class SSHTransports():
    def __init__(self,udid):
        ...
        self.authorized_path=os.path.join(os.path.dirname(sys.argv[0]), ".ssh")
        self.copyUnrestricted=copyUnrestricted(self.udid)
        
    def authorized(self):
        try:
            if os.path.exists(self.authorized_path) and os.path.exists(os.path.expanduser("~/.ssh/id_ed25519.pub")):
