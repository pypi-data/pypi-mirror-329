...
class Storage(APIClientBase):
    ...
    def promote_from_snapshot(
            self, volume_id: str, snapshot_name: str, keep_original: bool = True, nfs_share_config: dict = None
    ):
        body = {
            "volumeId": volume_id,
            "snapshotName": snapshot_name,
            "keepOriginal": keep_original,
            "nfsShareConfig": nfs_share_config,
        }
        return self.put_request(
            f"/volumes/{volume_id}/promote-from-snapshot",
            body=body,
        )
