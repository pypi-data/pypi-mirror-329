...
def download_ibov_w(
    ...
    try:
        with requests.get(
            f'{IBOV_URL}/{b64encode(IBOV_QUERY_STR).decode("utf-8")}'
        ) as r:
            r.raise_for_status()
        ...
        return download_ibov_w(retry=retry - 1, time_btw_retries=time_btw_retries * 2)
...
if __name__ == "__main__":
    ...
    (date_ref, divisor, ticket_symbol, quantity) = download_ibov_w()
