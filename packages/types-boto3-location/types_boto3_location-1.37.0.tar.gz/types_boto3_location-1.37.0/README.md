<a id="types-boto3-location"></a>

# types-boto3-location

[![PyPI - types-boto3-location](https://img.shields.io/pypi/v/types-boto3-location.svg?color=blue)](https://pypi.org/project/types-boto3-location/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-location.svg?color=blue)](https://pypi.org/project/types-boto3-location/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-location)](https://pypistats.org/packages/types-boto3-location)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 LocationService 1.37.0](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-location docs](https://youtype.github.io/types_boto3_docs/types_boto3_location/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-location](#types-boto3-location)
...
- Install `types-boto3[location]` in your environment:
...
- Install `types-boto3[location]` with services you use in your environment:
...
`types-boto3-location` dependency in production. However, there is an issue in
...
from types_boto3_location import LocationServiceClient
...
`types_boto3_location.paginator` module contains type annotations for all
paginators.
...
`types_boto3_location.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `LocationService` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_location/literals/).
...
`types_boto3_location.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `LocationService` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_location/type_defs/).
...
`types-boto3-location` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_location/)
