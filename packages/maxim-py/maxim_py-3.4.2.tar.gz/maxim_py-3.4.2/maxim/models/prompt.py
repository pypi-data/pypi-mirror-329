...
class PromptResponse:
    ...
    def from_dict(obj: Dict[str, Any]):
        ...
        model = obj['model']
        choices = [Choice(index=c['index'], message=Message.from_dict(c['message']), finish_reason=c['finish_reason']) for c in obj['choices']]
        usage = Usage(prompt_tokens=obj['usage']['prompt_tokens'], completion_tokens=obj['usage']['completion_tokens'], total_tokens=obj['usage']['total_tokens'], latency=obj['usage']['latency'])
