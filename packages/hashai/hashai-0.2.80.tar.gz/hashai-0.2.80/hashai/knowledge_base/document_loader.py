...
class DocumentLoader:
    ...
    - YouTube links: Extract transcripts via youtube_transcript_api
    ...
    def load(self, source: str) -> List[Dict[str, Any]]:
        """
        Dynamically load documents from a given source.
        If the source is a URL (starts with "http"), load from URL;
