...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-importexport)](https://pypistats.org/packages/mypy-boto3-importexport)
...
`mypy-boto3-importexport` dependency in production. However, there is an issue
