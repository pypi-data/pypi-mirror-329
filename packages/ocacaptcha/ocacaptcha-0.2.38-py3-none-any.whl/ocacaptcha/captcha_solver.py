...
def oca_solve_captcha(driver, user_api_key, action_type, number_captcha_attempts, wait_captcha_seconds, solve_captcha_speed, *args):
    ...
    def get_captcha_image(driver, blob_url):
        ...
        if image_data is None:
            raise ValueError("Error when getting captcha image")
                ...
                if not (is_exist_captcha_whirl or is_exist_captcha_slide or is_exist_captcha_3d or is_exist_captcha_icon): 
                    ...
                    if is_exist_captcha_whirl:
                        ...
                        if "blob:" in full_img_url:
                            full_img = get_captcha_image(driver, full_img_url)
                        else:                 
                        ...
                        if "blob:" in small_img_url:
                            small_img = get_captcha_image(driver, small_img_url)
                        else:
                ...
                if not (is_exist_captcha_slide or is_exist_captcha_audio): 
                    ...
                    if is_exist_captcha_slide:
                        ...
                        if "blob:" in get_audio_url:
                            audio_url = get_captcha_image(driver, get_audio_url)
                        else:                       
