...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mediapackage-vod)](https://pypistats.org/packages/mypy-boto3-mediapackage-vod)
...
`mypy-boto3-mediapackage-vod` dependency in production. However, there is an
