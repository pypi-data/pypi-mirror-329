...
class Pathway(_message.Message):
    __slots__ = ("id", "creator", "name", "description", "is_public", "ions", "fee_per_thousand_calls", "field_maps")
    ...
    def __init__(self, id: _Optional[int] = ..., creator: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., is_public: bool = ..., ions: _Optional[_Iterable[str]] = ..., fee_per_thousand_calls: _Optional[int] = ..., field_maps: _Optional[_Iterable[str]] = ...) -> None: ...
