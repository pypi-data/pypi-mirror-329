...
class Params(_message.Message):
    __slots__ = ("min_ion_stake", "max_number_of_slashes", "slash_ratio_percentage", "minimum_reporting_fee", "admin_address", "protocol_surcharge_ratio_percentage", "fee_increase_cooloff_period", "max_fee_increase_ratio_percentage", "stakers_reward_percentage")
