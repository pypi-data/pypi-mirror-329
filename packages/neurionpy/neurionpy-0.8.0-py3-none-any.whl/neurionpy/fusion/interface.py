...
class FusionMessage(ABC):
    ...
    @abstractmethod
    def UpdateParams(self, message: MsgUpdateParams, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgUpdateParamsResponse:
        """Update module parameters."""

    @abstractmethod
    def ApplyCreator(self, message: MsgApplyCreator, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgApplyCreatorResponse:
        """Apply to become a creator."""

    @abstractmethod
    def ApproveApplication(self, message: MsgApproveApplication, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgApproveApplicationResponse:
        """Approve a creator application."""

    @abstractmethod
    def RejectApplication(self, message: MsgRejectApplication, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgRejectApplicationResponse:
        """Reject a creator application."""

    @abstractmethod
    def CreateTask(self, message: MsgCreateTask, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgCreateTaskResponse:
        """Create a new task."""

    @abstractmethod
    def StartTask(self, message: MsgStartTask, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgStartTaskResponse:
        """Start a task."""

    @abstractmethod
    def ProposeModel(self, message: MsgProposeModel, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgProposeModelResponse:
        """Propose a model for a task."""

    @abstractmethod
    def RegisterProposer(self, message: MsgRegisterProposer, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgRegisterProposerResponse:
        """Register as a proposer for a task."""

    @abstractmethod
    def RegisterValidator(self, message: MsgRegisterValidator, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgRegisterValidatorResponse:
        """Register as a validator for a task."""

    @abstractmethod
    def StartTesting(self, message: MsgStartTesting, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgStartTestingResponse:
        """Start testing for a task."""

    @abstractmethod
    def RequestValidationTask(self, message: MsgRequestValidationTask, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgRequestValidationTaskResponse:
        """Request a validation task."""

    @abstractmethod
    def SubmitScore(self, message: MsgSubmitScore, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgSubmitScoreResponse:
        """Submit a score for a validation task."""

    @abstractmethod
    def DisputeModelScore(self, message: MsgDisputeModelScore, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgDisputeModelScoreResponse:
        """Dispute a model score."""

    @abstractmethod
    def StartNewRound(self, message: MsgStartNewRound, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgStartNewRoundResponse:
        """Start a new round for a task."""

    @abstractmethod
    def TerminateTask(self, message: MsgTerminateTask, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgTerminateTaskResponse:
        """Terminate a task."""

    @abstractmethod
    def StakeToTask(self, message: MsgStakeToTask, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgStakeToTaskResponse:
        """Stake tokens to a task."""

    @abstractmethod
    def ClaimTaskReward(self, message: MsgClaimTaskReward, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgClaimTaskRewardResponse:
        """Claim reward for a task."""

    @abstractmethod
    def UnstakeFromTask(self, message: MsgUnstakeFromTask, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgUnstakeFromTaskResponse:
        """Unstake tokens from a task."""

    @abstractmethod
    def DisclaimCreatorStatus(self, message: MsgDisclaimCreatorStatus, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgDisclaimCreatorStatusResponse:
        """Disclaim creator status."""

    @abstractmethod
    def AbortTask(self, message: MsgAbortTask, memo: Optional[str] = None, gas_limit: Optional[int] = None) -> MsgAbortTaskResponse:
        """Abort a task."""
