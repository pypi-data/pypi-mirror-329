...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-lex-runtime)](https://pypistats.org/packages/mypy-boto3-lex-runtime)
...
`mypy-boto3-lex-runtime` dependency in production. However, there is an issue
