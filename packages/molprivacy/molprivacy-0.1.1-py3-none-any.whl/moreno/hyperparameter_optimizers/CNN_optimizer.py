...
class CNNOptimizer(Optimizer[CNNLightning]):
    """
    Class for finding the best hyperparameters for a CNN and training a model with them.
    """

    def __init__(
        self,
        datamodule: CustomDataModule,
        model_class: Type[CNNLightning],
