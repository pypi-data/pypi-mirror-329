...
class CaloTowerContainer_v1:
    ...
    def tower(self, eta: float, phi: float) -> func_adl_servicex_xaodr21.xAOD.calotower_v1.CaloTower_v1:
        "A method"
        ...

    def front(self) -> func_adl_servicex_xaodr21.xAOD.calotower_v1.CaloTower_v1:
        "A method"
        ...

    def back(self) -> func_adl_servicex_xaodr21.xAOD.calotower_v1.CaloTower_v1:
        "A method"
        ...
