...
class mysqlOps:
    ...
    - port
        数据库端口，默认为3306
    """
    def __init__(self, host=os.getenv('MYSQL_HOST'), user=os.getenv('MYSQL_USER'), password=os.getenv('MYSQL_PASSWORD'), port=3306, database=None):
