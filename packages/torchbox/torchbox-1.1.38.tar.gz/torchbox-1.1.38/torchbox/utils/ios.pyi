...
def loadbin(file, dbsize=4, dtype='i', endian='little', offsets=0, nshots=None):
    ...
    ::
        ...
        x = [1, 3, 6, 111]
        tb.savebin('./data.bin', x, dtype='i', endian='L', mode='o')

        y = tb.loadbin('./data.bin', dbsize=4, dtype='i', endian='L')

        print(y)

        x = (1.3, 3.6)
        tb.savebin('./data.bin', x, dtype='f', endian='B', offsets=16, mode='a')

        y = tb.loadbin('./data.bin', dbsize=4, dtype='f', endian='B', offsets=16)
