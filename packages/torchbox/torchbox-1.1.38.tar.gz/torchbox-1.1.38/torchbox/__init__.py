...
from .utils.convert import value2unit, str2hash, file2hash, dict2str, str2bool, str2list, str2tuple, str2num, str2sec, int2bstr, bstr2int
...
from .base.baseops import sub2ind, ind2sub, dimpos, dimpermute, dimreduce, dimmerge, rmcdim, upkeys, dreplace, dmka, cat, argsort, argmin, argmax, min, max
