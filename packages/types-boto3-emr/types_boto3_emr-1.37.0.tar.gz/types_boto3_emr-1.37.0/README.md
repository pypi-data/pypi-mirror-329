<a id="types-boto3-emr"></a>

# types-boto3-emr

[![PyPI - types-boto3-emr](https://img.shields.io/pypi/v/types-boto3-emr.svg?color=blue)](https://pypi.org/project/types-boto3-emr/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-emr.svg?color=blue)](https://pypi.org/project/types-boto3-emr/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-emr)](https://pypistats.org/packages/types-boto3-emr)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 EMR 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-emr docs](https://youtype.github.io/types_boto3_docs/types_boto3_emr/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-emr](#types-boto3-emr)
...
- Install `types-boto3[emr]` in your environment:
...
- Install `types-boto3[emr]` with services you use in your environment:
...
`types-boto3-emr` dependency in production. However, there is an issue in
...
from types_boto3_emr import EMRClient
...
`types_boto3_emr.paginator` module contains type annotations for all
paginators.
...
`types_boto3_emr.waiter` module contains type annotations for all waiters.

```python
from boto3.session import Session

from types_boto3_emr import EMRClient
from types_boto3_emr.waiter import ClusterRunningWaiter, ClusterTerminatedWaiter, StepCompleteWaiter
...
`types_boto3_emr.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `EMR` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_emr/literals/).
...
`types_boto3_emr.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `EMR` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_emr/type_defs/).
...
`types-boto3-emr` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_emr/)
