...
class Issue:
    ...
    def create_bug(self, bug_title: str, bug_description: str, priority: str, version: str, testcase: str,
        ...
        return gitlab_response.get("iid")
    ...
    def get_issue_info(self, project_id, issue_iid):
        ...
        print(gitlab_response) # {'id': 39974, 'iid': 178, 'project_id': 1911, 'state': 'closed', 'closed_at': '2025-02-24T19:35:34.165+08:00', 'closed_by': {'id': 306, 'username': 'maoyongfan','labels': ['foundByAutoTest', 'priority::1', 'severity::1', 'type::bug']
        return gitlab_response.get("state"), gitlab_response.get("labels")
    def get_issue_status(self, project_id, issue_iid):
        pass
    ...
    def reopen_bug(self, project_id, issue_iid):
