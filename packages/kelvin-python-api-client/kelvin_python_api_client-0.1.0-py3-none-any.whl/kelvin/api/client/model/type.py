...
from . import enum, manifest, schemas_type
from .manifest import App as App_1
...
class Created(DataModelBase):
    ...
    created_at: Optional[datetime] = Field(
        ...
        example="2024-11-18T18:22:18.582724Z",
    )
...
class Resource(DataModelBase):
    ...
    parameters: Optional[Dict[str, Union[StrictInt, StrictFloat, StrictStr, StrictBool]]]
    datastreams: Optional[Dict[str, Datastreams]]

    """

    resource: Optional[StrictStr] = None
    parameters: Optional[Dict[str, Union[StrictInt, StrictFloat, StrictStr, StrictBool]]] = None
    datastreams: Optional[Dict[str, Datastreams]] = None


class AppDeploymentRuntime(DataModelBase):
    """
...
class App(App_1, Created, Updated):
    """
    App object.
...
class AppShort(App_1, Created, Updated):
    """
    AppShort object.
...
class AppVersionParameter(Created, Updated):
    ...
    resource: Optional[StrictStr] = Field(None, description="KRN of the Asset associated with the Parameter.")
...
class GuardrailValue(DataModelBase):
    ...
    value: StrictFloat = Field(..., description="The limiting value.")
...
class DatastreamsModel(DataModelBase):
    """
...
class ResourceModel(DataModelBase):
    ...
    properties: Optional[Dict[str, Union[StrictInt, StrictFloat, StrictStr, StrictBool]]]
    ...
    properties: Optional[Dict[str, Union[StrictInt, StrictFloat, StrictStr, StrictBool]]] = None
...
class ControlChangeReport(DataModelBase):
    ...
    timestamp: datetime = Field(..., example="2024-12-18T18:22:18.582724Z")
    source: enum.ControlChangeSource
...
class GuardrailConfigWithResource(GuardrailConfig):
    ...
    resource: StrictStr = Field(
        ...
        example="krn:ad:asset1/setpoint",
    )
...
class PropertyDefinition(DataModelBase):
    ...
    name: Optional[constr(max_length=64, strict=True)] = Field(
        None, description="Unique identifier `name` of the Property Definition.", example="region"
    )
    title: Optional[constr(min_length=1, max_length=64, strict=True)] = Field(
        None, description="Unique identifier `title` of the Property Definition.", example="Region"
    )
    primitive_type: Optional[enum.PropertyType] = None
    created: Optional[datetime] = Field(
        None,
        description="UTC time when the Property was created, formatted in RFC 3339.",
        example="2024-11-11T18:22:18.582724Z",
    )
    updated: Optional[datetime] = Field(
        None,
...
class PropertyValueHistory(DataModelBase):
    ...
    Parameters
    ----------
    property_name: Optional[constr(max_length=64, strict=True)]
    resource: Optional[StrictStr]
    ...
    property_name: Optional[constr(max_length=64, strict=True)] = Field(
        None, description="Unique identifier `name` of the Property.", example="region"
    )
    resource: Optional[StrictStr] = Field(
        None, description="Resource to which the value belongs.", example="krn:asset:asset1"
    )
    timestamp: Optional[datetime] = Field(
        None,
        description="UTC time for when the value was updated, formatted in RFC 3339.",
        example="2025-01-29T12:00:00.582724Z",
    )
    source: Optional[StrictStr] = Field(
        None, description="Represents who triggered the value change.", example="krn:user:user1"
    )
    value: Optional[Dict[str, Any]] = Field(None, description="Historical value at the given timestamp.", example=1)
...
class RecommendationEvidence(DataModelBase):
    ...
    type: Optional[Type] = Field(
        None, description="Type of evidence that is being used to create the Recommendation.", example="image"
    )
    payload: Optional[Dict[str, Any]] = Field(
...
class KelvinMessage(DataModelBase):
    ...
    resource: KRN = Field(
        ...
        example="krn:ad:bp_01/motor_speed_setpoint",
    )
    source: KRN = Field(
        ...,
        ...
        example="krn:wlappv:cluster-01/beam-pump-optimization/3.4.7",
    )
    timestamp: datetime = Field(
        ...,
...
class ResourceParameters(DataModelBase):
    ...
    ----------
    resource: KRNAsset
    parameters: List[schemas_type.ParameterItem]

    """

    resource: KRNAsset = Field(..., description="The target Asset to which the parameters are to be applied.")
    parameters: List[schemas_type.ParameterItem]
...
class LegacyWorkloadStaged(DataModelBase):
    ...
    status: Optional[schemas_type.StagedStatus]
    ...
    status: Optional[schemas_type.StagedStatus] = None
