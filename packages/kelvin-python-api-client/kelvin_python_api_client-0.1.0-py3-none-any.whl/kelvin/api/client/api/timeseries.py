    ...
    def create_timeseries(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": None, "207": None, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_timeseries_last(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": List[responses.TimeseriesLastGet], "400": response.Error, "401": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def list_timeseries(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.TimeseriesListPaginatedResponseCursor, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def download_timeseries_range(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": None, "400": response.Error, "401": response.Error},
            True,
            _dry_run,
            kwargs,
        )
    ...
    def get_timeseries_range(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.TimeseriesRangeGet, "400": response.Error, "401": response.Error},
            True,
            _dry_run,
            kwargs,
        )
