    ...
    def create_control_change(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": responses.ControlChangeCreate, "400": response.Error, "401": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_control_change_last(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.ControlChangeLastGetPaginatedResponseCursor, "400": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def list_control_changes(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.ControlChangesListPaginatedResponseCursor, "400": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_control_change_range(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.ControlChangeRangeGetPaginatedResponseCursor, "400": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_control_change(
        ...
        **Permission Required:** `kelvin.permission.control_change.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.ControlChangeGet, "400": response.Error, "404": response.Error},
            False,
            _dry_run,
        )
        return result
