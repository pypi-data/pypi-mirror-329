    ...
    def create_recommendation(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": responses.RecommendationCreate, "400": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_recommendation_last(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.RecommendationLastGetPaginatedResponseCursor, "400": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def list_recommendations(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.RecommendationsListPaginatedResponseCursor, "400": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def get_recommendation_range(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.RecommendationRangeGetPaginatedResponseCursor, "400": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def create_recommendation_type(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"201": responses.RecommendationTypeCreate, "400": response.Error, "409": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def delete_recommendation_type(cls, name: str, _dry_run: bool = False, _client: Any = None) -> None:
        ...
        **Permission Required:** `kelvin.permission.recommendation.delete`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": None, "400": response.Error, "404": response.Error, "409": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def get_recommendation_type(
        ...
        **Permission Required:** `kelvin.permission.recommendation.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.RecommendationTypeGet, "400": response.Error, "404": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def update_recommendation_type(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.RecommendationTypeUpdate, "400": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def update_recommendation_accept(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.RecommendationAcceptUpdate, "400": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def delete_recommendation(
        ...
        **Permission Required:** `kelvin.permission.recommendation.delete`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.RecommendationDelete, "400": response.Error, "404": response.Error},
            False,
            _dry_run,
        )
        return result
    ...
    def update_recommendation_reject(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": responses.RecommendationRejectUpdate, "400": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
