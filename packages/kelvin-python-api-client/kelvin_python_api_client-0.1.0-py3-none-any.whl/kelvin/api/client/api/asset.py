...
class Asset(ApiServiceModel):
    ...
    def create_asset_bulk(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": None, "207": None, "400": response.Error, "401": response.Error, "412": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def delete_asset_bulk(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {"200": None, "207": None, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
            kwargs,
        )
    ...
    def list_asset_property_definitions(
        ...
        _client: Any = None,
        **kwargs: Any,
    ) -> Union[KList[type.Property], responses.AssetPropertyDefinitionsListPaginatedResponseCursor]:
        """
    ...
    def get_asset_property_values(
        ...
        **kwargs:
        ...
        result = cls._make_request(
            ...
            False,
            {
                "200": responses.AssetPropertyValuesGet,
                "400": response.Error,
                "401": response.Error,
                "404": response.Error,
            },
    ...
    def get_asset(cls, asset_name: str, _dry_run: bool = False, _client: Any = None) -> responses.AssetGet:
        ...
        **Permission Required:** `kelvin.permission.asset.read`.
        ...
        result = cls._make_request(
            ...
            None,
            False,
            {"200": responses.AssetGet, "400": response.Error, "401": response.Error, "404": response.Error},
            False,
            _dry_run,
        )
        return result
