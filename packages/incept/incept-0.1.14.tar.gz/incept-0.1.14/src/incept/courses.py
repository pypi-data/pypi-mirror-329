...
def addCourse(db=DEFAULT_DB, template="default", df=None, **kwargs):
    ...
    for idx, row_data in df.iterrows():
        ...
        from incept.templates.manager import create_course_structure
        create_course_structure(course_name, template, base_path=Path(base_path) if base_path else None)

        # Insert into DB (the 'path' stored in Notion is the symbolic string)
