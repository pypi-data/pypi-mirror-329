...
setup(
    ...
    url="https://github.com/BUPT-GAMMA/ggfm",
    install_requires=['absl-py==2.0.0', 
                      'aiohttp==3.8.4', 
                      ...
                      'oauthlib==3.2.2', 'ogb==1.3.6', "omegaconf>=2.3.0",
                      ...
                      'pycodestyle==2.11.1', 'pydantic==1.10.13', 
                      'pydub==0.25.1', 
                   
                      'Pygments==2.17.2', 
                 
                      'PyMySQL==1.1.1', 'pyparsing==3.1.1', 
                      ...
                      'semantic-version==2.10.0', 'sentencepiece==0.1.99', "sentence-transformers>=2.2.2",
                      ...
                      'toolz==0.12.0', 'torch==2.1.0', 
                      'torchaudio', 'torchdata', 'torchmetrics', 
                      'torchvision', 
                    
                      'torch_geometric', 
                      'tqdm==4.66.1', 'transformers==4.46.3', 
