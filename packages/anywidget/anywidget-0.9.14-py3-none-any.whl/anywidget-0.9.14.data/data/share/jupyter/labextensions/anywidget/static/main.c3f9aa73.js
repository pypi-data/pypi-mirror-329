...
;// CONCATENATED MODULE: ./node_modules/.pnpm/solid-js@1.9.4/node_modules/solid-js/dist/solid.js
let taskIdCounter = 1,
...
function Switch(props) {
  ...
  const conditions = solid_children(() => props.children),
        ...
        ? solid_untrack(() =>
            c(
              keyed
                ? when
                : () => {
                    if (solid_untrack(evalConditions)[0] !== index) throw narrowedError("Match");
                    return cond.when;
                  }
            )
          )
...
;
//# sourceMappingURL=main.c3f9aa73.js.map