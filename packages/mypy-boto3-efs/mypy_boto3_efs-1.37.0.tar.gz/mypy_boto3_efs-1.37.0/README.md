...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-efs)](https://pypistats.org/packages/mypy-boto3-efs)
...
`mypy-boto3-efs` dependency in production. However, there is an issue in
