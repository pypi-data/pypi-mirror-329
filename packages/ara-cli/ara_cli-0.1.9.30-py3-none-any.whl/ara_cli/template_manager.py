...
class ArtefactFileManager:
    ...
    def copy_aspect_templates_to_directory(self, aspect, output_prefix=""):
        ...
        for src, dest in templates:
            ...
            copy(src, dest)
            print(f"Created file: {output_prefix}{dest}")
...
class SpecificationBreakdownAspects:
    ...
    def create(self, artefact_name='artefact_name', classifier='classifier', aspect='specification_breakdown_aspect'):
        ...
        self.file_manager.copy_aspect_templates_to_directory(aspect, output_prefix=f"{data_dir}/")
        if (aspect == "step"):
