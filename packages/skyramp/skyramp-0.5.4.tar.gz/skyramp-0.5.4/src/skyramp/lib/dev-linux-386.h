...
extern struct response_wrapper sendScenarioWrapper(char* address, char* dockerNetwork, char* namespace, char* kubePath, char* kubeContext, char* clusterName, char* scenarios, char* until, char* loadTestConfig, char* dependencies_filepath, char* workerImage, GoUint8 blocked, GoUint8 localImage);
extern struct response_wrapper sendRequestWrapper(char* address, char* namespace, char* kubePath, char* kubeContext, char* clusterName, char* request, char* dockerNetwork, char* workerImage, GoUint8 localImage);
