...
from skyramp.utils import _library, _call_function, _get_rest_path_name
...
class _Scenario:
    ...
    def add_async_request(
        ...
        self.steps_v2.append(step_request)
        return request

    def update_async_var(self, var_name, value):
        """
        construct backend interpretation of updating scenario vars
        """
        self.steps_v2.append({"var_name": var_name, "value": value, "type": "varOverride"})
