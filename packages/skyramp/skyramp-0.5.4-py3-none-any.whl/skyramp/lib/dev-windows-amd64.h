...
extern __declspec(dllexport) struct response_wrapper sendScenarioWrapper(char* address, char* dockerNetwork, char* namespace, char* kubePath, char* kubeContext, char* clusterName, char* scenarios, char* until, char* loadTestConfig, char* dependencies_filepath, char* workerImage, GoUint8 blocked, GoUint8 localImage);
extern __declspec(dllexport) struct response_wrapper sendRequestWrapper(char* address, char* namespace, char* kubePath, char* kubeContext, char* clusterName, char* request, char* dockerNetwork, char* workerImage, GoUint8 localImage);
...
extern __declspec(dllexport) char* generateRestTestWrapper(char* test, char* uri, char* methodX, char* language, char* framework, char* output, char* outputDir, char* runtime, char* dockerNetwork, GoInt dockerWorkerPort, char* k8sNamespace, char* k8sConfig, char* k8sContext, char* authHeader, char* requestData, char* responseData, char* responseStatusCode, GoUint8 force, GoUint8 deployDashboard, char* formParams, char* pathParams, char* queryParams, char* apiSchema, char* traceFilePath, char* generateInclude, char* generateExclude, GoUint8 generateInsecure, char* assertOption, GoInt loadCount, GoInt loadDuration, GoInt loadNumThreads, GoInt loadRampupDuration, GoInt loadRampupInterval, GoInt loadTargetRPS, char* traceOutputFile);
