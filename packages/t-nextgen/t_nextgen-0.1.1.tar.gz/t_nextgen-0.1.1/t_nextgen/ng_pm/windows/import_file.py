...
class ImportFileWindow(NextGenWindow):
    ...
    def set_835_directory_path(self, folder_835_path: str) -> None:
        ...
        with contextlib.suppress(_ctypes.COMError):
            self.window.child_window(title="txtFolderName", auto_id="txtFolderName", control_type="Edit").set_text(
                folder_835_path
            )
    ...
    def unselect_count_records_check_box(self) -> None:
        ...
        if count_record_check_box.get_toggle_state() == 1:
            count_record_check_box.toggle()
