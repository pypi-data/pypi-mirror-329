...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mediastore-data)](https://pypistats.org/packages/mypy-boto3-mediastore-data)
...
`mypy-boto3-mediastore-data` dependency in production. However, there is an
