<a id="types-boto3-elasticbeanstalk"></a>

# types-boto3-elasticbeanstalk

[![PyPI - types-boto3-elasticbeanstalk](https://img.shields.io/pypi/v/types-boto3-elasticbeanstalk.svg?color=blue)](https://pypi.org/project/types-boto3-elasticbeanstalk/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-elasticbeanstalk.svg?color=blue)](https://pypi.org/project/types-boto3-elasticbeanstalk/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-elasticbeanstalk)](https://pypistats.org/packages/types-boto3-elasticbeanstalk)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 ElasticBeanstalk 1.37.0](https://pypi.org/project/boto3/) compatible
...
[types-boto3-elasticbeanstalk docs](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-elasticbeanstalk](#types-boto3-elasticbeanstalk)
...
- Install `types-boto3[elasticbeanstalk]` in your environment:
...
- Install `types-boto3[elasticbeanstalk]` with services you use in your
  environment:
...
`types-boto3-elasticbeanstalk` dependency in production. However, there is an
...
from types_boto3_elasticbeanstalk import ElasticBeanstalkClient
...
`types_boto3_elasticbeanstalk.paginator` module contains type annotations for
all paginators.
...
`types_boto3_elasticbeanstalk.waiter` module contains type annotations for all
waiters.
...
`types_boto3_elasticbeanstalk.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `ElasticBeanstalk` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/literals/).
...
`types_boto3_elasticbeanstalk.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `ElasticBeanstalk` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/type_defs/).
...
`types-boto3-elasticbeanstalk` version is the same as related `boto3` version
and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_elasticbeanstalk/)
