...
class DiceAgent:
    ...
    def __init__(self, llm: str, api_key: str, serperapi:str, system_prompt: str = "You have access to a dice rolling tool, use it when required. Comply to requests from the user"):
        self.llm = llm
    ...
    async def main():
        dice_agent = DiceAgent(
            llm="llama-3.3-70b-versatile",
                ...
                serperapi="ca4a023c8b92184609fafb964dec7947122defa6"
            )
