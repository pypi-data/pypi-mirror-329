...
*UsersApi* | [**create_suppport_user**](agilicus_api/docs/UsersApi.md#create_suppport_user) | **POST** /v1/support_users | Create a support user
...
*UsersApi* | [**delete_support_user**](agilicus_api/docs/UsersApi.md#delete_support_user) | **DELETE** /v1/support_users/{user_id} | Delete a support user
...
*UsersApi* | [**get_support_user**](agilicus_api/docs/UsersApi.md#get_support_user) | **GET** /v1/support_users/{user_id} | Get a support user
...
*UsersApi* | [**list_support_users**](agilicus_api/docs/UsersApi.md#list_support_users) | **GET** /v1/support_users | List support users
...
*UsersApi* | [**update_support_user**](agilicus_api/docs/UsersApi.md#update_support_user) | **PUT** /v1/support_users/{user_id} | Update a support user&#39;s expiry
...
## Documentation For Models
 ...
 - [ListSupportUserResponse](agilicus_api/docs/ListSupportUserResponse.md)
 ...
 - [SupportUser](agilicus_api/docs/SupportUser.md)
 - [SupportUserSpec](agilicus_api/docs/SupportUserSpec.md)
 - [SupportUserStatus](agilicus_api/docs/SupportUserStatus.md)
