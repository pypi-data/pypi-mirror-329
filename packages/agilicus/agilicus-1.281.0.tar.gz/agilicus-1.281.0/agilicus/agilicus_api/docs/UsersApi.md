...
[**create_suppport_user**](UsersApi.md#create_suppport_user) | **POST** /v1/support_users | Create a support user
...
[**delete_support_user**](UsersApi.md#delete_support_user) | **DELETE** /v1/support_users/{user_id} | Delete a support user
...
[**get_support_user**](UsersApi.md#get_support_user) | **GET** /v1/support_users/{user_id} | Get a support user
...
[**list_support_users**](UsersApi.md#list_support_users) | **GET** /v1/support_users | List support users
...
[**update_support_user**](UsersApi.md#update_support_user) | **PUT** /v1/support_users/{user_id} | Update a support user&#39;s expiry
...
# **create_suppport_user**
> SupportUser create_suppport_user(support_user)
...
import agilicus_api
from agilicus_api.api import users_api
from agilicus_api.model.support_user import SupportUser
from agilicus_api.model.error_message import ErrorMessage
from pprint import pprint
# Defining the host is optional and defaults to https://api.agilicus.com
# See configuration.py for a list of all supported configuration parameters.
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a support user
        api_response = api_instance.create_suppport_user(support_user)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->create_suppport_user: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **support_user** | [**SupportUser**](SupportUser.md)|  |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**201** | New support user |  -  |
**400** | User is not in the list of allowed support user group |  -  |
**404** | user with the associated email does not exist |  -  |
**409** | Support user already exists |  -  |
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a support user
        api_instance.delete_support_user(user_id)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->delete_support_user: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Delete a support user
        api_instance.delete_support_user(user_id, org_id=org_id)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->delete_support_user: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | Support user was deleted |  -  |
**404** | Support user does not exist |  -  |
...
# **get_support_user**
> SupportUser get_support_user(user_id)
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a support user
        api_response = api_instance.get_support_user(user_id)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->get_support_user: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Get a support user
        api_response = api_instance.get_support_user(user_id, org_id=org_id)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->get_support_user: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Support user found and returned |  -  |
**404** | Support user does not exist |  -  |
...
# **list_support_users**
> ListSupportUserResponse list_support_users()
...
import agilicus_api
from agilicus_api.api import users_api
from agilicus_api.model.list_support_user_response import ListSupportUserResponse
from pprint import pprint
# Defining the host is optional and defaults to https://api.agilicus.com
# See configuration.py for a list of all supported configuration parameters.
configuration = agilicus_api.Configuration(
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # List support users
        api_response = api_instance.list_support_users(org_id=org_id, user_id=user_id, limit=limit)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->list_support_users: %s\n" % e)
```
...
[**ListSupportUserResponse**](ListSupportUserResponse.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Return a list of support users. The query can be limited to all support users in a specific organisation or can be used to look up support users associated with a user id.  |  -  |
...
# **update_support_user**
> SupportUser update_support_user(user_id)

Update a support user's expiry
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a support user's expiry
        api_response = api_instance.update_support_user(user_id)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->update_support_user: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Update a support user's expiry
        api_response = api_instance.update_support_user(user_id, support_user=support_user)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->update_support_user: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **user_id** | **str**| user_id path |
 **support_user** | [**SupportUser**](SupportUser.md)|  | [optional]
