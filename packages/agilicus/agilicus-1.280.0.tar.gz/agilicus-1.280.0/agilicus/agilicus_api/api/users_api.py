"""
    ...
    The version of the OpenAPI document: 2025.02.24
...
class UsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_suppport_user(
            self,
            support_user,
            **kwargs
        ):
            """Create a support user  # noqa: E501

            Create a support user  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.create_suppport_user(support_user, async_req=True)
            >>> result = thread.get()
        ...
        if self.create_suppport_user is None:
            self.create_suppport_user = _Endpoint(
                settings={
                    'response_type': (SupportUser,),
                    'auth': [
                        'token-valid'
                    ],
                    'endpoint_path': '/v1/support_users',
                    'operation_id': 'create_suppport_user',
                    'http_method': 'POST',
                    'servers': None,
                },
                params_map={
                ...
                api_client=api_client,
                callable=__create_suppport_user
            )
        ...
        def __delete_support_user(
            self,
            user_id,
            **kwargs
        ):
            """Delete a support user  # noqa: E501

            Delete a support user  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.delete_support_user(user_id, async_req=True)
            >>> result = thread.get()
        ...
        if self.delete_support_user is None:
            self.delete_support_user = _Endpoint(
                settings={
                    'response_type': None,
                    'auth': [
                        'token-valid'
                    ],
                    'endpoint_path': '/v1/support_users/{user_id}',
                    'operation_id': 'delete_support_user',
                    'http_method': 'DELETE',
                    'servers': None,
                },
                params_map={
                ...
                api_client=api_client,
                callable=__delete_support_user
            )
        ...
        def __get_support_user(
            self,
            user_id,
            **kwargs
        ):
            """Get a support user  # noqa: E501

            Get a support user  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_support_user(user_id, async_req=True)
            >>> result = thread.get()
        ...
        if self.get_support_user is None:
            self.get_support_user = _Endpoint(
                settings={
                    'response_type': (SupportUser,),
                    'auth': [
                        'token-valid'
        ...
        def __list_support_users(
            self,
            **kwargs
        ):
            """List support users  # noqa: E501

            List support users  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.list_support_users(async_req=True)
            >>> result = thread.get()
        ...
        if self.list_support_users is None:
            self.list_support_users = _Endpoint(
                settings={
                    'response_type': (ListSupportUserResponse,),
                    'auth': [
                        'token-valid'
                    ],
                    'endpoint_path': '/v1/support_users',
                    'operation_id': 'list_support_users',
                    'http_method': 'GET',
                    'servers': None,
                },
                params_map={
        ...
        def __update_support_user(
            self,
            user_id,
            **kwargs
        ):
            """Update a support user's expiry  # noqa: E501

            Update a support user's expiry  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.update_support_user(user_id, async_req=True)
            >>> result = thread.get()
            ...
            Keyword Args:
                support_user (SupportUser): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        if self.update_support_user is None:
            self.update_support_user = _Endpoint(
                settings={
                    'response_type': (SupportUser,),
                    'auth': [
                        'token-valid'
                    ...
                    'endpoint_path': '/v1/support_users/{user_id}',
                    'operation_id': 'update_support_user',
                    'http_method': 'PUT',
                    'servers': None,
                },
                params_map={
                ...
                api_client=api_client,
                callable=__update_support_user
            )
