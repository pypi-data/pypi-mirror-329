...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-evidently)](https://pypistats.org/packages/mypy-boto3-evidently)
...
`mypy-boto3-evidently` dependency in production. However, there is an issue in
