...
async def cadastro_pre_venda_header(
    nop: str, cod_cliente: str, cod_pagamento: str
) -> RpaRetornoProcessoDTO:
    try:
        ...
        while i < 20:
            ...
            if nop == value_nop_selected:
                console.print("NOP corretamente selecionada...\n")
                break
            else:
                pyautogui.press("up")
                await worker_sleep(1)
                try:
                    ...
                    console.print("Não possui pop-up de nota de entrada não sera referenciada...\n")
                finally:
                    i = i+1
...
async def wait_nf_ready():
    ...
    while current_try <= max_trys:
        ...
        if not window_closed:
            ...
            desktop = Desktop(backend="uia")
            #console.print("Janela aguarde já foi fechada", style="bold green")
            #Identificando janela Aguarde...
            try:
                ...
                if window.exists():
                    ...
                    current_try += 1
                    continue
                # app = Application().connect(class_name="Ghost", timeout=15, title="Aguarde...")
                # window_aguarde = app["Ghost"]
                # window_aguarde.set_focus()
                # if window_aguarde.exists():
            ...
            try:
                ...
                console.print("Janela de mensagem não encontrada, seguindo o processo...")
            ...
            if len(dados) < len(cabecalho):
                ...
                if get_error_msg == "" or get_error_msg is None:
    ...
    return {"sucesso": False, "retorno": f"Número máximo de tenntativass excedido ao tentar transmitir a nota"}
