                    ...
                    if preenchimento_header_pre_venda.sucesso:
                        try:
                            ...
                            if 'gasolina' in descricao.lower() or 'diesel' in descricao.lower() or 'gnv' in descricao.lower() or 'etanol' in descricao.lower():
                                set_combobox("||List", "5667 - VENDA DE COMB OU LUBRI - SEM ESTOQ E COM FINANC")
                            elif 'arla' in descricao.lower():
                                set_combobox("||List", "5102 - MERCAD. ADQ DE TERCEIRO-5.102 S/ ESTOQU C/ FINAN")
                            else:
                                if nop_to_be_select != '':
                                    set_combobox("||List", nop_to_be_select)
                                else:
                            ...
                            # if ("gasolina comum" in descricao or "diesel s500" in descricao or "gnv" in descricao or "gasolina aditivada" in descricao or "etanol" in descricao or "diesel s10" in descricao or "diesel comum" in descricao):
                            #     set_combobox("||List", "5656 - VENDA DE COMB OU LUB ADQ DE TERCEIRO C/ FIN S/ ESTOQUE")
                            # elif 'arla' in descricao:
                            #     set_combobox("||List", "5102 - VENDA MERCAD. ADQ. DE TERCEIRO-5.102 S/ ESTOQ C/ FINAN")
                            # else:
                ...
                if preenchimento_header_pre_venda.sucesso:
                    try:
                        ...
                        try:
                            ...
                            console.print(f"Mensagem adicionada com sucesso, selecionando o tipo de documento\n")
