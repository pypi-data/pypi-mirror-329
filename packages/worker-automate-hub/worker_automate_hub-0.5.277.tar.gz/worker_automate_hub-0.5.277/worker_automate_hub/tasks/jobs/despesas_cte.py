...
async def despesas_cte(task: RpaProcessoEntradaDTO):
    try:
        ...
        if status_nf_emsys.get("status") == "Lançada":
            console.print("\\CTE ja lançado, processo finalizado...", style="bold green")
        ...
        if return_login.sucesso:
            ...
            try:
                ...
                console.print("Não foi possivel focar no campo dataEmissao, clicando na coordenada (903, 417)")
            ...
            try:
                ...
                console.print("Não foi possivel focar no campo dataEntrada, clicando na coordenada (1096, 419)")
