...
async def open_contabil_processes():
    try:
        ...
        subprocess.Popen(["C:\\Users\\automatehub\\Desktop\\Contaabil\\contabil1.exe"])
        await worker_sleep(3)
        os.startfile("C:\\Users\\automatehub\\Desktop\\Contaabil\\contabil2.lnk")
        await worker_sleep(30)
        os.startfile("C:\\Users\\automatehub\\Desktop\\Contaabil\\contabil3.lnk")
        await worker_sleep(20)
        pyautogui.hotkey("win", "d")
        await worker_sleep(4)
        os.startfile("C:\\Users\\automatehub\\Desktop\\Contaabil\\contabil4.lnk")
...
async def integracao_contabil(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    try:
        ...
        emsys.verify_warning_and_error("Erro", "&Ok")
        await worker_sleep(4)
        ...
        await worker_sleep(2)
        console.print("Selecionando campo outras despesas...")
        pyautogui.press("down", presses=40, interval=1)
        await worker_sleep(4)
        console.print("Preenchendo campo periodo...")
        pyautogui.press("tab")
        await worker_sleep(1)
        periodo = task.configEntrada.get("periodo")
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            console.print(f"Texto de status tela: {field}")
