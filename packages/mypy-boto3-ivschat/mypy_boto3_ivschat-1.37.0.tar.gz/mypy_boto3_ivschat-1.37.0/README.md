...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-ivschat)](https://pypistats.org/packages/mypy-boto3-ivschat)
...
`mypy-boto3-ivschat` dependency in production. However, there is an issue in
