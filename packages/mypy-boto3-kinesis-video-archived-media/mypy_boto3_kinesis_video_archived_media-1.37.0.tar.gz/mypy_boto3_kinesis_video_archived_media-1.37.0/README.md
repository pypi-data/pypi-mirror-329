...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kinesis-video-archived-media)](https://pypistats.org/packages/mypy-boto3-kinesis-video-archived-media)
...
`mypy-boto3-kinesis-video-archived-media` dependency in production. However,
