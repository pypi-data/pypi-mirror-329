...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iot-data)](https://pypistats.org/packages/mypy-boto3-iot-data)
...
`mypy-boto3-iot-data` dependency in production. However, there is an issue in
