    ...
    I: Layer,
{
    ...
    fn parse_puzzle(allocator: &Allocator, puzzle: Puzzle) -> Result<Option<Self>, DriverError> {
        ...
        let args = WriterLayerArgs::<NodePtr>::from_klvm(allocator, puzzle.args)?;
    ...
    fn parse_solution(
        ...
        let inner_solution =
            WriterLayerSolution::<NodePtr>::from_klvm(allocator, solution)?.inner_solution;
...
impl WriterLayer<StandardLayer> {
    pub fn spend(
        ...
        let dp = ctx.alloc(&klvm_quote!(output_conditions))?;
