...
pub(crate) fn impl_conditions(input: TokenStream) -> TokenStream {
    ...
    } in items
    {
        ...
        structs.push(quote! {
            #[derive(::klvm_traits::ToKlvm, ::klvm_traits::FromKlvm)]
            #[::klvm_traits::apply_constants]
    ...
    quote! {
        #[non_exhaustive]
        #[derive(Debug, Clone, PartialEq, Eq, ::klvm_traits::ToKlvm, ::klvm_traits::FromKlvm)]
        #[klvm(transparent)]
        pub enum #name<#enum_generic = ::klvmr::NodePtr> {
            #( #variants )*
            Other(T),
        }
