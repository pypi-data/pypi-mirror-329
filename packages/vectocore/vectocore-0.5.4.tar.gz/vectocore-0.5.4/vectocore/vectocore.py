...
class Lens:
    def __init__(
        self, tenant_key="", role=None, rule=None, output_format=None, mode=None, max_his_count=None, session_key=None, num_of_ref=3
    ):
        # 변수 은닉화
        self.__VECTOR_URL = "https://api.vectocore.com"
    ...
    def chat(self, question, stream=False, index_name=None, custom_data=None):
