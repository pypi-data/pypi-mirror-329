...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-globalaccelerator)](https://pypistats.org/packages/mypy-boto3-globalaccelerator)
...
`mypy-boto3-globalaccelerator` dependency in production. However, there is an
