...
class _ServiceStateEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _ServiceState.ValueType
    ],
    builtins.type,
):
...
class _ExperimentCommandEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _ExperimentCommand.ValueType
    ],
    builtins.type,
):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    BEGIN: _ExperimentCommand.ValueType  # 0
    END: _ExperimentCommand.ValueType  # 1
    ABORT: _ExperimentCommand.ValueType  # 2

class ExperimentCommand(
    _ExperimentCommand, metaclass=_ExperimentCommandEnumTypeWrapper
): ...

BEGIN: ExperimentCommand.ValueType  # 0
END: ExperimentCommand.ValueType  # 1
ABORT: ExperimentCommand.ValueType  # 2
