<a id="types-boto3-compute-optimizer"></a>

# types-boto3-compute-optimizer

[![PyPI - types-boto3-compute-optimizer](https://img.shields.io/pypi/v/types-boto3-compute-optimizer.svg?color=blue)](https://pypi.org/project/types-boto3-compute-optimizer/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-compute-optimizer.svg?color=blue)](https://pypi.org/project/types-boto3-compute-optimizer/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-compute-optimizer)](https://pypistats.org/packages/types-boto3-compute-optimizer)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 ComputeOptimizer 1.37.0](https://pypi.org/project/boto3/) compatible
...
[types-boto3-compute-optimizer docs](https://youtype.github.io/types_boto3_docs/types_boto3_compute_optimizer/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-compute-optimizer](#types-boto3-compute-optimizer)
...
- Install `types-boto3[compute-optimizer]` in your environment:
...
- Install `types-boto3[compute-optimizer]` with services you use in your
  environment:
...
`types-boto3-compute-optimizer` dependency in production. However, there is an
...
from types_boto3_compute_optimizer import ComputeOptimizerClient
...
`types_boto3_compute_optimizer.paginator` module contains type annotations for
all paginators.
...
`types_boto3_compute_optimizer.literals` module contains literals extracted
from shapes that can be used in user code for type checking.

Full list of `ComputeOptimizer` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_compute_optimizer/literals/).
...
`types_boto3_compute_optimizer.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `ComputeOptimizer` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_compute_optimizer/type_defs/).
...
`types-boto3-compute-optimizer` version is the same as related `boto3` version
and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_compute_optimizer/)
