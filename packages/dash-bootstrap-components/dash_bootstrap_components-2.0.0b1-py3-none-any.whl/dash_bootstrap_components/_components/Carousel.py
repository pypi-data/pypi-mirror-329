...
- variant (a value equal to: 'dark'; optional):
    ...
    def __init__(
        ...
        *,
        ...
        active_index: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'active_index', 'className', 'class_name', 'controls', 'indicators', 'interval', 'items', 'persisted_props', 'persistence', 'persistence_type', 'slide', 'style', 'variant']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'active_index', 'className', 'class_name', 'controls', 'indicators', 'interval', 'items', 'persisted_props', 'persistence', 'persistence_type', 'slide', 'style', 'variant']
