...
- style (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'align', 'className', 'class_name', 'justify', 'key', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'align', 'className', 'class_name', 'justify', 'key', 'style']
