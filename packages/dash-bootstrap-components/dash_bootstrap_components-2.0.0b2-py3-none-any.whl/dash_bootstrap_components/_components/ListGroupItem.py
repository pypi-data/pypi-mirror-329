...
- target (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'action', 'active', 'className', 'class_name', 'color', 'disabled', 'external_link', 'href', 'key', 'n_clicks', 'style', 'tag', 'target']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'action', 'active', 'className', 'class_name', 'color', 'disabled', 'external_link', 'href', 'key', 'n_clicks', 'style', 'tag', 'target']
