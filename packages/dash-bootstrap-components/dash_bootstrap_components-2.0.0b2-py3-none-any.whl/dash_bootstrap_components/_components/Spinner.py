...
- type (string; default 'border'):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'color', 'delay_hide', 'delay_show', 'display', 'fullscreen', 'fullscreenClassName', 'fullscreen_class_name', 'fullscreen_style', 'show_initially', 'size', 'spinnerClassName', 'spinner_class_name', 'spinner_style', 'target_components', 'type']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'color', 'delay_hide', 'delay_show', 'display', 'fullscreen', 'fullscreenClassName', 'fullscreen_class_name', 'fullscreen_style', 'show_initially', 'size', 'spinnerClassName', 'spinner_class_name', 'spinner_style', 'target_components', 'type']
