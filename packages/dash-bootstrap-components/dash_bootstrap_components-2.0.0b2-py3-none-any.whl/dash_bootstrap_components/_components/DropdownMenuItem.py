...
- toggle (boolean; default True):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'active', 'className', 'class_name', 'disabled', 'divider', 'external_link', 'header', 'href', 'key', 'n_clicks', 'style', 'target', 'toggle']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'active', 'className', 'class_name', 'disabled', 'divider', 'external_link', 'header', 'href', 'key', 'n_clicks', 'style', 'target', 'toggle']
