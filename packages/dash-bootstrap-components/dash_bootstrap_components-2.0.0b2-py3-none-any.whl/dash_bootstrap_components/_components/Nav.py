...
- vertical (boolean | string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'card', 'className', 'class_name', 'fill', 'horizontal', 'justified', 'key', 'navbar', 'navbar_scroll', 'pills', 'style', 'vertical']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'card', 'className', 'class_name', 'fill', 'horizontal', 'justified', 'key', 'navbar', 'navbar_scroll', 'pills', 'style', 'vertical']
