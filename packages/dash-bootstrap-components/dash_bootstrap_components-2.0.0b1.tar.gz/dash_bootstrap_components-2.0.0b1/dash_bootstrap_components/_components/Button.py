...
- value (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'active', 'className', 'class_name', 'color', 'disabled', 'download', 'external_link', 'href', 'key', 'n_clicks', 'name', 'outline', 'rel', 'size', 'style', 'target', 'title', 'type', 'value']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'active', 'className', 'class_name', 'color', 'disabled', 'download', 'external_link', 'href', 'key', 'n_clicks', 'name', 'outline', 'rel', 'size', 'style', 'target', 'title', 'type', 'value']
