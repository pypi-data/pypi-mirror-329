...
- top (boolean; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'alt', 'bottom', 'className', 'class_name', 'key', 'src', 'style', 'tag', 'title', 'top']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'alt', 'bottom', 'className', 'class_name', 'key', 'src', 'style', 'tag', 'title', 'top']
