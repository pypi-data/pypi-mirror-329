...
- style (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'body', 'className', 'class_name', 'color', 'inverse', 'key', 'outline', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'body', 'className', 'class_name', 'color', 'inverse', 'key', 'outline', 'style']
