...
- target (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'active', 'className', 'class_name', 'disabled', 'external_link', 'href', 'key', 'n_clicks', 'style', 'target']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'active', 'className', 'class_name', 'disabled', 'external_link', 'href', 'key', 'n_clicks', 'style', 'target']
