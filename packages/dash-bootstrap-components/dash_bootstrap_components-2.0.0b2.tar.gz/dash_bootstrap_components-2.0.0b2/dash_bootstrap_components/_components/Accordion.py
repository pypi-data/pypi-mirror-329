...
- style (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'active_item', 'always_open', 'className', 'class_name', 'flush', 'key', 'persisted_props', 'persistence', 'persistence_type', 'start_collapsed', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'active_item', 'always_open', 'className', 'class_name', 'flush', 'key', 'persisted_props', 'persistence', 'persistence_type', 'start_collapsed', 'style']
