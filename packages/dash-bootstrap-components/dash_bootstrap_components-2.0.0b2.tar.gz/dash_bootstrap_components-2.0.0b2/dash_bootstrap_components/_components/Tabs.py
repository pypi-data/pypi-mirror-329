...
- style (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'active_tab', 'className', 'class_name', 'key', 'persisted_props', 'persistence', 'persistence_type', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'active_tab', 'className', 'class_name', 'key', 'persisted_props', 'persistence', 'persistence_type', 'style']
