...
- tag (string; optional):
    ...
    def __init__(
        ...
        *,
        ...
        n_dismiss: typing.Optional[typing.Union[int, float, numbers.Number]] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'bodyClassName', 'body_class_name', 'body_style', 'className', 'class_name', 'color', 'dismissable', 'duration', 'header', 'headerClassName', 'header_class_name', 'header_style', 'icon', 'is_open', 'key', 'n_dismiss', 'persisted_props', 'persistence', 'persistence_type', 'style', 'tag']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'bodyClassName', 'body_class_name', 'body_style', 'className', 'class_name', 'color', 'dismissable', 'duration', 'header', 'headerClassName', 'header_class_name', 'header_style', 'icon', 'is_open', 'key', 'n_dismiss', 'persisted_props', 'persistence', 'persistence_type', 'style', 'tag']
