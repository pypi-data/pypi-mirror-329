...
class PyRobstrideActuator:
    def __new__(cls,ports:typing.Sequence[builtins.str], py_actuators_config:typing.Sequence[tuple[builtins.int, PyRobstrideActuatorConfig]], polling_interval:builtins.float): ...
...
class PyRobstrideActuatorCommand:
    ...
    def __new__(cls,actuator_id:builtins.int): ...
...
class PyRobstrideActuatorConfig:
    ...
    def __new__(cls,actuator_type:builtins.int): ...
