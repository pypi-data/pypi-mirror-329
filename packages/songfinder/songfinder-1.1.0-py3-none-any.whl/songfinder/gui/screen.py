...
class Screen:
    ...
    def fullScreen(self, frame):
        ...
        logging.info(f"Fullscreen on: {self!s}")
...
class Screens:
    ...
    def update(self, referenceWidget=None, verbose=True):
        ...
        if verbose:
            ...
            for screen in self._screens:
                logging.info(f"Fullscreen: {screen!s}, Usable: {screen.usable}")
    ...
    def _getXrandrScreen(self):
        ...
        try:
            ...
            if code != 0:
                logging.warning(
                    f"Erreur de detection des ecrans: Error {code!s}\n{err}"
                )
                return False
            deb = 0
