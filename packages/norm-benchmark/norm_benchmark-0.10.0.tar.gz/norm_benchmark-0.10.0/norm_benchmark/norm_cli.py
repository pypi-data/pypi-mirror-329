...
class Norm(object):
    ...
    def dashboard(self):
        ...
        from norm_benchmark.frontend.dashboard import create_dashboard  # Import the dashboard script as a module
        
        with resources.path(create_dashboard, "dashboard.py") as dashboard_script:
