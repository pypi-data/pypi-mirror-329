...
class TestArticleideasAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ArticleideasAPIClient(self.api_key)

    @patch('apiverve_articleideasgenerator.apiClient.requests.get')
