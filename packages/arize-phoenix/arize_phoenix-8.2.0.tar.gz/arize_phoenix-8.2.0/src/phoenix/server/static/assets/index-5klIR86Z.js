import{r as t,j as o,ba as z,l as c,O as w,R as P,E as b,ck as k,d$ as S,e0 as F,e1 as L,e2 as l,v as C,e3 as E}from"./vendor-Cqfydjep.js";import{d as R,J as T,D as A,V as I,W as _}from"./vendor-arizeai-WnerlUPN.js";import{L as j,r as D,d as O,e as G,F as N,f as V,P as M,h as W,M as m,g as U,D as q,i as B,E as J,j as $,k as K,p as H,l as p,n as Y,s as Q,S as X,o as Z,q as oo,t as lo,v as u,w as f,x as y,y as ao,z as ro,A as co,B as go,C as eo,G as bo,H as no,I as io,J as so,K as to,N as mo,O as po,Q as uo,U as fo,V as yo,W as vo,X as ho,Y as xo,Z as zo,_ as wo,$ as Po,a0 as ko,a1 as So,a2 as Fo,a3 as Lo,a4 as Co,a5 as Eo,a6 as Ro,a7 as To,a8 as Ao,a9 as Io}from"./pages-sERWyBWu.js";import{W as _o,dA as jo,b9 as Do,U as Oo,dB as Go,dC as No}from"./components-C48uRczp.js";import"./vendor-three-C-AGeJYv.js";import"./vendor-codemirror-D-ZZKLFq.js";import"./vendor-shiki-D5K9GnFn.js";import"./vendor-recharts-KY97ZPfK.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const g of r)if(g.type==="childList")for(const n of g.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(r){const g={};return r.integrity&&(g.integrity=r.integrity),r.referrerPolicy&&(g.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?g.credentials="include":r.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function s(r){if(r.ep)return;r.ep=!0;const g=i(r);fetch(r.href,g)}})();const v="arize-phoenix-feature-flags",d={__RESET__:!1};function Vo(){const a=localStorage.getItem(v);if(!a)return d;try{const e=JSON.parse(a);return Object.assign({},d,e)}catch{return d}}const h=t.createContext(null);function Mo(){const a=P.useContext(h);if(a===null)throw new Error("useFeatureFlags must be used within a FeatureFlagsProvider");return a}function Wo(a){const[e,i]=t.useState(Vo()),s=r=>{localStorage.setItem(v,JSON.stringify(r)),i(r)};return o(h.Provider,{value:{featureFlags:e,setFeatureFlags:s},children:o(Uo,{children:a.children})})}function Uo(a){const{children:e}=a,{featureFlags:i,setFeatureFlags:s}=Mo(),[r,g]=t.useState(!1);return z("ctrl+shift+f",()=>g(!0)),c(w,{children:[e,o(A,{type:"modal",isDismissable:!0,onDismiss:()=>g(!1),children:r&&o(R,{title:"Feature Flags",children:o(_o,{height:"size-1000",padding:"size-100",children:Object.keys(i).map(n=>o(T,{isSelected:i[n],onChange:x=>s({...i,[n]:x}),children:n},n))})})})]})}const qo=b`
  :root {
