...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-identitystore)](https://pypistats.org/packages/mypy-boto3-identitystore)
...
`mypy-boto3-identitystore` dependency in production. However, there is an issue
