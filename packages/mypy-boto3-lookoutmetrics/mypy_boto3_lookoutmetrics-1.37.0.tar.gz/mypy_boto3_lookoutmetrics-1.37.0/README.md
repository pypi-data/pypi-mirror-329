...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-lookoutmetrics)](https://pypistats.org/packages/mypy-boto3-lookoutmetrics)
...
`mypy-boto3-lookoutmetrics` dependency in production. However, there is an
