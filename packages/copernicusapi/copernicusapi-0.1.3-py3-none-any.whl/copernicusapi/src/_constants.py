...
COLLECTION_PRODUCT_TYPE_MATCHES = {
    "SENTINEL-1": ("CARD-BS", "CARD-COH6", "RAW", "SLC", "GRD", "GRDH", "OCN"),
    ...
    "SENTINEL-6": ("MW_2__AMR____", "P4_1B_LR_____", "P4_1B_HR_____", "P4_2__LR_____", "P4_2__HR_____"),
    "SENTINEL-1-RTC": ("RTC",),
