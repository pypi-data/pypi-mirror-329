...
def reduce_wkt_coordinate_precision(geom: BaseGeometry, decimals: int = 4) -> str:
    """
    Reduces the coordinate precision of an arbitrary geometry.
    ...
    return wkt.dumps(geom, rounding_precision=decimals)
