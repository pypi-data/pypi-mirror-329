...
def configure_query_constructor(query_constructor, settings_dict):
    ...
    for key, value in settings_dict.items():
        if key == "collection":
            ...
            query_constructor.add_aoi_filter(value, decimals=4)
...
def create_query_constructor_test_case(test_resources_dir):
    ...
    def _test_case(test_case):
        if test_case == "test_case1":
            ...
            test_case["settings"] = {
                "aoi": gdf["geometry"].values.tolist()[0],
            ...
            test_case["settings"] = {
                ...
                "attribute": [
                    {"name": "orbitDirection", "operator": "eq", "value": "ASCENDING", "attribute_type": "String"}
                ],
            }
            ...
            test_case["settings"] = {
                ...
                "attribute": [
                    {"name": "polarisationChannels", "operator": "eq", "value": "VV&VH", "attribute_type": "String"}
                ],
            }
            ...
            test_case["settings"] = {
                ...
                "attribute": [
                    {"name": "orbitDirection", "operator": "eq", "value": "DESCENDING", "attribute_type": "String"},
            ...
            test_case["settings"] = {
                "product_names": [
                    "S2B_MSIL1C_20230101T102339_N0509_R065_T32UNU_20230101T105601.SAFE",
