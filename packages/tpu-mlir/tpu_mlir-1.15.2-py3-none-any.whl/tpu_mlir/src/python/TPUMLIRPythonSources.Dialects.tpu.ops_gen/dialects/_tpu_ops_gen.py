...
class BatchNormTrainOp(_ods_ir.OpView):
  ...
  def __init__(self, output, mean_out, saved_invstd, running_mean, running_var, input, mean, var, gamma, beta, *, do_relu=None, epsilon=None, momentum=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class PadOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, left_select, right_select, buffer, paddings, *, paddingsT=None, val=None, mode=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
