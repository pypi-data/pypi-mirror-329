<a id="types-boto3-apigatewayv2"></a>

# types-boto3-apigatewayv2

[![PyPI - types-boto3-apigatewayv2](https://img.shields.io/pypi/v/types-boto3-apigatewayv2.svg?color=blue)](https://pypi.org/project/types-boto3-apigatewayv2/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-apigatewayv2.svg?color=blue)](https://pypi.org/project/types-boto3-apigatewayv2/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-apigatewayv2)](https://pypistats.org/packages/types-boto3-apigatewayv2)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 ApiGatewayV2 1.37.0](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-apigatewayv2 docs](https://youtype.github.io/types_boto3_docs/types_boto3_apigatewayv2/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-apigatewayv2](#types-boto3-apigatewayv2)
...
- Install `types-boto3[apigatewayv2]` in your environment:
...
- Install `types-boto3[apigatewayv2]` with services you use in your
  environment:
...
`types-boto3-apigatewayv2` dependency in production. However, there is an issue
...
from types_boto3_apigatewayv2 import ApiGatewayV2Client
...
`types_boto3_apigatewayv2.paginator` module contains type annotations for all
paginators.
...
`types_boto3_apigatewayv2.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `ApiGatewayV2` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_apigatewayv2/literals/).
...
`types_boto3_apigatewayv2.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `ApiGatewayV2` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_apigatewayv2/type_defs/).
...
`types-boto3-apigatewayv2` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_apigatewayv2/)
