...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mediapackage)](https://pypistats.org/packages/mypy-boto3-mediapackage)
...
`mypy-boto3-mediapackage` dependency in production. However, there is an issue
