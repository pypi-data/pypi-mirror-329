...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-codestar-notifications)](https://pypistats.org/packages/mypy-boto3-codestar-notifications)
...
`mypy-boto3-codestar-notifications` dependency in production. However, there is
