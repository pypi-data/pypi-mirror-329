    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return DatasetRequestModel(
                ...
                phs_id = 'phs123456', 
                experimental_self_hosted = True, 
                properties = None, 
                dedicated_ingest_service_account = True, 
                experimental_predictable_file_ids = True, 
                policies = data_repo_client.models.dataset_request_model_policies.DatasetRequestModel_policies(
                    stewards = [
                        '0'
                        ], 
                    custodians = [
