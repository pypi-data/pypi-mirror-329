...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-application-insights)](https://pypistats.org/packages/mypy-boto3-application-insights)
...
`mypy-boto3-application-insights` dependency in production. However, there is
