...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-amplifybackend)](https://pypistats.org/packages/mypy-boto3-amplifybackend)
...
`mypy-boto3-amplifybackend` dependency in production. However, there is an
