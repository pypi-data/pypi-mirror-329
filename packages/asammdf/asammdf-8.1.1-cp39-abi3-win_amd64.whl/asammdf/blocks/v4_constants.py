...
FLAG_AT_MD5_VALID = 4
FLAG_DZ_DEFLATE = 0
FLAG_DZ_TRANSPOSED_DEFLATE = 1
FLAG_DZ_ZSTD = 2
FLAG_DZ_TRANSPOSED_ZSTD = 3
FLAG_DZ_LZ4 = 4
FLAG_DZ_TRANSPOSED_LZ4 = 5
...
FLAG_CN_VLSD = 1 << 14
FLAG_CN_RAW_SENSOR_EVENT = 1 << 15
FLAG_CN_AUXILIARY_CHANNEL = 1 << 16
FLAG_CN_DS = 1 << 17
FLAG_CN_ALIGNMENT_RESET = 1 << 18
FLAG_CN_PROTOCOL_EVENT = 1 << 19
...
GD_u = struct.Struct(FMT_GD_BLOCK).unpack
GD_uf = struct.Struct(FMT_GD_BLOCK).unpack_from
GD_p = struct.Struct(FMT_GD_BLOCK).pack
