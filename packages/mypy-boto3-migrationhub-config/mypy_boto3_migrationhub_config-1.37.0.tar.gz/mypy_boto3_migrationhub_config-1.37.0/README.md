...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-migrationhub-config)](https://pypistats.org/packages/mypy-boto3-migrationhub-config)
...
`mypy-boto3-migrationhub-config` dependency in production. However, there is an
