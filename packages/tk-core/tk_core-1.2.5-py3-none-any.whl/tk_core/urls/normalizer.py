...
class URLNormalizer:
    ...
    def __init__(self, url: str, log_errors: bool = True) -> None:
        try:
            ...
            self.normalized_url, self.parent_canonical_url, self.root_canonical_url = self.normalize_url(url)
    ...
    def normalize_url(self, url: str) -> Tuple[str, str, str]:
        ...
        canonicalized_url = self.rebuild_url(netloc, path, unique_params)
        parent_canonical_url = self.get_parent_canonical_url(netloc)
        root_canonical_url = self.get_root_canonical_url(netloc)
        return canonicalized_url, parent_canonical_url, root_canonical_url
    ...
    def compute_hashes(self) -> Dict[str, str]:
        ...
        return {
            "canonicalized_url_hash": sha256_hash(self.normalized_url),
    ...
    def get_canonicalized_url(self) -> Dict[str, Union[str, Dict[str, str]]]:
        return {
            "canonicalized_url": self.normalized_url,
