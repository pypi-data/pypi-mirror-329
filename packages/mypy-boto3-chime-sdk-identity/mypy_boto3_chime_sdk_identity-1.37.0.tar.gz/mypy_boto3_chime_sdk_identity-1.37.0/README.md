...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-chime-sdk-identity)](https://pypistats.org/packages/mypy-boto3-chime-sdk-identity)
...
`mypy-boto3-chime-sdk-identity` dependency in production. However, there is an
