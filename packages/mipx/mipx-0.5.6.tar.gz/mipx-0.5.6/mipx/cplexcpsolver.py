...
class CplexCpSolver(ICpModel):
    ...
    def addGenConstrOr(self, resvar: IVar, varList: List[IVar], name=""):
        self.addConstr(resvar == self.__model.logical_or(*varList))  # type: ignore
    ...
    def addGenConstrAbs(self, resvar, var_abs: IVar, M, name=""):  # type: ignore
    ...
    def valueExpression(self, expression: CpoExpr) -> Real:  # type: ignore
        ...
        ), "CpoFunctionCall下的`expression.children`的长度必须等于2"
