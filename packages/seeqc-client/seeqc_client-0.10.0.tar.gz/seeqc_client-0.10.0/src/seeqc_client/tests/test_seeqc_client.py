...
class BaseCase(unittest.TestCase):
    ...
    @patch('requests.sessions.Session.post', MockedAuthenticate)
    ...
    @patch('requests.sessions.Session.post', MockedRefresh)
    ...
    def test_get_version_valid(self):
        ...
        with patch('requests.sessions.Session.post', MockedAuthenticate):
            self.client.auth.authenticate(self.credentials)
        with patch('requests.sessions.Session.get', MockedVersion):
