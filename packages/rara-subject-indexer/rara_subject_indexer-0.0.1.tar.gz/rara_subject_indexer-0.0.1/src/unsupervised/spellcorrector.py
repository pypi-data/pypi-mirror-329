...
from src.utils.constants import SPELL_CHECK_DICTIONARIES_CONFIG
...
class SpellCorrector:
    ...
    def _load_dictionaries(self):
        ...
        for lang_code, config in SPELL_CHECK_DICTIONARIES_CONFIG.items():
            ...
            if not sym_spell.load_dictionary(config["path"], term_index=term_index, count_index=count_index,
                                             separator=separator):
                raise FileNotFoundError(f"Dictionary file not found at {config['path']}")
