...
from src.supervised.omikuji_helpers import assert_both_files_same_length
...
class DataLoader:
    ...
    def write_lemmatized_texts(self, output_file: str, preprocess_fn: Callable) -> List[List[str]]:
        """
        ...
        preprocess_fn : callable
            A function that takes raw text and returns a preprocessed (lemmatized) text.
