...
from vellum.workflows.context import ExecutionContext, execution_context
...
def stream_workflow(
    ...
    def call_workflow() -> Generator[dict[str, Any], Any, None]:
        ...
        try:
            ...
            starting_execution_context = executor_context.execution_context or ExecutionContext()
            with execution_context(
                parent_context=starting_execution_context.parent_context, trace_id=starting_execution_context.trace_id
            ):
