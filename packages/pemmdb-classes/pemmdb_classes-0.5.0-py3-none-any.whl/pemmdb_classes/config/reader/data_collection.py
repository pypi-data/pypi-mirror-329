...
class DataCollectionConfig(BaseModel):
    data_collection_name: str = Field(..., description="The name of the data collection.", example='ERAA2025-TYNDP2026_Data_Collection')
    nickname: str = Field(..., description="The nickname of the data collection.", example='ERAA2025')
