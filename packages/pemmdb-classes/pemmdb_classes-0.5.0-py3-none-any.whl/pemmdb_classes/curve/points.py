...
class Point(Raw, extra="ignore"):
    value: int | float | str = Field(..., alias="VALUE", description='The value of the point', example='1', frozen=True)


class YearlyPoint(Point):
    year: int = Field(..., alias="YEAR", description='The year of the point', example='2024', frozen=True)
...
class MonthlyPoint(Point):
    month: int = Field(..., alias="MONTH", description='The month of the point', example='1', frozen=True)
...
class DailyPoint(Point):
    day: int = Field(..., alias="DAY", description='The day of the point', example='1', frozen=True)
...
class HourlyPoint(Point):
    hour: int = Field(..., alias="HOUR", description='The hour of the point', example='1', frozen=True)
...
class WeeklyPoint(Point):
    week: int = Field(..., alias="WEEK", description='The week of the point', example='1', frozen=True)
