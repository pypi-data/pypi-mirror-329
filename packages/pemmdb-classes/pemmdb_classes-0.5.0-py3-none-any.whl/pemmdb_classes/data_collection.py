...
from . import CurveTable, DataTable
from .classes import get_model_classes
...
class DataCollection:
    ...
    def __init__(self, 
        ...
        for item in config.sheets:
            ...
            logger.debug(f"Adding {item.sheet_type} {table.sheet_name} to the collection (from {self.version_path})")
