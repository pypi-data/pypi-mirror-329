...
class TestCoreV1alpha1Transform(unittest.TestCase):
    """CoreV1alpha1Transform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1alpha1Transform:
        """Test CoreV1alpha1Transform
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1alpha1Transform`
        """
        model = CoreV1alpha1Transform()
        if include_optional:
            return CoreV1alpha1Transform(
                api_version = '',
                kind = '',
                metadata = dasl_api.models.common/v1alpha1/object_meta.common.v1alpha1.ObjectMeta(
                    ...
                    ui_status = '', ),
                spec = dasl_api.models.core/v1alpha1/transform_spec.core.v1alpha1.TransformSpec(
                    schedule = null, 
                    output_table = '', 
    ...
    def testCoreV1alpha1Transform(self):
        """Test CoreV1alpha1Transform"""
