...
class TestCoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner(unittest.TestCase):
    """CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner:
        """Test CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner`
        """
        model = CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner()
        if include_optional:
            return CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner(
    ...
    def testCoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner(self):
        """Test CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesAddTablesInner"""
