...
class TestDbuiV1alpha1TransformRequestTransformsInner(unittest.TestCase):
    """DbuiV1alpha1TransformRequestTransformsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DbuiV1alpha1TransformRequestTransformsInner:
        """Test DbuiV1alpha1TransformRequestTransformsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DbuiV1alpha1TransformRequestTransformsInner`
        """
        model = DbuiV1alpha1TransformRequestTransformsInner()
        if include_optional:
            return DbuiV1alpha1TransformRequestTransformsInner(
    ...
    def testDbuiV1alpha1TransformRequestTransformsInner(self):
        """Test DbuiV1alpha1TransformRequestTransformsInner"""
