...
class TestCoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner(unittest.TestCase):
    """CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner:
        """Test CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner`
        """
        model = CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner()
        if include_optional:
            return CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner(
                name = '',
                source_table = '',
    ...
    def testCoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner(self):
        """Test CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner"""
