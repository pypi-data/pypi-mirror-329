...
class TestCoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner(unittest.TestCase):
    """CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner:
        """Test CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner`
        """
        model = CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner()
        if include_optional:
            return CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner(
                name = '',
    ...
    def testCoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner(self):
        """Test CoreV1alpha1DataSourceSpecSilverTransformPresetOverridesModifyTablesInner"""
