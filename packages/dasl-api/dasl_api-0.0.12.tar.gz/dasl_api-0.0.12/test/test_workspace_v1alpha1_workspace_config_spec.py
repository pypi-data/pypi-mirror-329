...
class TestWorkspaceV1alpha1WorkspaceConfigSpec(unittest.TestCase):
    """WorkspaceV1alpha1WorkspaceConfigSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkspaceV1alpha1WorkspaceConfigSpec:
        """Test WorkspaceV1alpha1WorkspaceConfigSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkspaceV1alpha1WorkspaceConfigSpec`
        """
        model = WorkspaceV1alpha1WorkspaceConfigSpec()
        if include_optional:
            return WorkspaceV1alpha1WorkspaceConfigSpec(
    ...
    def testWorkspaceV1alpha1WorkspaceConfigSpec(self):
        """Test WorkspaceV1alpha1WorkspaceConfigSpec"""
