...
class TestContentV1alpha1DatasourcePresetSilverTransformInner(unittest.TestCase):
    """ContentV1alpha1DatasourcePresetSilverTransformInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentV1alpha1DatasourcePresetSilverTransformInner:
        """Test ContentV1alpha1DatasourcePresetSilverTransformInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentV1alpha1DatasourcePresetSilverTransformInner`
        """
        model = ContentV1alpha1DatasourcePresetSilverTransformInner()
        if include_optional:
            return ContentV1alpha1DatasourcePresetSilverTransformInner(
                name = '',
                filter = '',
                post_filter = '',
                fields = [
    ...
    def testContentV1alpha1DatasourcePresetSilverTransformInner(self):
        """Test ContentV1alpha1DatasourcePresetSilverTransformInner"""
