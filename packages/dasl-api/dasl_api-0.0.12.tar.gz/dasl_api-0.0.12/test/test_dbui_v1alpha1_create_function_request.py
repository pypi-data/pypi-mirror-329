...
class TestDbuiV1alpha1CreateFunctionRequest(unittest.TestCase):
    """DbuiV1alpha1CreateFunctionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DbuiV1alpha1CreateFunctionRequest:
        """Test DbuiV1alpha1CreateFunctionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DbuiV1alpha1CreateFunctionRequest`
        """
        model = DbuiV1alpha1CreateFunctionRequest()
        if include_optional:
            return DbuiV1alpha1CreateFunctionRequest(
                name = '',
                path = '',
                pre_filter = '',
                post_filter = '',
    ...
    def testDbuiV1alpha1CreateFunctionRequest(self):
        """Test DbuiV1alpha1CreateFunctionRequest"""
