...
class TestCoreV1alpha1DataSourceSpecSilverTransform(unittest.TestCase):
    """CoreV1alpha1DataSourceSpecSilverTransform unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1alpha1DataSourceSpecSilverTransform:
        """Test CoreV1alpha1DataSourceSpecSilverTransform
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1alpha1DataSourceSpecSilverTransform`
        """
        model = CoreV1alpha1DataSourceSpecSilverTransform()
        if include_optional:
            return CoreV1alpha1DataSourceSpecSilverTransform(
    ...
    def testCoreV1alpha1DataSourceSpecSilverTransform(self):
        """Test CoreV1alpha1DataSourceSpecSilverTransform"""
