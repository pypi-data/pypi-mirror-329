...
class TestContentV1alpha1DatasourcePresetSilverPreTransformInner(unittest.TestCase):
    """ContentV1alpha1DatasourcePresetSilverPreTransformInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentV1alpha1DatasourcePresetSilverPreTransformInner:
        """Test ContentV1alpha1DatasourcePresetSilverPreTransformInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentV1alpha1DatasourcePresetSilverPreTransformInner`
        """
        model = ContentV1alpha1DatasourcePresetSilverPreTransformInner()
        if include_optional:
            return ContentV1alpha1DatasourcePresetSilverPreTransformInner(
                name = '',
                filter = '',
                post_filter = '',
                fields = [
    ...
    def testContentV1alpha1DatasourcePresetSilverPreTransformInner(self):
        """Test ContentV1alpha1DatasourcePresetSilverPreTransformInner"""
