...
class CoreV1alpha1Rule(BaseModel):
    """
    ...
    spec: CoreV1alpha1RuleSpec = Field(description="The rule configuration.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1Rule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1Rule from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": CoreV1alpha1RuleSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
