...
class CoreV1alpha1PostMetricsRequest(BaseModel):
    """
    CoreV1alpha1PostMetricsRequest
    """ # noqa: E501
    ...
    exec_results: Optional[List[CoreV1alpha1PostMetricsRequestExecResultsInner]] = Field(default=None, alias="execResults")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1PostMetricsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1PostMetricsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "execResults": [CoreV1alpha1PostMetricsRequestExecResultsInner.from_dict(_item) for _item in obj["execResults"]] if obj.get("execResults") is not None else None
        })
        return _obj
