...
class CoreV1alpha1DataSourceSpecSilverBronzeTablesInner(BaseModel):
    """
    CoreV1alpha1DataSourceSpecSilverBronzeTablesInner
    """ # noqa: E501
    ...
    watermark: Optional[CoreV1alpha1DataSourceSpecSilverBronzeTablesInnerWatermark] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceSpecSilverBronzeTablesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceSpecSilverBronzeTablesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "watermark": CoreV1alpha1DataSourceSpecSilverBronzeTablesInnerWatermark.from_dict(obj["watermark"]) if obj.get("watermark") is not None else None,
            "alias": obj.get("alias"),
