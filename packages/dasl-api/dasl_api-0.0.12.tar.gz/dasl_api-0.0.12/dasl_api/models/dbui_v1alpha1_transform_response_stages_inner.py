...
class DbuiV1alpha1TransformResponseStagesInner(BaseModel):
    """
    DbuiV1alpha1TransformResponseStagesInner
    """ # noqa: E501
    transform_type: StrictStr = Field(alias="transformType")
    columns: List[DbuiV1alpha1TableColumnDetails] = Field(description="A list of metadata about the columns returned.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1TransformResponseStagesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1TransformResponseStagesInner from a dict"""
        if obj is None:
            return None
