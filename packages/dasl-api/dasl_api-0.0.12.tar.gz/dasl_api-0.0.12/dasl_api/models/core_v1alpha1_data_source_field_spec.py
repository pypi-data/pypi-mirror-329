...
class CoreV1alpha1DataSourceFieldSpec(BaseModel):
    """
    ...
    var_assert: Optional[List[CoreV1alpha1DataSourceFieldSpecAssertInner]] = Field(default=None, description="A list of SQL expressions that must evaluate to true for every processed row. The name of the column can be used in the SQL expression. If the assertion is false, an operational alert is raised using 'message' for each row. ", alias="assert")
    var_from: Optional[StrictStr] = Field(default=None, description="This field obtains its value from the source column of this names.", alias="from")
    alias: Optional[StrictStr] = Field(default=None, description="This field obtains its value from the destination (transformed) column of this name.")
    ...
    join: Optional[CoreV1alpha1DataSourceFieldSpecJoin] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceFieldSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceFieldSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "assert": [CoreV1alpha1DataSourceFieldSpecAssertInner.from_dict(_item) for _item in obj["assert"]] if obj.get("assert") is not None else None,
            "from": obj.get("from"),
            "alias": obj.get("alias"),
            "expr": obj.get("expr"),
            "literal": obj.get("literal"),
            "join": CoreV1alpha1DataSourceFieldSpecJoin.from_dict(obj["join"]) if obj.get("join") is not None else None
        })
        return _obj
