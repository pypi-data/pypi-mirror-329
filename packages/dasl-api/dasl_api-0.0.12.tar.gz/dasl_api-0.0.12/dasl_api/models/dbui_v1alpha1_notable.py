...
class DbuiV1alpha1Notable(BaseModel):
    """
    DbuiV1alpha1Notable
    """ # noqa: E501
    id: StrictStr
    ...
    rule: Dict[str, Any]
    observables: List[DbuiV1alpha1ObservableInstance]
    collate: DbuiV1alpha1NotableCollate
    __properties: ClassVar[List[str]] = ["id", "summary", "context", "state", "assignedTo", "rule", "observables", "collate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1Notable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1Notable from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rule": obj.get("rule"),
            "observables": [DbuiV1alpha1ObservableInstance.from_dict(_item) for _item in obj["observables"]] if obj.get("observables") is not None else None,
            "collate": DbuiV1alpha1NotableCollate.from_dict(obj["collate"]) if obj.get("collate") is not None else None
        })
        return _obj
