...
class ContentV1alpha1DatasourcePresetSilver(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentV1alpha1DatasourcePresetSilver from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentV1alpha1DatasourcePresetSilver from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "preTransform": [ContentV1alpha1DatasourcePresetSilverPreTransformInner.from_dict(_item) for _item in obj["preTransform"]] if obj.get("preTransform") is not None else None,
            "transform": [ContentV1alpha1DatasourcePresetSilverTransformInner.from_dict(_item) for _item in obj["transform"]] if obj.get("transform") is not None else None
        })
        return _obj
