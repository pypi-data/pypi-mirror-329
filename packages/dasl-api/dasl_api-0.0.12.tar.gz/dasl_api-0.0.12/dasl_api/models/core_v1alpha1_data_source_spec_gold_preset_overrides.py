...
class CoreV1alpha1DataSourceSpecGoldPresetOverrides(BaseModel):
    """
    CoreV1alpha1DataSourceSpecGoldPresetOverrides
    """ # noqa: E501
    omit_tables: Optional[List[StrictStr]] = Field(default=None, alias="omitTables")
    modify_tables: Optional[List[CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner]] = Field(default=None, alias="modifyTables")
    add_tables: Optional[List[CoreV1alpha1DataSourceSpecGoldPresetOverridesAddTablesInner]] = Field(default=None, alias="addTables")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceSpecGoldPresetOverrides from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceSpecGoldPresetOverrides from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "modifyTables": [CoreV1alpha1DataSourceSpecGoldPresetOverridesModifyTablesInner.from_dict(_item) for _item in obj["modifyTables"]] if obj.get("modifyTables") is not None else None,
            "addTables": [CoreV1alpha1DataSourceSpecGoldPresetOverridesAddTablesInner.from_dict(_item) for _item in obj["addTables"]] if obj.get("addTables") is not None else None
        })
        return _obj
