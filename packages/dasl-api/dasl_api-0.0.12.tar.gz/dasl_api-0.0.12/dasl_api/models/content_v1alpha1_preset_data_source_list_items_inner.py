...
class ContentV1alpha1PresetDataSourceListItemsInner(BaseModel):
    """
    ContentV1alpha1PresetDataSourceListItemsInner
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentV1alpha1PresetDataSourceListItemsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentV1alpha1PresetDataSourceListItemsInner from a dict"""
        if obj is None:
            return None
