...
class CoreV1alpha1DataSourceFieldUtilsUnreferencedColumns(BaseModel):
    """
    CoreV1alpha1DataSourceFieldUtilsUnreferencedColumns
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceFieldUtilsUnreferencedColumns from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceFieldUtilsUnreferencedColumns from a dict"""
        if obj is None:
            return None
