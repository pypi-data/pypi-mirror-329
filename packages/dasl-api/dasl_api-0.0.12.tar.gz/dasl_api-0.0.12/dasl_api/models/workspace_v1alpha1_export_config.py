...
class WorkspaceV1alpha1ExportConfig(BaseModel):
    """
    ...
    webhook_config: Optional[WorkspaceV1alpha1ExportConfigWebhookConfig] = Field(default=None, alias="webhookConfig")
    slack_config: Optional[WorkspaceV1alpha1ExportConfigSlackConfig] = Field(default=None, alias="slackConfig")
    __properties: ClassVar[List[str]] = ["destination", "exportOpenOnly", "webhookConfig", "slackConfig"]
    ...
    def destination_validate_enum(cls, value):
        ...
        if value not in set(['webhook', 'slack']):
            raise ValueError("must be one of enum values ('webhook', 'slack')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1ExportConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1ExportConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "webhookConfig": WorkspaceV1alpha1ExportConfigWebhookConfig.from_dict(obj["webhookConfig"]) if obj.get("webhookConfig") is not None else None,
            "slackConfig": WorkspaceV1alpha1ExportConfigSlackConfig.from_dict(obj["slackConfig"]) if obj.get("slackConfig") is not None else None
        })
        return _obj
