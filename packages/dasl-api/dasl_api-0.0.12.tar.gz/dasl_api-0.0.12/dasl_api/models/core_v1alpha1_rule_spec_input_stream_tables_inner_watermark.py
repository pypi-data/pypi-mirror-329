...
class CoreV1alpha1RuleSpecInputStreamTablesInnerWatermark(BaseModel):
    """
    CoreV1alpha1RuleSpecInputStreamTablesInnerWatermark
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecInputStreamTablesInnerWatermark from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecInputStreamTablesInnerWatermark from a dict"""
        if obj is None:
            return None
