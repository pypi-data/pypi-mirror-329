...
class CoreV1alpha1ResourceStatus(BaseModel):
    """
    ...
    events: List[CoreV1alpha1StatusEvent] = Field(description="The most recent 25 events related to this resource.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1ResourceStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1ResourceStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "events": [CoreV1alpha1StatusEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
