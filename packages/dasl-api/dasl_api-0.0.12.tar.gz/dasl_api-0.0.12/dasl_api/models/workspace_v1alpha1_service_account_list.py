...
class WorkspaceV1alpha1ServiceAccountList(BaseModel):
    """
    ...
    items: List[WorkspaceV1alpha1ServiceAccount] = Field(description="A list of ServiceAccounts.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1ServiceAccountList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1ServiceAccountList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [WorkspaceV1alpha1ServiceAccount.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
