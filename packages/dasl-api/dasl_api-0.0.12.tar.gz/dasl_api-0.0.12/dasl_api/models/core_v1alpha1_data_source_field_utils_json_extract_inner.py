...
class CoreV1alpha1DataSourceFieldUtilsJsonExtractInner(BaseModel):
    """
    CoreV1alpha1DataSourceFieldUtilsJsonExtractInner
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceFieldUtilsJsonExtractInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceFieldUtilsJsonExtractInner from a dict"""
        if obj is None:
            return None
