...
class CoreV1alpha1RuleSpecMetadata(BaseModel):
    """
    ...
    mitre: Optional[List[CoreV1alpha1RuleSpecMetadataMitreInner]] = None
    ...
    response: Optional[CoreV1alpha1RuleSpecMetadataResponse] = None
    ...
    def severity_validate_enum(cls, value):
        ...
        if value not in set(['Informational', 'Low', 'Medium', 'High', 'Critical']):
            raise ValueError("must be one of enum values ('Informational', 'Low', 'Medium', 'High', 'Critical')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "mitre": [CoreV1alpha1RuleSpecMetadataMitreInner.from_dict(_item) for _item in obj["mitre"]] if obj.get("mitre") is not None else None,
            "objective": obj.get("objective"),
            "response": CoreV1alpha1RuleSpecMetadataResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
