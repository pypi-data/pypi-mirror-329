...
class DbuiV1alpha1TransformRequestTransformsInner(BaseModel):
    """
    ...
    preset_overrides: Optional[DbuiV1alpha1TransformRequestTransformsInnerPresetOverrides] = Field(default=None, alias="presetOverrides")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1TransformRequestTransformsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1TransformRequestTransformsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "presetOverrides": DbuiV1alpha1TransformRequestTransformsInnerPresetOverrides.from_dict(obj["presetOverrides"]) if obj.get("presetOverrides") is not None else None,
