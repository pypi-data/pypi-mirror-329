...
class CoreV1alpha1DataSourceAutoloaderSpec(BaseModel):
    """
    ...
    cloud_files: Optional[ContentV1alpha1DatasourcePresetAutoloaderCloudFiles] = Field(default=None, alias="cloudFiles")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceAutoloaderSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceAutoloaderSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cloudFiles": ContentV1alpha1DatasourcePresetAutoloaderCloudFiles.from_dict(obj["cloudFiles"]) if obj.get("cloudFiles") is not None else None
        })
        return _obj
