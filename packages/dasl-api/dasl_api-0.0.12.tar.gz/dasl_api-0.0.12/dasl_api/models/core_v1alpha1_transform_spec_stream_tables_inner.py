...
class CoreV1alpha1TransformSpecStreamTablesInner(BaseModel):
    """
    CoreV1alpha1TransformSpecStreamTablesInner
    """ # noqa: E501
    ...
    watermark: Optional[CoreV1alpha1TransformSpecStreamTablesInnerWatermark] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1TransformSpecStreamTablesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1TransformSpecStreamTablesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "watermark": CoreV1alpha1TransformSpecStreamTablesInnerWatermark.from_dict(obj["watermark"]) if obj.get("watermark") is not None else None,
