...
class WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInnerOverridesInner(BaseModel):
    """
    WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInnerOverridesInner
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInnerOverridesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInnerOverridesInner from a dict"""
        if obj is None:
            return None
