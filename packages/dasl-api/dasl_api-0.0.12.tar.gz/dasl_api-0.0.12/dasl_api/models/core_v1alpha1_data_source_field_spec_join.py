...
class CoreV1alpha1DataSourceFieldSpecJoin(BaseModel):
    """
    CoreV1alpha1DataSourceFieldSpecJoin
    """ # noqa: E501
    with_table: Optional[StrictStr] = Field(default=None, description="The table to join to.", alias="withTable")
    with_csv: Optional[CoreV1alpha1DataSourceFieldSpecJoinWithCSV] = Field(default=None, alias="withCSV")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceFieldSpecJoin from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceFieldSpecJoin from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "withCSV": CoreV1alpha1DataSourceFieldSpecJoinWithCSV.from_dict(obj["withCSV"]) if obj.get("withCSV") is not None else None,
            "lhs": obj.get("lhs"),
            "rhs": obj.get("rhs"),
