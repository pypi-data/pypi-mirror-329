...
class CoreV1DataSourceSpecSilver(BaseModel):
    ...
    """ # noqa: E501
    bronze_tables: Optional[List[CoreV1DataSourceSpecSilverBronzeTablesInner]] = Field(default=None, description="A list of bronze tables to be joined together for use by the silver transformation.", alias="bronzeTables")
