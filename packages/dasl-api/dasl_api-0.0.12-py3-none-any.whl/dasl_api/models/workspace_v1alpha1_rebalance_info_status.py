...
class WorkspaceV1alpha1RebalanceInfoStatus(BaseModel):
    """
    WorkspaceV1alpha1RebalanceInfoStatus
    """ # noqa: E501
    ...
    resources: Optional[List[WorkspaceV1alpha1RebalanceInfoStatusResourcesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1RebalanceInfoStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1RebalanceInfoStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "resources": [WorkspaceV1alpha1RebalanceInfoStatusResourcesInner.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
