...
class CoreV1alpha1DataSourceSpecBronze(BaseModel):
    """
    Describes what and how to import the data into a single bronze table.
    """ # noqa: E501
    clustering: Optional[CoreV1alpha1DataSourceSpecBronzeClustering] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceSpecBronze from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceSpecBronze from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "clustering": CoreV1alpha1DataSourceSpecBronzeClustering.from_dict(obj["clustering"]) if obj.get("clustering") is not None else None,
