...
class DbuiV1alpha1PromoteEventRequest(BaseModel):
    """
    DbuiV1alpha1PromoteEventRequest
    """ # noqa: E501
    summary: Optional[StrictStr] = None
    context: Optional[Dict[str, StrictStr]] = None
    state: Optional[StrictStr] = None
    assigned_to: Optional[StrictStr] = Field(default=None, alias="assignedTo")
    observables: Optional[List[DbuiV1alpha1ObservableInstance]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1PromoteEventRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1PromoteEventRequest from a dict"""
        if obj is None:
            return None
