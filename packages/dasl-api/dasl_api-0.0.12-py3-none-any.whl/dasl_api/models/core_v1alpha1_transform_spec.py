...
class CoreV1alpha1TransformSpec(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1TransformSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1TransformSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "stream": CoreV1alpha1TransformSpecStream.from_dict(obj["stream"]) if obj.get("stream") is not None else None
        })
        return _obj
