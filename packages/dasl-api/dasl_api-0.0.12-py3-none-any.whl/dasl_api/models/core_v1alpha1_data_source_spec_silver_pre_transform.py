...
class CoreV1alpha1DataSourceSpecSilverPreTransform(BaseModel):
    """
    ...
    """ # noqa: E501
    use_preset: Optional[StrictStr] = Field(default=None, description="The name of the preset to use for this pretransform. This is often pre-populated when the original  source and sourceType are determined. If `skipPreTransform` is set to true, the subsequent contents of this attribute will be ignored. ", alias="usePreset")
    ...
    custom: Optional[CoreV1alpha1DataSourceSpecSilverPreTransformCustom] = None
    ...
    preset_overrides: Optional[CoreV1alpha1DataSourceSpecSilverPreTransformPresetOverrides] = Field(default=None, alias="presetOverrides")
    add_fields: Optional[List[Optional[CoreV1alpha1DataSourceFieldSpec]]] = Field(default=None, description="User defined fields to add to the data transformation. These fields can be derived from  existing fields, an expression, from a literal value, from a join, etc. ", alias="addFields")
    utils: Optional[CoreV1alpha1DataSourceFieldUtils] = Field(default=None, description="A list of utilities for handling fields, including managing unreferenced fields and extracting fields  from hierarchical or JSON objects. Supplying a FieldUtils object here will override the FieldUtil in the preset. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceSpecSilverPreTransform from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1DataSourceSpecSilverPreTransform from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "custom": CoreV1alpha1DataSourceSpecSilverPreTransformCustom.from_dict(obj["custom"]) if obj.get("custom") is not None else None,
            "filter": obj.get("filter"),
            "postFilter": obj.get("postFilter"),
            "presetOverrides": CoreV1alpha1DataSourceSpecSilverPreTransformPresetOverrides.from_dict(obj["presetOverrides"]) if obj.get("presetOverrides") is not None else None,
            ...
            "utils": CoreV1alpha1DataSourceFieldUtils.from_dict(obj["utils"]) if obj.get("utils") is not None else None
        })
        return _obj
