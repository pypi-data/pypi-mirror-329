...
class DbuiV1alpha1DataSourceSummaryListDataSourcesInnerAlerts(BaseModel):
    """
    DbuiV1alpha1DataSourceSummaryListDataSourcesInnerAlerts
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1DataSourceSummaryListDataSourcesInnerAlerts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1DataSourceSummaryListDataSourcesInnerAlerts from a dict"""
        if obj is None:
            return None
