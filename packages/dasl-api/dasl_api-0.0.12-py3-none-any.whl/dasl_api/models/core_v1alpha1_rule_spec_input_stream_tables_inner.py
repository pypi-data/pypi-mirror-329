...
class CoreV1alpha1RuleSpecInputStreamTablesInner(BaseModel):
    """
    CoreV1alpha1RuleSpecInputStreamTablesInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    watermark: Optional[CoreV1alpha1RuleSpecInputStreamTablesInnerWatermark] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecInputStreamTablesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecInputStreamTablesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "watermark": CoreV1alpha1RuleSpecInputStreamTablesInnerWatermark.from_dict(obj["watermark"]) if obj.get("watermark") is not None else None,
            "alias": obj.get("alias"),
