...
class WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInner(BaseModel):
    """
    ...
    overrides: Optional[List[WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInnerOverridesInner]] = Field(default=None, description="Per table retention management configuration.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "overrides": [WorkspaceV1alpha1WorkspaceConfigSpecManagedRetentionInnerOverridesInner.from_dict(_item) for _item in obj["overrides"]] if obj.get("overrides") is not None else None
        })
        return _obj
