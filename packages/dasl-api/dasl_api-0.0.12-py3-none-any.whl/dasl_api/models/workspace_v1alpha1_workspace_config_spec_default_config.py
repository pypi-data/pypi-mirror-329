...
class WorkspaceV1alpha1WorkspaceConfigSpecDefaultConfig(BaseModel):
    """
    Configuration per resource type.
    """ # noqa: E501
    datasources: Optional[WorkspaceV1alpha1DefaultConfig] = None
    transforms: Optional[WorkspaceV1alpha1DefaultConfig] = None
    rules: Optional[WorkspaceV1alpha1DefaultConfig] = None
    var_global: Optional[WorkspaceV1alpha1DefaultConfig] = Field(default=None, alias="global")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1WorkspaceConfigSpecDefaultConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1alpha1WorkspaceConfigSpecDefaultConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "datasources": WorkspaceV1alpha1DefaultConfig.from_dict(obj["datasources"]) if obj.get("datasources") is not None else None,
            "transforms": WorkspaceV1alpha1DefaultConfig.from_dict(obj["transforms"]) if obj.get("transforms") is not None else None,
            "rules": WorkspaceV1alpha1DefaultConfig.from_dict(obj["rules"]) if obj.get("rules") is not None else None,
            "global": WorkspaceV1alpha1DefaultConfig.from_dict(obj["global"]) if obj.get("global") is not None else None
        })
        return _obj
