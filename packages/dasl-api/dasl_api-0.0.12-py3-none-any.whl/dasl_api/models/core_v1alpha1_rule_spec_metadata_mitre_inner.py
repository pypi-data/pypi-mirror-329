...
class CoreV1alpha1RuleSpecMetadataMitreInner(BaseModel):
    """
    CoreV1alpha1RuleSpecMetadataMitreInner
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecMetadataMitreInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1alpha1RuleSpecMetadataMitreInner from a dict"""
        if obj is None:
            return None
