...
class ContentV1alpha1DatasourcePreset(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentV1alpha1DatasourcePreset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentV1alpha1DatasourcePreset from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "autoloader": ContentV1alpha1DatasourcePresetAutoloader.from_dict(obj["autoloader"]) if obj.get("autoloader") is not None else None,
            "silver": ContentV1alpha1DatasourcePresetSilver.from_dict(obj["silver"]) if obj.get("silver") is not None else None,
            "gold": [ContentV1alpha1DatasourcePresetGoldInner.from_dict(_item) for _item in obj["gold"]] if obj.get("gold") is not None else None
        })
        return _obj
