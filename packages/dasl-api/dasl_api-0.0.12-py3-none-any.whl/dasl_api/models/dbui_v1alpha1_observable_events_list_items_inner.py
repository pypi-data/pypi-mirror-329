...
class DbuiV1alpha1ObservableEventsListItemsInner(BaseModel):
    """
    DbuiV1alpha1ObservableEventsListItemsInner
    """ # noqa: E501
    ...
    notable: Optional[DbuiV1alpha1ObservableEventsListItemsInnerNotable] = None
    ...
    def var_from_validate_enum(cls, value):
        ...
        if value not in set(['notable', 'manual']):
            raise ValueError("must be one of enum values ('notable', 'manual')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1ObservableEventsListItemsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1alpha1ObservableEventsListItemsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "notable": DbuiV1alpha1ObservableEventsListItemsInnerNotable.from_dict(obj["notable"]) if obj.get("notable") is not None else None
        })
        return _obj
