...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-codecatalyst)](https://pypistats.org/packages/mypy-boto3-codecatalyst)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 CodeCatalyst 1.37.0](https://pypi.org/project/boto3/) compatible with
...
`mypy-boto3-codecatalyst` dependency in production. However, there is an issue
