...
class Database:
    ...
    @__db_operation
    def select(self, cursor:Cursor, table_name:str=None, cols='*', where:str = None, order_by:str = None, distinct:bool = False):
    ...
    @__db_operation
    def insert(self, cursor:Cursor, table_name:str=None, dict_data:dict=None):
        ...
        table_columns = list(cursor.columns(table=table_name).keys())
        filtered_dict_data = {}
    ...
    @__db_operation
    def get_definition(self, cursor:Cursor, table_name:str=None, schema_name:str='dbo') -> dict:
