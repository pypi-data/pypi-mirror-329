...
class Tree:
    ...
    def _setup_logging(self, log_dir: str = conf.LOG_DIR, log_level: int = logging.INFO, 
...
class MultiTree:
    ...
    def _setup_logging(self, log_dir: str = conf.LOG_DIR, log_level: int = logging.INFO, log_format: str = '%(asctime)s - %(levelname)s - %(message)s'):
        """
