...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in openfl/protocols/director_pb2_grpc.py depends on'
...
class DirectorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetExperimentStatus = channel.unary_unary(
                '/openfl.director.Director/GetExperimentStatus',
                request_serializer=openfl_dot_protocols_dot_director__pb2.GetExperimentStatusRequest.SerializeToString,
                response_deserializer=openfl_dot_protocols_dot_director__pb2.GetExperimentStatusResponse.FromString,
                _registered_method=True)
...
def add_DirectorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetExperimentStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=openfl_dot_protocols_dot_director__pb2.GetExperimentStatusRequest.FromString,
                    response_serializer=openfl_dot_protocols_dot_director__pb2.GetExperimentStatusResponse.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('openfl.director.Director', rpc_method_handlers)
...
class Director(object):
    ...
    def GetExperimentStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/openfl.director.Director/GetExperimentStatus',
            openfl_dot_protocols_dot_director__pb2.GetExperimentStatusRequest.SerializeToString,
            openfl_dot_protocols_dot_director__pb2.GetExperimentStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
