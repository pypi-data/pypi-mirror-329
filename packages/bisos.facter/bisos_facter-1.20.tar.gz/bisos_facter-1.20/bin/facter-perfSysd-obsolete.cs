...
** This File: /bisos/git/auth/bxRepos/bisos-pip/facter/py3/bin/facterDaemonSysd.cs
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['facterDaemonSysd'], }
csInfo['version'] = '202305114317'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'facterDaemonSysd-Panel.org'
...
from bisos.facter import facterPerfSysd
...
sysdConfigFacter = facterPerfSysd.sysdConfigFacter
sysdUnitFacter = facterPerfSysd.sysdUnitFacter
...
(setq  b:py:cs:csuList
  (list
   ...
   "bisos.facter.facterPerfSysd"
 ))
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.b.clsMethod_csu | bisos.debian.configFile | bisos.debian.bifSystemd | bisos.facter.facterPerfSysd |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.b.clsMethod_csu', 'bisos.debian.configFile', 'bisos.debian.bifSystemd', 'bisos.facter.facterPerfSysd', ]
...
####+END:
        ...
        facterPerfSysd.examples_csu(sectionTitle="default")
