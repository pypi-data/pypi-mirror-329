...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-ec2-instance-connect)](https://pypistats.org/packages/mypy-boto3-ec2-instance-connect)
...
`mypy-boto3-ec2-instance-connect` dependency in production. However, there is
