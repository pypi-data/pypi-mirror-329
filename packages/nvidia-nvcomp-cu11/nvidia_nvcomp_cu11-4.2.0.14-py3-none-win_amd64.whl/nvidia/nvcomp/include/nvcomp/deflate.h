 ...
 * batch.
 * @param[in] format_opts The Deflate compression options to use.
 ...
 */
const nvcompAlignmentRequirements_t nvcompBatchedDeflateDecompressRequiredAlignments = {
 ...
 * `nvcompBatchedDeflateDecompressRequiredAlignments.input`.
 ...
 * below may result in undefined behaviour.
 *
 * @note In the case where a chunk of compressed data is not a valid Deflate
 ...
 * Must be aligned to the value in `nvcompBatchedDeflateDecompressRequiredAlignments.temp`.
 ...
 * `nvcompBatchedDeflateDecompressRequiredAlignments.output`.
