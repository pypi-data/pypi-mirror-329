<a id="types-boto3-neptune"></a>

# types-boto3-neptune

[![PyPI - types-boto3-neptune](https://img.shields.io/pypi/v/types-boto3-neptune.svg?color=blue)](https://pypi.org/project/types-boto3-neptune/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-neptune.svg?color=blue)](https://pypi.org/project/types-boto3-neptune/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-neptune)](https://pypistats.org/packages/types-boto3-neptune)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 Neptune 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-neptune docs](https://youtype.github.io/types_boto3_docs/types_boto3_neptune/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-neptune](#types-boto3-neptune)
...
- Install `types-boto3[neptune]` in your environment:
...
- Install `types-boto3[neptune]` with services you use in your environment:
...
`types-boto3-neptune` dependency in production. However, there is an issue in
...
from types_boto3_neptune import NeptuneClient
...
`types_boto3_neptune.paginator` module contains type annotations for all
paginators.
...
`types_boto3_neptune.waiter` module contains type annotations for all waiters.

```python
from boto3.session import Session

from types_boto3_neptune import NeptuneClient
from types_boto3_neptune.waiter import DBInstanceAvailableWaiter, DBInstanceDeletedWaiter
...
`types_boto3_neptune.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `Neptune` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_neptune/literals/).
...
`types_boto3_neptune.type_defs` module contains structures and shapes assembled
to typed dictionaries and unions for additional type checking.

Full list of `Neptune` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_neptune/type_defs/).
...
`types-boto3-neptune` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_neptune/)
