...
class SubscribeType(Enum):
    ...
    K_MINUTE_5 = 'K_MINUTE_5'
    K_MINUTE_15 = 'K_MINUTE_15'
    K_MINUTE_30 = 'K_MINUTE_30'
...
COLUMN2INDICATOR: dict = {
    IndicatorColumn.TICKPRICE: Indicator.TICK,
...
INTERVAL2SUBSCRIBE_TYPE = {
    ...
    Interval.MINUTE_5: SubscribeType.K_MINUTE_5,
    Interval.MINUTE_15: SubscribeType.K_MINUTE_15,
    Interval.MINUTE_30: SubscribeType.K_MINUTE_30
}

INTERVAL2SUBSCRIBE_TYPE = {v:k for k,v in INTERVAL2SUBSCRIBE_TYPE.items()}
...
class PositionStrategy(Enum):
    BASE_POSITION_STRATEGY = '基础数量'
    GRID_POSITION_STRATEGY = '网格'

POSITION_STRATEGY_MAP = enum_map(PositionStrategy)

class ExecuteStrategy(Enum):
    BASE_EXECUTE_STRATEGY = '市价/限价'
    CONDITION_EXECUTE_STRATEGY = '条件'
