...
class SessionMonitoringResponse(object):
    """
    Attributes:
     - sessionId
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('SessionMonitoringResponse')
...
all_structs.append(SessionMonitoringResponse)
SessionMonitoringResponse.thrift_spec = (
    None,  # 0
