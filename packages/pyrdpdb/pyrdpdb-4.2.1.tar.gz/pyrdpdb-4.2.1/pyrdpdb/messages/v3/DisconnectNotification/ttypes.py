...
class DisconnectNotification(object):
    """
    Attributes:
     - reason
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('DisconnectNotification')
...
all_structs.append(DisconnectNotification)
DisconnectNotification.thrift_spec = (
    None,  # 0
