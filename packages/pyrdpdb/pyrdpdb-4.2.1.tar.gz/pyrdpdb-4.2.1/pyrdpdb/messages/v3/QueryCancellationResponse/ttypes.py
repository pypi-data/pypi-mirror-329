...
class QueryCancellationResponse(object):
    """
    Attributes:
     - queryId
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('QueryCancellationResponse')
...
all_structs.append(QueryCancellationResponse)
QueryCancellationResponse.thrift_spec = (
    None,  # 0
