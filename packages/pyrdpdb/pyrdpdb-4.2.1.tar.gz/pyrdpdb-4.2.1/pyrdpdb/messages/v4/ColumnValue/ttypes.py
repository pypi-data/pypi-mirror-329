...
class Timestamp(object):
    ...
    def __init__(self, year=None, month=None, day=None, hour=None, minute=None, second=None, nanoseconds=None, offsetHours=None, offsetMinutes=None, tzName=None,):
        self.year = year
        self.month = month
        self.day = day
        self.hour = hour
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BYTE:
                    self.offsetHours = iprot.readByte()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.BYTE:
                    self.offsetMinutes = iprot.readByte()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.STRING:
                    self.tzName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.nanoseconds is not None:
            ...
            oprot.writeFieldEnd()
        if self.offsetHours is not None:
            oprot.writeFieldBegin('offsetHours', TType.BYTE, 8)
            oprot.writeByte(self.offsetHours)
            oprot.writeFieldEnd()
        if self.offsetMinutes is not None:
            oprot.writeFieldBegin('offsetMinutes', TType.BYTE, 9)
            oprot.writeByte(self.offsetMinutes)
            oprot.writeFieldEnd()
        if self.tzName is not None:
            oprot.writeFieldBegin('tzName', TType.STRING, 10)
            oprot.writeString(self.tzName.encode('utf-8') if sys.version_info[0] == 2 else self.tzName)
            oprot.writeFieldEnd()
...
class Date(object):
    ...
    def __init__(self, year=None, month=None, day=None, offsetHours=None, offsetMinutes=None, tzName=None,):
        self.year = year
        self.month = month
        self.day = day
        self.offsetHours = offsetHours
    ...
    def write(self, oprot):
        ...
        if self.day is not None:
            ...
            oprot.writeFieldEnd()
        if self.offsetHours is not None:
            oprot.writeFieldBegin('offsetHours', TType.BYTE, 4)
            oprot.writeByte(self.offsetHours)
            oprot.writeFieldEnd()
        if self.offsetMinutes is not None:
            oprot.writeFieldBegin('offsetMinutes', TType.BYTE, 5)
            oprot.writeByte(self.offsetMinutes)
            oprot.writeFieldEnd()
        if self.tzName is not None:
            oprot.writeFieldBegin('tzName', TType.STRING, 6)
            oprot.writeString(self.tzName.encode('utf-8') if sys.version_info[0] == 2 else self.tzName)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class Time(object):
    ...
    def __init__(self, hour=None, minute=None, second=None, nanoseconds=None, offsetHours=None, offsetMinutes=None, tzName=None,):
        self.hour = hour
        self.minute = minute
        self.second = second
        self.nanoseconds = nanoseconds
    ...
    def write(self, oprot):
        ...
        if self.second is not None:
            ...
            oprot.writeFieldEnd()
        if self.nanoseconds is not None:
            oprot.writeFieldBegin('nanoseconds', TType.I32, 4)
            oprot.writeI32(self.nanoseconds)
            oprot.writeFieldEnd()
        if self.offsetHours is not None:
            oprot.writeFieldBegin('offsetHours', TType.BYTE, 5)
            oprot.writeByte(self.offsetHours)
            oprot.writeFieldEnd()
        if self.offsetMinutes is not None:
            oprot.writeFieldBegin('offsetMinutes', TType.BYTE, 6)
            oprot.writeByte(self.offsetMinutes)
            oprot.writeFieldEnd()
        if self.tzName is not None:
            oprot.writeFieldBegin('tzName', TType.STRING, 7)
            oprot.writeString(self.tzName.encode('utf-8') if sys.version_info[0] == 2 else self.tzName)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ColumnValue(object):
    ...
    def __init__(self, isNull=None, booleanVal=None, tinyIntVal=None, smallIntVal=None, integerVal=None, bigintVal=None, doubleVal=None, bigDecimalVal=None, timestampVal=None, timeVal=None, dateVal=None, intervalVal=None, stringVal=None, binaryVal=None,):
        self.isNull = isNull
    ...
    def write(self, oprot):
        ...
        if self.timeVal is not None:
            oprot.writeFieldBegin('timeVal', TType.STRUCT, 10)
            self.timeVal.write(oprot)
            oprot.writeFieldEnd()
        if self.dateVal is not None:
            oprot.writeFieldBegin('dateVal', TType.STRUCT, 11)
            self.dateVal.write(oprot)
            oprot.writeFieldEnd()
...
Timestamp.thrift_spec = (
    ...
    (8, TType.BYTE, 'offsetHours', None, None, ),  # 8
    (9, TType.BYTE, 'offsetMinutes', None, None, ),  # 9
    (10, TType.STRING, 'tzName', 'UTF8', None, ),  # 10
)
...
Date.thrift_spec = (
    ...
    (2, TType.I16, 'month', None, None, ),  # 2
    (3, TType.I16, 'day', None, None, ),  # 3
    (4, TType.BYTE, 'offsetHours', None, None, ),  # 4
    (5, TType.BYTE, 'offsetMinutes', None, None, ),  # 5
    (6, TType.STRING, 'tzName', 'UTF8', None, ),  # 6
)
...
Time.thrift_spec = (
    ...
    (4, TType.I32, 'nanoseconds', None, None, ),  # 4
    (5, TType.BYTE, 'offsetHours', None, None, ),  # 5
    (6, TType.BYTE, 'offsetMinutes', None, None, ),  # 6
    (7, TType.STRING, 'tzName', 'UTF8', None, ),  # 7
)
...
ColumnValue.thrift_spec = (
    ...
    (10, TType.STRUCT, 'timeVal', [Time, None], None, ),  # 10
    (11, TType.STRUCT, 'dateVal', [Date, None], None, ),  # 11
