...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-groundstation)](https://pypistats.org/packages/mypy-boto3-groundstation)
...
`mypy-boto3-groundstation` dependency in production. However, there is an issue
