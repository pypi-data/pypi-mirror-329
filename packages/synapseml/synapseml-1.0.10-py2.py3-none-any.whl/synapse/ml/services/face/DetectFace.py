...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectFace_3219cb865032_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_3219cb865032_output",
        ...
        self._setDefault(errorCol="DetectFace_3219cb865032_error")
        self._setDefault(outputCol="DetectFace_3219cb865032_output")
