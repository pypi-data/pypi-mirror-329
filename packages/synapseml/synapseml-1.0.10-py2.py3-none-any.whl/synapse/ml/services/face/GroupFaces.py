...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GroupFaces_0b44468c0a7d_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_0b44468c0a7d_output",
        ...
        self._setDefault(errorCol="GroupFaces_0b44468c0a7d_error")
        self._setDefault(outputCol="GroupFaces_0b44468c0a7d_output")
