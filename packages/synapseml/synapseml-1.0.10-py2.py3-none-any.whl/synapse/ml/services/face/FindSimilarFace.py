...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="FindSimilarFace_1c40143bd260_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_1c40143bd260_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_1c40143bd260_error")
        self._setDefault(outputCol="FindSimilarFace_1c40143bd260_output")
