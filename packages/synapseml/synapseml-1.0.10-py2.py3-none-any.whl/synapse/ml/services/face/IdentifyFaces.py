...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="IdentifyFaces_fc2608ccffc7_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_fc2608ccffc7_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_fc2608ccffc7_error")
        self._setDefault(outputCol="IdentifyFaces_fc2608ccffc7_output")
