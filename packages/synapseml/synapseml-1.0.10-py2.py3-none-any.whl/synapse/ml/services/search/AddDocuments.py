...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AddDocuments_c861b61b2c87_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_c861b61b2c87_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_c861b61b2c87_error")
        self._setDefault(outputCol="AddDocuments_c861b61b2c87_output")
