...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_061dc2c4955e_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_061dc2c4955e_output",
        ...
        self._setDefault(errorCol="Transliterate_061dc2c4955e_error")
        self._setDefault(outputCol="Transliterate_061dc2c4955e_output")
