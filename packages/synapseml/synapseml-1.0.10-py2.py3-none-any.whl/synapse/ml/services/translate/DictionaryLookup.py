...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryLookup_cfe5c3c0aae8_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_cfe5c3c0aae8_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_cfe5c3c0aae8_error")
        self._setDefault(outputCol="DictionaryLookup_cfe5c3c0aae8_output")
