...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_27fc5c9037cf_error",
        handler=None,
        outputCol="Detect_27fc5c9037cf_output",
        ...
        self._setDefault(errorCol="Detect_27fc5c9037cf_error")
        self._setDefault(outputCol="Detect_27fc5c9037cf_output")
