...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_bdd903cf001b_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_bdd903cf001b_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_bdd903cf001b_error")
        self._setDefault(outputCol="DictionaryExamples_bdd903cf001b_output")
