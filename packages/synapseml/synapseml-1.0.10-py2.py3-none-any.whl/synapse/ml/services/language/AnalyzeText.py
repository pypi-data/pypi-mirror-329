...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_7a0f5856f1c5_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_7a0f5856f1c5_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_7a0f5856f1c5_error")
        self._setDefault(outputCol="AnalyzeText_7a0f5856f1c5_output")
