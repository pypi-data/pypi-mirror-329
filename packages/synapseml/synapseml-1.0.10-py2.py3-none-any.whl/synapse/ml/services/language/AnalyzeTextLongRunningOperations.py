...
class AnalyzeTextLongRunningOperations(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeTextLongRunningOperations_4084f1b4c7e9_error",
        ...
        outputCol="AnalyzeTextLongRunningOperations_4084f1b4c7e9_output",
        overlapPolicy=None,
        ...
        self._setDefault(errorCol="AnalyzeTextLongRunningOperations_4084f1b4c7e9_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeTextLongRunningOperations_4084f1b4c7e9_output")
