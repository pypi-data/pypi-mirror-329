...
class _BingImageSearch(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="BingImageSearch_c8e64be6f2f6_error",
        freshness=None,
        freshnessCol=None,
        handler=None,
        height=None,
        ...
        offset=None,
        offsetCol=None,
        outputCol="BingImageSearch_c8e64be6f2f6_output",
        q=None,
        qCol=None,
        size=None,
        sizeCol=None,
        ...
        self._setDefault(errorCol="BingImageSearch_c8e64be6f2f6_error")
        self._setDefault(outputCol="BingImageSearch_c8e64be6f2f6_output")
