...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_6b30399a3340_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_6b30399a3340_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_6b30399a3340_error")
        self._setDefault(outputCol="CheckPointInPolygon_6b30399a3340_output")
