...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_56c7e0e9f783_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_56c7e0e9f783_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_56c7e0e9f783_error")
        self._setDefault(outputCol="SpeakerEmotionInference_56c7e0e9f783_output")
