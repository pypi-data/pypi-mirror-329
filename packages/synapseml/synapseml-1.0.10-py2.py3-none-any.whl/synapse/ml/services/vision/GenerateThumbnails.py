...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GenerateThumbnails_8091fd64615c_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_8091fd64615c_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_8091fd64615c_error")
        self._setDefault(outputCol="GenerateThumbnails_8091fd64615c_output")
