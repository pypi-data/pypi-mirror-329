...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DescribeImage_24ddcfc637fd_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_24ddcfc637fd_output",
        ...
        self._setDefault(errorCol="DescribeImage_24ddcfc637fd_error")
        self._setDefault(outputCol="DescribeImage_24ddcfc637fd_output")
