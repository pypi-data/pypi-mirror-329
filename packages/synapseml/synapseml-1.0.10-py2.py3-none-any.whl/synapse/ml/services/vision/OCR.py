...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_cff329a8310a_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_cff329a8310a_output",
        ...
        self._setDefault(errorCol="OCR_cff329a8310a_error")
        self._setDefault(outputCol="OCR_cff329a8310a_output")
