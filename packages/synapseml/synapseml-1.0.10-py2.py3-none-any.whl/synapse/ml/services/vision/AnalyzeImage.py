...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_bb3bb1440b39_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_bb3bb1440b39_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_bb3bb1440b39_error")
        self._setDefault(outputCol="AnalyzeImage_bb3bb1440b39_output")
