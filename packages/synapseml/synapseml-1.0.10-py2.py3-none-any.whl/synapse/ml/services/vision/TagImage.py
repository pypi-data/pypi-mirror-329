...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="TagImage_9aa417c85eb7_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_9aa417c85eb7_output",
        ...
        self._setDefault(errorCol="TagImage_9aa417c85eb7_error")
        self._setDefault(outputCol="TagImage_9aa417c85eb7_output")
