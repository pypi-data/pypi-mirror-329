...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        dimensions=None,
        dimensionsCol=None,
        errorCol="OpenAIEmbedding_1de6b10f3171_error",
        handler=None,
        outputCol="OpenAIEmbedding_1de6b10f3171_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_1de6b10f3171_error")
        self._setDefault(outputCol="OpenAIEmbedding_1de6b10f3171_output")
