...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_6b1cff54bfe2_error",
        ...
        maxTokens=None,
        maxTokensCol=None,
        messagesCol="OpenAIPrompt_6b1cff54bfe2_messages",
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_6b1cff54bfe2_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_6b1cff54bfe2_error")
        self._setDefault(messagesCol="OpenAIPrompt_6b1cff54bfe2_messages")
        self._setDefault(outputCol="OpenAIPrompt_6b1cff54bfe2_output")
