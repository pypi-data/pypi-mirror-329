...
class DetectLastMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectLastMultivariateAnomaly_e5cd896b5237_error",
        handler=None,
        inputVariablesCols=None,
        modelId=None,
        outputCol="DetectLastMultivariateAnomaly_e5cd896b5237_output",
        ...
        self._setDefault(errorCol="DetectLastMultivariateAnomaly_e5cd896b5237_error")
        self._setDefault(outputCol="DetectLastMultivariateAnomaly_e5cd896b5237_output")
