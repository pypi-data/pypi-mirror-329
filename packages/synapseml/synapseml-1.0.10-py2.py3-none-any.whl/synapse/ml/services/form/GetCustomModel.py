...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_3ebf11c9d5a2_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_3ebf11c9d5a2_output",
        ...
        self._setDefault(errorCol="GetCustomModel_3ebf11c9d5a2_error")
        self._setDefault(outputCol="GetCustomModel_3ebf11c9d5a2_output")
