...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_fa497b2f9e12_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_fa497b2f9e12_output",
        ...
        self._setDefault(errorCol="ListCustomModels_fa497b2f9e12_error")
        self._setDefault(outputCol="ListCustomModels_fa497b2f9e12_output")
