...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_87cecfcd02d3_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_87cecfcd02d3_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_87cecfcd02d3_error")
        self._setDefault(outputCol="PII_87cecfcd02d3_output")
