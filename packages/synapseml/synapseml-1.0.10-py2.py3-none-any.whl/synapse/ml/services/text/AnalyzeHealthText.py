...
class AnalyzeHealthText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeHealthText_c3e13c02c7ef_error",
        ...
        outputCol="AnalyzeHealthText_c3e13c02c7ef_output",
        pollingDelay=300,
        showStats=None,
        showStatsCol=None,
        ...
        self._setDefault(errorCol="AnalyzeHealthText_c3e13c02c7ef_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeHealthText_c3e13c02c7ef_output")
