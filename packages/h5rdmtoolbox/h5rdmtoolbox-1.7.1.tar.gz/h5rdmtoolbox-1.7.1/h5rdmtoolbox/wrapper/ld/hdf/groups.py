...
def process_group(group, graph, parent_uri, blank_node_iri_base: Optional[str] = None):
    ...
    for name, item in group.items():
        ...
        if isinstance(item, h5py.Group):
            ...
            process_dataset(item, graph, group_uri, item_uri, blank_node_iri_base=blank_node_iri_base)
