...
from mlgb.tf.components.linears import TaskLayer
from mlgb.tf.modules.ranking.normal import (
...
from mlgb.tf.modules.ranking.sequential import (
...
class LR(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None, 
                 inputs_if_multivalued=False, inputs_if_sequential=False, inputs_if_embed_dense=False,
                 embed_dim=32, embed_2d_dim=None, embed_l2=0.0, embed_initializer=None,
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 linear_if_bias=True, linear_l1=0.0, linear_l2=0.0, linear_initializer=None,
                 ):
        """
        ...
        Task Model Parameters:
            ...
            :param linear_initializer: Optional[str], default None. When None, activation judge first, he_uniform end.
        """
        super().__init__()
...
class MaskNet(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param block_l2: float, default 0.0.
...
class DCN(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param dcn_l2: float, default 0.0.
...
class EDCN(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param rgl_l2: float, default 0.0.
            :param dcn_version: str, default 'v2'. Union['v1', 'v2']
            :param dcn_l2: float, default 0.0.
            :param dcn_initializer: Optional[str], default None. When None, activation judge first, he_uniform end.
            :param dnn_activation: Optional[str], default 'relu'.
...
class FMs(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
                 inputs_if_multivalued=False, inputs_if_sequential=False, inputs_if_embed_dense=False,
                 embed_dim=32, embed_2d_dim=None, embed_l2=0.0, embed_initializer=None,
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 fbi_mode='FM', fbi_unit=32, fbi_l2=0.0, fbi_initializer=None,
...
class FM(FMs):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param fbi_l2: float, default 0.0.
        ...
        super().__init__(
            ...
            embed_dim, embed_2d_dim, embed_l2, embed_initializer,
...
class FFM(FMs):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 fbi_mode='FFM', fbi_unit=32, fbi_l2=0.0, fbi_initializer=None,
                 linear_l1=0.0, linear_l2=0.0, linear_initializer=None,
                 ):
        """
...
class HOFM(FMs):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 fbi_mode='HOFM', fbi_unit=32, fbi_l2=0.0, fbi_initializer=None,
                 fbi_hofm_order=3,
                 linear_l1=0.0, linear_l2=0.0, linear_initializer=None,
                 ):
        """
...
class FwFM(FMs):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 fbi_mode='FwFM', fbi_unit=32, fbi_l2=0.0, fbi_initializer=None,
                 linear_l1=0.0, linear_l2=0.0, linear_initializer=None,
                 ):
        """
...
class FEFM(FMs):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 fbi_mode='FEFM', fbi_unit=32, fbi_l2=0.0, fbi_initializer=None,
                 linear_l1=0.0, linear_l2=0.0, linear_initializer=None,
                 ):
        """
...
class FmFM(FMs):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 fbi_mode='FmFM', fbi_unit=32, fbi_l2=0.0, fbi_initializer=None,
                 linear_l1=0.0, linear_l2=0.0, linear_initializer=None,
                 ):
        """
...
class AFM(FMs):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 fbi_mode='AFM', fbi_unit=32, fbi_l2=0.0, fbi_initializer=None,
...
class LFM(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 lfm_beta=1.0, fbi_l2=0.0, fbi_initializer=None,
                 ):
        """
...
class IMs(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
                 inputs_if_multivalued=False, inputs_if_sequential=False, inputs_if_embed_dense=False,
                 embed_dim=32, embed_2d_dim=None, embed_l2=0.0, embed_initializer=None,
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 im_mode='IM', im_order=3, im_l2=0.0, im_initializer=None,
                 dnn_hidden_units=(64, 32), dnn_activation='relu', dnn_dropout=0.0, dnn_if_bn=False, dnn_if_ln=False,
                 dnn_l2=0.0, dnn_initializer=None,
                 ):
        super().__init__()
...
class IM(IMs):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 im_order=3, im_l2=0.0, im_initializer=None,
                 ):
        """
        ...
        super().__init__(
            ...
            pool_mv_mode, pool_mv_axis, pool_mv_l2, pool_mv_initializer,
            pool_seq_mode, pool_seq_axis, pool_seq_l2, pool_seq_initializer,
            'IM', im_order, im_l2, im_initializer,
...
class DeepIM(IMs):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        super().__init__(
            ...
            pool_mv_mode, pool_mv_axis, pool_mv_l2, pool_mv_initializer,
            pool_seq_mode, pool_seq_axis, pool_seq_l2, pool_seq_initializer,
            'DeepIM', im_order, im_l2, im_initializer,
            dnn_hidden_units, dnn_activation, dnn_dropout, dnn_if_bn, dnn_if_ln,
            dnn_l2, dnn_initializer,
        )


class IFMs(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
                 inputs_if_multivalued=False, inputs_if_sequential=False, inputs_if_embed_dense=False,
                 embed_dim=32, embed_2d_dim=None, embed_l2=0.0, embed_initializer=None,
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
        ...
        self.ifm_fn = AllInputFactorizationMachineLayer(
            ...
            fen_if_ln=fen_if_ln, 
            fen_l2=fen_l2, 
            fen_initializer=fen_initializer, 
...
class IFM(IFMs):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param fen_l2: float, default 0.0.
            :param fen_initializer: Optional[str], default None. When None, activation judge first, he_uniform end.
        """
        super().__init__(
            feature_names, task, seed, 
            inputs_if_multivalued, inputs_if_sequential, inputs_if_embed_dense, 
...
class DIFM(IFMs):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param trm_mha_l2: float, default 0.0.
...
class PNN(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 fbi_mode='PNN:both', fbi_l2=0.0, fbi_initializer=None,
                 fbi_hofm_order=3, fbi_afm_activation='relu', fbi_afm_dropout=0.0,
                 linear_l1=0.0, linear_l2=0.0, linear_initializer=None,
                 dnn_hidden_units=(64, 32), dnn_activation='relu', dnn_dropout=0.0, dnn_if_bn=False, dnn_if_ln=False,
                 dnn_l2=0.0, dnn_initializer=None,
...
class AFN(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param ltl_l2: float, default 0.0.
            ...
            :param ensemble_dnn_l2: float, default 0.0.
            :param ensemble_dnn_initializer: Optional[str], default None. When None, activation judge first, he_uniform end.
        """
        super().__init__()
        if pool_mv_mode not in MVPoolModeList:
            raise MLGBError('pool_mv_mode')
        ...
        self.afn_fn = AdaptiveFactorizationNetworkLayer(
            ...
            ensemble_dnn_l2=ensemble_dnn_l2,
            ensemble_dnn_initializer=ensemble_dnn_initializer,
            seed=seed,
        )
        self.task_fn = TaskLayer(
            task=task,
...
class FGCNN(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 cnn_filter_nums=(64, 32), cnn_kernel_sizes=(64, 32), cnn_pool_sizes=(2, 2),
...
class XDeepFM(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
                 inputs_if_multivalued=False, inputs_if_sequential=False, inputs_if_embed_dense=False,
                 embed_dim=32, embed_2d_dim=32, embed_l2=0.0, embed_initializer=None,
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
...
class FiBiNet(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
                 ...
                 pool_mv_mode='Pooling:average', pool_mv_axis=2, pool_mv_l2=0.0, pool_mv_initializer=None,
                 pool_seq_mode='Pooling:average', pool_seq_axis=1, pool_seq_l2=0.0, pool_seq_initializer=None,
                 sen_pool_mode='Pooling:average', sen_reduction_factor=2, sen_activation='relu',
                 sen_l2=0.0, sen_initializer=None,
                 fbi_mode='Bilinear:field_interaction', fbi_unit=32, fbi_l2=0.0, fbi_initializer=None,
                 fbi_hofm_order=3, fbi_afm_activation='relu', fbi_afm_dropout=0.0,
                 dnn_hidden_units=(64, 32), dnn_activation='relu', dnn_dropout=0.0, dnn_if_bn=False, dnn_if_ln=False,
                 dnn_l2=0.0, dnn_initializer=None,
                 ):
        ...
        Task Model Parameters:
            ...
            :param sen_l2: float, default 0.0.
...
class GRU4Rec(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param gru_l2: float, default 0.0.
            :param gru_initializer: Optional[str], default None. When None, activation judge first, he_uniform end.
            :param gru_rct_activation: Optional[str], default 'sigmoid'.
            :param gru_rct_dropout: float, default 0.0.
            :param gru_rct_l2: float, default 0.0.
            :param gru_rct_initializer: Optional[str], default 'orthogonal'. When None, activation judge first, he_uniform end.
            :param gru_reset_after: bool, default True. True if cuda or GRU_v1 else False(GRU_v3).
            :param gru_unroll: bool, default False. False if cuda or small memory else True.
            :param dnn_hidden_units: Tuple[int], default (64, 32).
            :param dnn_activation: Optional[str], default 'relu'.
            :param dnn_if_bn: bool, default False. Batch Normalization.
            :param dnn_if_ln: bool, default False. Layer Normalization.
...
class DIN(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        query_3d_tensor = tf.reduce_sum(item_embed_3d_tensor, axis=1, keepdims=True)
        query_3d_tensor = tf.tile(query_3d_tensor, multiples=tf.constant([1, key_3d_tensor.shape[1], 1], dtype=tf.int32))
...
class DSIN(tf.keras.Model):
    def __init__(self, feature_names, task='binary', seed=None,
        ...
        Task Model Parameters:
            ...
            :param bias_l2: float, default 0.0.
