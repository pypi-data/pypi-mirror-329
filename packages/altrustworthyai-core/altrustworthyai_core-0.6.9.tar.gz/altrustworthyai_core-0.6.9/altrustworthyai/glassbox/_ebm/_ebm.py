...
class EBMExplanation(FeatureValueExplanation):
    ...
    def visualize(self, key=None):
        ...
        if self.explanation_type == "global" and key is None:
            ...
            figure._altrustworthyai_help_text = (
            ...
            figure._altrustworthyai_help_link = "https://github.com/AffectLog360/altrustworthyai/blob/develop/docs/altrustworthyai/python/examples/group-importances.ipynb"
...
class EBMModel(ExplainerMixin, BaseEstimator):
    ...
    def eval_terms(self, X):
        ...
        Calling altrustworthyai.utils.inv_link(ebm.eval_terms(X).sum(axis=1) + ebm.intercept\_, ebm.link\_)
