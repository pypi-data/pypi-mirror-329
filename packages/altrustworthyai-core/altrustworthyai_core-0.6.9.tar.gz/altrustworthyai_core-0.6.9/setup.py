...
def _copy_native_code_to_setup():
    ...
    sym_path = os.path.join(script_path, "altrustworthyai", "root")
...
def build_copy_root_libebm():
    ...
    to_path = os.path.join(script_path, "altrustworthyai", "root", "bld", "lib")
...
def build_vis_if_needed():
    ...
    js_bundle_dest = os.path.join(
        script_path, "altrustworthyai", "root", "bld", "lib", "altrustworthyai-inline.js"
    )
    ...
    js_bundle_src = os.path.join(js_path, "dist", "altrustworthyai-inline.js")
    os.makedirs(os.path.dirname(js_bundle_dest), exist_ok=True)
    shutil.copyfile(js_bundle_src, js_bundle_dest)

    js_bundle_src_lic = os.path.join(js_path, "dist", "altrustworthyai-inline.js.LICENSE.txt")
    js_bundle_dest_lic = os.path.join(
        ...
        "bld",
        "lib",
        "altrustworthyai-inline.js.LICENSE.txt",
    )
...
class BuildCommand(build):
    def run(self):
        ...
        script_path = os.path.dirname(os.path.abspath(__file__))
        sym_path = os.path.join(script_path, "altrustworthyai", "root", "shared", "libebm")
        ...
        # should put them in ./altrustworthyai/python/altrustworthyai-core/altrustworthyai/root/bld/lib
...
setup(
    ...
    description="The AffectLog’s Trustworthy AI (ALT-AI) provides a suite of tools for the explanation, visualization, and understanding of complex machine learning models.",
    long_description="""
Minimal dependency core system for the altrustworthyai package.
...
""",
    ...
    package_data={
        "altrustworthyai": [
            ...
            "root/bld/lib/altrustworthyai-inline.js",
            "root/bld/lib/altrustworthyai-inline.js.LICENSE.txt",
