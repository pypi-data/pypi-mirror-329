...
class Native:
    ...
    def _get_ebm_lib_path(debug=False):
        ...
        altrustworthyai_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..")
        root_path = os.path.join(altrustworthyai_path, "root")
        if os.path.isdir(root_path):
            ...
            root_path = os.path.join(altrustworthyai_path, "..", "..", "..")
            if os.path.isdir(root_path):
                bld_path = os.path.join(root_path, "bld")
                if os.path.isdir(bld_path):
                    lib_path = os.path.join(bld_path, "lib")
