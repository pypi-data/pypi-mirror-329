...
# https://dev.azure.com/ms/altrustworthyai/_build?definitionId=293&_a=summary
...
if [ ! -f "$script_path_unsanitized/libebm_test.sh" ] ; then
   ...
   printf "Could not find script file root directory for building ALTrustworthyAI.  Exiting."
   exit 1
fi
