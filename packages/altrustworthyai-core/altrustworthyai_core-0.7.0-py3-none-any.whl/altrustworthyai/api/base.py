...
# TODO: instead of having altrustworthyai.api.base, it would probably be easier to just have a single base.py file
...
class ExplainerMixin(abc.ABC):
    """An object that computes explanations.
        This is a contract required for ALTrustworthyAI.
