...
JS_URL = f"https://unpkg.com/@AffectLog360/altrustworthyai/-inline@{__version__}/dist/altrustworthyai-inline.js"
...
class InlineProvider(VisualizeProvider):
    ...
    def __init__(self, detected_envs=None, js_url=None):
        ...
        Args:
            detected_envs: Environments targetted as defined in `altrustworthyai.utils.environment`.
            js_url: If defined, will load the JavaScript bundle for altrustworthyai-inline from the given URL.
        """
