...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-cloudsearch)](https://pypistats.org/packages/mypy-boto3-cloudsearch)
...
`mypy-boto3-cloudsearch` dependency in production. However, there is an issue
