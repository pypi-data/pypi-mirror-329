...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-cloudtrail-data)](https://pypistats.org/packages/mypy-boto3-cloudtrail-data)
...
`mypy-boto3-cloudtrail-data` dependency in production. However, there is an
