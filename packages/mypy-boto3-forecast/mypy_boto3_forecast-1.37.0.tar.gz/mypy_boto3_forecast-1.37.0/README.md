...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-forecast)](https://pypistats.org/packages/mypy-boto3-forecast)
...
`mypy-boto3-forecast` dependency in production. However, there is an issue in
