<a id="types-boto3-mgh"></a>

# types-boto3-mgh

[![PyPI - types-boto3-mgh](https://img.shields.io/pypi/v/types-boto3-mgh.svg?color=blue)](https://pypi.org/project/types-boto3-mgh/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-mgh.svg?color=blue)](https://pypi.org/project/types-boto3-mgh/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-mgh)](https://pypistats.org/packages/types-boto3-mgh)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 MigrationHub 1.37.0](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-mgh docs](https://youtype.github.io/types_boto3_docs/types_boto3_mgh/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-mgh](#types-boto3-mgh)
...
- Install `types-boto3[mgh]` in your environment:
...
- Install `types-boto3[mgh]` with services you use in your environment:
...
`types-boto3-mgh` dependency in production. However, there is an issue in
...
from types_boto3_mgh import MigrationHubClient
...
`types_boto3_mgh.paginator` module contains type annotations for all
paginators.
...
`types_boto3_mgh.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `MigrationHub` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_mgh/literals/).
...
`types_boto3_mgh.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `MigrationHub` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_mgh/type_defs/).
...
`types-boto3-mgh` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_mgh/)
