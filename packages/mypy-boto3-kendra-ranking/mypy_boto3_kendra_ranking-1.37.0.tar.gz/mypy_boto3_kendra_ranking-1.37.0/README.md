...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kendra-ranking)](https://pypistats.org/packages/mypy-boto3-kendra-ranking)
...
`mypy-boto3-kendra-ranking` dependency in production. However, there is an
