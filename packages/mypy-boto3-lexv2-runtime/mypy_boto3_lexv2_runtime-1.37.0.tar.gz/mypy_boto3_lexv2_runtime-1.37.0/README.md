...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-lexv2-runtime)](https://pypistats.org/packages/mypy-boto3-lexv2-runtime)
...
`mypy-boto3-lexv2-runtime` dependency in production. However, there is an issue
