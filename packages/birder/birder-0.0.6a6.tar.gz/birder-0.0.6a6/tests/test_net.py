...
class TestNet(unittest.TestCase):
    @parameterized.expand(  # type: ignore[misc]
        [
            ...
            ("vit_b32"),
            ("vitreg4_b32"),
            ("vit_so150m_p14", None, False, 1, 14),
            ("vitreg4_so150m_p14", None, False, 1, 14),
            ("vit_sam_b16"),
            ("wide_resnet_50"),
            ("xception"),
            ("xcit_nano12_p16"),
    ...
    @parameterized.expand(  # type: ignore[misc]
        [
            ...
            ("vit_so150m_p14", None, False),
            ("vitreg4_so150m_p14", None, False),
...
class TestNonSquareNet(unittest.TestCase):
    @parameterized.expand(  # type: ignore[misc]
        [
            ...
            ("vit_b32"),
            ("vitreg4_b32"),
            ("vit_so150m_p14", None, 1, 14, 14),
            ("vitreg4_so150m_p14", None, 1, 14, 14),
            ("vit_sam_b16"),
            ("wide_resnet_50"),
            ("xception"),
            ("xcit_nano12_p16"),
