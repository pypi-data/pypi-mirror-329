<a id="types-boto3-robomaker"></a>

# types-boto3-robomaker

[![PyPI - types-boto3-robomaker](https://img.shields.io/pypi/v/types-boto3-robomaker.svg?color=blue)](https://pypi.org/project/types-boto3-robomaker/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-robomaker.svg?color=blue)](https://pypi.org/project/types-boto3-robomaker/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-robomaker)](https://pypistats.org/packages/types-boto3-robomaker)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 RoboMaker 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-robomaker docs](https://youtype.github.io/types_boto3_docs/types_boto3_robomaker/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-robomaker](#types-boto3-robomaker)
...
- Install `types-boto3[robomaker]` in your environment:
...
- Install `types-boto3[robomaker]` with services you use in your environment:
...
`types-boto3-robomaker` dependency in production. However, there is an issue in
...
from types_boto3_robomaker import RoboMakerClient
...
`types_boto3_robomaker.paginator` module contains type annotations for all
paginators.
...
`types_boto3_robomaker.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `RoboMaker` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_robomaker/literals/).
...
`types_boto3_robomaker.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `RoboMaker` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_robomaker/type_defs/).
...
`types-boto3-robomaker` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_robomaker/)
