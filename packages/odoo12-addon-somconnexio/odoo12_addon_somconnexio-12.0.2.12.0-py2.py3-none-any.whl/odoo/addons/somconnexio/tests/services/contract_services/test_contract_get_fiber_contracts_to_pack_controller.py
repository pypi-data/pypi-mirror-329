...
class TestContractGetFiberContractsNotPackedController(BaseEMCRestCaseAdmin):
    ...
    def test_filter_out_fibers_used_in_OTRS_tickets(
        ...
        filtered_contracts = self.env[
            "contract.service"
        ]._filter_out_fibers_used_in_OTRS_tickets(fiber_contract_1 + fiber_contract_2)
    ...
    def test_filter_out_fibers_used_in_OTRS_tickets_empty(self):
        ...
        filtered_contracts = self.env[
            "contract.service"
        ]._filter_out_fibers_used_in_OTRS_tickets(contracts)
    ...
    def test_filter_out_fibers_used_in_ODOO_lead_lines(self):
        ...
        filtered_contracts = self.env[
            "contract.service"
        ]._filter_out_fibers_used_in_ODOO_lead_lines(
    ...
    def test_filter_out_fibers_used_in_ODOO_lead_lines_empty(self):
        ...
        filtered_contracts = self.env[
            "contract.service"
        ]._filter_out_fibers_used_in_ODOO_lead_lines(contracts)
