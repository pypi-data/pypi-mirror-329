...
class TestContract(SCComponentTestCase):
    ...
    def test_quit_sharing_bond_and_update_sharing_mobiles_tariffs_from_2_to_1(
        self, MockChangeTariffTicket, *args
    ):
        """
        ...
        contract.quit_sharing_bond_and_update_sharing_mobiles_tariffs()
    ...
    def test_quit_sharing_bond_and_update_sharing_mobiles_tariffs_from_3_to_2(
        self, *args
    ):
        """
        Contract 1 from 3 sharing contract changes its tariff,
    ...
    def test_update_sharing_mobiles_tariffs_after_joining_shared_bond(self, *args):
        ...
        new_mbl_contract.update_sharing_mobiles_tariffs_after_joining_shared_bond()
        ...
        self.assertEquals(len(new_mbl_contract.sharing_bond_contract_ids), 3)
        self.assertIn(
            sharing_contract_1,
            new_mbl_contract.sharing_bond_contract_ids,
        )
        self.assertIn(
            sharing_contract_2,
            new_mbl_contract.sharing_bond_contract_ids,
    ...
    def test_update_sharing_mobiles_tariffs_after_joining_shared_bond_extra(
        self, *args
    ):
        ...
        self.assertEqual(len(sharing_contract_3.sharing_bond_contract_ids), 3)
        mbl_vals_contract = contract_mobile_create_data(
