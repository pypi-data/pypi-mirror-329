...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-applicationcostprofiler)](https://pypistats.org/packages/mypy-boto3-applicationcostprofiler)
...
`mypy-boto3-applicationcostprofiler` dependency in production. However, there
