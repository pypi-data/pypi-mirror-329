...
def warn_versions() -> None:
    ...
    supported_versions = {
        ...
        "numpy": ["2.0.2", "1.24.4", "1.26.4", "2.1.1", "2.1.2", "2.1.3", "2.2.1", "2.2.2", "2.2.3"],
        "matplotlib": ["3.9.4", "3.6.3", "3.7.5", "3.9.0", "3.9.1", "3.9.1.post1", "3.9.2", "3.9.3", "3.10.0"],
        ...
        "jaxtyping": ["0.2.36", "0.2.34", "0.2.19", "0.2.37", "0.2.38"],
        ...
        "mpmath": ["1.3.0"],
        "sympy": ["1.13.3", "1.13.1"],
        "setuptools": ["44.0.0", "56.0.0", "66.1.1", "75.2.0", "58.1.0", "59.6.0", "75.3.0", "75.5.0", "75.6.0", "75.8.0", "70.2.0", "65.5.0"],
