...
[boto3 Mediapackagev2 1.37.0](https://pypi.org/project/boto3/) compatible with
...
`mypy-boto3-mediapackagev2` dependency in production. However, there is an
...
`mypy_boto3_mediapackagev2.waiter` module contains type annotations for all
waiters.
