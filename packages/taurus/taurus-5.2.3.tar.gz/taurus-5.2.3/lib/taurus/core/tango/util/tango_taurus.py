...
FROM_TANGO_TO_TAURUS_TYPE = {
    ...
    PyTango.CmdArgType.DevEnum: DataType.Integer,
}
# DevInt removed in cpptango/pytango 9.5.0
try:
    FROM_TANGO_TO_TAURUS_TYPE[PyTango.CmdArgType.DevInt] = DataType.Integer
