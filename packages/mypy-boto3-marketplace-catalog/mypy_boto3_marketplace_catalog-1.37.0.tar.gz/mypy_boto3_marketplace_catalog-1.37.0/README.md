...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-marketplace-catalog)](https://pypistats.org/packages/mypy-boto3-marketplace-catalog)
...
`mypy-boto3-marketplace-catalog` dependency in production. However, there is an
