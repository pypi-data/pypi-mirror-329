"""
Setup script for types-boto3-athena.
...
setup(
    ...
    version="1.37.0",
    packages=["types_boto3_athena"],
    url="https://github.com/youtype/mypy_boto3_builder",
    license="MIT License",
    author="Vlad Emelianov",
    author_email="vlad.emelianov.nz@gmail.com",
    description="Type annotations for boto3 Athena 1.37.0 service generated with mypy-boto3-builder 8.9.2",
    classifiers=[
    ...
    package_data={"types_boto3_athena": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
