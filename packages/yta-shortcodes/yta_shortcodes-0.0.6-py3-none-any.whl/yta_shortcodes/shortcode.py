...
class YTAShortcode(Shortcode):
    ...
    def calculate_start_and_duration(
        ...
        fields by using the 'transcription' if needed
        (if 'start' and 'duration' fields are not numbers
        ...
        if PythonValidator.is_instance(self.start, [SimpleShortcodeStart, BlockShortcodeStart]):
