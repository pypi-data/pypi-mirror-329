...
import unittest
from asset_loader import LoadedAsset, AssetLoader, YamlAsset, YamlAssetLoader, JSONAsset, JSONAssetLoader, PythonAsset, PythonAssetLoader
...
class TestMain(unittest.TestCase):
    def test_txt(self):
        environ["ASSET_LOADER_BASE_DIR"] = 'D:\\workspaces\\py-asset-loader\\test'
