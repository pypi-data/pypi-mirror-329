...
from sklearn.utils.validation import assert_all_finite, check_is_fitted, check_X_y
...
class Earth(BaseEstimator, RegressorMixin, TransformerMixin):
    ...
    def _scrub(self, X, y, sample_weight, output_weight, missing, **kwargs):
        ...
        check_X_y(X, y, accept_sparse=False, multi_output=True, ensure_all_finite=False)
    ...
    def fit(
        ...
        if self.feature_importance_type is not None:
            ...
            if len(feature_importance_type) > 0 and self.enable_pruning is False:
                raise ValueError(
                    "Cannot compute feature importances because pruning is disabled,"
