...
class Routing:
    ...
    def __init__(self, network: gpd.GeoDataFrame) -> None:
        self.network = network
        self._osm_ids = {}
    ...
    def routing(self, start_node, end_node, by: str = "length") -> list:
        ...
        Parameters
        --------
        :param start_x: start longitude
        :param start_y: start latitude
        :param end_x: end longitude
        :param end_y: end latitude
        :param network: OSM network graph
        :param by: calculate shortest path by attribute
        :param algorithm: choose which algorithm to use 'speed' / 'length' 
