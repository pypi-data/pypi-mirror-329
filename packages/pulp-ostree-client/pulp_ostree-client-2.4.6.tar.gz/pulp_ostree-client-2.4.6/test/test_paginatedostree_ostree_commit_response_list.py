...
class TestPaginatedostreeOstreeCommitResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedostreeOstreeCommitResponseList:
        """Test PaginatedostreeOstreeCommitResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedostreeOstreeCommitResponseList`
        """
        model = PaginatedostreeOstreeCommitResponseList()
        if include_optional:
