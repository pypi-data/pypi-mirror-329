...
class TestPaginatedostreeOstreeObjectResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedostreeOstreeObjectResponseList:
        """Test PaginatedostreeOstreeObjectResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedostreeOstreeObjectResponseList`
        """
        model = PaginatedostreeOstreeObjectResponseList()
        if include_optional:
