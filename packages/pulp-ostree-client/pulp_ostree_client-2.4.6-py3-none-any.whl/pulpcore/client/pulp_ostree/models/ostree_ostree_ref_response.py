...
class OstreeOstreeRefResponse(BaseModel):
    """
    ...
    name: StrictStr
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "artifact", "relative_path", "commit", "checksum", "name"]
