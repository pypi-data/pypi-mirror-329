...
class OstreeOstreeObjectResponse(BaseModel):
    """
    ...
    checksum: StrictStr
    typ: StrictInt = Field(description="             The type of an object. All values are described by the mapping declared at             https://lazka.github.io/pgi-docs/OSTree-1.0/enums.html#OSTree.ObjectType             ")
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "artifact", "relative_path", "checksum", "typ"]
