        ...
        try:
            ...
            for index, prompt in enumerate(prompts):
                ...
                if _formatter not in ["json", "csv", "xml"]:
                    ...
                    message_data.append({"role": "user", "context":f"give valid json format"})
                    message_data.append({"role": "system", "context":f"understood"})
                    message_data.append({"role": "user", "content": prompt})
