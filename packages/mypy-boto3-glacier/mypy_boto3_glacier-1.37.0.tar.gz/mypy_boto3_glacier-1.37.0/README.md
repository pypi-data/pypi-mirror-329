...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-glacier)](https://pypistats.org/packages/mypy-boto3-glacier)
...
`mypy-boto3-glacier` dependency in production. However, there is an issue in
