...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-connect-contact-lens)](https://pypistats.org/packages/mypy-boto3-connect-contact-lens)
...
`mypy-boto3-connect-contact-lens` dependency in production. However, there is
