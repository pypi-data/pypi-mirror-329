...
from altai.api.defaults import DEFAULT_DATA_ANCHOR_IMG, DEFAULT_META_ANCHOR
from altai.api.interfaces import Explainer, Explanation
from altai.exceptions import (PredictorCallError,
...
class AnchorImage(Explainer):
    ...
    def _build_explanation(
        ...
        params
            Parameters passed to `:py:meth:altai.explainers.anchor_image.AnchorImage.explain`.
        """
