...
LanguageModelSampler = import_optional(
    'altai.explainers.anchors.language_model_text_sampler',
...
if TYPE_CHECKING:
    ...
    from altai.utils import LanguageModel
...
class AnchorText(Explainer):
    ...
    def __init__(self,
        ...
        language_model
            ...
            `LanguageModel` interface we define in :py:class:`altai.utils.lang_model.LanguageModel`.
        seed
        ...
        kwargs
            ...
            Check default arguments defined in:
                ...
                - :py:data:`altai.explainers.anchor_text.DEFAULT_SAMPLING_UNKNOWN`

                - :py:data:`altai.explainers.anchor_text.DEFAULT_SAMPLING_SIMILARITY`

                - :py:data:`altai.explainers.anchor_text.DEFAULT_SAMPLING_LANGUAGE_MODEL`
