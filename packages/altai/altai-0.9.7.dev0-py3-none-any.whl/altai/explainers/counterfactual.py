...
from altai.api.defaults import DEFAULT_DATA_CF, DEFAULT_META_CF
from altai.api.interfaces import Explainer, Explanation
from altai.utils.gradients import num_grad_batch
    ...
    def explain(self, X: np.ndarray) -> Explanation:
        ...
        explanation
            ...
            .. _Counterfactual examples:
                https://docs.affectlog.com/projects/altai/en/stable/methods/CF.html
        """
