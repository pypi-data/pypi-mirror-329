...
from altai.api.defaults import (DEFAULT_DATA_PD, DEFAULT_DATA_PDVARIANCE, DEFAULT_META_PDVARIANCE)
from altai.api.interfaces import Explainer, Explanation
from altai.explainers import plot_pd
from altai.explainers.partial_dependence import (Kind, PartialDependence,
...
class PartialDependenceVariance(Explainer):
    ...
    def explain(self,
        ...
        explanation
            ...
            .. _Partial dependence variance examples:
                https://docs.affectlog.com/projects/altai/en/stable/methods/PartialDependenceVariance.html
        """
    ...
    def _compute_pd_variance(self, features: List[int], pd_values: List[np.ndarray]) -> np.ndarray:
        ...
        ----------
        features
            See :py:meth:`altai.explainers.pd_variance.PartialDependenceVariance.explain`.
        pd_values
...
def _plot_hbar(exp_values: np.ndarray,
    ...
    features, targets, n_cols, sort, top_k, ax, bar_kw, fig_kw
        See :py:meth:`altai.explainers.pd_variance.plot_pd_variance`
    title
...
def plot_pd_variance(exp: Explanation,
    ...
    exp
        ...
        :py:meth:`altai.explainers.pd_variance.PartialDependenceVariance.explain` method.
    features
        A list of features entries provided in `feature_names` argument  to the
        :py:meth:`altai.explainers.pd_variance.PartialDependenceVariance.explain` method, or
