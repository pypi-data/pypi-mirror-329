...
These tests import all the named objects from the public API of altai and test that they throw the correct errors if the
...
functionality should work for the default altai install. If this is not the case the exported object name should be
...
`altai.utils.missing_optional_dependency`.
...
def check_correct_dependencies(
    ...
    dependencies
        ...
        should pass for the default altai install.
    opt_dep
...
def test_tensorflow_model_dependencies(opt_dep):
    ...
    from altai.models import tensorflow
...
def test_pytorch_model_dependencies(opt_dep):
    ...
    from altai.models import pytorch
