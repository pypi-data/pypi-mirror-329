...
from altai.explainers import ALE
from altai.explainers import AnchorTabular
from altai.explainers import KernelShap, TreeShap
from altai.explainers.tests.utils import predict_fcn, MockTreeExplainer
from altai.tests.utils import MockPredictor
from altai.utils.lang_model import BertBaseUncased, DistilbertBaseUncased, RobertaBase
from altai.utils.download import spacy_model

import tensorflow as tf

import altai_testing
from altai_testing.data import get_adult_data, get_iris_data, get_diabetes_data, get_mnist_data, \
...
def models(request):
    ...
    altai-testing helper package.
    """
    models = []
    for name in request.param:
        models.append(altai_testing.load(name))
    return models
...
# See the *_dataset functions in altai.tests.utils for
