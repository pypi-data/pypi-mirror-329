...
from altai.api.defaults import DEFAULT_DATA_ALE, DEFAULT_META_ALE
from altai.api.interfaces import Explanation
from altai.explainers.ale import (_plot_one_ale_num, adaptive_grid, ale_num,
...
def test_plot_ale_features(feats, explanation, mocker):
    ...
    m = mocker.patch('altai.explainers.ale._plot_one_ale_num')
...
def test_plot_ale_n_cols(n_cols, explanation, mocker):
    ...
    mocker.patch('altai.explainers.ale._plot_one_ale_num')
