...
from altai.api.defaults import DEFAULT_DATA_CFP, DEFAULT_META_CFP
from altai.api.interfaces import Explainer, Explanation, FitMixin
from altai.confidence import TrustScore
from altai.utils.discretizer import Discretizer
from altai.utils.distance import abdm, multidim_scaling, mvdm
from altai.utils.gradients import perturb
from altai.utils.mapping import (num_to_ord, ohe_to_ord, ohe_to_ord_shape,
                                 ord_to_num, ord_to_ohe)
from altai.utils.tf import argmax_grad, argmin_grad, one_hot_grad, round_grad
...
class CounterfactualProto(Explainer, FitMixin):
    ...
    def explain(self,
        ...
        explanation
            ...
            .. _CFProto examples:
                https://docs.affectlog.com/projects/altai/en/stable/methods/CFProto.html
        """
        # get params for storage in meta
        params = locals()
        remove = ['self', 'X', 'Y']
