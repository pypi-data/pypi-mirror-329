...
:py:class:`altai.explainers.cfrl_base` for the Pytorch backend.
"""
...
from altai.explainers.backends.cfrl_base import CounterfactualRLDataset
from altai.models.pytorch.actor_critic import Actor, Critic

if TYPE_CHECKING:
    from altai.explainers.cfrl_base import NormalActionNoise
