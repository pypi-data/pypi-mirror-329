...
from altai.api.defaults import (DEFAULT_DATA_PROTOSELECT,
                                DEFAULT_META_PROTOSELECT)
from altai.api.interfaces import Explanation, FitMixin, Summariser
from altai.utils.distance import batch_compute_kernel_matrix
from altai.utils.kernel import EuclideanDistance
...
class ProtoSelect(Summariser, FitMixin):
    def __init__(self,
        ...
        lambda_penalty
            ...
            :py:meth:`altai.prototypes.protoselect.ProtoSelect.fit` method.
        batch_size
...
def cv_protoselect_euclidean(trainset: Tuple[np.ndarray, np.ndarray],
    ...
    protoselect_kw
        Keyword arguments passed to :py:meth:`altai.prototypes.protoselect.ProtoSelect.__init__`.
    knn_kw
...
def compute_prototype_importances(summary: 'Explanation',
    ...
    summary
        ...
        :py:meth:`altai.prototypes.protoselect.ProtoSelect.summarise` method.
    trainset
        Tuple, `(X_train, y_train)`, consisting of the training data instances with the corresponding labels.
    preprocess_fn
