...
from altai.saving import load_explainer
from altai_testing.data import get_adult_data, get_iris_data, get_movie_sentiment_data
...
@pytest.fixture(scope='module')
def language_model():
    from altai.utils.lang_model import DistilbertBaseUncased
...
@pytest.fixture(scope='module')
def mnist_predictor():
    model = altai_testing.load('mnist-cnn-tf2.18.0.keras')
...
def iris_ae(iris_data):
    from altai.models.tensorflow.autoencoder import AE
