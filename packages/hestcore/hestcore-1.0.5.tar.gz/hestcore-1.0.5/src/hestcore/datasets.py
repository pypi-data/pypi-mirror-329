...
def wsi_coords_dataset(slide_fpath, patches_h5_fpath, transforms=None) -> WSIPatcherDataset:
    ...
    # TODO make compatible with fishing rod
    ...
    wsi_patcher = WSIPatcher(
        wsi, patch_size, src_pixel_size, dst_pixel_size, custom_coords)
