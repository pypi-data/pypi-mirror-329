...
class KeysWordsAndPhrases:
    ...
    def get_key_words(self,
        ...
        importants_lemma=["cadastre","signature","procuration","maritale","métier","partage","iban","vente","répertoire","banque","syndic","convention","bail","confidentialité","imposition",
