...
```sh
pip install git+https://github.com/client-api/forgejo-python.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/client-api/forgejo-python.git`)
...
------------ | ------------- | ------------- | -------------
*ActivitypubApi* | [**activitypub_instance_actor**](docs/ActivitypubApi.md#activitypub_instance_actor) | **GET** /activitypub/actor | Returns the instance&#39;s Actor
*ActivitypubApi* | [**activitypub_instance_actor_inbox**](docs/ActivitypubApi.md#activitypub_instance_actor_inbox) | **POST** /activitypub/actor/inbox | Send to the inbox
...
*ActivitypubApi* | [**activitypub_repository**](docs/ActivitypubApi.md#activitypub_repository) | **GET** /activitypub/repository-id/{repository-id} | Returns the Repository actor for a repo
*ActivitypubApi* | [**activitypub_repository_inbox**](docs/ActivitypubApi.md#activitypub_repository_inbox) | **POST** /activitypub/repository-id/{repository-id}/inbox | Send to the inbox
*AdminApi* | [**admin_add_rule_to_quota_group**](docs/AdminApi.md#admin_add_rule_to_quota_group) | **PUT** /admin/quota/groups/{quotagroup}/rules/{quotarule} | Adds a rule to a quota group
*AdminApi* | [**admin_add_user_to_quota_group**](docs/AdminApi.md#admin_add_user_to_quota_group) | **PUT** /admin/quota/groups/{quotagroup}/users/{username} | Add a user to a quota group
...
*AdminApi* | [**admin_create_quota_group**](docs/AdminApi.md#admin_create_quota_group) | **POST** /admin/quota/groups | Create a new quota group
*AdminApi* | [**admin_create_quota_rule**](docs/AdminApi.md#admin_create_quota_rule) | **POST** /admin/quota/rules | Create a new quota rule
...
*AdminApi* | [**admin_d_elete_quota_rule**](docs/AdminApi.md#admin_d_elete_quota_rule) | **DELETE** /admin/quota/rules/{quotarule} | Deletes a quota rule
*AdminApi* | [**admin_delete_hook**](docs/AdminApi.md#admin_delete_hook) | **DELETE** /admin/hooks/{id} | Delete a hook
*AdminApi* | [**admin_delete_quota_group**](docs/AdminApi.md#admin_delete_quota_group) | **DELETE** /admin/quota/groups/{quotagroup} | Delete a quota group
...
*AdminApi* | [**admin_edit_quota_rule**](docs/AdminApi.md#admin_edit_quota_rule) | **PATCH** /admin/quota/rules/{quotarule} | Change an existing quota rule
...
*AdminApi* | [**admin_get_quota_group**](docs/AdminApi.md#admin_get_quota_group) | **GET** /admin/quota/groups/{quotagroup} | Get information about the quota group
*AdminApi* | [**admin_get_quota_rule**](docs/AdminApi.md#admin_get_quota_rule) | **GET** /admin/quota/rules/{quotarule} | Get information about a quota rule
...
*AdminApi* | [**admin_get_user_quota**](docs/AdminApi.md#admin_get_user_quota) | **GET** /admin/users/{username}/quota | Get the user&#39;s quota info
*AdminApi* | [**admin_list_hooks**](docs/AdminApi.md#admin_list_hooks) | **GET** /admin/hooks | List system&#39;s webhooks
*AdminApi* | [**admin_list_quota_groups**](docs/AdminApi.md#admin_list_quota_groups) | **GET** /admin/quota/groups | List the available quota groups
*AdminApi* | [**admin_list_quota_rules**](docs/AdminApi.md#admin_list_quota_rules) | **GET** /admin/quota/rules | List the available quota rules
*AdminApi* | [**admin_list_users_in_quota_group**](docs/AdminApi.md#admin_list_users_in_quota_group) | **GET** /admin/quota/groups/{quotagroup}/users | List users in a quota group
*AdminApi* | [**admin_remove_rule_from_quota_group**](docs/AdminApi.md#admin_remove_rule_from_quota_group) | **DELETE** /admin/quota/groups/{quotagroup}/rules/{quotarule} | Removes a rule from a quota group
*AdminApi* | [**admin_remove_user_from_quota_group**](docs/AdminApi.md#admin_remove_user_from_quota_group) | **DELETE** /admin/quota/groups/{quotagroup}/users/{username} | Remove a user from a quota group
...
*AdminApi* | [**admin_set_user_quota_groups**](docs/AdminApi.md#admin_set_user_quota_groups) | **POST** /admin/users/{username}/quota/groups | Set the user&#39;s quota groups to a given list.
...
*OrganizationApi* | [**org_block_user**](docs/OrganizationApi.md#org_block_user) | **PUT** /orgs/{org}/block/{username} | Blocks a user from the organization
*OrganizationApi* | [**org_check_quota**](docs/OrganizationApi.md#org_check_quota) | **GET** /orgs/{org}/quota/check | Check if the organization is over quota for a given subject
...
*OrganizationApi* | [**org_get_quota**](docs/OrganizationApi.md#org_get_quota) | **GET** /orgs/{org}/quota | Get quota information for an organization
...
*OrganizationApi* | [**org_list_blocked_users**](docs/OrganizationApi.md#org_list_blocked_users) | **GET** /orgs/{org}/list_blocked | List the organization&#39;s blocked users
...
*OrganizationApi* | [**org_list_quota_artifacts**](docs/OrganizationApi.md#org_list_quota_artifacts) | **GET** /orgs/{org}/quota/artifacts | List the artifacts affecting the organization&#39;s quota
*OrganizationApi* | [**org_list_quota_attachments**](docs/OrganizationApi.md#org_list_quota_attachments) | **GET** /orgs/{org}/quota/attachments | List the attachments affecting the organization&#39;s quota
*OrganizationApi* | [**org_list_quota_packages**](docs/OrganizationApi.md#org_list_quota_packages) | **GET** /orgs/{org}/quota/packages | List the packages affecting the organization&#39;s quota
...
*OrganizationApi* | [**org_unblock_user**](docs/OrganizationApi.md#org_unblock_user) | **PUT** /orgs/{org}/unblock/{username} | Unblock a user from the organization
...
*RepositoryApi* | [**dispatch_workflow**](docs/RepositoryApi.md#dispatch_workflow) | **POST** /repos/{owner}/{repo}/actions/workflows/{workflowname}/dispatches | Dispatches a workflow
...
*RepositoryApi* | [**repo_add_flag**](docs/RepositoryApi.md#repo_add_flag) | **PUT** /repos/{owner}/{repo}/flags/{flag} | Add a flag to a repository
...
*RepositoryApi* | [**repo_check_flag**](docs/RepositoryApi.md#repo_check_flag) | **GET** /repos/{owner}/{repo}/flags/{flag} | Check if a repository has a given flag
...
*RepositoryApi* | [**repo_create_pull_review_comment**](docs/RepositoryApi.md#repo_create_pull_review_comment) | **POST** /repos/{owner}/{repo}/pulls/{index}/reviews/{id}/comments | Add a new comment to a pull request review
...
*RepositoryApi* | [**repo_delete_all_flags**](docs/RepositoryApi.md#repo_delete_all_flags) | **DELETE** /repos/{owner}/{repo}/flags | Remove all flags from a repository
...
*RepositoryApi* | [**repo_delete_flag**](docs/RepositoryApi.md#repo_delete_flag) | **DELETE** /repos/{owner}/{repo}/flags/{flag} | Remove a flag from a repository
...
*RepositoryApi* | [**repo_delete_pull_review_comment**](docs/RepositoryApi.md#repo_delete_pull_review_comment) | **DELETE** /repos/{owner}/{repo}/pulls/{index}/reviews/{id}/comments/{comment} | Delete a pull review comment
...
*RepositoryApi* | [**repo_get_pull_review_comment**](docs/RepositoryApi.md#repo_get_pull_review_comment) | **GET** /repos/{owner}/{repo}/pulls/{index}/reviews/{id}/comments/{comment} | Get a pull review comment
...
*RepositoryApi* | [**repo_list_flags**](docs/RepositoryApi.md#repo_list_flags) | **GET** /repos/{owner}/{repo}/flags | List a repository&#39;s flags
...
*RepositoryApi* | [**repo_remove_note**](docs/RepositoryApi.md#repo_remove_note) | **DELETE** /repos/{owner}/{repo}/git/notes/{sha} | Removes a note corresponding to a single commit from a repository
*RepositoryApi* | [**repo_replace_all_flags**](docs/RepositoryApi.md#repo_replace_all_flags) | **PUT** /repos/{owner}/{repo}/flags | Replace all flags of a repository
*RepositoryApi* | [**repo_search**](docs/RepositoryApi.md#repo_search) | **GET** /repos/search | Search for repositories
*RepositoryApi* | [**repo_set_note**](docs/RepositoryApi.md#repo_set_note) | **POST** /repos/{owner}/{repo}/git/notes/{sha} | Set a note corresponding to a single commit from a repository
...
*UserApi* | [**user_block_user**](docs/UserApi.md#user_block_user) | **PUT** /user/block/{username} | Blocks a user from the doer.
...
*UserApi* | [**user_check_quota**](docs/UserApi.md#user_check_quota) | **GET** /user/quota/check | Check if the authenticated user is over quota for a given subject
...
*UserApi* | [**user_get_o_auth2_applications**](docs/UserApi.md#user_get_o_auth2_applications) | **GET** /user/applications/oauth2 | List the authenticated user&#39;s oauth2 applications
*UserApi* | [**user_get_quota**](docs/UserApi.md#user_get_quota) | **GET** /user/quota | Get quota information for the authenticated user
...
*UserApi* | [**user_list_blocked_users**](docs/UserApi.md#user_list_blocked_users) | **GET** /user/list_blocked | List the authenticated user&#39;s blocked users
...
*UserApi* | [**user_list_quota_artifacts**](docs/UserApi.md#user_list_quota_artifacts) | **GET** /user/quota/artifacts | List the artifacts affecting the authenticated user&#39;s quota
*UserApi* | [**user_list_quota_attachments**](docs/UserApi.md#user_list_quota_attachments) | **GET** /user/quota/attachments | List the attachments affecting the authenticated user&#39;s quota
*UserApi* | [**user_list_quota_packages**](docs/UserApi.md#user_list_quota_packages) | **GET** /user/quota/packages | List the packages affecting the authenticated user&#39;s quota
...
*UserApi* | [**user_unblock_user**](docs/UserApi.md#user_unblock_user) | **PUT** /user/unblock/{username} | Unblocks a user from the doer.
...
## Documentation For Models
 ...
 - [APIForbiddenError](docs/APIForbiddenError.md)
 - [APIInvalidTopicsError](docs/APIInvalidTopicsError.md)
 - [APINotFound](docs/APINotFound.md)
 - [APIRepoArchivedError](docs/APIRepoArchivedError.md)
 - [APIUnauthorizedError](docs/APIUnauthorizedError.md)
 ...
 - [CreateQuotaGroupOptions](docs/CreateQuotaGroupOptions.md)
 - [CreateQuotaRuleOptions](docs/CreateQuotaRuleOptions.md)
 ...
 - [DeleteLabelsOption](docs/DeleteLabelsOption.md)
 - [DeployKey](docs/DeployKey.md)
 - [DismissPullReviewOptions](docs/DismissPullReviewOptions.md)
 - [DispatchWorkflowOption](docs/DispatchWorkflowOption.md)
 ...
 - [EditQuotaRuleOptions](docs/EditQuotaRuleOptions.md)
 ...
 - [Note](docs/Note.md)
 - [NoteOptions](docs/NoteOptions.md)
 ...
 - [QuotaGroup](docs/QuotaGroup.md)
 - [QuotaInfo](docs/QuotaInfo.md)
 - [QuotaRuleInfo](docs/QuotaRuleInfo.md)
 - [QuotaUsed](docs/QuotaUsed.md)
 - [QuotaUsedArtifact](docs/QuotaUsedArtifact.md)
 - [QuotaUsedAttachment](docs/QuotaUsedAttachment.md)
 - [QuotaUsedAttachmentContainedIn](docs/QuotaUsedAttachmentContainedIn.md)
 - [QuotaUsedPackage](docs/QuotaUsedPackage.md)
 - [QuotaUsedSize](docs/QuotaUsedSize.md)
 - [QuotaUsedSizeAssets](docs/QuotaUsedSizeAssets.md)
 - [QuotaUsedSizeAssetsAttachments](docs/QuotaUsedSizeAssetsAttachments.md)
 - [QuotaUsedSizeAssetsPackages](docs/QuotaUsedSizeAssetsPackages.md)
 - [QuotaUsedSizeGit](docs/QuotaUsedSizeGit.md)
 - [QuotaUsedSizeRepos](docs/QuotaUsedSizeRepos.md)
 - [Reaction](docs/Reaction.md)
 - [Reference](docs/Reference.md)
 - [Release](docs/Release.md)
 - [RenameUserOption](docs/RenameUserOption.md)
 - [ReplaceFlagsOption](docs/ReplaceFlagsOption.md)
 ...
 - [SetUserQuotaGroupsOptions](docs/SetUserQuotaGroupsOptions.md)
 - [StopWatch](docs/StopWatch.md)
 - [SubmitPullReviewOptions](docs/SubmitPullReviewOptions.md)
 - [Tag](docs/Tag.md)
 - [TagArchiveDownloadCount](docs/TagArchiveDownloadCount.md)
