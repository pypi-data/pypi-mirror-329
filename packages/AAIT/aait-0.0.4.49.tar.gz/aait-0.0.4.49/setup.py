...
VERSION = "0.0.4.49"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
# Dépendances
INSTALL_REQUIRES = ["torch==2.2.2", "sentence-transformers>=3.3.1", "gpt4all", "sacremoses>=0.1.1",
                    "transformers>=4.46.3", "sentencepiece>=0.2.0", "optuna", "spacy==3.7.6", "markdown", "uvicorn",
                    "fastapi", "python-multipart", "PyMuPDF>=1.24.14", "chonkie>=0.4.1", "GPUtil>=1.4.0", "unidecode",
                    "docling"]
