...
class OWExtraChunks(widget.OWWidget):
    ...
    def process(self):
        ...
        print("Données complètes reçues:", self.complete_data)
        print("Données sélectionnées reçues:", self.selected_data)
        ...
        index_var = domain["index"]
        print("Domaine extrait:", domain)
        print("Variable index extraite:", index_var)
        ...
        for idx in selected_indices:
            ...
            print(f"Pour l'index {idx}, indices ajoutés: {list(extracted_range)}")
        ...
        print("Indices complets du dataset:", complete_indices)

        covered_indices = sorted(full_indices.intersection(set(complete_indices)))
        print("Indices couverts après filtrage:", covered_indices)
        ...
        print("Nombre de lignes sélectionnées:", len(selected_rows))
        ...
        print("Données envoyées en sortie:", output_data)
