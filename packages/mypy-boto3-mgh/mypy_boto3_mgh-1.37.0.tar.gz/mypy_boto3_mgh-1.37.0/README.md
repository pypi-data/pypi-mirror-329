...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mgh)](https://pypistats.org/packages/mypy-boto3-mgh)
...
`mypy-boto3-mgh` dependency in production. However, there is an issue in
