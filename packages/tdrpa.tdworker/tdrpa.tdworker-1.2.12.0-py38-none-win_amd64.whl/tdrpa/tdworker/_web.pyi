...
class Web:
    ...
    def CloseTab(continueOnError: bool = False, delayAfter: int = 100, delayBefore: int = 100) -> bool | None:
        ...
        """
    @staticmethod
    def CreateBrowser(url: str = None, chromeExePath: str = None, isMaximize: bool = True, supportMode: str = 'pw', userData: str = None, clearChrome: bool = True, otherStartupParam: Incomplete | None = None, waitPage: bool = True, delayTime: int = 60000, continueOnError: bool = False, delayAfter: int = 100, delayBefore: int = 100) -> None:
        """
        创建浏览器

        Web.CreateBrowser(url='https://www.baidu.com', chromeExePath=None, isMaximize=True, supportMode='pw', userData=None, clearChrome=True, otherStartupParam=None, waitPage=True, delayTime=60000, continueOnError=False, delayAfter=100, delayBefore=100)
        ...
        :param supportMode:[可选参数]浏览器元素拾取模式，'uia': 客户端模式，'pw': 网页模式。默认'pw'
    ...
    def Exists(target: str | dict, onlyvis: bool = False, index: int = None, fromElementTdid: str = None, returnType: str = 'id', continueOnError: bool = False, delayAfter: int = 100, delayBefore: int = 100) -> bool | str | None:
        ...
        '''
    @staticmethod
    def GetAllElements(target: str | dict, onlyvis: bool = False, getMode: str = None, continueOnError: bool = False, delayAfter: int = 100, delayBefore: int = 100) -> list | None:
        '''
        获取指定特征所有元素（tdrpa_element_id或文本值）

        tdrpa_element_ids = Web.GetAllElements(target, onlyvis=False, getMode=None, continueOnError=False, delayAfter=100, delayBefore=100)

        :param target: [必选参数]网页元素特征码。str类型时：css选择器，或xpath。dict类型时：{"selector":css选择器, "txt": 网页元素上的文字}
        :param onlyvis: [可选参数]仅匹配可见元素。默认False
        :param getMode: [可选参数]获取文本值的方式。\'auto\':自动获取，\'text\':获取元素内所有文本内容，\'innerText\':获取元素内可见文本内容，\'value\':获取元素值， None:获取tdrpa_element_id。默认None
        :param continueOnError:[可选参数]是否在发生错误时继续执行。默认为False。
        :param delayAfter:[可选参数]执行后延时(毫秒)。默认100。
        :param delayBefore:[可选参数]执行前延时(毫秒)。默认100。
        :return:所有目标元素的tdrpa_element_id列表或文本值列表。
        '''
    @staticmethod
