...
class Collection:
    ...
    def update_one(self, key, new_value):
        """Update an existing item in the collection (in the Avro file)."""
        ...
        # Find the record by key and update it
        ...
        print(f"Updated item with key '{key}' in collection '{self.collection_name}'.")
