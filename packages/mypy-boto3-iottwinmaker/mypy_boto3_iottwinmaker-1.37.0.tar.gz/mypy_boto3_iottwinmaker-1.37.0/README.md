...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iottwinmaker)](https://pypistats.org/packages/mypy-boto3-iottwinmaker)
...
`mypy-boto3-iottwinmaker` dependency in production. However, there is an issue
