...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-inspector)](https://pypistats.org/packages/mypy-boto3-inspector)
...
`mypy-boto3-inspector` dependency in production. However, there is an issue in
