...
have its own set of tests, be formatted correctly and be consistent with the overall jDMN vision.
It must follow the pull request procedure outlined below.

### Coding Style

* Use 4 spaces for indentation. No tabs.
* Follow Oracle Code Style rules http://www.oracle.com/technetwork/java/codeconventions-150003.pdf


### Before your first code pull request

If you have never contributed to jDMN, or your copyright ownership has changed, you must first create a pull request that has
...
Apache 2.0 license for the purpose of contribution to jDMN. Negotiating such authorization and administering 
