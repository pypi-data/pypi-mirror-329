...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-appmesh)](https://pypistats.org/packages/mypy-boto3-appmesh)
...
`mypy-boto3-appmesh` dependency in production. However, there is an issue in
