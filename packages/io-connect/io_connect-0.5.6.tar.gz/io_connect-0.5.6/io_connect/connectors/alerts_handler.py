...
class AlertsHandler:
    ...
    def __init__(self, ds_url: str):
        ...
        """
        self.ds_url = ds_url
        self.__mail_url = c.MAIL_URL.format(ds_url=ds_url)
        self.__teams_url = c.TEAMS_URL.format(ds_url=ds_url)
    ...
    def notify_email(self, subject: str, message: str, recipient_email: list):
        ...
        try:
            ...
            response = requests.post(self.__mail_url, json=payload)
            ...
            # Log the error
            print(f"[EXCEPTION] Mail Alert: {e}")
    ...
    def notify_teams(
        ...
        try:
            ...
            response = requests.post(self.__teams_url, json=payload)
            ...
            # Log the error
            print(f"[EXCEPTION] Teams alert: {e}")
