...
GET_INSIGHT_RESULT = "{protocol}://{data_url}/api/bruce/insightResult/fetch/count/{count}"
...
GET_FILTERED_OPERATION_DATA = "{protocol}://{data_url}/api/consumption/getOperationDataWithTime"
...
GET_MAINTENANCE_MODULE_DATA = "{protocol}://{data_url}/api/widget/getMaintenanceModuleData"
