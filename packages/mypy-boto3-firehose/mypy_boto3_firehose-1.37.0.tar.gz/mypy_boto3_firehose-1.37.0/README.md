...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-firehose)](https://pypistats.org/packages/mypy-boto3-firehose)
...
`mypy-boto3-firehose` dependency in production. However, there is an issue in
