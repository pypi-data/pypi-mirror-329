...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mediastore)](https://pypistats.org/packages/mypy-boto3-mediastore)
...
`mypy-boto3-mediastore` dependency in production. However, there is an issue in
