...
version_line = open("sensirion_i2c_sfm3304/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_sfm3304',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion SFM3304 sensor family',
    license='BSD',
    keywords="""Sensirion SFM3304
        I2C
        SFM3304""",
    project_urls={
        "Documentation": "https://sensirion.github.io/python-i2c-sfm3304",
        "Repository": "https://github.com/Sensirion/python-i2c-sfm3304",
        "Changelog": "https://github.com/Sensirion/python-i2c-sfm3304/blob/master/CHANGELOG.md",
    },
