<a id="types-boto3-machinelearning"></a>

# types-boto3-machinelearning

[![PyPI - types-boto3-machinelearning](https://img.shields.io/pypi/v/types-boto3-machinelearning.svg?color=blue)](https://pypi.org/project/types-boto3-machinelearning/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-machinelearning.svg?color=blue)](https://pypi.org/project/types-boto3-machinelearning/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-machinelearning)](https://pypistats.org/packages/types-boto3-machinelearning)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 MachineLearning 1.37.0](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-machinelearning docs](https://youtype.github.io/types_boto3_docs/types_boto3_machinelearning/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-machinelearning](#types-boto3-machinelearning)
...
- Install `types-boto3[machinelearning]` in your environment:
...
- Install `types-boto3[machinelearning]` with services you use in your
  environment:
...
`types-boto3-machinelearning` dependency in production. However, there is an
...
from types_boto3_machinelearning import MachineLearningClient
...
`types_boto3_machinelearning.paginator` module contains type annotations for
all paginators.
...
`types_boto3_machinelearning.waiter` module contains type annotations for all
waiters.
...
`types_boto3_machinelearning.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `MachineLearning` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_machinelearning/literals/).
...
`types_boto3_machinelearning.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `MachineLearning` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_machinelearning/type_defs/).
...
`types-boto3-machinelearning` version is the same as related `boto3` version
and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_machinelearning/)
