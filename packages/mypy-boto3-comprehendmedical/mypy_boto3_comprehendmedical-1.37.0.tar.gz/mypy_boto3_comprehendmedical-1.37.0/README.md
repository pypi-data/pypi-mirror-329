...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-comprehendmedical)](https://pypistats.org/packages/mypy-boto3-comprehendmedical)
...
`mypy-boto3-comprehendmedical` dependency in production. However, there is an
