...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-chime)](https://pypistats.org/packages/mypy-boto3-chime)
...
`mypy-boto3-chime` dependency in production. However, there is an issue in
