...
def _lazyframe_from_domain(
    ...
    [_lazyframe_from_domain in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250221.1/opendp/domains/fn._lazyframe_from_domain.html)
...
def atom_domain(
    ...
    [atom_domain in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250221.1/opendp/domains/fn.atom_domain.html)
    ...
    try:
        output.__opendp_dict__ = {
            ...
            '__module__': 'domains',
            '__kwargs__': {
                'bounds': bounds, 'nullable': nullable, 'T': T
            },
        }
    except AttributeError:  # pragma: no cover
        pass
...
def datetime_domain(
    ...
    [datetime_domain in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250221.1/opendp/domains/fn.datetime_domain.html)
...
def option_domain(
    ...
    [option_domain in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250221.1/opendp/domains/fn.option_domain.html)
...
def series_domain(
    ...
    [series_domain in Rust documentation.](https://docs.rs/opendp/0.12.1-nightly.20250221.1/opendp/domains/fn.series_domain.html)
...
def wild_expr_domain(
    ...
    c_by = py_to_c(by, c_type=AnyObjectPtr, type_name=RuntimeType(origin='Option', args=[RuntimeType(origin='Vec', args=[Expr])]))
    ...
    try:
        output.__opendp_dict__ = {
            ...
            '__module__': 'domains',
            '__kwargs__': {
                'columns': columns, 'by': by, 'max_partition_length': max_partition_length, 'max_num_partitions': max_num_partitions, 'max_partition_contributions': max_partition_contributions, 'max_influenced_partitions': max_influenced_partitions, 'public_info': public_info
            },
        }
    except AttributeError:  # pragma: no cover
        pass
...
def with_margin(
    ...
    try:
        output.__opendp_dict__ = {
            ...
            '__module__': 'domains',
            '__kwargs__': {
                'frame_domain': frame_domain, 'by': by, 'max_partition_length': max_partition_length, 'max_num_partitions': max_num_partitions, 'max_partition_contributions': max_partition_contributions, 'max_influenced_partitions': max_influenced_partitions, 'public_info': public_info
            },
        }
    except AttributeError:  # pragma: no cover
        pass
