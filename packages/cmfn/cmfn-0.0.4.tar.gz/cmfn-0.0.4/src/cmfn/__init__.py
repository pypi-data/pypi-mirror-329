...
def pick_fields(dict_data: dict, fields: list[str]) -> dict:
    """
    ...
    Returns:
        dict: A new dictionary with only the selected fields.
    """
    return {key: dict_data[key] for key in fields if key in dict_data}
