<a id="types-boto3-devops-guru"></a>

# types-boto3-devops-guru

[![PyPI - types-boto3-devops-guru](https://img.shields.io/pypi/v/types-boto3-devops-guru.svg?color=blue)](https://pypi.org/project/types-boto3-devops-guru/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-devops-guru.svg?color=blue)](https://pypi.org/project/types-boto3-devops-guru/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-devops-guru)](https://pypistats.org/packages/types-boto3-devops-guru)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 DevOpsGuru 1.37.0](https://pypi.org/project/boto3/)
...
[types-boto3-devops-guru docs](https://youtype.github.io/types_boto3_docs/types_boto3_devops_guru/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-devops-guru](#types-boto3-devops-guru)
...
- Install `types-boto3[devops-guru]` in your environment:
...
- Install `types-boto3[devops-guru]` with services you use in your environment:
...
`types-boto3-devops-guru` dependency in production. However, there is an issue
...
from types_boto3_devops_guru import DevOpsGuruClient
...
`types_boto3_devops_guru.paginator` module contains type annotations for all
paginators.
...
`types_boto3_devops_guru.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `DevOpsGuru` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_devops_guru/literals/).
...
`types_boto3_devops_guru.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `DevOpsGuru` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_devops_guru/type_defs/).
...
`types-boto3-devops-guru` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_devops_guru/)
