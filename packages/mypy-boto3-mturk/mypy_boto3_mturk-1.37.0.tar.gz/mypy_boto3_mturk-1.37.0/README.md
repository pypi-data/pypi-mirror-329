...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mturk)](https://pypistats.org/packages/mypy-boto3-mturk)
...
`mypy-boto3-mturk` dependency in production. However, there is an issue in
