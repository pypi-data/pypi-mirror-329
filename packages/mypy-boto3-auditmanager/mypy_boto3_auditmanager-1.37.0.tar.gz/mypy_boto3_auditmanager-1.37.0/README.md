...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-auditmanager)](https://pypistats.org/packages/mypy-boto3-auditmanager)
...
`mypy-boto3-auditmanager` dependency in production. However, there is an issue
