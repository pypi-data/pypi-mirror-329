...
class StateQueryBuilder(QueryBuilder):
    ...
    def _build_field_reference(self, prop_name: str, model: type['ModelType'], table_name: str | None = ...) -> list[glue.FieldReference]: ...
    @classmethod
    def _build_aliased_field_reference(cls, prop_name: str, model: type['ModelType'], alias: Callable[[str], str], table_name: str | None = ...) -> list[glue.FieldReferenceAliased]: ...
    @classmethod
