...
class Executor(ExecutorBase['ModelType']):
    ...
    def count(self) -> int:
        ...
        """
    def _process_data(self, data: dict[str, Any], select_related: dict[tuple[str, type['ModelType'], str], Any] | None = ...) -> dict[str, Any]: ...
...
class AsyncExecutor(AsyncExecutorBase['ModelType']):
    ...
    async def count(self) -> int:
        ...
        Returns:
            int: The count of matching results.
        """
    async def _process_data(self, data: dict[str, Any], select_related: dict[tuple[str, type['ModelType'], str], Any] | None = ...) -> dict[str, Any]: ...
