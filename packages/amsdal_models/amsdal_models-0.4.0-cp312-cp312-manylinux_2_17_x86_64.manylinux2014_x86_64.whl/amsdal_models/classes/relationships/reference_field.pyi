...
def build_reference_db_field(field_name: str, suffix: str = ...) -> str: ...
...
class ReferenceFieldInfo(FieldInfo):
    ...
    @staticmethod
    def merge_field_infos(*field_infos: Union[FieldInfo, 'ReferenceFieldInfo'], **overrides: Any) -> ReferenceFieldInfo:
