...
class ReferenceLoader(ReferenceLoaderBase):
    ...
    def load_reference(self, only: list[str] | None = ..., using: str | None = ...) -> Model:
        ...
        """
    async def aload_reference(self, only: list[str] | None = ..., using: str | None = ...) -> Model:
        """
    ...
    def _load_record(self, model_class: type[Model], only: list[str] | None = ..., using: str | None = ...) -> QuerySetOneRequired[Model]: ...
