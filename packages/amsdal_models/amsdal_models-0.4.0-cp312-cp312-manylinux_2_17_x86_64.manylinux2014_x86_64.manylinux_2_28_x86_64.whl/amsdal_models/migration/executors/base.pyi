...
class BaseMigrationExecutor(ABC, metaclass=abc.ABCMeta):
    ...
    def forward_schema(self, schemas: BaseMigrationSchemas, class_name: str, object_schema: ObjectSchema, module_type: ModuleType) -> None:
        """
    ...
    def buffer_class_migration(self, class_name: str, object_schema: ObjectSchema, module_type: ModuleType) -> None:
        """
