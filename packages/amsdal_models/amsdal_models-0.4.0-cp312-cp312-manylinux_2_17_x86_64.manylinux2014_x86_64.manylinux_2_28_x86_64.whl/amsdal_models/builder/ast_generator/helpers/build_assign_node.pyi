...
def build_assign_node(class_name: str, target_name: str, type_data: TypeData, ast_dependency_generator: AstDependencyGenerator, value: Any = ..., *, is_required: bool = ..., can_be_a_reference: bool = ..., title: str | None = ...) -> ast.AnnAssign | ast.stmt:
    """
