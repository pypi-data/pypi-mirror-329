...
def build_assign_node(class_name: str, target_name: str, type_data: TypeData, ast_dependency_generator: AstDependencyGenerator, value: Any = ..., *, is_required: bool = True, can_be_a_reference: bool = True, title: str | None = None) -> ast.AnnAssign | ast.stmt:
    """
