...
class BaseHistoricalQueryBuilder:
    ...
    def build_group_by(self, model: type['ModelType'], only: list[str] | None = ..., select_related: dict[tuple[str, type['ModelType'], str], Any] | None = ..., order_by: list[glue.OrderByQuery] | None = ...) -> list[glue.GroupByQuery]: ...
