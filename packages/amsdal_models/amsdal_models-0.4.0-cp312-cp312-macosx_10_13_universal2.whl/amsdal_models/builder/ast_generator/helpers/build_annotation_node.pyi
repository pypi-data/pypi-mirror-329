...
def build_annotation_node(type_data: TypeData, ast_dependency_generator: AstDependencyGenerator, *, current_class_name: str = ..., is_required: bool = ..., can_be_a_reference: bool = ...) -> ast.Subscript | ast.Constant | ast.Name | ast.BinOp:
    """
