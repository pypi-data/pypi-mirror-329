...
class FileMigrationExecutorManager:
    ...
    store: Incomplete
    def __init__(self, core_migrations_path: Path, app_migrations_loader: MigrationsLoader, executor: BaseMigrationExecutor, store: BaseMigrationStore | None = ..., contrib: list[str] | None = ..., contrib_migrations_directory_name: str = ...) -> None: ...
    def execute(self, migration_number: int | None = ..., module_type: ModuleType | None = ..., *, fake: bool = ..., skip_data_migrations: bool = ...) -> list[MigrationResult]:
        """
    ...
    def _apply(self, migration_number: int | None = ..., module_type: ModuleType | None = ..., *, fake: bool = ..., skip_data_migrations: bool = ...) -> list[MigrationResult]: ...
    def _apply_migrations(self, loader: MigrationsLoader, module_type: ModuleType, migration_number: int | None = ..., *, fake: bool = ..., skip_data_migrations: bool = ...) -> list[MigrationResult]: ...
...
class AsyncFileMigrationExecutorManager:
    ...
    _applied_migration_files: Incomplete
    store: Incomplete
    def __init__(self, core_migrations_path: Path, app_migrations_loader: MigrationsLoader, executor: AsyncBaseMigrationExecutor, store: AsyncBaseMigrationStore | None = ..., contrib: list[str] | None = ..., contrib_migrations_directory_name: str = ...) -> None: ...
    async def execute(self, migration_number: int | None = ..., module_type: ModuleType | None = ..., *, fake: bool = ..., skip_data_migrations: bool = ...) -> list[MigrationResult]:
        """
        Executes the migrations.
    ...
    @staticmethod
    def _get_contrib_loaders(contrib: list[str], contrib_migrations_directory_name: str) -> list[MigrationsLoader]: ...
    async def _apply(self, migration_number: int | None = ..., module_type: ModuleType | None = ..., *, fake: bool = ..., skip_data_migrations: bool = ...) -> list[MigrationResult]: ...
    async def _apply_migrations(self, loader: MigrationsLoader, module_type: ModuleType, migration_number: int | None = ..., *, fake: bool = ..., skip_data_migrations: bool = ...) -> list[MigrationResult]: ...
