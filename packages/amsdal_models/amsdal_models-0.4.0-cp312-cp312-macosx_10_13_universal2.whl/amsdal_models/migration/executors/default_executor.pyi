...
from amsdal_models.errors import MigrationsError as MigrationsError
...
class DefaultMigrationExecutor(BaseMigrationExecutor):
    ...
    def __init__(self, schemas: BaseMigrationSchemas, *, use_foreign_keys: bool = ...) -> None: ...
    ...
    def _save_object_class_meta(self, base_class: type[Model], object_schema: ObjectSchema, module_type: str) -> None: ...
    def _create_table(self, object_schema: ObjectSchema, class_version: str | Versions, using: str | None = ...) -> tuple[bool, bool]: ...
...
class DefaultAsyncMigrationExecutor(AsyncBaseMigrationExecutor):
    ...
    async def _save_object_class_meta(self, base_class: type[Model], object_schema: ObjectSchema, module_type: str) -> None: ...
    async def _create_table(self, object_schema: ObjectSchema, class_version: str | Versions, using: str | None = ...) -> tuple[bool, bool]: ...
