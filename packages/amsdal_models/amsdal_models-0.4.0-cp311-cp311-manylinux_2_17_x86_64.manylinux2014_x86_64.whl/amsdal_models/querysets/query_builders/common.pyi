...
class BaseQueryBuilder:
    ...
    def _process_select_related(self, select_related: dict[str, Any], model: type['ModelType'], alias_index: int = ...) -> dict[tuple[str, type['ModelType'], str], Any] | None: ...
    @staticmethod
    def _to_glue_lookup(lookup: Lookup) -> glue.FieldLookup: ...
    @classmethod
    def _process_nested_rest(cls, rest: str, select_related: dict[tuple[str, type['ModelType'], str], Any] | None = ...) -> str: ...
...
class QueryBuilder(BaseQueryBuilder, ABC, metaclass=abc.ABCMeta):
    ...
    def build_only(self, model: type['ModelType'], only: list[str] | None = ..., select_related: dict[tuple[str, type['ModelType'], str], Any] | None = ...) -> list[glue.FieldReference | glue.FieldReferenceAliased] | None: ...
...
class AsyncQueryBuilder(BaseQueryBuilder, ABC, metaclass=abc.ABCMeta):
    ...
    async def build_only(self, model: type['ModelType'], only: list[str] | None = ..., select_related: dict[tuple[str, type['ModelType'], str], Any] | None = ...) -> list[glue.FieldReference | glue.FieldReferenceAliased] | None: ...
