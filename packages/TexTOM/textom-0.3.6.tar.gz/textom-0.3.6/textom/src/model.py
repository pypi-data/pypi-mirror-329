...
class model:
    ...
    def __init__(self, path, single=False):
        ...
        if os.path.isfile(os.path.join(path,'analysis','diffractlets.h5')): # loads a crystal if it exists
            ...
            with h5py.File( os.path.join(path,'analysis','diffractlets.h5'), 'w' ) as hf:
                ...
                hf.create_dataset('Energy_keV', data=cr.Ex)
    ...
    def _init_diffractlets(self):
        ...
        self.lattice_vectors = crystal_data['lattice_vectors']
        self.symmetry = sym.get_proper_point_group(crystal_data['space_group'])
    ...
    Methods
    """
    def get_orders(self, n_max = 20, info=True ):
        ...
        '''
        if info:
            print(f'\tBuild model for symmetry {self.symmetry}')
