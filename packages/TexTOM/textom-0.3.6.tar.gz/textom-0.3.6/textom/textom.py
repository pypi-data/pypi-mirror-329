...
def integrate( mode='online', wait=5. ):
    ...
    """
    if mode=='parallel':
        pyf.start_integration_parallel( sample_dir )
    elif mode=='online':
        pyf.start_integration_online( sample_dir, wait=wait )
    else:
...
def preprocess_data( pattern='.h5', flip_fov=False, baselines=1, use_ion=True ):
