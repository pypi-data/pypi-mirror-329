...
def setup_integration( sample_dir:str ):
...
def update_filelist( sample_dir:str, par:integration_parameters ):
...
def start_integration_parallel( sample_dir:str ):
...
def start_integration_online( sample_dir:str, wait=5. ):
