...
def import_data( sample_dir, pattern, mod:model,  baselines=False,
    ...
    baselines : str or False, optional
        'polynomial' to fit the whole q-range minus the peaks with a 5th order polynomial, 
        'simple' to draw a line under each peak, does not work if there is peak-overlap,
        'False' for no baselines, by default False
