...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-chime-sdk-voice)](https://pypistats.org/packages/mypy-boto3-chime-sdk-voice)
...
`mypy-boto3-chime-sdk-voice` dependency in production. However, there is an
