...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-kinesis-video-media)](https://pypistats.org/packages/mypy-boto3-kinesis-video-media)
...
`mypy-boto3-kinesis-video-media` dependency in production. However, there is an
