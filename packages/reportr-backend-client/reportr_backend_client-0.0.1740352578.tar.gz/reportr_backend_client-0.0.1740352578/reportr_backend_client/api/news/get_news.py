...
def _get_kwargs(
    *,
    ...
    time_filter: Union[Unset, Any] = "latest",
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        time_filter (Union[Unset, Any]): Time filter to use Default: 'latest'.
        page_size (Union[Unset, int]): Number of items per page Default: 5.
