...
# BEGIN PLOT /ATLAS_2024_I2768921*/d22
Title= Transverse momentum $p_\mathrm{T}(\gamma)$ for combined channels
XLabel=$p_\mathrm{T}(\gamma)$ [GeV]
YLabel= $\frac{\mathrm{d}\sigma}{\mathrm{d}p_\mathrm{T}(\gamma)}$ [1 / GeV]
RatioPlotYMin=0.55
RatioPlotYMax=1.45
Legend=1
LogY=1
...
# BEGIN PLOT /ATLAS_2024_I2768921*/d24
Title= Absolute pseudorapidity $|\eta(\gamma)|$ for combined channels
XLabel=$|\eta(\gamma)|$
YLabel= $\frac{\mathrm{d}\sigma}{\mathrm{d}|\eta(\gamma)|}$
RatioPlotYMin=0.55
RatioPlotYMax=1.45
Legend=1
LogY=0
...
# BEGIN PLOT /ATLAS_2024_I2768921*/d26
Title= Transverse momentum $p_\mathrm{T}(\mathrm{j1})$ for combined channels
XLabel=$p_\mathrm{T}(\gamma)$ [GeV]
YLabel= $\frac{\mathrm{d}\sigma}{\mathrm{d}p_\mathrm{T}(\mathrm{j1})}$ [1 / GeV]
RatioPlotYMin=0.55
RatioPlotYMax=1.45
Legend=1
LogY=1
...
# BEGIN PLOT /ATLAS_2024_I2768921*/d28
Title= Angular separation $\Delta R(\gamma,b)_\mathrm{min}$ in single-lepton channel
XLabel=$\Delta R(\gamma,b)_\mathrm{min}$
YLabel= $\frac{\mathrm{d}\sigma}{\mathrm{d} \Delta R(\gamma,b)_\mathrm{min}}$ [fb]
RatioPlotYMin=0.55
...
# BEGIN PLOT /ATLAS_2024_I2768921*/d30
Title= Angular separation $\Delta R(\gamma,\ell)$ in single-lepton channel
XLabel=$\Delta R(\gamma,\ell)$
YLabel= $\frac{\mathrm{d}\sigma}{\mathrm{d} \Delta R(\gamma,\ell)}$ [fb]
RatioPlotYMin=0.55
...
# BEGIN PLOT /ATLAS_2024_I2768921*/d32
Title= Angular separation $\Delta R(\ell,j)_\mathrm{min}$ in single-lepton channel
XLabel=$\Delta R(\ell,j)_\mathrm{min}$
YLabel= $\frac{\mathrm{d}\sigma}{\mathrm{d} \Delta R(\ell,j)_\mathrm{min}}$ [fb]
RatioPlotYMin=0.55
