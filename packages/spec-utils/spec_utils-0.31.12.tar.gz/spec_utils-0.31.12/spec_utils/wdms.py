...
from spec_utils.base import OAuthClient, JSONResponse
from schemas import JWT
from schemas.wdms import (
    Company,
    CompanyList,
    Area,
    AreaList,
...
class Client(OAuthClient):
    ...
    def refresh_headers(
        ...
        if token:
            self.token = JWT(
                access_token=token.get("token", ""), token_type="JWT"
            )
    ...
    @validate_arguments
    def update_terminal(
        self, id: int, terminal: Terminal, **kwargs
    ) -> Terminal:
    ...
    def delete_terminal(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.device_api_url}terminals/{id}/", **kwargs
        )
    ...
    def terminals_upload_transaction(
        self, terminals: List[int], **kwargs
    ) -> Any:
    ...
    def get_employees(
        ...
        **kwargs,
        ...
        path = "{}employees/{}".format(
            self.personnel_api_url, f"{id}/" if id else ""
        )
    ...
    @validate_arguments
    def update_employee(
        self, id: int, employee: Employee, **kwargs
    ) -> Employee:
    ...
    def delete_employee(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.personnel_api_url}employees/{id}/", **kwargs
        )
    ...
    def delete_department(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.personnel_api_url}departments/{id}/", **kwargs
        )
    ...
    def delete_company(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.personnel_api_url}company/{id}/", **kwargs
        )
    ...
    def delete_area(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.personnel_api_url}areas/{id}/", **kwargs
        )
    ...
    @validate_arguments
    def update_position(
        self, id: int, position: Position, **kwargs
    ) -> Position:
    ...
    def delete_position(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.personnel_api_url}positions/{id}/", **kwargs
        )
    ...
    def get_transactions(
        ...
        upload_time_more_than: Optional[
    ...
    def delete_transaction(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.device_api_url}transactions/{id}/", **kwargs
        )
    ...
    def delete_public_message(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.device_api_url}publicmessages/{id}/", **kwargs
        )
    ...
    def delete_private_message(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.device_api_url}privatemessages/{id}/", **kwargs
        )
    ...
    def update_work_code(
        self, id: int, work_code: WorkCode, **kwargs
    ) -> WorkCode:
    ...
    def delete_work_code(self, id: int, **kwargs) -> bool:
        ...
        return self.delete(
            path=f"{self.device_api_url}workcodes/{id}/", **kwargs
        )
