...
from spec_utils.base import OAuthClient, AsyncOAuthClient
...
class Client(OAuthClient):
    ...
    def __init__(
        ...
        *,
        ...
        if admin_url:
            ...
            self.client_url = urlparse(
                urljoin(self.client_url.geturl(), "/WebApi/")
            )
    ...
    def login(self) -> None:
        ...
        # data prepare
        login_url = urljoin(
            self.client_admin_url.geturl(), "authentication/login"
        )
        data = {
    ...
    def logout(self) -> None:
        ...
        # data prepare
        logout_url = urljoin(
            self.client_admin_url.geturl(), "authentication/logout"
        )
    ...
    def get_addresses(
        self, address: str = None, extension: str = None, **kwargs
    ):
    ...
    def get_journals(
        self, journal: str = None, extension: str = "lines", **kwargs
    ):
    ...
    def get_sync(
        self, extension: str = None, applicationName: str = None, **kwargs
    ):
    ...
    async def get_journals(
        ...
        **kwargs,
        ...
        params = {
            ...
            "pageSize": kwargs.get("pageSize", self.defaults.PAGE_SIZE),
            "dateFrom": kwargs.get(
                "dateFrom", self.defaults.DATE_FROM.isoformat()
            ),
            "dateTo": kwargs.get("dateTo", None),
            "processDate": kwargs.get("processDate", None),
            "companyId": kwargs.get("companyId", None),
