...
def send_reading_summary(api_inputs: ApiInputs, df: pd.DataFrame):
...
@_with_func_attrs(df_required_columns=['ObjectPropertyId', 'InstallationId', 'LastRecord'])
def update_last_record(api_inputs: ApiInputs, df: pandas.DataFrame):
    """
    ...
    required_columns = getattr(update_last_record, 'df_required_columns')
