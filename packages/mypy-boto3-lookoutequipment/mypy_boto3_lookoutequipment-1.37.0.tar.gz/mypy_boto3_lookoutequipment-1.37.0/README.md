...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-lookoutequipment)](https://pypistats.org/packages/mypy-boto3-lookoutequipment)
...
`mypy-boto3-lookoutequipment` dependency in production. However, there is an
