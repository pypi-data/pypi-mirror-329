...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-lex-models)](https://pypistats.org/packages/mypy-boto3-lex-models)
...
`mypy-boto3-lex-models` dependency in production. However, there is an issue in
