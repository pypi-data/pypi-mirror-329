...
class AsroPreprocessing:
    def __init__(self, profile_path):
        base_path = os.getcwd()
        self.profile_path = profile_path  # path to the user profile data
        ...
        self.ensure_files_exist([stopwords_path, normalization_path, news_dictionary_path, profile_path])
    ...
    def detect_media_source(self, tokens, channel_title):
        """ Detect if the channel title or any of the tokens are in the set of known media sources. """
...
if __name__ == "__main__":
    app = AsroPreprocessing('data/profile.json')
