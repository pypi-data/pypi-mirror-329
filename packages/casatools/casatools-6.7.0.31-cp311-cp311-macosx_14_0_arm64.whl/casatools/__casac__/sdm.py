...
class sdm(object):
    ...
    def toms(self, *args, **kwargs):
        r"""
        toms(self, _vis=string(""), _createmms=bool(false), _separationaxis=string("auto"), _numsubms=variant( ), _corr_mode=string("all"), _srt=string("all"), _time_sampling=string("all"), _ocorr_mode=string("ca"), _compression=bool(false), _lazy=bool(false), _asis=string(""), _wvr_corrected_data=string("no"), _scans=string(""), _ignore_time=bool(false), _process_syspower=bool(true), _process_caldevice=bool(true), _process_pointing=bool(true), _process_flags=bool(true), _tbuff=double(0.0), _applyflags=bool(false), _savecmds=bool(false), _outfile=variant( ), _flagbackup=bool(true), _verbose=bool(false), _overwrite=bool(false), _bdfflags=bool(false), _with_pointing_correction=bool(false), _convert_ephem2geo=bool(true), _polyephem_tabtimestep=double(0.)) -> bool
