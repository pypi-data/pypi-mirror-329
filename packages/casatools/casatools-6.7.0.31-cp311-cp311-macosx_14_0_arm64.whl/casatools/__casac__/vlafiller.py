...
class vlafiller(object):
    ...
    def fill(self, *args, **kwargs):
        r"""
        fill(self, _msname=string(""), _inputfile=string(""), _project=string(""), _start=string("1970/1/1/00:00:00"), _stop=string("2199/1/1/23:59:59"), _centerfreq=string("1.0e18Hz"), _bandwidth=string("2.0e18Hz"), _bandname=string("*"), _source=string(""), _subarray=long(0), _qualifier=long(-65536), _calcode=string("#"), _overwrite=bool(false), _freqtol=variant( ), _applytsys=bool(true), _keepautocorr=bool(false), _antnamescheme=string("new"), _useday=long(1), _keepblanks=bool(false), _evlabands=bool(true))
