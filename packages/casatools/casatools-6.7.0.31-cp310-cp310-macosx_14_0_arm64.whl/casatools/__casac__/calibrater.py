...
class calibrater(object):
    r"""Proxy of C++ casac::calibrater class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(self) -> calibrater"""
        _calibrater.calibrater_swiginit(self, _calibrater.new_calibrater())

    def open(self, *args, **kwargs):
        r"""
        open(self, _filename=string(""), _compress=bool(false), _addcorr=bool(true), _addmodel=bool(true)) -> bool
    ...
    def selectvis(self, *args, **kwargs):
        r"""
        selectvis(self, _time=variant( ), _spw=variant( ), _scan=variant( ), _field=variant( ), _intent=variant( ), _observation=variant( ), _baseline=variant( ), _uvrange=variant( ), _chanmode=string("none"), _nchan=long(1), _start=long(0), _step=long(1), _mstart=Quantity(std::vector<double>(1,0.0),"km/s"), _mstep=Quantity(std::vector<double>(1,0.0),"km/s"), _msselect=string("")) -> bool
        ...
        Input Parameters:
            ...
            chanmode                  Type of data selection: channel or velocity
            nchan                     Number of channels to select (mode='channel')
            start                     Start channel (0-relative) (mode='channel')
            step                      Step in channel number (mode='channel')
    ...
    def setmodel(self, *args, **kwargs):
        r"""
        setmodel(self, _modelimage=string("")) -> bool
    ...
    def setptmodel(self, *args, **kwargs):
        r"""
        setptmodel(self, _stokes=std::vector< double >({0.0,0.0,0.0,0.0})) -> bool
        ...
        Input Parameters:
            stokes                    Vector of Stokes parameters.
    ...
    def setapply(self, *args, **kwargs):
        r"""
        setapply(self, _type=string(""), _t=double(0.0), _table=string(""), _field=variant( ), _interp=string("linear"), _select=string(""), _calwt=bool(false), _spwmap=std::vector< long >({-1}), _opacity=std::vector< double >({0.0})) -> bool
        ...
        Input Parameters:
            ...
            opacity                   Array-wide zenith opacity per antenna (for type='TOPAC')
    ...
    def setcallib(self, *args, **kwargs):
        r"""
        setcallib(self, _callib=initialize_record("")) -> bool
    ...
    def validatecallib(self, *args, **kwargs):
        r"""
        validatecallib(self, _callib=initialize_record("")) -> bool
    ...
    def setsolve(self, *args, **kwargs):
        r"""
        setsolve(self, _type=string("MF"), _t=variant( ), _table=string(""), _append=bool(false), _preavg=double(-1.0), _phaseonly=bool(false), _apmode=string("AP"), _refant=variant( ), _refantmode=string("flex"), _minblperant=long(4), _solnorm=bool(false), _normtype=string("mean"), _minsnr=float(0.0), _combine=string(""), _fillgaps=long(0), _cfcache=string(""), _painc=float(360.0), _fitorder=long(0), _fraction=float(0.1), _numedge=long(-1), _radius=string(""), _smooth=bool(true), _zerorates=bool(false), _globalsolve=bool(true), _niter=long(100), _corrcomb=string("none"), _delaywindow=std::vector< double >({}), _ratewindow=std::vector< double >({}), _paramactive=std::vector< bool >({}), _concatspws=bool(true), _solmode=string(""), _rmsthresh=std::vector< double >({})) -> bool
        ...
        Input Parameters:
            ...
            phaseonly                 Solve only for phase?
            apmode                    Solve for 'AP', 'A' (amp-only) or 'P' (phase-only)
            refant                    Reference antenna.  Default is none.
            refantmode                Reference antenna mode
            minblperant               Minimum number of baselines per ant for solving
            solnorm                   Normalize solution after solve
            normtype                  Solution normalization type
            minsnr                    SNR threshold for accepting solutions
            ...
            painc                     Parallactic Angle increment used to trigger computation of a new convolution function.  This is used when type=EP.  Default value implies that only one convolution function will be computed for the entire range of observation.
            fitorder                  Order of the polynomial fit, used when type='A'.
            fraction                  [SINGLE-DISH SPECIFIC] Edge detection parameter for otfraster/otf calibration. This is a number of edge points as a fraction of total number of points.
            ...
            radius                    [SINGLE-DISH SPECIFIC] Specifies radius of the central region of double circle gain calibration for fast scanning data. The value must be either empty or quantum string (numeric value with unit). Default ('') is to use a radius of primary beam.
            smooth                    [SINGLE-DISH SPECIFIC] Whether or not applying smoothing during double circle gain calibration for fast scanning data. Default is True.
            zerorates                 [FRINGE-FIT SPECIFIC] Zero delay-rates in fringe fitting solution tables.
            globalsolve               [FRINGE-FIT SPECIFIC] Use global least-squares solver to improve fringe-fitting parameter estimates
            niter                     [FRINGE-FIT SPECIFIC] Maximum number of iterations for global least-squares solver
            corrcomb                  [FRINGE-FIT SPECIFIC] Combine correlations (currently supported values are 'none' and 'all') 
            delaywindow               [FRINGE-FIT SPECIFIC] Constrain FFT delay search to a window; a two-element list, units of nanoseconds
            ratewindow                [FRINGE-FIT SPECIFIC] Constrain FFT rate search to a window; a two-element list, units of seconds per second
            paramactive               An array of three booleans to control whether to sove for delay, fringe-rate and dispersive delay
            concatspws                A flag to control multiband FFT behaviour in fringefit task.
            solmode                   Solving mode: '', 'L1'; add 'R' for iterative outlier excision.
    ...
    def setsolvegainspline(self, *args, **kwargs):
        r"""
        setsolvegainspline(self, _table=string(""), _append=bool(false), _mode=string("PHAS"), _splinetime=double(10800), _preavg=double(0.0), _npointaver=long(10), _phasewrap=double(250), _refant=variant( )) -> bool
    ...
    def setsolvebandpoly(self, *args, **kwargs):
        r"""
        setsolvebandpoly(self, _table=string(""), _append=bool(false), _t=variant( ), _combine=string(""), _degamp=long(3), _degphase=long(3), _visnorm=bool(false), _solnorm=bool(true), _maskcenter=long(0), _maskedge=double(5.0), _refant=variant( )) -> bool
    ...
    def returndict(self):
        r"""
        returndict(self) -> record *


        Summary:
            Return a dictionary describing the current calibrater state
        ...
        """
        return _calibrater.calibrater_returndict(self)
    ...
    def reset(self, *args, **kwargs):
        r"""
        reset(self, _apply=bool(true), _solve=bool(true)) -> bool
        ...
        Input Parameters:
            apply                     If true, unset all apply settings
            solve                     If true, unset all solve settings
        ...
        """
        return _calibrater.calibrater_reset(self, *args, **kwargs)

    def initcalset(self, *args, **kwargs):
        r"""
        initcalset(self, _calset=long(0)) -> bool
        ...
        """
        return _calibrater.calibrater_initcalset(self, *args, **kwargs)

    def delmod(self, *args, **kwargs):
        r"""
        delmod(self, _otf=bool(false), _field=variant( ), _spw=variant( ), _scr=bool(false)) -> bool
        ...
        Input Parameters:
            otf                       If T, delete the otf model data keywords
            field                     Select on field
            spw                       Select on spw only if field is defined
            scr                       If T, delete the MODEL_DATA column
    ...
    def correct(self, *args, **kwargs):
        r"""
        correct(self, _applymode=string("")) -> bool
    ...
    def initweights(self, *args, **kwargs):
        r"""
        initweights(self, _wtmode=string("nyq"), _dowtsp=bool(false), _tsystable=string(""), _gainfield=string(""), _interp=string(""), _spwmap=std::vector< long >({})) -> bool
        ...
        Input Parameters:
            ...
            dowtsp                    Initialize WEIGHT_SPECTRUM column
            tsystable                 Tsys calibration table to apply on the fly
            gainfield                 Select a subset of calibrators from Tsys caltable
            interp                    Interp type in time[,freq]. default==linear,linear
    ...
    def fluxscale(self, *args, **kwargs):
        r"""
        fluxscale(self, _tablein=string(""), _reference=variant( ), _tableout=string(""), _transfer=variant( ), _listfile=string(""), _append=bool(false), _refspwmap=std::vector< long >({-1}), _gainthreshold=float(-1.0), _antenna=string(""), _timerange=string(""), _scan=string(""), _incremental=bool(false), _fitorder=long(1), _display=bool(false)) -> record *
        ...
        Input Parameters:
            ...
            append                    Append to existing table?
            refspwmap                 List of alternate spw for referencing
            gainthreshold             Threshold of gain amplitudes with respect to the median value to be used in flux scale calculation. Default: -1.0 (no threshold)
            ...
            incremental               create a incremental caltable
            fitorder                  order for spectral fitting for multiple spws
            display                   display statistics of the flux ratios
        ...
        This example generates a calibration table containing {tt G}
        ...
        assumed that 1331+305 has already had its MODEL_DATA set to
    ...
    def accumulate(self, *args, **kwargs):
        r"""
        accumulate(self, _tablein=string(""), _incrtable=string(""), _tableout=string(""), _field=variant( ), _calfield=variant( ), _interp=string("linear"), _t=double(-1.0), _spwmap=std::vector< long >({-1})) -> bool
        ...
        Input Parameters:
            ...
            t                         Cumulative table timescale when creating from scratch
            spwmap                    Spectral windows to apply
    ...
    def specifycal(self, *args, **kwargs):
        r"""
        specifycal(self, _caltable=string(""), _time=string(""), _spw=string(""), _antenna=string(""), _pol=string(""), _caltype=string(""), _parameter=std::vector< double >({1.0}), _infile=string(""), _uniform=bool(true)) -> bool
    ...
    def smooth(self, *args, **kwargs):
        r"""
        smooth(self, _tablein=string(""), _tableout=string(""), _field=variant( ), _smoothtype=string("median"), _smoothtime=double(60.0), _ratesmooth=bool(false)) -> bool
        ...
        Input Parameters:
            ...
            smoothtype                The smoothing type: 'mean' or 'median'
            smoothtime                Smoothing filter time constant (sec)
            ratesmooth                Use rate aware smoothing with fringfit data
    ...
    def rerefant(self, *args, **kwargs):
        r"""
        rerefant(self, _tablein=string(""), _tableout=string(""), _refantmode=string("flexible"), _refant=variant( )) -> bool
        ...
        Input Parameters:
            tablein                   Input calibration table
            tableout                  Output calibration table
            refantmode                The refant application mode
            refant                    Reference antenna.  Default is none.
        ...
        """
        return _calibrater.calibrater_rerefant(self, *args, **kwargs)

    def listcal(self, *args, **kwargs):
        r"""
        listcal(self, _caltable=string(""), _field=variant( ), _antenna=variant( ), _spw=variant( ), _listfile=string(""), _pagerows=long(50)) -> bool
    ...
    def posangcal(self, *args, **kwargs):
        r"""
        posangcal(self, _posangcor=std::vector< double >({}), _tablein=string(""), _tableout=string("")) -> bool
        ...
        This example takes an existing calibration table containing {tt D}
    ...
    def linpolcor(self, *args, **kwargs):
        r"""
        linpolcor(self, _tablein=string(""), _tableout=string(""), _fields=std::vector< std::string >({})) -> bool
        ...
        This example takes an existing calibration table containing {tt G}
    ...
    def plotcal(self, *args, **kwargs):
        r"""
        plotcal(self, _antennas=std::vector< long >({}), _fields=std::vector< long >({}), _spwids=std::vector< long >({}), _plottype=string("AMP"), _tablename=string(""), _polarization=long(1), _multiplot=bool(false), _nx=long(1), _ny=long(1), _psfile=string("")) -> bool
    ...
    def modelfit(self, *args, **kwargs):
        r"""
        modelfit(self, _vary=std::vector< bool >({}), _niter=long(0), _compshape=string("P"), _par=std::vector< double >({1.0,0.0,0.0}), _file=string("")) -> std::vector< double >
        ...
        Input Parameters:
            ...
            niter                     Number of non-linear fitting iterations
            compshape                 Component shape, P=point G=gaussian
            par                       Initial guess for fit parameters (default is for 'P)'I flux, rel RA, rel Dec, 1,0, 0.0, 0.0 are defaults
    ...
    def createcaltable(self, *args, **kwargs):
        r"""
        createcaltable(self, _caltable=string(""), _partype=string(""), _caltype=string(""), _singlechan=bool(false)) -> bool
        ...
        Input Parameters:
            ...
            partype                   Parameter type name
            caltype                   Calibration type name
            singlechan                Create a calibration table with frequency-independent parameters?
        ...
        """
        return _calibrater.calibrater_createcaltable(self, *args, **kwargs)
    ...
    def parsecallibfile(self, *args, **kwargs):
        r"""
        parsecallibfile(self, _filein=string("")) -> record *
        ...
        Input Parameters:
            filein                    Input cal library file name
        ...
        """
        return _calibrater.calibrater_parsecallibfile(self, *args, **kwargs)

    def setcorrdepflags(self, *args, **kwargs):
        r"""
        setcorrdepflags(self, _corrdepflags=bool(false)) -> bool
        ...
        Input Parameters:
            corrdepflags              Turn correlation dependent flags on/off (true/false)
        ...
        """
        return _calibrater.calibrater_setcorrdepflags(self, *args, **kwargs)

    def setvi(self, *args, **kwargs):
        r"""
        setvi(self, _old=bool(false), _quiet=bool(false)) -> bool
        ...
        Input Parameters:
            old                       Use old-style VI, if old=True, else use new VI2
            quiet                     Warn in logger, if quiet=False
        ...
        """
        return _calibrater.calibrater_setvi(self, *args, **kwargs)
    __swig_destroy__ = _calibrater.delete_calibrater

# Register calibrater in _calibrater:
_calibrater.calibrater_swigregister(calibrater)
