...
class synthesisimager(object):
    ...
    def setimage(self, *args, **kwargs):
        r"""
        setimage(self, _imagename=string(""), _nx=long(128), _ny=long(-1), _cellx=variant( ), _celly=variant( ), _stokes=string("I"), _phasecenter=variant( ), _nchan=long(-1), _freqstart=variant( ), _freqstep=variant( ), _restfreq=variant( ), _facets=long(1), _ftmachine=string("gridft"), _ntaylorterms=long(1), _reffreq=variant( ), _projection=string("SIN"), _distance=variant( ), _freqframe=string("LSRK"), _tracksource=bool(false), _trackdir=variant( ), _overwrite=bool(true), _padding=float(1.0), _useautocorr=bool(false), _usedoubleprec=bool(true), _wprojplanes=long(1), _convfunc=string("SF"), _startmodel=string(""), _aterm=bool(true), _psterm=bool(true), _mterm=bool(false), _wbawp=bool(true), _cfcache=string(""), _usepointing=bool(false), _pointingoffsetsigdev=variant( ), _dopbcorr=bool(true), _conjbeams=bool(false), _computepastep=float(360.0), _rotatepastep=float(5.0)) -> bool
    ...
    def setweighting(self, *args, **kwargs):
        r"""
        setweighting(self, _type=string("natural"), _rmode=string("norm"), _noise=variant( ), _robust=double(0.0), _fieldofview=variant( ), _npixels=long(0), _multifield=bool(false), _usecubebriggs=bool(false), _uvtaper=std::vector< std::string >({})) -> bool
