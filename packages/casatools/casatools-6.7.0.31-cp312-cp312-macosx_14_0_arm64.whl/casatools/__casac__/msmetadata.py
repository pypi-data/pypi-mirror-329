...
class msmetadata(object):
    ...
    def antennadiameter(self, *args, **kwargs):
        r"""
        antennadiameter(self, _antenna=variant( )) -> record *
    ...
    def antennaids(self, *args, **kwargs):
        r"""
        antennaids(self, _name=variant( ), _mindiameter=variant( ), _maxdiameter=variant( ), _obsid=long(-1)) -> std::vector< long >
    ...
    def antennanames(self, *args, **kwargs):
        r"""
        antennanames(self, _antennaids=variant( )) -> std::vector< std::string >
    ...
    def antennaoffset(self, *args, **kwargs):
        r"""
        antennaoffset(self, _which=variant( )) -> record *
    ...
    def antennaposition(self, *args, **kwargs):
        r"""
        antennaposition(self, _which=variant( )) -> record *
    ...
    def antennastations(self, *args, **kwargs):
        r"""
        antennastations(self, _which=variant( ), _obsid=long(-1)) -> std::vector< std::string >
    ...
    def bandwidths(self, *args, **kwargs):
        r"""
        bandwidths(self, _spw=variant( )) -> variant *
    ...
    def corrbit(self, *args, **kwargs):
        r"""
        corrbit(self, _spw=variant( )) -> variant *
    ...
    def corrprodsforpol(self, *args, **kwargs):
        r"""
        corrprodsforpol(self, _pol=long(-1)) -> variant *
    ...
    def fieldsforintent(self, *args, **kwargs):
        r"""
        fieldsforintent(self, _intent=string(""), _asnames=bool(false)) -> variant *
    ...
    def fieldsforscan(self, *args, **kwargs):
        r"""
        fieldsforscan(self, _scan=long(-1), _asnames=bool(false), _obsid=long(-1), _arrayid=long(-1)) -> variant *
    ...
    def fieldsforscans(self, *args, **kwargs):
        r"""
        fieldsforscans(self, _scans=std::vector< long >({}), _asnames=bool(false), _obsid=long(-1), _arrayid=long(-1), _asmap=bool(false)) -> variant *
    ...
    def fieldsforsource(self, *args, **kwargs):
        r"""
        fieldsforsource(self, _source=long(-1), _asnames=bool(false)) -> variant *
    ...
    def fieldsforspw(self, *args, **kwargs):
        r"""
        fieldsforspw(self, _spw=long(-1), _asnames=bool(false)) -> variant *
    ...
    def intentsforfield(self, *args, **kwargs):
        r"""
        intentsforfield(self, _field=variant( )) -> std::vector< std::string >
    ...
    def namesforfields(self, *args, **kwargs):
        r"""
        namesforfields(self, _fieldids=variant( )) -> std::vector< std::string >
    ...
    def namesforspws(self, *args, **kwargs):
        r"""
        namesforspws(self, _spwids=variant( )) -> std::vector< std::string >
    ...
    def ncorrforpol(self, *args, **kwargs):
        r"""
        ncorrforpol(self, _polid=long(-1)) -> variant *
    ...
    def polidfordatadesc(self, *args, **kwargs):
        r"""
        polidfordatadesc(self, _ddid=long(-1)) -> variant *
    ...
    def refdir(self, *args, **kwargs):
        r"""
        refdir(self, _field=variant( ), _epoch=initialize_record("")) -> record *
    ...
    def restfreqs(self, *args, **kwargs):
        r"""
        restfreqs(self, _sourceid=long(0), _spw=long(0)) -> variant *
    ...
    def rxbands(self, *args, **kwargs):
        r"""
        rxbands(self, _spwids=variant( )) -> std::vector< long >
    ...
    def scansforfield(self, *args, **kwargs):
        r"""
        scansforfield(self, _field=variant( ), _obsid=long(-1), _arrayid=long(-1)) -> std::vector< long >
    ...
    def spwsforbaseband(self, *args, **kwargs):
        r"""
        spwsforbaseband(self, _baseband=long(-1), _sqldmode=string("include")) -> variant *
    ...
    def spwfordatadesc(self, *args, **kwargs):
        r"""
        spwfordatadesc(self, _ddid=long(-1)) -> variant *
    ...
    def spwsforfield(self, *args, **kwargs):
        r"""
        spwsforfield(self, _field=variant( )) -> std::vector< long >
    ...
    def spwsfornames(self, *args, **kwargs):
        r"""
        spwsfornames(self, _spwids=variant( )) -> record *
    ...
    def subwindows(self, *args, **kwargs):
        r"""
        subwindows(self, _spwids=variant( )) -> std::vector< long >
    ...
    def timesforscan(self, *args, **kwargs):
        r"""
        timesforscan(self, _scan=long(-1), _obsid=long(-1), _arrayid=long(-1), _perspw=bool(false)) -> variant *
    ...
    def timesforscans(self, *args, **kwargs):
        r"""
        timesforscans(self, _scans=variant( ), _obsid=long(-1), _arrayid=long(-1)) -> std::vector< double >
    ...
    def timesforspws(self, *args, **kwargs):
        r"""
        timesforspws(self, _spw=variant( )) -> variant *
    ...
    def transitions(self, *args, **kwargs):
        r"""
        transitions(self, _sourceid=long(0), _spw=long(0)) -> variant *
