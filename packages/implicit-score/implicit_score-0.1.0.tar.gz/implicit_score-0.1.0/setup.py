...
setuptools.setup(
    ...
    version="0.1.0",            # Update as needed (semantic versioning)
    author="Yuxin Wang",
    ...
    # package_data={
    #     "impscore": ["model_data/*"],  # matches files in `impscore/model_data/`
    # },
    classifiers=[
    ...
    python_requires=">=3.6",
    install_requires=[
        # Add any runtime dependencies here, like "numpy>=1.21.0"
    ],
)