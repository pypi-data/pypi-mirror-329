...
class PyrpcSchedule:
    ...
    def __new__(cls, *args, **kwargs):
        if 'is_initialize' in kwargs and kwargs['is_initialize'] is False:
            _instance = super(PyrpcSchedule, cls).__new__(cls)
            _instance._initialize_module()
            return _instance
    ...
    def __init__(self, config: dict, is_cipher: bool = False, is_initialize: bool = True):
        """
        ...
        Args:
            ...
            is_initialize (bool): A flag indicating whether to initialize the instance. Default is True.
        """
    ...
    def _initialize(self, config, is_cipher=False, is_initialize=True):
        """
        Initialize the PyrpcSchedule instance.
        Args:
