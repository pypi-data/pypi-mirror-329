...
class TestBarcodegeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = BarcodegeneratorAPIClient(self.api_key)

    @patch('apiverve_barcodegenerator.apiClient.requests.get')
