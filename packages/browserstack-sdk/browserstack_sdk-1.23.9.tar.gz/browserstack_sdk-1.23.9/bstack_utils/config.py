...
conf = {
    bstack111l1ll_opy_ (u"ࠫࡦࡶࡰࡠࡣࡸࡸࡴࡳࡡࡵࡧࠪႏ"): False,
    bstack111l1ll_opy_ (u"ࠬࡨࡳࡵࡣࡦ࡯ࡤࡹࡥࡴࡵ࡬ࡳࡳ࠭႐"): True,
    bstack111l1ll_opy_ (u"࠭ࡳ࡬࡫ࡳࡣࡸ࡫ࡳࡴ࡫ࡲࡲࡤࡹࡴࡢࡶࡸࡷࠬ႑"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    def bstack1l1l11lll1_opy_(self, property_name, bstack1111l11lll_opy_):
        self._1111l1l111_opy_[property_name] = bstack1111l11lll_opy_
    def bstack1ll1l1l1l_opy_(self, val):
        self._1111l1l111_opy_[bstack111l1ll_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭႒")] = bool(val)
    def bstack111ll11l1l_opy_(self):
        return self._1111l1l111_opy_.get(bstack111l1ll_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧ႓"), False)