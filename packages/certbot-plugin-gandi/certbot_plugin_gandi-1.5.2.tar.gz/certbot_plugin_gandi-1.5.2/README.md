...
> [!CAUTION]
> This plugin is now deprecated and has been repackaged into a new name [`certbot-dns-plugin`](https://pypi.org/project/certbot-dns-gandi/) to follow the common naming convention for dns plugins. The new plugin has been added as a dependency of this one for smooth transition.
