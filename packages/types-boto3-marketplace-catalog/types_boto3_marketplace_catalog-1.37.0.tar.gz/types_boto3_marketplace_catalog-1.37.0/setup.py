"""
Setup script for types-boto3-marketplace-catalog.
...
setup(
    name="types-boto3-marketplace-catalog",
    version="1.37.0",
    packages=["types_boto3_marketplace_catalog"],
    ...
    package_data={"types_boto3_marketplace_catalog": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
