...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-discovery)](https://pypistats.org/packages/mypy-boto3-discovery)
...
`mypy-boto3-discovery` dependency in production. However, there is an issue in
