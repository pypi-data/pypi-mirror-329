...
def generate_talklink_page(transcript: Transcript, claims: ClaimsData, video_id: str,  speakers: str, video_title="Talk Link", toc_path="TODO_REPLACE_WITH_TOC_PATH"):
    if video_title == "":
