...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-codeguru-security)](https://pypistats.org/packages/mypy-boto3-codeguru-security)
...
`mypy-boto3-codeguru-security` dependency in production. However, there is an
