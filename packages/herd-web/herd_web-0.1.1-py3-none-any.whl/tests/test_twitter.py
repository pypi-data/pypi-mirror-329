...
# Twitter credentials
TWITTER_USERNAME = "playzimbo"  # Replace with actual username
TWITTER_PASSWORD = "E2w68!@c9X2yPU"  # Replace with actual password

# Test parameters
DEFAULT_WAIT_TIME = 2
TEST_SEARCH_TERM = "python programming"
TEST_PROFILE = "pathfinderSport"
TEST_TWEET_ID = "1234567890"  # Replace with actual tweet ID
SEARCH_TABS = ["Top", "Latest", "People", "Photos", "Videos"]
