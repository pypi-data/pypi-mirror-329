...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-oam)](https://pypistats.org/packages/mypy-boto3-oam)
...
`mypy-boto3-oam` dependency in production. However, there is an issue in
