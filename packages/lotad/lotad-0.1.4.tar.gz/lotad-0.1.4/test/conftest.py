...
def create_clean_databases() -> str:
...
def config(create_clean_databases: str) -> Config:
    clean_db_path = create_clean_databases
    tmp_dir = tempfile.mkdtemp()
    ...
    return Config(
        ...
        db1_connection_string=db1_path,
        db2_connection_string=db2_path,
        ignore_dates=False,
    )
