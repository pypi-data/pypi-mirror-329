...
class _FiinIndicator:
    ...
    class smart_money_concepts:
        ...
        # class Previous_Highs_Lows:
        #     def __init__(self, df: pd.DataFrame, time_frame: str = "1M") -> None: ...
        #     def previous_high(self) -> pd.Series: ...
        #     def previous_low(self) -> pd.Series: ...
        #     def broken_high (self) -> pd.Series: ...
        #     def broken_low (self) -> pd.Series: ...
        class Liquidity:
    ...
    # def previous_high(self, df: pd.DataFrame, time_frame: str = "5m") -> pd.Series: ...
    
    # def previous_low(self, df: pd.DataFrame, time_frame: str = "5m") -> pd.Series: ...
    
    # def broken_high(self, df: pd.DataFrame, time_frame: str = "5m") -> pd.Series: ...
    
    # def broken_low(self, df: pd.DataFrame, time_frame: str = "5m") -> pd.Series: ...
