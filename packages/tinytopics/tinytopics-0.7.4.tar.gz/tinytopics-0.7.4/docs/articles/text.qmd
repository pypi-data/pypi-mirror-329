...
---
title: "Text data topic modeling"
format: gfm
eval: false
---
...
14036 terms. More details about the dataset can be found in
[this GitHub repo](https://github.com/stephenslab/fastTopics-experiments).
...
We first load the L and F matrices fitted by fastTopics and then
compare them with the tinytopics model. For easier visual comparison, we will
try to "align" the topics fitted by tinytopics with those from fastTopics,
and sort documents grouped by dominant topics.
...
Plot the probability of top 15 terms in each topic from both models
to inspect their concordance:
