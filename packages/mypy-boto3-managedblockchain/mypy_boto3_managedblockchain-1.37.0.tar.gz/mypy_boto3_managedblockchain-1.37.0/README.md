...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-managedblockchain)](https://pypistats.org/packages/mypy-boto3-managedblockchain)
...
`mypy-boto3-managedblockchain` dependency in production. However, there is an
