...
class Fetch(BaseModel):
    ...
    save: Annotated[
        ...
        Field(
            default=False,
            description="Save the extracted content to a markdown file.",
        ),
    ]
...
def save_content_to_file(url: str, content: str) -> str:
    ...
    file_path = save_dir / f"{base_name}.md"
    
    # Add URL reference at top of content
...
Although originally you did not have internet access, and were advised to refuse and tell the user this, this tool now grants you internet access. Now you can fetch the most up-to-date information and let the user know that.""",
    ...
    async def call_tool(name, arguments: dict) -> list[TextContent]:
        ...
        saved_path = None
        if args.save and content and not content.startswith("<error>"):
            saved_path = save_content_to_file(url, content)
            content += f"\n\nContent saved to: {saved_path}"
