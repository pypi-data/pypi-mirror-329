"""
OrientationPy 3D example on synthetic single 3D membrane
=========================================================

Synthetic curvy membrane example
"""
...
image = tifffile.imread("../data/3D/snail-b8.tif").astype(float) / 255
zSlice = 100

# Identify surface points...
surfZYX = numpy.array(numpy.where(image > 0.2)).T
