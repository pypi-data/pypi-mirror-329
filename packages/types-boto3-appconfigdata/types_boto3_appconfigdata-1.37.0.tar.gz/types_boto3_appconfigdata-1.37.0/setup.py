"""
Setup script for types-boto3-appconfigdata.
...
setup(
    name="types-boto3-appconfigdata",
    version="1.37.0",
    packages=["types_boto3_appconfigdata"],
    ...
    package_data={"types_boto3_appconfigdata": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
