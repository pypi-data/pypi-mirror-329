...
class Analytics(BaseSDK):
    def retrieve(
        ...
        *,
        request: Optional[
            Union[models.AnalyticsRequestBody, models.AnalyticsRequestBodyTypedDict]
        ] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.AnalyticsRequestBody])
        request = cast(Optional[models.AnalyticsRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.AnalyticsRequestBody]
            ),
