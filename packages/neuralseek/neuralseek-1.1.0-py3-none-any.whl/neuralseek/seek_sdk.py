...
class SeekSDK(BaseSDK):
    def execute(
        self,
        *,
        request: Union[models.Seek, models.SeekTypedDict] = models.Seek(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.SeekResponse:
        r"""Seek an answer from NeuralSeek
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.Seek)
        request = cast(models.Seek, request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.Seek]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.SeekResponse)
