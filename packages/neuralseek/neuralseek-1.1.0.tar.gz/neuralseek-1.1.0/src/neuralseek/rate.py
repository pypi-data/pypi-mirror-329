...
class Rate(BaseSDK):
    def submit(
        ...
        *,
        request: Union[
            models.RateRequestBody, models.RateRequestBodyTypedDict
        ] = models.RateRequestBody(),
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.RateRequestBody)
        request = cast(models.RateRequestBody, request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.RateRequestBody]
            ),
