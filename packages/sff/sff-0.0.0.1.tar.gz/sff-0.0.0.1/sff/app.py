...
def get_list_feature_demo(df, number_of_runs, n_estimators, percent,type=None, percent_hybrid=None ):
    if type is None or percent_hybrid is None:
        return get_frequency_of_feature_by_percent(df, number_of_runs, percent, n_estimators)
    method_switch = {
        "MI": get_features_by_mi_and_tffs(df, percent, number_of_runs, n_estimators, percent_hybrid),
        "PC": get_features_by_pc_and_tffs(df,percent, number_of_runs, n_estimators, percent_hybrid),
        "FS": get_features_by_fs_and_tffs(df, percent, number_of_runs, n_estimators, percent_hybrid),
        "BW": get_features_by_backward_and_tffs(df, percent, number_of_runs, n_estimators, percent_hybrid),
        "FW": get_features_by_forward_and_tffs(df, percent, number_of_runs, n_estimators, percent_hybrid),
        "RC": get_features_by_recusive_and_tffs(df, percent, number_of_runs, n_estimators, percent_hybrid),
        "LS": get_features_by_lasso_and_tffs(df, percent, number_of_runs, n_estimators, percent_hybrid)
    }
