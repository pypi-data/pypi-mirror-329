...
from .network import HMAC_Incorrect, ChecksumError, PacketSizeError
from typing import Union

from cryptography.fernet import InvalidToken

NetworkError = Union[InvalidToken, HMAC_Incorrect, ChecksumError, PacketSizeError] # Usual errors
ConnSocket = Union[Server, Client]
