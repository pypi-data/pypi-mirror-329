...
class _BauplanIterableCatalogAPIResponse(Generic[T, RT]):
    ...
    def __str__(self) -> str:
        return f'{self.__class__.__name__}(ref={str(self.ref)!r}, iterator={self.responses[0].metadata.request_id!r})'
...
class GetTablesResponse(_BauplanIterableCatalogAPIResponseWithRef[Table, Union[Branch, Tag]]): ...
