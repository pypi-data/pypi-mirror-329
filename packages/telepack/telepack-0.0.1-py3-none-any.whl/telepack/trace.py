...
# # Define a function which has been decorated to state that it should be timed
# @timed()
...
# # Call function before TraceLogger is configured - results in function being called as expected but no trace logged
# example_function()
# # Outputs:
# # Function executing
# # Function executed

# # Configure TraceLogger - this initialises the New Relic client and sets up caching of spans and logging them to New Relic on completion of a trace
# tl = TraceLogger(
#         "dummy_service", 
#         "dummy_host", 
#         use_kaggle_secret=True,
#         licence_key_secret_name="NEW_RELIC_LICENSE_KEY", 
#         eu_hosted=True
#         )

# All spans logged after this point will be sent to New Relic - TraceLogger has been configured and is active
# TraceLogger can be set to inactive at any point which will result in timings not being recorded and logged

# # Example usage of TimedContext - use this when timing of an ad ad hoc block of code (i.e. not a function) is to be timed
# import time
# with TimedContext("Adhoc Span 1"):
#     print("Adhoc Span 1 executing")
#     time.sleep(1)
#     print("Adhoc Span 1 executed")
# # Outputs:
# # Adhoc Span 1 executing
# # Adhoc Span 1 executed

# # Example of a function that is timed and includes a call to another function that is timed
# @timed()
# def example_function_2():
#     print("Function executing 2")
#     time.sleep(2)
#     example_function()
