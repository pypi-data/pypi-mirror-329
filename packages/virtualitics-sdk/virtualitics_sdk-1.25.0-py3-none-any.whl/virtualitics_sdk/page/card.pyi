...
class Card:
    ...
    :param show_comments: Whether or not to share the comments icon on this card. Defaults to False for non-Dashboard Steps
                          This value always be True with Dashboard Steps.
    :param show_export: Whether or not to share the export icon on this card. Defaults to False for non-Dashboard Steps
                        This value always be True with Dashboard Steps.
    :param show_share: Whether or not to share the share icon on this card. Defaults to False for non-Dashboard Steps
                       This value always be True with Dashboard Steps.
