...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-appflow)](https://pypistats.org/packages/mypy-boto3-appflow)
...
`mypy-boto3-appflow` dependency in production. However, there is an issue in
