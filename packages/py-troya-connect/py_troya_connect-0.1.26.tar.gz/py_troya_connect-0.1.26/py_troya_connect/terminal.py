...
class ExtraTerminal:
    ...
    def get_cursor_position(self):
        ...
        if not self.is_connected():
            raise ConnectionError("Not connected to terminal")
        try:
            return (self.screen.CursorRow, self.screen.CursorColumn)
        except pythoncom.com_error as e:
            raise CommandError(f"Cursor position failed: {e}") from e
...
if __name__ == "__main__":
    try:
        print("Attempting to initialize Extra Terminal...")
