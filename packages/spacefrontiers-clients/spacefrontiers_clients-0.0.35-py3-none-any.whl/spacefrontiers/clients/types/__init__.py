...
class Query(BaseModel):
    ...
    Attributes:
        ...
        intent (Literal["search", "no_search", "news", "research", "specified_document"]): 
            The intent category of the query (default: "search")
        representation (Literal["serp", "question", "digest", "summary"]): 
    ...
    query_language: str | None = None
    intent: Literal["search", "no_search", "news", "research", "specified_document"] = Field(default="search")
    representation: Literal["serp", "question", "digest", "summary"] = Field(default="serp")
