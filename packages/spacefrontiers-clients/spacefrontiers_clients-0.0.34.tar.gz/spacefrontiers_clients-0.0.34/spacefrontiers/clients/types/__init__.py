...
class Query(BaseModel):
    ...
    Attributes:
        ...
        representation (Literal["regular", "digest", "summary"]): Format for displaying results (default: "regular")
    """
    ...
    representation: Literal["regular", "digest", "summary"] = Field(default="regular")
