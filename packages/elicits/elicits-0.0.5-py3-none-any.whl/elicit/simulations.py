...
from elicit.types import Trainer, Parameter, NF, ExpertDict
...
class Priors(tf.Module):
    ...
    def __init__(self, ground_truth: bool,
                 init_matrix_slice: Optional[dict[str, tf.Tensor]], trainer: Trainer, parameters: list[Parameter],
                 network: Optional[NF], expert: ExpertDict,
                 seed: int):
        """
...
def intialize_priors(init_matrix_slice: Optional[dict[str, tf.Tensor]],
                     method: str, seed: int, parameters: list[Parameter],
                     network: Optional[NF]
                     ) -> dict[str, tf.Tensor]:
    """
...
def sample_from_priors(initialized_priors: Union[dict[str, tf.Variable], Callable],
                       ground_truth: bool, num_samples: int, B: int, seed: int,
                       method: str, parameters: list[Parameter], network: Optional[NF],
                       expert: ExpertDict
