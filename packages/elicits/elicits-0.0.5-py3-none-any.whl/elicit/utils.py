...
from elicit.targets import computation_target_quantities, computation_elicited_statistics
from elicit.types import Parallel, SaveHist, SaveResults, Trainer, Parameter, Target, ExpertDict, NF
...
def one_forward_simulation(
    prior_model: Priors, model: dict[str, Any],
    targets: list[Target], seed: int
...
def softmax_gumbel_trick(likelihood: Callable,
