...
- useCapture (boolean; default False):
    ...
    def __init__(
        ...
        captureKeys: typing.Optional[typing.Sequence[typing.Union[str, dict]]] = None,
        keydown: typing.Optional[dict] = None,
        keyup: typing.Optional[dict] = None,
        keys_pressed: typing.Optional[dict] = None,
