...
class ConcurrentWorkflow(BaseSwarm):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        metadata = SwarmMetadata(
            ...
            author="swarms_corp",
            tags=["concurrent", "workflow"],
            primary_objective="Execute multiple agents concurrently",
        ...
        self.swarm_visualizer = SwarmVisualizationRich(
    ...
    async def _run_agent(
        ...
        try:
            ...
            self.swarm_visualizer.log_agent_output(
