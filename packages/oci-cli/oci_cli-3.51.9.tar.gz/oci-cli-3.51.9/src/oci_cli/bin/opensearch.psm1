...
function GetOciSubcommands_opensearch() {
    $ociSubcommands = @{
        ...
        'opensearch cluster' = 'backup configureoutboundcluster create delete get list list-versions resizehorizontal resizevertical restore update work-request work-request-error work-request-log-entry'
