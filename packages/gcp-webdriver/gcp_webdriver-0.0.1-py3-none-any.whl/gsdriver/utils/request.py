from gsdriver.base.abstract import CustomDict, INVALID_OBJECT_TYPE_MSG
from gsdriver.base.types import _KT, _VT, TypeHint, IndexLabel, JsonData
from gsdriver.utils.map import regex_get, replace_map
