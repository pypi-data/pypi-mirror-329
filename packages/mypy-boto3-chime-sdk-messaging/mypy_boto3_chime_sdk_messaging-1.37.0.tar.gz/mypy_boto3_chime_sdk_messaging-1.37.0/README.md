...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-chime-sdk-messaging)](https://pypistats.org/packages/mypy-boto3-chime-sdk-messaging)
...
`mypy-boto3-chime-sdk-messaging` dependency in production. However, there is an
