...
if TYPE_CHECKING:
    from ..models.local_group_dto import LocalGroupDTO


T = TypeVar("T", bound="ApiResultResponseListLocalGroupDTO")


@_attrs_define
class ApiResultResponseListLocalGroupDTO:
    """
    Attributes:
        ...
        payload (Union[Unset, list['LocalGroupDTO']]): Is the value returned by api
    """

    error_code: int
    error_message: Union[Unset, str] = UNSET
    error_domain: Union[Unset, str] = UNSET
    payload: Union[Unset, list["LocalGroupDTO"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for payload_item_data in _payload or []:
            payload_item = LocalGroupDTO.from_dict(payload_item_data)

            payload.append(payload_item)

        api_result_response_list_local_group_dto = cls(
        ...
        api_result_response_list_local_group_dto.additional_properties = d
        return api_result_response_list_local_group_dto
