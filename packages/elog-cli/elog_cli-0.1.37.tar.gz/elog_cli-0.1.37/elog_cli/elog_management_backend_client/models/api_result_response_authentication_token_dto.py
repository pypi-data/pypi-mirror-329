...
T = TypeVar("T", bound="ApiResultResponseAuthenticationTokenDTO")


@_attrs_define
class ApiResultResponseAuthenticationTokenDTO:
    """
    Attributes:
        ...
        payload (Union[Unset, AuthenticationTokenDTO]): The authentication token
    """

    error_code: int
    error_message: Union[Unset, str] = UNSET
    error_domain: Union[Unset, str] = UNSET
    payload: Union[Unset, "AuthenticationTokenDTO"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        payload: Union[Unset, AuthenticationTokenDTO]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = AuthenticationTokenDTO.from_dict(_payload)

        api_result_response_authentication_token_dto = cls(
        ...
        api_result_response_authentication_token_dto.additional_properties = d
        return api_result_response_authentication_token_dto
