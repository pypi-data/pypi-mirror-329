...
T = TypeVar("T", bound="ApiResultResponseLocalGroupDTO")


@_attrs_define
class ApiResultResponseLocalGroupDTO:
    """
    Attributes:
        ...
        payload (Union[Unset, LocalGroupDTO]): Local group information
    """

    error_code: int
    error_message: Union[Unset, str] = UNSET
    error_domain: Union[Unset, str] = UNSET
    payload: Union[Unset, "LocalGroupDTO"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        payload: Union[Unset, LocalGroupDTO]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = LocalGroupDTO.from_dict(_payload)

        api_result_response_local_group_dto = cls(
        ...
        api_result_response_local_group_dto.additional_properties = d
        return api_result_response_local_group_dto
