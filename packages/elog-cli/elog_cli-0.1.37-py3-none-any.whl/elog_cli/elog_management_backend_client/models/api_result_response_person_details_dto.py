...
if TYPE_CHECKING:
    from ..models.person_details_dto import PersonDetailsDTO


T = TypeVar("T", bound="ApiResultResponsePersonDetailsDTO")


@_attrs_define
class ApiResultResponsePersonDetailsDTO:
    """
    Attributes:
        ...
        payload (Union[Unset, PersonDetailsDTO]): Details of a person
    """

    error_code: int
    error_message: Union[Unset, str] = UNSET
    error_domain: Union[Unset, str] = UNSET
    payload: Union[Unset, "PersonDetailsDTO"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        payload: Union[Unset, PersonDetailsDTO]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = PersonDetailsDTO.from_dict(_payload)

        api_result_response_person_details_dto = cls(
        ...
        api_result_response_person_details_dto.additional_properties = d
        return api_result_response_person_details_dto
