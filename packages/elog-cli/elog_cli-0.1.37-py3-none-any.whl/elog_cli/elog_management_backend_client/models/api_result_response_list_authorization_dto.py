...
T = TypeVar("T", bound="ApiResultResponseListAuthorizationDTO")


@_attrs_define
class ApiResultResponseListAuthorizationDTO:
    """
    Attributes:
        ...
        payload (Union[Unset, list['AuthorizationDTO']]): Is the value returned by api
    """

    error_code: int
    error_message: Union[Unset, str] = UNSET
    error_domain: Union[Unset, str] = UNSET
    payload: Union[Unset, list["AuthorizationDTO"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for payload_item_data in _payload or []:
            payload_item = AuthorizationDTO.from_dict(payload_item_data)

            payload.append(payload_item)

        api_result_response_list_authorization_dto = cls(
        ...
        api_result_response_list_authorization_dto.additional_properties = d
        return api_result_response_list_authorization_dto
